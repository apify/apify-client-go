...
// checks if the ActorRunTimeoutExceededError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorRunTimeoutExceededError{}

// ActorRunTimeoutExceededError struct for ActorRunTimeoutExceededError
type ActorRunTimeoutExceededError struct {
	Error *RunTimeoutExceededErrorDetail `json:"error,omitempty"`
}

// NewActorRunTimeoutExceededError instantiates a new ActorRunTimeoutExceededError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorRunTimeoutExceededError() *ActorRunTimeoutExceededError {
	this := ActorRunTimeoutExceededError{}
	return &this
}

// NewActorRunTimeoutExceededErrorWithDefaults instantiates a new ActorRunTimeoutExceededError object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorRunTimeoutExceededErrorWithDefaults() *ActorRunTimeoutExceededError {
	this := ActorRunTimeoutExceededError{}
	return &this
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *ActorRunTimeoutExceededError) GetError() RunTimeoutExceededErrorDetail {
	if o == nil || IsNil(o.Error) {
		var ret RunTimeoutExceededErrorDetail
		return ret
	}
	return *o.Error
}
...
func (o *ActorRunTimeoutExceededError) GetErrorOk() (*RunTimeoutExceededErrorDetail, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *ActorRunTimeoutExceededError) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
// SetError gets a reference to the given RunTimeoutExceededErrorDetail and assigns it to the Error field.
func (o *ActorRunTimeoutExceededError) SetError(v RunTimeoutExceededErrorDetail) {
	o.Error = &v
}

func (o ActorRunTimeoutExceededError) MarshalJSON() ([]byte, error) {
...
func (o ActorRunTimeoutExceededError) ToMap() (map[string]interface{}, error) {
...
type NullableActorRunTimeoutExceededError struct {
	value *ActorRunTimeoutExceededError
	isSet bool
}

func (v NullableActorRunTimeoutExceededError) Get() *ActorRunTimeoutExceededError {
	return v.value
}

func (v *NullableActorRunTimeoutExceededError) Set(val *ActorRunTimeoutExceededError) {
	v.value = val
	v.isSet = true
}

func (v NullableActorRunTimeoutExceededError) IsSet() bool {
	return v.isSet
}

func (v *NullableActorRunTimeoutExceededError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorRunTimeoutExceededError(val *ActorRunTimeoutExceededError) *NullableActorRunTimeoutExceededError {
	return &NullableActorRunTimeoutExceededError{value: val, isSet: true}
}

func (v NullableActorRunTimeoutExceededError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorRunTimeoutExceededError) UnmarshalJSON(src []byte) error {
	v.isSet = true
