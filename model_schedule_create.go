...
// ScheduleCreate struct for ScheduleCreate
type ScheduleCreate struct {
	...
	// 
	Actions []ScheduleCreateAction `json:"actions,omitempty"`
}
...
func (o *ScheduleCreate) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ScheduleCreate) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o *ScheduleCreate) SetIsExclusiveNil() {
...
func (o *ScheduleCreate) SetCronExpressionNil() {
...
func (o *ScheduleCreate) SetDescriptionNil() {
...
func (o *ScheduleCreate) SetTitleNil() {
	o.Title.Set(nil)
}
...
// SetActions gets a reference to the given []ScheduleCreateAction and assigns it to the Actions field.
