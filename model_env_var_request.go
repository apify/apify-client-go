...
// checks if the EnvVarRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvVarRequest{}

// EnvVarRequest struct for EnvVarRequest
...
type _EnvVarRequest EnvVarRequest

// NewEnvVarRequest instantiates a new EnvVarRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEnvVarRequest(name string) *EnvVarRequest {
	this := EnvVarRequest{}
	this.Name = name
	return &this
}

// NewEnvVarRequestWithDefaults instantiates a new EnvVarRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEnvVarRequestWithDefaults() *EnvVarRequest {
	this := EnvVarRequest{}
	return &this
}

// GetName returns the Name field value
func (o *EnvVarRequest) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *EnvVarRequest) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *EnvVarRequest) SetName(v string) {
	o.Name = v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *EnvVarRequest) GetValue() string {
...
// and a boolean to check if the value has been set.
func (o *EnvVarRequest) GetValueOk() (*string, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *EnvVarRequest) HasValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *EnvVarRequest) SetValue(v string) {
	o.Value = &v
}

// GetIsSecret returns the IsSecret field value if set, zero value otherwise.
func (o *EnvVarRequest) GetIsSecret() bool {
...
// and a boolean to check if the value has been set.
func (o *EnvVarRequest) GetIsSecretOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSecret) {
		return nil, false
	}
...
func (o *EnvVarRequest) HasIsSecret() bool {
	if o != nil && !IsNil(o.IsSecret) {
		return true
	}
...
func (o *EnvVarRequest) SetIsSecret(v bool) {
	o.IsSecret = &v
}

func (o EnvVarRequest) MarshalJSON() ([]byte, error) {
...
func (o EnvVarRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EnvVarRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvVarRequest := _EnvVarRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEnvVarRequest)

	if err != nil {
		return err
	}

	*o = EnvVarRequest(varEnvVarRequest)

	return err
}

type NullableEnvVarRequest struct {
	value *EnvVarRequest
	isSet bool
}

func (v NullableEnvVarRequest) Get() *EnvVarRequest {
	return v.value
}

func (v *NullableEnvVarRequest) Set(val *EnvVarRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvVarRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvVarRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvVarRequest(val *EnvVarRequest) *NullableEnvVarRequest {
	return &NullableEnvVarRequest{value: val, isSet: true}
}

func (v NullableEnvVarRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvVarRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
