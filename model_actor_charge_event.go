...
// checks if the ActorChargeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorChargeEvent{}

// ActorChargeEvent Definition of a single chargeable event for a pay-per-event Actor. Each event is either flat-priced (`eventPriceUsd` is set) or tier-priced (`eventTieredPricingUsd` is set); the two are mutually exclusive. 
type ActorChargeEvent struct {
	...
	EventPriceUsd *float32 `json:"eventPriceUsd,omitempty"`
	...
	EventTieredPricingUsd map[string]TieredPricingPerEventEntry `json:"eventTieredPricingUsd,omitempty"`
	// Whether this event is the Actor's primary chargeable event.
	IsPrimaryEvent *bool `json:"isPrimaryEvent,omitempty"`
	// Whether this event can only be charged once per Actor run.
	IsOneTimeEvent *bool `json:"isOneTimeEvent,omitempty"`
}

type _ActorChargeEvent ActorChargeEvent
...
// GetEventTitle returns the EventTitle field value
...
// GetEventTitleOk returns a tuple with the EventTitle field value
...
// SetEventTitle sets field value
...
// GetEventPriceUsd returns the EventPriceUsd field value if set, zero value otherwise.
func (o *ActorChargeEvent) GetEventPriceUsd() float32 {
	if o == nil || IsNil(o.EventPriceUsd) {
		var ret float32
		return ret
	}
	return *o.EventPriceUsd
}

// GetEventPriceUsdOk returns a tuple with the EventPriceUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorChargeEvent) GetEventPriceUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.EventPriceUsd) {
		return nil, false
	}
	return o.EventPriceUsd, true
}
...
// SetEventPriceUsd gets a reference to the given float32 and assigns it to the EventPriceUsd field.
func (o *ActorChargeEvent) SetEventPriceUsd(v float32) {
	o.EventPriceUsd = &v
}

// GetEventTieredPricingUsd returns the EventTieredPricingUsd field value if set, zero value otherwise.
func (o *ActorChargeEvent) GetEventTieredPricingUsd() map[string]TieredPricingPerEventEntry {
	if o == nil || IsNil(o.EventTieredPricingUsd) {
		var ret map[string]TieredPricingPerEventEntry
		return ret
	}
	return o.EventTieredPricingUsd
}

// GetEventTieredPricingUsdOk returns a tuple with the EventTieredPricingUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorChargeEvent) GetEventTieredPricingUsdOk() (map[string]TieredPricingPerEventEntry, bool) {
	if o == nil || IsNil(o.EventTieredPricingUsd) {
		return map[string]TieredPricingPerEventEntry{}, false
	}
	return o.EventTieredPricingUsd, true
}
...
// SetEventTieredPricingUsd gets a reference to the given map[string]TieredPricingPerEventEntry and assigns it to the EventTieredPricingUsd field.
func (o *ActorChargeEvent) SetEventTieredPricingUsd(v map[string]TieredPricingPerEventEntry) {
	o.EventTieredPricingUsd = v
}

// GetIsPrimaryEvent returns the IsPrimaryEvent field value if set, zero value otherwise.
func (o *ActorChargeEvent) GetIsPrimaryEvent() bool {
	if o == nil || IsNil(o.IsPrimaryEvent) {
		var ret bool
		return ret
	}
	return *o.IsPrimaryEvent
}

// GetIsPrimaryEventOk returns a tuple with the IsPrimaryEvent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorChargeEvent) GetIsPrimaryEventOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPrimaryEvent) {
		return nil, false
	}
	return o.IsPrimaryEvent, true
}
...
// SetIsPrimaryEvent gets a reference to the given bool and assigns it to the IsPrimaryEvent field.
func (o *ActorChargeEvent) SetIsPrimaryEvent(v bool) {
	o.IsPrimaryEvent = &v
}

// GetIsOneTimeEvent returns the IsOneTimeEvent field value if set, zero value otherwise.
func (o *ActorChargeEvent) GetIsOneTimeEvent() bool {
	if o == nil || IsNil(o.IsOneTimeEvent) {
		var ret bool
		return ret
	}
	return *o.IsOneTimeEvent
}

// GetIsOneTimeEventOk returns a tuple with the IsOneTimeEvent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorChargeEvent) GetIsOneTimeEventOk() (*bool, bool) {
	if o == nil || IsNil(o.IsOneTimeEvent) {
		return nil, false
	}
	return o.IsOneTimeEvent, true
}
...
// SetIsOneTimeEvent gets a reference to the given bool and assigns it to the IsOneTimeEvent field.
func (o *ActorChargeEvent) SetIsOneTimeEvent(v bool) {
	o.IsOneTimeEvent = &v
}

func (o ActorChargeEvent) MarshalJSON() ([]byte, error) {
...
func (o ActorChargeEvent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["eventTitle"] = o.EventTitle
	toSerialize["eventDescription"] = o.EventDescription
	if !IsNil(o.EventPriceUsd) {
		toSerialize["eventPriceUsd"] = o.EventPriceUsd
	}
	if !IsNil(o.EventTieredPricingUsd) {
		toSerialize["eventTieredPricingUsd"] = o.EventTieredPricingUsd
	}
	if !IsNil(o.IsPrimaryEvent) {
		toSerialize["isPrimaryEvent"] = o.IsPrimaryEvent
	}
	if !IsNil(o.IsOneTimeEvent) {
		toSerialize["isOneTimeEvent"] = o.IsOneTimeEvent
	}
	return toSerialize, nil
}

func (o *ActorChargeEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varActorChargeEvent := _ActorChargeEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorChargeEvent)

	if err != nil {
		return err
	}

	*o = ActorChargeEvent(varActorChargeEvent)

	return err
}

type NullableActorChargeEvent struct {
	value *ActorChargeEvent
	isSet bool
}

func (v NullableActorChargeEvent) Get() *ActorChargeEvent {
	return v.value
}

func (v *NullableActorChargeEvent) Set(val *ActorChargeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableActorChargeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableActorChargeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorChargeEvent(val *ActorChargeEvent) *NullableActorChargeEvent {
	return &NullableActorChargeEvent{value: val, isSet: true}
}

func (v NullableActorChargeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorChargeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
