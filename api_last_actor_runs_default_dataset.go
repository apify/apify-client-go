...
// LastActorRunsDefaultDatasetAPIService LastActorRunsDefaultDatasetAPI service
type LastActorRunsDefaultDatasetAPIService service

type ApiActRunsLastDatasetDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
	status *string
}

// Filter for the run status.
func (r ApiActRunsLastDatasetDeleteRequest) Status(status string) ApiActRunsLastDatasetDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastDatasetDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActRunsLastDatasetDeleteExecute(r)
}

/*
ActRunsLastDatasetDelete Delete last run's default dataset
...
[Delete dataset](/api/v2/dataset-delete) endpoint.
 ...
 @return ApiActRunsLastDatasetDeleteRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetDelete(ctx context.Context, actorId string) ApiActRunsLastDatasetDeleteRequest {
	return ApiActRunsLastDatasetDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetDeleteExecute(r ApiActRunsLastDatasetDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/dataset"
...
type ApiActRunsLastDatasetGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastDatasetGetRequest) Status(status string) ApiActRunsLastDatasetGetRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastDatasetGetRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastDatasetGetExecute(r)
}

/*
ActRunsLastDatasetGet Get last run's default dataset
...
[Get dataset](/api/v2/dataset-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastDatasetGetRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetGet(ctx context.Context, actorId string) ApiActRunsLastDatasetGetRequest {
	return ApiActRunsLastDatasetGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetGetExecute(r ApiActRunsLastDatasetGetRequest) (*DatasetResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetGet")
	if err != nil {
...
type ApiActRunsLastDatasetItemsGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastDatasetItemsGetRequest) Status(status string) ApiActRunsLastDatasetItemsGetRequest {
	r.status = &status
	return r
}

// Format of the results, possible values are: &#x60;json&#x60;, &#x60;jsonl&#x60;, &#x60;csv&#x60;, &#x60;html&#x60;, &#x60;xlsx&#x60;, &#x60;xml&#x60; and &#x60;rss&#x60;. The default value is &#x60;json&#x60;. 
func (r ApiActRunsLastDatasetItemsGetRequest) Format(format string) ApiActRunsLastDatasetItemsGetRequest {
	r.format = &format
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Clean(clean bool) ApiActRunsLastDatasetItemsGetRequest {
	r.clean = &clean
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiActRunsLastDatasetItemsGetRequest) Offset(offset float64) ApiActRunsLastDatasetItemsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. By default there is no limit.
func (r ApiActRunsLastDatasetItemsGetRequest) Limit(limit float64) ApiActRunsLastDatasetItemsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Fields(fields string) ApiActRunsLastDatasetItemsGetRequest {
	r.fields = &fields
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) OutputFields(outputFields string) ApiActRunsLastDatasetItemsGetRequest {
	r.outputFields = &outputFields
	return r
}

// A comma-separated list of fields which should be omitted from the items.
func (r ApiActRunsLastDatasetItemsGetRequest) Omit(omit string) ApiActRunsLastDatasetItemsGetRequest {
	r.omit = &omit
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Unwind(unwind string) ApiActRunsLastDatasetItemsGetRequest {
	r.unwind = &unwind
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Flatten(flatten string) ApiActRunsLastDatasetItemsGetRequest {
	r.flatten = &flatten
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Desc(desc bool) ApiActRunsLastDatasetItemsGetRequest {
	r.desc = &desc
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) Attachment(attachment bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) Delimiter(delimiter string) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) Bom(bom bool) ApiActRunsLastDatasetItemsGetRequest {
	r.bom = &bom
	return r
}

// Overrides default root element name of &#x60;xml&#x60; output. By default the root element is &#x60;items&#x60;. 
func (r ApiActRunsLastDatasetItemsGetRequest) XmlRoot(xmlRoot string) ApiActRunsLastDatasetItemsGetRequest {
	r.xmlRoot = &xmlRoot
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) XmlRow(xmlRow string) ApiActRunsLastDatasetItemsGetRequest {
	r.xmlRow = &xmlRow
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then header row in the &#x60;csv&#x60; format is skipped.
func (r ApiActRunsLastDatasetItemsGetRequest) SkipHeaderRow(skipHeaderRow bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) SkipHidden(skipHidden bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) SkipEmpty(skipEmpty bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) Simplified(simplified bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) View(view string) ApiActRunsLastDatasetItemsGetRequest {
	r.view = &view
	return r
}
...
func (r ApiActRunsLastDatasetItemsGetRequest) SkipFailedPages(skipFailedPages bool) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) FeedTitle(feedTitle string) ApiActRunsLastDatasetItemsGetRequest {
...
func (r ApiActRunsLastDatasetItemsGetRequest) FeedDescription(feedDescription string) ApiActRunsLastDatasetItemsGetRequest {
	r.feedDescription = &feedDescription
	return r
}

// Signature used for the access.
func (r ApiActRunsLastDatasetItemsGetRequest) Signature(signature string) ApiActRunsLastDatasetItemsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActRunsLastDatasetItemsGetRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActRunsLastDatasetItemsGetExecute(r)
}

/*
ActRunsLastDatasetItemsGet Get last run's dataset items
...
[Get dataset items](/api/v2/dataset-items-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastDatasetItemsGetRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetItemsGet(ctx context.Context, actorId string) ApiActRunsLastDatasetItemsGetRequest {
	return ApiActRunsLastDatasetItemsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetItemsGetExecute(r ApiActRunsLastDatasetItemsGetRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetItemsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/dataset/items"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActRunsLastDatasetItemsPostRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
...
// 
func (r ApiActRunsLastDatasetItemsPostRequest) ActRunsLastDatasetItemsPostRequest(actRunsLastDatasetItemsPostRequest ActRunsLastDatasetItemsPostRequest) ApiActRunsLastDatasetItemsPostRequest {
	r.actRunsLastDatasetItemsPostRequest = &actRunsLastDatasetItemsPostRequest
	return r
}

// Filter for the run status.
func (r ApiActRunsLastDatasetItemsPostRequest) Status(status string) ApiActRunsLastDatasetItemsPostRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastDatasetItemsPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActRunsLastDatasetItemsPostExecute(r)
}

/*
ActRunsLastDatasetItemsPost Store items in last run's dataset
...
[Store items](/api/v2/dataset-items-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastDatasetItemsPostRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetItemsPost(ctx context.Context, actorId string) ApiActRunsLastDatasetItemsPostRequest {
	return ApiActRunsLastDatasetItemsPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetItemsPostExecute(r ApiActRunsLastDatasetItemsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetItemsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastDatasetPutRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
...
// 
func (r ApiActRunsLastDatasetPutRequest) UpdateDatasetRequest(updateDatasetRequest UpdateDatasetRequest) ApiActRunsLastDatasetPutRequest {
	r.updateDatasetRequest = &updateDatasetRequest
	return r
}

// Filter for the run status.
func (r ApiActRunsLastDatasetPutRequest) Status(status string) ApiActRunsLastDatasetPutRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastDatasetPutRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastDatasetPutExecute(r)
}

/*
ActRunsLastDatasetPut Update last run's default dataset
...
[Update dataset](/api/v2/dataset-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastDatasetPutRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetPut(ctx context.Context, actorId string) ApiActRunsLastDatasetPutRequest {
	return ApiActRunsLastDatasetPutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return DatasetResponse
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetPutExecute(r ApiActRunsLastDatasetPutRequest) (*DatasetResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastDatasetStatisticsGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultDatasetAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastDatasetStatisticsGetRequest) Status(status string) ApiActRunsLastDatasetStatisticsGetRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastDatasetStatisticsGetRequest) Execute() (*DatasetStatisticsResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastDatasetStatisticsGetExecute(r)
}

/*
ActRunsLastDatasetStatisticsGet Get last run's dataset statistics
...
[Get dataset statistics](/api/v2/dataset-statistics-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastDatasetStatisticsGetRequest
*/
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetStatisticsGet(ctx context.Context, actorId string) ApiActRunsLastDatasetStatisticsGetRequest {
	return ApiActRunsLastDatasetStatisticsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultDatasetAPIService) ActRunsLastDatasetStatisticsGetExecute(r ApiActRunsLastDatasetStatisticsGetRequest) (*DatasetStatisticsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultDatasetAPIService.ActRunsLastDatasetStatisticsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/dataset/statistics"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
