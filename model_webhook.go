...
type Webhook struct {
	...
	LastDispatch NullableExampleWebhookDispatch `json:"lastDispatch,omitempty"`
	Stats NullableWebhookStats `json:"stats,omitempty"`
}
...
func (o *Webhook) SetShouldInterpolateStringsNil() {
...
// GetIgnoreSslErrors returns the IgnoreSslErrors field value
...
// GetIgnoreSslErrorsOk returns a tuple with the IgnoreSslErrors field value
// and a boolean to check if the value has been set.
...
// SetIgnoreSslErrors sets field value
...
func (o *Webhook) SetDoNotRetryNil() {
...
func (o *Webhook) SetPayloadTemplateNil() {
...
func (o *Webhook) SetHeadersTemplateNil() {
...
// GetLastDispatch returns the LastDispatch field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Webhook) GetLastDispatch() ExampleWebhookDispatch {
	if o == nil || IsNil(o.LastDispatch.Get()) {
		var ret ExampleWebhookDispatch
		return ret
	}
	return *o.LastDispatch.Get()
}

// GetLastDispatchOk returns a tuple with the LastDispatch field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLastDispatch gets a reference to the given NullableExampleWebhookDispatch and assigns it to the LastDispatch field.
func (o *Webhook) SetLastDispatch(v ExampleWebhookDispatch) {
	o.LastDispatch.Set(&v)
}
// SetLastDispatchNil sets the value for LastDispatch to be an explicit nil
func (o *Webhook) SetLastDispatchNil() {
	o.LastDispatch.Set(nil)
}
...
// SetStats gets a reference to the given NullableWebhookStats and assigns it to the Stats field.
func (o *Webhook) SetStats(v WebhookStats) {
	o.Stats.Set(&v)
}
// SetStatsNil sets the value for Stats to be an explicit nil
func (o *Webhook) SetStatsNil() {
	o.Stats.Set(nil)
}
...
func (o Webhook) ToMap() (map[string]interface{}, error) {
	...
	if o.LastDispatch.IsSet() {
		toSerialize["lastDispatch"] = o.LastDispatch.Get()
	}
	if o.Stats.IsSet() {
