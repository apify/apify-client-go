...
// checks if the DefaultRunOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultRunOptions{}

// DefaultRunOptions struct for DefaultRunOptions
type DefaultRunOptions struct {
	Build *string `json:"build,omitempty"`
	TimeoutSecs *int32 `json:"timeoutSecs,omitempty"`
	MemoryMbytes *int32 `json:"memoryMbytes,omitempty"`
	RestartOnError *bool `json:"restartOnError,omitempty"`
	MaxItems NullableInt32 `json:"maxItems,omitempty"`
	ForcePermissionLevel NullableActorPermissionLevel `json:"forcePermissionLevel,omitempty"`
}
...
// GetMemoryMbytes returns the MemoryMbytes field value if set, zero value otherwise.
func (o *DefaultRunOptions) GetMemoryMbytes() int32 {
	if o == nil || IsNil(o.MemoryMbytes) {
		var ret int32
		return ret
	}
	return *o.MemoryMbytes
}
...
// SetMemoryMbytes gets a reference to the given int32 and assigns it to the MemoryMbytes field.
...
func (o *DefaultRunOptions) SetMaxItemsNil() {
	o.MaxItems.Set(nil)
}
...
// GetForcePermissionLevel returns the ForcePermissionLevel field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DefaultRunOptions) GetForcePermissionLevel() ActorPermissionLevel {
	if o == nil || IsNil(o.ForcePermissionLevel.Get()) {
		var ret ActorPermissionLevel
		return ret
	}
	return *o.ForcePermissionLevel.Get()
}

// GetForcePermissionLevelOk returns a tuple with the ForcePermissionLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetForcePermissionLevel gets a reference to the given NullableActorPermissionLevel and assigns it to the ForcePermissionLevel field.
func (o *DefaultRunOptions) SetForcePermissionLevel(v ActorPermissionLevel) {
	o.ForcePermissionLevel.Set(&v)
}
// SetForcePermissionLevelNil sets the value for ForcePermissionLevel to be an explicit nil
func (o *DefaultRunOptions) SetForcePermissionLevelNil() {
	o.ForcePermissionLevel.Set(nil)
}
...
func (o *DefaultRunOptions) UnsetForcePermissionLevel() {
	o.ForcePermissionLevel.Unset()
}

func (o DefaultRunOptions) MarshalJSON() ([]byte, error) {
...
func (o DefaultRunOptions) ToMap() (map[string]interface{}, error) {
	...
	if o.ForcePermissionLevel.IsSet() {
		toSerialize["forcePermissionLevel"] = o.ForcePermissionLevel.Get()
	}
	return toSerialize, nil
}

type NullableDefaultRunOptions struct {
	value *DefaultRunOptions
	isSet bool
}

func (v NullableDefaultRunOptions) Get() *DefaultRunOptions {
	return v.value
}

func (v *NullableDefaultRunOptions) Set(val *DefaultRunOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableDefaultRunOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableDefaultRunOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefaultRunOptions(val *DefaultRunOptions) *NullableDefaultRunOptions {
	return &NullableDefaultRunOptions{value: val, isSet: true}
}

func (v NullableDefaultRunOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefaultRunOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
