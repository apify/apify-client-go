...
type ActRunsLastDatasetItemsPostRequest struct {
	ArrayOfMapmapOfStringAny *[]map[string]interface{}
	MapmapOfStringAny *map[string]interface{}
}

// []map[string]interface{}AsActRunsLastDatasetItemsPostRequest is a convenience function that returns []map[string]interface{} wrapped in ActRunsLastDatasetItemsPostRequest
func ArrayOfMapmapOfStringAnyAsActRunsLastDatasetItemsPostRequest(v *[]map[string]interface{}) ActRunsLastDatasetItemsPostRequest {
	return ActRunsLastDatasetItemsPostRequest{
		ArrayOfMapmapOfStringAny: v,
	}
}

// map[string]interface{}AsActRunsLastDatasetItemsPostRequest is a convenience function that returns map[string]interface{} wrapped in ActRunsLastDatasetItemsPostRequest
func MapmapOfStringAnyAsActRunsLastDatasetItemsPostRequest(v *map[string]interface{}) ActRunsLastDatasetItemsPostRequest {
	return ActRunsLastDatasetItemsPostRequest{
		MapmapOfStringAny: v,
	}
}
...
func (dst *ActRunsLastDatasetItemsPostRequest) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ActRunsLastDatasetItemsPostRequest)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ActRunsLastDatasetItemsPostRequest)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ActRunsLastDatasetItemsPostRequest) MarshalJSON() ([]byte, error) {
...
func (obj *ActRunsLastDatasetItemsPostRequest) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj ActRunsLastDatasetItemsPostRequest) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfMapmapOfStringAny != nil {
		return *obj.ArrayOfMapmapOfStringAny
	}
...
type NullableActRunsLastDatasetItemsPostRequest struct {
	value *ActRunsLastDatasetItemsPostRequest
	isSet bool
}

func (v NullableActRunsLastDatasetItemsPostRequest) Get() *ActRunsLastDatasetItemsPostRequest {
	return v.value
}

func (v *NullableActRunsLastDatasetItemsPostRequest) Set(val *ActRunsLastDatasetItemsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableActRunsLastDatasetItemsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableActRunsLastDatasetItemsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActRunsLastDatasetItemsPostRequest(val *ActRunsLastDatasetItemsPostRequest) *NullableActRunsLastDatasetItemsPostRequest {
	return &NullableActRunsLastDatasetItemsPostRequest{value: val, isSet: true}
}

func (v NullableActRunsLastDatasetItemsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActRunsLastDatasetItemsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
