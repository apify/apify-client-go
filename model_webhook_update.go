...
type WebhookUpdate struct {
	...
	Condition NullableWebhookCondition `json:"condition,omitempty"`
...
func (o *WebhookUpdate) SetIsAdHocNil() {
	o.IsAdHoc.Set(nil)
}
...
// SetCondition gets a reference to the given NullableWebhookCondition and assigns it to the Condition field.
func (o *WebhookUpdate) SetCondition(v WebhookCondition) {
	o.Condition.Set(&v)
}
// SetConditionNil sets the value for Condition to be an explicit nil
func (o *WebhookUpdate) SetConditionNil() {
	o.Condition.Set(nil)
}
...
func (o *WebhookUpdate) SetIgnoreSslErrorsNil() {
...
func (o *WebhookUpdate) SetDoNotRetryNil() {
...
func (o *WebhookUpdate) SetRequestUrlNil() {
...
func (o *WebhookUpdate) SetPayloadTemplateNil() {
...
func (o *WebhookUpdate) SetHeadersTemplateNil() {
...
func (o *WebhookUpdate) SetShouldInterpolateStringsNil() {
