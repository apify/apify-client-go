...
// checks if the DatasetStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetStatistics{}

// DatasetStatistics struct for DatasetStatistics
type DatasetStatistics struct {
	...
	FieldStatistics map[string]DatasetFieldStatistics `json:"fieldStatistics,omitempty"`
}
...
func (o *DatasetStatistics) GetFieldStatistics() map[string]DatasetFieldStatistics {
	if o == nil || IsNil(o.FieldStatistics) {
		var ret map[string]DatasetFieldStatistics
		return ret
	}
...
func (o *DatasetStatistics) GetFieldStatisticsOk() (map[string]DatasetFieldStatistics, bool) {
	if o == nil || IsNil(o.FieldStatistics) {
		return map[string]DatasetFieldStatistics{}, false
	}
...
// SetFieldStatistics gets a reference to the given map[string]DatasetFieldStatistics and assigns it to the FieldStatistics field.
func (o *DatasetStatistics) SetFieldStatistics(v map[string]DatasetFieldStatistics) {
	o.FieldStatistics = v
}

func (o DatasetStatistics) MarshalJSON() ([]byte, error) {
...
func (o DatasetStatistics) ToMap() (map[string]interface{}, error) {
...
type NullableDatasetStatistics struct {
	value *DatasetStatistics
	isSet bool
}

func (v NullableDatasetStatistics) Get() *DatasetStatistics {
	return v.value
}

func (v *NullableDatasetStatistics) Set(val *DatasetStatistics) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetStatistics) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetStatistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetStatistics(val *DatasetStatistics) *NullableDatasetStatistics {
	return &NullableDatasetStatistics{value: val, isSet: true}
}

func (v NullableDatasetStatistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetStatistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
