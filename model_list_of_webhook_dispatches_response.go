...
// checks if the ListOfWebhookDispatchesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfWebhookDispatchesResponse{}

// ListOfWebhookDispatchesResponse struct for ListOfWebhookDispatchesResponse
type ListOfWebhookDispatchesResponse struct {
	Data ListOfWebhookDispatches `json:"data"`
}

type _ListOfWebhookDispatchesResponse ListOfWebhookDispatchesResponse

// NewListOfWebhookDispatchesResponse instantiates a new ListOfWebhookDispatchesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfWebhookDispatchesResponse(data ListOfWebhookDispatches) *ListOfWebhookDispatchesResponse {
	this := ListOfWebhookDispatchesResponse{}
	this.Data = data
	return &this
}

// NewListOfWebhookDispatchesResponseWithDefaults instantiates a new ListOfWebhookDispatchesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfWebhookDispatchesResponseWithDefaults() *ListOfWebhookDispatchesResponse {
	this := ListOfWebhookDispatchesResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfWebhookDispatchesResponse) GetData() ListOfWebhookDispatches {
	if o == nil {
		var ret ListOfWebhookDispatches
		return ret
	}
...
func (o *ListOfWebhookDispatchesResponse) GetDataOk() (*ListOfWebhookDispatches, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfWebhookDispatchesResponse) SetData(v ListOfWebhookDispatches) {
	o.Data = v
}

func (o ListOfWebhookDispatchesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfWebhookDispatchesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfWebhookDispatchesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfWebhookDispatchesResponse := _ListOfWebhookDispatchesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfWebhookDispatchesResponse)

	if err != nil {
		return err
	}

	*o = ListOfWebhookDispatchesResponse(varListOfWebhookDispatchesResponse)

	return err
}

type NullableListOfWebhookDispatchesResponse struct {
	value *ListOfWebhookDispatchesResponse
	isSet bool
}

func (v NullableListOfWebhookDispatchesResponse) Get() *ListOfWebhookDispatchesResponse {
	return v.value
}

func (v *NullableListOfWebhookDispatchesResponse) Set(val *ListOfWebhookDispatchesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfWebhookDispatchesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfWebhookDispatchesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfWebhookDispatchesResponse(val *ListOfWebhookDispatchesResponse) *NullableListOfWebhookDispatchesResponse {
	return &NullableListOfWebhookDispatchesResponse{value: val, isSet: true}
}

func (v NullableListOfWebhookDispatchesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfWebhookDispatchesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
