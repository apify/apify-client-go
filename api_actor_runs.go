...
// ActorRunsAPIService ActorRunsAPI service
type ActorRunsAPIService service

type ApiActorRunAbortPostRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
	gracefully *bool
}
...
func (r ApiActorRunAbortPostRequest) Gracefully(gracefully bool) ApiActorRunAbortPostRequest {
	r.gracefully = &gracefully
	return r
}

func (r ApiActorRunAbortPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorRunAbortPostExecute(r)
}

/*
ActorRunAbortPost Abort run
...
//  @return RunResponse
func (a *ActorRunsAPIService) ActorRunAbortPostExecute(r ApiActorRunAbortPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunAbortPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/abort"
...
type ApiActorRunDeleteRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
}

func (r ApiActorRunDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunDeleteExecute(r)
}

/*
ActorRunDelete Delete run
...
organization that initiated the run can delete it.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunDeleteRequest
*/
func (a *ActorRunsAPIService) ActorRunDelete(ctx context.Context, runId string) ApiActorRunDeleteRequest {
	return ApiActorRunDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
func (a *ActorRunsAPIService) ActorRunDeleteExecute(r ApiActorRunDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunGetRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
...
func (r ApiActorRunGetRequest) WaitForFinish(waitForFinish float64) ApiActorRunGetRequest {
	r.waitForFinish = &waitForFinish
	return r
}

func (r ApiActorRunGetRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorRunGetExecute(r)
}
...
if you access the endpoint without the token, certain attributes, such as `usageUsd` and `usageTotalUsd`, will be hidden.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunGetRequest
*/
func (a *ActorRunsAPIService) ActorRunGet(ctx context.Context, runId string) ApiActorRunGetRequest {
	return ApiActorRunGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RunResponse
func (a *ActorRunsAPIService) ActorRunGetExecute(r ApiActorRunGetRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunLogGetRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
	stream *bool
...
func (r ApiActorRunLogGetRequest) Stream(stream bool) ApiActorRunLogGetRequest {
	r.stream = &stream
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the web browser will download the log file rather than open it in a tab. 
func (r ApiActorRunLogGetRequest) Download(download bool) ApiActorRunLogGetRequest {
	r.download = &download
	return r
}
...
func (r ApiActorRunLogGetRequest) Raw(raw bool) ApiActorRunLogGetRequest {
	r.raw = &raw
	return r
}

func (r ApiActorRunLogGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.ActorRunLogGetExecute(r)
}

/*
ActorRunLogGet Get run's log
...
This endpoint is a shortcut for getting the run's log. Same as [Get log](/api/v2/log-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunLogGetRequest
*/
func (a *ActorRunsAPIService) ActorRunLogGet(ctx context.Context, runId string) ApiActorRunLogGetRequest {
	return ApiActorRunLogGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return string
func (a *ActorRunsAPIService) ActorRunLogGetExecute(r ApiActorRunLogGetRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunLogGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunMetamorphPostRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
...
func (r ApiActorRunMetamorphPostRequest) TargetActorId(targetActorId string) ApiActorRunMetamorphPostRequest {
...
func (r ApiActorRunMetamorphPostRequest) Build(build string) ApiActorRunMetamorphPostRequest {
	r.build = &build
	return r
}

func (r ApiActorRunMetamorphPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorRunMetamorphPostExecute(r)
}

/*
ActorRunMetamorphPost Metamorph run
...
For more information, see the [Actor docs](https://docs.apify.com/platform/actors/development/programming-interface/metamorph).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunMetamorphPostRequest
*/
func (a *ActorRunsAPIService) ActorRunMetamorphPost(ctx context.Context, runId string) ApiActorRunMetamorphPostRequest {
	return ApiActorRunMetamorphPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RunResponse
func (a *ActorRunsAPIService) ActorRunMetamorphPostExecute(r ApiActorRunMetamorphPostRequest) (*RunResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunMetamorphPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/metamorph"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunPutRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
...
// 
func (r ApiActorRunPutRequest) UpdateRunRequest(updateRunRequest UpdateRunRequest) ApiActorRunPutRequest {
	r.updateRunRequest = &updateRunRequest
	return r
}

func (r ApiActorRunPutRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorRunPutExecute(r)
}

/*
ActorRunPut Update run
...
When a run is accessible anonymously, all of the run's default storages and logs also become accessible anonymously.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunPutRequest
*/
func (a *ActorRunsAPIService) ActorRunPut(ctx context.Context, runId string) ApiActorRunPutRequest {
	return ApiActorRunPutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RunResponse
func (a *ActorRunsAPIService) ActorRunPutExecute(r ApiActorRunPutRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateRunRequest == nil {
		return localVarReturnValue, nil, reportError("updateRunRequest is required and must be specified")
	}
...
type ApiActorRunRebootPostRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
}

func (r ApiActorRunRebootPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorRunRebootPostExecute(r)
}

/*
ActorRunRebootPost Reboot run
...
key-value store, dataset, or request queue will be lost.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRebootPostRequest
*/
func (a *ActorRunsAPIService) ActorRunRebootPost(ctx context.Context, runId string) ApiActorRunRebootPostRequest {
	return ApiActorRunRebootPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RunResponse
func (a *ActorRunsAPIService) ActorRunRebootPostExecute(r ApiActorRunRebootPostRequest) (*RunResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunRebootPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/reboot"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunsGetRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	offset *float64
	limit *float64
...
func (r ApiActorRunsGetRequest) Offset(offset float64) ApiActorRunsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiActorRunsGetRequest) Limit(limit float64) ApiActorRunsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorRunsGetRequest) Desc(desc bool) ApiActorRunsGetRequest {
	r.desc = &desc
	return r
}
...
func (r ApiActorRunsGetRequest) Status(status []string) ApiActorRunsGetRequest {
	r.status = &status
	return r
}
...
func (r ApiActorRunsGetRequest) StartedAfter(startedAfter time.Time) ApiActorRunsGetRequest {
...
func (r ApiActorRunsGetRequest) StartedBefore(startedBefore time.Time) ApiActorRunsGetRequest {
	r.startedBefore = &startedBefore
	return r
}

func (r ApiActorRunsGetRequest) Execute() (*ListOfRunsResponse, *http.Response, error) {
	return r.ApiService.ActorRunsGetExecute(r)
}

/*
ActorRunsGet Get user runs list
...
statuses](https://docs.apify.com/platform/actors/running/runs-and-builds#lifecycle)).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiActorRunsGetRequest
*/
func (a *ActorRunsAPIService) ActorRunsGet(ctx context.Context) ApiActorRunsGetRequest {
	return ApiActorRunsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ActorRunsAPIService) ActorRunsGetExecute(r ApiActorRunsGetRequest) (*ListOfRunsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.ActorRunsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs"
...
type ApiPostChargeRunRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
	chargeRunRequest *ChargeRunRequest
	idempotencyKey *string
}

// Define which event, and how many times, you want to charge for.
func (r ApiPostChargeRunRequest) ChargeRunRequest(chargeRunRequest ChargeRunRequest) ApiPostChargeRunRequest {
	r.chargeRunRequest = &chargeRunRequest
	return r
}
...
func (r ApiPostChargeRunRequest) IdempotencyKey(idempotencyKey string) ApiPostChargeRunRequest {
	r.idempotencyKey = &idempotencyKey
	return r
}

func (r ApiPostChargeRunRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.PostChargeRunExecute(r)
}

/*
PostChargeRun Charge events in run
...
:::
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiPostChargeRunRequest
*/
func (a *ActorRunsAPIService) PostChargeRun(ctx context.Context, runId string) ApiPostChargeRunRequest {
	return ApiPostChargeRunRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *ActorRunsAPIService) PostChargeRunExecute(r ApiPostChargeRunRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.PostChargeRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/charge"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.chargeRunRequest == nil {
		return localVarReturnValue, nil, reportError("chargeRunRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.chargeRunRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiPostResurrectRunRequest struct {
	ctx context.Context
	ApiService *ActorRunsAPIService
	runId string
	build *string
...
func (r ApiPostResurrectRunRequest) Build(build string) ApiPostResurrectRunRequest {
	r.build = &build
	return r
}
...
func (r ApiPostResurrectRunRequest) Timeout(timeout float64) ApiPostResurrectRunRequest {
	r.timeout = &timeout
	return r
}
...
func (r ApiPostResurrectRunRequest) Memory(memory float64) ApiPostResurrectRunRequest {
	r.memory = &memory
	return r
}
...
func (r ApiPostResurrectRunRequest) MaxItems(maxItems float64) ApiPostResurrectRunRequest {
	r.maxItems = &maxItems
	return r
}
...
func (r ApiPostResurrectRunRequest) MaxTotalChargeUsd(maxTotalChargeUsd float64) ApiPostResurrectRunRequest {
...
func (r ApiPostResurrectRunRequest) RestartOnError(restartOnError bool) ApiPostResurrectRunRequest {
	r.restartOnError = &restartOnError
	return r
}

func (r ApiPostResurrectRunRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.PostResurrectRunExecute(r)
}

/*
PostResurrectRun Resurrect run
...
For more information, see the [Actor docs](https://docs.apify.com/platform/actors/running/runs-and-builds#resurrection-of-finished-run).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiPostResurrectRunRequest
*/
func (a *ActorRunsAPIService) PostResurrectRun(ctx context.Context, runId string) ApiPostResurrectRunRequest {
	return ApiPostResurrectRunRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RunResponse
func (a *ActorRunsAPIService) PostResurrectRunExecute(r ApiPostResurrectRunRequest) (*RunResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorRunsAPIService.PostResurrectRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/resurrect"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
