...
// checks if the PrivateUserDataResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrivateUserDataResponse{}

// PrivateUserDataResponse struct for PrivateUserDataResponse
type PrivateUserDataResponse struct {
	Data UserPrivateInfo `json:"data"`
}

type _PrivateUserDataResponse PrivateUserDataResponse

// NewPrivateUserDataResponse instantiates a new PrivateUserDataResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPrivateUserDataResponse(data UserPrivateInfo) *PrivateUserDataResponse {
	this := PrivateUserDataResponse{}
	this.Data = data
	return &this
}

// NewPrivateUserDataResponseWithDefaults instantiates a new PrivateUserDataResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPrivateUserDataResponseWithDefaults() *PrivateUserDataResponse {
	this := PrivateUserDataResponse{}
	return &this
}

// GetData returns the Data field value
func (o *PrivateUserDataResponse) GetData() UserPrivateInfo {
	if o == nil {
		var ret UserPrivateInfo
		return ret
	}
...
func (o *PrivateUserDataResponse) GetDataOk() (*UserPrivateInfo, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *PrivateUserDataResponse) SetData(v UserPrivateInfo) {
	o.Data = v
}

func (o PrivateUserDataResponse) MarshalJSON() ([]byte, error) {
...
func (o PrivateUserDataResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *PrivateUserDataResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPrivateUserDataResponse := _PrivateUserDataResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrivateUserDataResponse)

	if err != nil {
		return err
	}

	*o = PrivateUserDataResponse(varPrivateUserDataResponse)

	return err
}

type NullablePrivateUserDataResponse struct {
	value *PrivateUserDataResponse
	isSet bool
}

func (v NullablePrivateUserDataResponse) Get() *PrivateUserDataResponse {
	return v.value
}

func (v *NullablePrivateUserDataResponse) Set(val *PrivateUserDataResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateUserDataResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateUserDataResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateUserDataResponse(val *PrivateUserDataResponse) *NullablePrivateUserDataResponse {
	return &NullablePrivateUserDataResponse{value: val, isSet: true}
}

func (v NullablePrivateUserDataResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateUserDataResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
