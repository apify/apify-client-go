...
// checks if the UserPublicInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserPublicInfo{}

// UserPublicInfo struct for UserPublicInfo
type UserPublicInfo struct {
	Username string `json:"username"`
	Profile *Profile `json:"profile,omitempty"`
}

type _UserPublicInfo UserPublicInfo
...
func (o UserPublicInfo) MarshalJSON() ([]byte, error) {
...
func (o UserPublicInfo) ToMap() (map[string]interface{}, error) {
...
func (o *UserPublicInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varUserPublicInfo := _UserPublicInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserPublicInfo)

	if err != nil {
		return err
	}

	*o = UserPublicInfo(varUserPublicInfo)

	return err
}

type NullableUserPublicInfo struct {
	value *UserPublicInfo
	isSet bool
}

func (v NullableUserPublicInfo) Get() *UserPublicInfo {
	return v.value
}

func (v *NullableUserPublicInfo) Set(val *UserPublicInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableUserPublicInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableUserPublicInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserPublicInfo(val *UserPublicInfo) *NullableUserPublicInfo {
	return &NullableUserPublicInfo{value: val, isSet: true}
}

func (v NullableUserPublicInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserPublicInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
