...
// checks if the BatchAddResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchAddResponse{}

// BatchAddResponse Response containing the result of a batch add operation.
type BatchAddResponse struct {
	Data BatchAddResult `json:"data"`
}

type _BatchAddResponse BatchAddResponse

// NewBatchAddResponse instantiates a new BatchAddResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBatchAddResponse(data BatchAddResult) *BatchAddResponse {
	this := BatchAddResponse{}
	this.Data = data
	return &this
}

// NewBatchAddResponseWithDefaults instantiates a new BatchAddResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBatchAddResponseWithDefaults() *BatchAddResponse {
	this := BatchAddResponse{}
	return &this
}

// GetData returns the Data field value
func (o *BatchAddResponse) GetData() BatchAddResult {
	if o == nil {
		var ret BatchAddResult
		return ret
	}
...
func (o *BatchAddResponse) GetDataOk() (*BatchAddResult, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *BatchAddResponse) SetData(v BatchAddResult) {
	o.Data = v
}

func (o BatchAddResponse) MarshalJSON() ([]byte, error) {
...
func (o BatchAddResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *BatchAddResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchAddResponse := _BatchAddResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchAddResponse)

	if err != nil {
		return err
	}

	*o = BatchAddResponse(varBatchAddResponse)

	return err
}

type NullableBatchAddResponse struct {
	value *BatchAddResponse
	isSet bool
}

func (v NullableBatchAddResponse) Get() *BatchAddResponse {
	return v.value
}

func (v *NullableBatchAddResponse) Set(val *BatchAddResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchAddResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchAddResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchAddResponse(val *BatchAddResponse) *NullableBatchAddResponse {
	return &NullableBatchAddResponse{value: val, isSet: true}
}

func (v NullableBatchAddResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchAddResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
