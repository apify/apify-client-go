...
// checks if the ListOfVersions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfVersions{}

// ListOfVersions struct for ListOfVersions
...
type _ListOfVersions ListOfVersions
...
func (o ListOfVersions) MarshalJSON() ([]byte, error) {
...
func (o ListOfVersions) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfVersions) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfVersions := _ListOfVersions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfVersions)

	if err != nil {
		return err
	}

	*o = ListOfVersions(varListOfVersions)

	return err
}

type NullableListOfVersions struct {
	value *ListOfVersions
	isSet bool
}

func (v NullableListOfVersions) Get() *ListOfVersions {
	return v.value
}

func (v *NullableListOfVersions) Set(val *ListOfVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfVersions(val *ListOfVersions) *NullableListOfVersions {
	return &NullableListOfVersions{value: val, isSet: true}
}

func (v NullableListOfVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
