...
// checks if the ListOfSchedulesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfSchedulesResponse{}

// ListOfSchedulesResponse struct for ListOfSchedulesResponse
type ListOfSchedulesResponse struct {
	Data ListOfSchedules `json:"data"`
}

type _ListOfSchedulesResponse ListOfSchedulesResponse

// NewListOfSchedulesResponse instantiates a new ListOfSchedulesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfSchedulesResponse(data ListOfSchedules) *ListOfSchedulesResponse {
	this := ListOfSchedulesResponse{}
	this.Data = data
	return &this
}

// NewListOfSchedulesResponseWithDefaults instantiates a new ListOfSchedulesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfSchedulesResponseWithDefaults() *ListOfSchedulesResponse {
	this := ListOfSchedulesResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfSchedulesResponse) GetData() ListOfSchedules {
	if o == nil {
		var ret ListOfSchedules
		return ret
	}
...
func (o *ListOfSchedulesResponse) GetDataOk() (*ListOfSchedules, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfSchedulesResponse) SetData(v ListOfSchedules) {
	o.Data = v
}

func (o ListOfSchedulesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfSchedulesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfSchedulesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfSchedulesResponse := _ListOfSchedulesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfSchedulesResponse)

	if err != nil {
		return err
	}

	*o = ListOfSchedulesResponse(varListOfSchedulesResponse)

	return err
}

type NullableListOfSchedulesResponse struct {
	value *ListOfSchedulesResponse
	isSet bool
}

func (v NullableListOfSchedulesResponse) Get() *ListOfSchedulesResponse {
	return v.value
}

func (v *NullableListOfSchedulesResponse) Set(val *ListOfSchedulesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfSchedulesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfSchedulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfSchedulesResponse(val *ListOfSchedulesResponse) *NullableListOfSchedulesResponse {
	return &NullableListOfSchedulesResponse{value: val, isSet: true}
}

func (v NullableListOfSchedulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfSchedulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
