...
// LastActorRunsLogAPIService LastActorRunsLogAPI service
type LastActorRunsLogAPIService service

type ApiActRunsLastLogGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsLogAPIService
	actorId string
	stream *bool
	download *bool
	raw *bool
...
func (r ApiActRunsLastLogGetRequest) Stream(stream bool) ApiActRunsLastLogGetRequest {
	r.stream = &stream
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the web browser will download the log file rather than open it in a tab. 
func (r ApiActRunsLastLogGetRequest) Download(download bool) ApiActRunsLastLogGetRequest {
	r.download = &download
	return r
}
...
func (r ApiActRunsLastLogGetRequest) Raw(raw bool) ApiActRunsLastLogGetRequest {
	r.raw = &raw
	return r
}

func (r ApiActRunsLastLogGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.ActRunsLastLogGetExecute(r)
}

/*
ActRunsLastLogGet Get last Actor run's log
...
This endpoint is a shortcut for getting last Actor run's log. Same as [Get log](/api/v2/log-get) endpoint.
 ...
 @return ApiActRunsLastLogGetRequest
*/
func (a *LastActorRunsLogAPIService) ActRunsLastLogGet(ctx context.Context, actorId string) ApiActRunsLastLogGetRequest {
	return ApiActRunsLastLogGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
//  @return string
func (a *LastActorRunsLogAPIService) ActRunsLastLogGetExecute(r ApiActRunsLastLogGetRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsLogAPIService.ActRunsLastLogGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/log"
