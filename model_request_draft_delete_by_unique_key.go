...
// checks if the RequestDraftDeleteByUniqueKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestDraftDeleteByUniqueKey{}
...
type _RequestDraftDeleteByUniqueKey RequestDraftDeleteByUniqueKey
...
func NewRequestDraftDeleteByUniqueKey(uniqueKey string) *RequestDraftDeleteByUniqueKey {
	this := RequestDraftDeleteByUniqueKey{}
...
func (o RequestDraftDeleteByUniqueKey) MarshalJSON() ([]byte, error) {
...
func (o RequestDraftDeleteByUniqueKey) ToMap() (map[string]interface{}, error) {
...
func (o *RequestDraftDeleteByUniqueKey) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestDraftDeleteByUniqueKey := _RequestDraftDeleteByUniqueKey{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestDraftDeleteByUniqueKey)

	if err != nil {
		return err
	}

	*o = RequestDraftDeleteByUniqueKey(varRequestDraftDeleteByUniqueKey)

	return err
}

type NullableRequestDraftDeleteByUniqueKey struct {
	value *RequestDraftDeleteByUniqueKey
	isSet bool
}

func (v NullableRequestDraftDeleteByUniqueKey) Get() *RequestDraftDeleteByUniqueKey {
	return v.value
}

func (v *NullableRequestDraftDeleteByUniqueKey) Set(val *RequestDraftDeleteByUniqueKey) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestDraftDeleteByUniqueKey) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestDraftDeleteByUniqueKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestDraftDeleteByUniqueKey(val *RequestDraftDeleteByUniqueKey) *NullableRequestDraftDeleteByUniqueKey {
	return &NullableRequestDraftDeleteByUniqueKey{value: val, isSet: true}
}

func (v NullableRequestDraftDeleteByUniqueKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestDraftDeleteByUniqueKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
