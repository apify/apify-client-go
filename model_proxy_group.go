...
// checks if the ProxyGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProxyGroup{}

// ProxyGroup struct for ProxyGroup
...
func (o ProxyGroup) MarshalJSON() ([]byte, error) {
...
func (o ProxyGroup) ToMap() (map[string]interface{}, error) {
...
func (o *ProxyGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varProxyGroup := _ProxyGroup{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProxyGroup)

	if err != nil {
		return err
	}

	*o = ProxyGroup(varProxyGroup)

	return err
}

type NullableProxyGroup struct {
	value *ProxyGroup
	isSet bool
}

func (v NullableProxyGroup) Get() *ProxyGroup {
	return v.value
}

func (v *NullableProxyGroup) Set(val *ProxyGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableProxyGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableProxyGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProxyGroup(val *ProxyGroup) *NullableProxyGroup {
	return &NullableProxyGroup{value: val, isSet: true}
}

func (v NullableProxyGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProxyGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
