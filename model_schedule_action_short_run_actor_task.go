...
// checks if the ScheduleActionShortRunActorTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleActionShortRunActorTask{}

// ScheduleActionShortRunActorTask struct for ScheduleActionShortRunActorTask
...
type _ScheduleActionShortRunActorTask ScheduleActionShortRunActorTask

// NewScheduleActionShortRunActorTask instantiates a new ScheduleActionShortRunActorTask object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleActionShortRunActorTask(id string, type_ interface{}, actorTaskId string) *ScheduleActionShortRunActorTask {
	this := ScheduleActionShortRunActorTask{}
	this.Id = id
	this.Type = type_
...
// NewScheduleActionShortRunActorTaskWithDefaults instantiates a new ScheduleActionShortRunActorTask object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleActionShortRunActorTaskWithDefaults() *ScheduleActionShortRunActorTask {
	this := ScheduleActionShortRunActorTask{}
	return &this
}

// GetId returns the Id field value
func (o *ScheduleActionShortRunActorTask) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScheduleActionShortRunActorTask) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScheduleActionShortRunActorTask) SetId(v string) {
	o.Id = v
}

// GetType returns the Type field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ScheduleActionShortRunActorTask) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ScheduleActionShortRunActorTask) GetTypeOk() (*interface{}, bool) {
...
func (o *ScheduleActionShortRunActorTask) SetType(v interface{}) {
	o.Type = v
}

// GetActorTaskId returns the ActorTaskId field value
func (o *ScheduleActionShortRunActorTask) GetActorTaskId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScheduleActionShortRunActorTask) GetActorTaskIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleActionShortRunActorTask) SetActorTaskId(v string) {
	o.ActorTaskId = v
}

func (o ScheduleActionShortRunActorTask) MarshalJSON() ([]byte, error) {
...
func (o ScheduleActionShortRunActorTask) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleActionShortRunActorTask) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleActionShortRunActorTask := _ScheduleActionShortRunActorTask{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleActionShortRunActorTask)

	if err != nil {
		return err
	}

	*o = ScheduleActionShortRunActorTask(varScheduleActionShortRunActorTask)

	return err
}

type NullableScheduleActionShortRunActorTask struct {
	value *ScheduleActionShortRunActorTask
	isSet bool
}

func (v NullableScheduleActionShortRunActorTask) Get() *ScheduleActionShortRunActorTask {
	return v.value
}

func (v *NullableScheduleActionShortRunActorTask) Set(val *ScheduleActionShortRunActorTask) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionShortRunActorTask) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionShortRunActorTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionShortRunActorTask(val *ScheduleActionShortRunActorTask) *NullableScheduleActionShortRunActorTask {
	return &NullableScheduleActionShortRunActorTask{value: val, isSet: true}
}

func (v NullableScheduleActionShortRunActorTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionShortRunActorTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
