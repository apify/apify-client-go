...
// checks if the RequestDraftDeleteById type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestDraftDeleteById{}
...
type _RequestDraftDeleteById RequestDraftDeleteById

// NewRequestDraftDeleteById instantiates a new RequestDraftDeleteById object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequestDraftDeleteById(id string) *RequestDraftDeleteById {
	this := RequestDraftDeleteById{}
	this.Id = id
	return &this
}

// NewRequestDraftDeleteByIdWithDefaults instantiates a new RequestDraftDeleteById object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRequestDraftDeleteByIdWithDefaults() *RequestDraftDeleteById {
	this := RequestDraftDeleteById{}
	return &this
}

// GetId returns the Id field value
func (o *RequestDraftDeleteById) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RequestDraftDeleteById) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *RequestDraftDeleteById) SetId(v string) {
	o.Id = v
}

// GetUniqueKey returns the UniqueKey field value if set, zero value otherwise.
func (o *RequestDraftDeleteById) GetUniqueKey() string {
...
// and a boolean to check if the value has been set.
func (o *RequestDraftDeleteById) GetUniqueKeyOk() (*string, bool) {
	if o == nil || IsNil(o.UniqueKey) {
		return nil, false
	}
...
func (o *RequestDraftDeleteById) HasUniqueKey() bool {
	if o != nil && !IsNil(o.UniqueKey) {
		return true
	}
...
func (o *RequestDraftDeleteById) SetUniqueKey(v string) {
	o.UniqueKey = &v
}

func (o RequestDraftDeleteById) MarshalJSON() ([]byte, error) {
...
func (o RequestDraftDeleteById) ToMap() (map[string]interface{}, error) {
...
func (o *RequestDraftDeleteById) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestDraftDeleteById := _RequestDraftDeleteById{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestDraftDeleteById)

	if err != nil {
		return err
	}

	*o = RequestDraftDeleteById(varRequestDraftDeleteById)

	return err
}

type NullableRequestDraftDeleteById struct {
	value *RequestDraftDeleteById
	isSet bool
}

func (v NullableRequestDraftDeleteById) Get() *RequestDraftDeleteById {
	return v.value
}

func (v *NullableRequestDraftDeleteById) Set(val *RequestDraftDeleteById) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestDraftDeleteById) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestDraftDeleteById) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestDraftDeleteById(val *RequestDraftDeleteById) *NullableRequestDraftDeleteById {
	return &NullableRequestDraftDeleteById{value: val, isSet: true}
}

func (v NullableRequestDraftDeleteById) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestDraftDeleteById) UnmarshalJSON(src []byte) error {
	v.isSet = true
