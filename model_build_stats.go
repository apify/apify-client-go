...
// checks if the BuildStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildStats{}

// BuildStats struct for BuildStats
...
// SetImageSizeBytes gets a reference to the given int32 and assigns it to the ImageSizeBytes field.
func (o *BuildStats) SetImageSizeBytes(v int32) {
	o.ImageSizeBytes = &v
}

func (o BuildStats) MarshalJSON() ([]byte, error) {
...
func (o BuildStats) ToMap() (map[string]interface{}, error) {
...
func (o *BuildStats) UnmarshalJSON(data []byte) (err error) {
	...
	varBuildStats := _BuildStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBuildStats)

	if err != nil {
		return err
	}

	*o = BuildStats(varBuildStats)

	return err
}

type NullableBuildStats struct {
	value *BuildStats
	isSet bool
}

func (v NullableBuildStats) Get() *BuildStats {
	return v.value
}

func (v *NullableBuildStats) Set(val *BuildStats) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildStats) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildStats(val *BuildStats) *NullableBuildStats {
	return &NullableBuildStats{value: val, isSet: true}
}

func (v NullableBuildStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
