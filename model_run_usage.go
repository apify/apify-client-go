...
// checks if the RunUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunUsage{}

// RunUsage struct for RunUsage
type RunUsage struct {
	ACTOR_COMPUTE_UNITS NullableFloat32 `json:"ACTOR_COMPUTE_UNITS,omitempty"`
	DATASET_READS NullableInt32 `json:"DATASET_READS,omitempty"`
	DATASET_WRITES NullableInt32 `json:"DATASET_WRITES,omitempty"`
	KEY_VALUE_STORE_READS NullableInt32 `json:"KEY_VALUE_STORE_READS,omitempty"`
	KEY_VALUE_STORE_WRITES NullableInt32 `json:"KEY_VALUE_STORE_WRITES,omitempty"`
	KEY_VALUE_STORE_LISTS NullableInt32 `json:"KEY_VALUE_STORE_LISTS,omitempty"`
	REQUEST_QUEUE_READS NullableInt32 `json:"REQUEST_QUEUE_READS,omitempty"`
	REQUEST_QUEUE_WRITES NullableInt32 `json:"REQUEST_QUEUE_WRITES,omitempty"`
	...
	PROXY_SERPS NullableInt32 `json:"PROXY_SERPS,omitempty"`
}
...
func (o *RunUsage) SetACTOR_COMPUTE_UNITSNil() {
...
// SetDATASET_READS gets a reference to the given NullableInt32 and assigns it to the DATASET_READS field.
...
func (o *RunUsage) SetDATASET_READSNil() {
...
// SetDATASET_WRITES gets a reference to the given NullableInt32 and assigns it to the DATASET_WRITES field.
...
func (o *RunUsage) SetDATASET_WRITESNil() {
...
// SetKEY_VALUE_STORE_READS gets a reference to the given NullableInt32 and assigns it to the KEY_VALUE_STORE_READS field.
...
func (o *RunUsage) SetKEY_VALUE_STORE_READSNil() {
...
// SetKEY_VALUE_STORE_WRITES gets a reference to the given NullableInt32 and assigns it to the KEY_VALUE_STORE_WRITES field.
...
func (o *RunUsage) SetKEY_VALUE_STORE_WRITESNil() {
...
// SetKEY_VALUE_STORE_LISTS gets a reference to the given NullableInt32 and assigns it to the KEY_VALUE_STORE_LISTS field.
...
func (o *RunUsage) SetKEY_VALUE_STORE_LISTSNil() {
...
// SetREQUEST_QUEUE_READS gets a reference to the given NullableInt32 and assigns it to the REQUEST_QUEUE_READS field.
...
func (o *RunUsage) SetREQUEST_QUEUE_READSNil() {
...
// SetREQUEST_QUEUE_WRITES gets a reference to the given NullableInt32 and assigns it to the REQUEST_QUEUE_WRITES field.
...
func (o *RunUsage) SetREQUEST_QUEUE_WRITESNil() {
...
func (o *RunUsage) SetDATA_TRANSFER_INTERNAL_GBYTESNil() {
...
func (o *RunUsage) SetDATA_TRANSFER_EXTERNAL_GBYTESNil() {
...
func (o *RunUsage) SetPROXY_RESIDENTIAL_TRANSFER_GBYTESNil() {
...
// SetPROXY_SERPS gets a reference to the given NullableInt32 and assigns it to the PROXY_SERPS field.
func (o *RunUsage) SetPROXY_SERPS(v int32) {
	o.PROXY_SERPS.Set(&v)
}
// SetPROXY_SERPSNil sets the value for PROXY_SERPS to be an explicit nil
func (o *RunUsage) SetPROXY_SERPSNil() {
...
func (o RunUsage) MarshalJSON() ([]byte, error) {
...
func (o RunUsage) ToMap() (map[string]interface{}, error) {
...
type NullableRunUsage struct {
	value *RunUsage
	isSet bool
}

func (v NullableRunUsage) Get() *RunUsage {
	return v.value
}

func (v *NullableRunUsage) Set(val *RunUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableRunUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableRunUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunUsage(val *RunUsage) *NullableRunUsage {
	return &NullableRunUsage{value: val, isSet: true}
}

func (v NullableRunUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
