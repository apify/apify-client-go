...
// checks if the CreateActorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateActorRequest{}

// CreateActorRequest struct for CreateActorRequest
type CreateActorRequest struct {
	...
	DefaultRunOptions *DefaultRunOptions `json:"defaultRunOptions,omitempty"`
...
func (o *CreateActorRequest) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *CreateActorRequest) SetDescriptionNil() {
...
func (o *CreateActorRequest) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *CreateActorRequest) SetIsPublicNil() {
	o.IsPublic.Set(nil)
}
...
func (o *CreateActorRequest) SetSeoTitleNil() {
	o.SeoTitle.Set(nil)
}
...
func (o *CreateActorRequest) SetSeoDescriptionNil() {
...
// GetDefaultRunOptions returns the DefaultRunOptions field value if set, zero value otherwise.
func (o *CreateActorRequest) GetDefaultRunOptions() DefaultRunOptions {
	if o == nil || IsNil(o.DefaultRunOptions) {
...
// SetDefaultRunOptions gets a reference to the given DefaultRunOptions and assigns it to the DefaultRunOptions field.
...
func (o *CreateActorRequest) SetActorStandbyNil() {
...
func (o *CreateActorRequest) SetExampleRunInputNil() {
...
func (o *CreateActorRequest) SetIsDeprecatedNil() {
...
func (o CreateActorRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateActorRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateActorRequest struct {
	value *CreateActorRequest
	isSet bool
}

func (v NullableCreateActorRequest) Get() *CreateActorRequest {
	return v.value
}

func (v *NullableCreateActorRequest) Set(val *CreateActorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateActorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateActorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateActorRequest(val *CreateActorRequest) *NullableCreateActorRequest {
	return &NullableCreateActorRequest{value: val, isSet: true}
}

func (v NullableCreateActorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateActorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
