...
type ApiToolsBrowserInfoDeleteRequest struct {
	ctx context.Context
...
func (r ApiToolsBrowserInfoDeleteRequest) SkipHeaders(skipHeaders bool) ApiToolsBrowserInfoDeleteRequest {
	r.skipHeaders = &skipHeaders
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60;, the response includes the &#x60;rawHeaders&#x60; field with the raw request headers.
func (r ApiToolsBrowserInfoDeleteRequest) RawHeaders(rawHeaders bool) ApiToolsBrowserInfoDeleteRequest {
	r.rawHeaders = &rawHeaders
	return r
}

func (r ApiToolsBrowserInfoDeleteRequest) Execute() (*BrowserInfoResponse, *http.Response, error) {
	return r.ApiService.ToolsBrowserInfoDeleteExecute(r)
}

/*
ToolsBrowserInfoDelete Get browser info
...
client IP addresses are anonymized.
 ...
 @return ApiToolsBrowserInfoDeleteRequest
*/
func (a *ToolsAPIService) ToolsBrowserInfoDelete(ctx context.Context) ApiToolsBrowserInfoDeleteRequest {
	return ApiToolsBrowserInfoDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ToolsAPIService) ToolsBrowserInfoDeleteExecute(r ApiToolsBrowserInfoDeleteRequest) (*BrowserInfoResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BrowserInfoResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsBrowserInfoDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/browser-info"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if r.skipHeaders != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "skipHeaders", r.skipHeaders, "form", "")
	}
	if r.rawHeaders != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "rawHeaders", r.rawHeaders, "form", "")
	}
...
type ApiToolsBrowserInfoGetRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
	skipHeaders *bool
	rawHeaders *bool
...
// If &#x60;true&#x60; or &#x60;1&#x60;, the response omits the &#x60;headers&#x60; field.
func (r ApiToolsBrowserInfoGetRequest) SkipHeaders(skipHeaders bool) ApiToolsBrowserInfoGetRequest {
	r.skipHeaders = &skipHeaders
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60;, the response includes the &#x60;rawHeaders&#x60; field with the raw request headers.
func (r ApiToolsBrowserInfoGetRequest) RawHeaders(rawHeaders bool) ApiToolsBrowserInfoGetRequest {
	r.rawHeaders = &rawHeaders
	return r
}

func (r ApiToolsBrowserInfoGetRequest) Execute() (*BrowserInfoResponse, *http.Response, error) {
	return r.ApiService.ToolsBrowserInfoGetExecute(r)
}

/*
ToolsBrowserInfoGet Get browser info
...
client IP addresses are anonymized.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiToolsBrowserInfoGetRequest
*/
func (a *ToolsAPIService) ToolsBrowserInfoGet(ctx context.Context) ApiToolsBrowserInfoGetRequest {
	return ApiToolsBrowserInfoGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BrowserInfoResponse
func (a *ToolsAPIService) ToolsBrowserInfoGetExecute(r ApiToolsBrowserInfoGetRequest) (*BrowserInfoResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsBrowserInfoGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiToolsBrowserInfoPostRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
	skipHeaders *bool
	rawHeaders *bool
...
// If &#x60;true&#x60; or &#x60;1&#x60;, the response omits the &#x60;headers&#x60; field.
func (r ApiToolsBrowserInfoPostRequest) SkipHeaders(skipHeaders bool) ApiToolsBrowserInfoPostRequest {
	r.skipHeaders = &skipHeaders
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60;, the response includes the &#x60;rawHeaders&#x60; field with the raw request headers.
func (r ApiToolsBrowserInfoPostRequest) RawHeaders(rawHeaders bool) ApiToolsBrowserInfoPostRequest {
	r.rawHeaders = &rawHeaders
	return r
}

func (r ApiToolsBrowserInfoPostRequest) Execute() (*BrowserInfoResponse, *http.Response, error) {
	return r.ApiService.ToolsBrowserInfoPostExecute(r)
}

/*
ToolsBrowserInfoPost Get browser info
...
client IP addresses are anonymized.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiToolsBrowserInfoPostRequest
*/
func (a *ToolsAPIService) ToolsBrowserInfoPost(ctx context.Context) ApiToolsBrowserInfoPostRequest {
	return ApiToolsBrowserInfoPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BrowserInfoResponse
func (a *ToolsAPIService) ToolsBrowserInfoPostExecute(r ApiToolsBrowserInfoPostRequest) (*BrowserInfoResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsBrowserInfoPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiToolsBrowserInfoPutRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
	skipHeaders *bool
	rawHeaders *bool
...
// If &#x60;true&#x60; or &#x60;1&#x60;, the response omits the &#x60;headers&#x60; field.
func (r ApiToolsBrowserInfoPutRequest) SkipHeaders(skipHeaders bool) ApiToolsBrowserInfoPutRequest {
	r.skipHeaders = &skipHeaders
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60;, the response includes the &#x60;rawHeaders&#x60; field with the raw request headers.
func (r ApiToolsBrowserInfoPutRequest) RawHeaders(rawHeaders bool) ApiToolsBrowserInfoPutRequest {
	r.rawHeaders = &rawHeaders
	return r
}

func (r ApiToolsBrowserInfoPutRequest) Execute() (*BrowserInfoResponse, *http.Response, error) {
	return r.ApiService.ToolsBrowserInfoPutExecute(r)
}

/*
ToolsBrowserInfoPut Get browser info
...
client IP addresses are anonymized.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiToolsBrowserInfoPutRequest
*/
func (a *ToolsAPIService) ToolsBrowserInfoPut(ctx context.Context) ApiToolsBrowserInfoPutRequest {
	return ApiToolsBrowserInfoPutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BrowserInfoResponse
func (a *ToolsAPIService) ToolsBrowserInfoPutExecute(r ApiToolsBrowserInfoPutRequest) (*BrowserInfoResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsBrowserInfoPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiToolsDecodeAndVerifyPostRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
	decodeAndVerifyRequest *DecodeAndVerifyRequest
}

// 
func (r ApiToolsDecodeAndVerifyPostRequest) DecodeAndVerifyRequest(decodeAndVerifyRequest DecodeAndVerifyRequest) ApiToolsDecodeAndVerifyPostRequest {
	r.decodeAndVerifyRequest = &decodeAndVerifyRequest
	return r
}

func (r ApiToolsDecodeAndVerifyPostRequest) Execute() (*DecodeAndVerifyResponse, *http.Response, error) {
	return r.ApiService.ToolsDecodeAndVerifyPostExecute(r)
}

/*
ToolsDecodeAndVerifyPost Decode and verify object
...
HTTP header.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiToolsDecodeAndVerifyPostRequest
*/
func (a *ToolsAPIService) ToolsDecodeAndVerifyPost(ctx context.Context) ApiToolsDecodeAndVerifyPostRequest {
	return ApiToolsDecodeAndVerifyPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DecodeAndVerifyResponse
func (a *ToolsAPIService) ToolsDecodeAndVerifyPostExecute(r ApiToolsDecodeAndVerifyPostRequest) (*DecodeAndVerifyResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DecodeAndVerifyResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsDecodeAndVerifyPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/tools/decode-and-verify"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.decodeAndVerifyRequest == nil {
		return localVarReturnValue, nil, reportError("decodeAndVerifyRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.decodeAndVerifyRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiToolsEncodeAndSignPostRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
...
// 
func (r ApiToolsEncodeAndSignPostRequest) Body(body map[string]interface{}) ApiToolsEncodeAndSignPostRequest {
	r.body = &body
	return r
}

func (r ApiToolsEncodeAndSignPostRequest) Execute() (*EncodeAndSignResponse, *http.Response, error) {
	return r.ApiService.ToolsEncodeAndSignPostExecute(r)
}

/*
ToolsEncodeAndSignPost Encode and sign object
...
HTTP header.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiToolsEncodeAndSignPostRequest
*/
func (a *ToolsAPIService) ToolsEncodeAndSignPost(ctx context.Context) ApiToolsEncodeAndSignPostRequest {
	return ApiToolsEncodeAndSignPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EncodeAndSignResponse
func (a *ToolsAPIService) ToolsEncodeAndSignPostExecute(r ApiToolsEncodeAndSignPostRequest) (*EncodeAndSignResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EncodeAndSignResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.ToolsEncodeAndSignPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/tools/encode-and-sign"
