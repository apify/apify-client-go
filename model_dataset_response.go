...
// checks if the DatasetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetResponse{}
...
func (o *DatasetResponse) GetData() Dataset {
	if o == nil {
		var ret Dataset
		return ret
	}
...
func (o *DatasetResponse) GetDataOk() (*Dataset, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *DatasetResponse) SetData(v Dataset) {
	o.Data = v
}
...
func (o DatasetResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *DatasetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasetResponse := _DatasetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDatasetResponse)

	if err != nil {
		return err
	}

	*o = DatasetResponse(varDatasetResponse)

	return err
}

type NullableDatasetResponse struct {
	value *DatasetResponse
	isSet bool
}

func (v NullableDatasetResponse) Get() *DatasetResponse {
	return v.value
}

func (v *NullableDatasetResponse) Set(val *DatasetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetResponse(val *DatasetResponse) *NullableDatasetResponse {
	return &NullableDatasetResponse{value: val, isSet: true}
}

func (v NullableDatasetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
