...
// checks if the ListOfRuns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRuns{}

// ListOfRuns struct for ListOfRuns
...
type _ListOfRuns ListOfRuns

// NewListOfRuns instantiates a new ListOfRuns object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfRuns(total int32, offset int32, limit int32, desc bool, count int32, items []RunShort) *ListOfRuns {
	this := ListOfRuns{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
...
// NewListOfRunsWithDefaults instantiates a new ListOfRuns object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfRunsWithDefaults() *ListOfRuns {
	this := ListOfRuns{}
	return &this
}

// GetTotal returns the Total field value
func (o *ListOfRuns) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListOfRuns) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ListOfRuns) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ListOfRuns) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfRuns) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListOfRuns) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ListOfRuns) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfRuns) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ListOfRuns) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ListOfRuns) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfRuns) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ListOfRuns) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ListOfRuns) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfRuns) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ListOfRuns) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ListOfRuns) GetItems() []RunShort {
	if o == nil {
		var ret []RunShort
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfRuns) GetItemsOk() ([]RunShort, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListOfRuns) SetItems(v []RunShort) {
	o.Items = v
}

func (o ListOfRuns) MarshalJSON() ([]byte, error) {
...
func (o ListOfRuns) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfRuns) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRuns := _ListOfRuns{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRuns)

	if err != nil {
		return err
	}

	*o = ListOfRuns(varListOfRuns)

	return err
}

type NullableListOfRuns struct {
	value *ListOfRuns
	isSet bool
}

func (v NullableListOfRuns) Get() *ListOfRuns {
	return v.value
}

func (v *NullableListOfRuns) Set(val *ListOfRuns) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRuns) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRuns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRuns(val *ListOfRuns) *NullableListOfRuns {
	return &NullableListOfRuns{value: val, isSet: true}
}

func (v NullableListOfRuns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRuns) UnmarshalJSON(src []byte) error {
	v.isSet = true
