...
// checks if the ListOfRequestQueuesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRequestQueuesResponse{}

// ListOfRequestQueuesResponse Response containing a list of request queues.
type ListOfRequestQueuesResponse struct {
	Data ListOfRequestQueues `json:"data"`
}

type _ListOfRequestQueuesResponse ListOfRequestQueuesResponse

// NewListOfRequestQueuesResponse instantiates a new ListOfRequestQueuesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfRequestQueuesResponse(data ListOfRequestQueues) *ListOfRequestQueuesResponse {
	this := ListOfRequestQueuesResponse{}
	this.Data = data
	return &this
}

// NewListOfRequestQueuesResponseWithDefaults instantiates a new ListOfRequestQueuesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfRequestQueuesResponseWithDefaults() *ListOfRequestQueuesResponse {
	this := ListOfRequestQueuesResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfRequestQueuesResponse) GetData() ListOfRequestQueues {
	if o == nil {
		var ret ListOfRequestQueues
		return ret
	}
...
func (o *ListOfRequestQueuesResponse) GetDataOk() (*ListOfRequestQueues, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfRequestQueuesResponse) SetData(v ListOfRequestQueues) {
	o.Data = v
}

func (o ListOfRequestQueuesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfRequestQueuesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfRequestQueuesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRequestQueuesResponse := _ListOfRequestQueuesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRequestQueuesResponse)

	if err != nil {
		return err
	}

	*o = ListOfRequestQueuesResponse(varListOfRequestQueuesResponse)

	return err
}

type NullableListOfRequestQueuesResponse struct {
	value *ListOfRequestQueuesResponse
	isSet bool
}

func (v NullableListOfRequestQueuesResponse) Get() *ListOfRequestQueuesResponse {
	return v.value
}

func (v *NullableListOfRequestQueuesResponse) Set(val *ListOfRequestQueuesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRequestQueuesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRequestQueuesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRequestQueuesResponse(val *ListOfRequestQueuesResponse) *NullableListOfRequestQueuesResponse {
	return &NullableListOfRequestQueuesResponse{value: val, isSet: true}
}

func (v NullableListOfRequestQueuesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRequestQueuesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
