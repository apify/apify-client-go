...
// checks if the AddRequestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddRequestResponse{}

// AddRequestResponse Response containing the result of adding a request to the request queue.
type AddRequestResponse struct {
	Data RequestRegistration `json:"data"`
}

type _AddRequestResponse AddRequestResponse

// NewAddRequestResponse instantiates a new AddRequestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAddRequestResponse(data RequestRegistration) *AddRequestResponse {
	this := AddRequestResponse{}
	this.Data = data
	return &this
}

// NewAddRequestResponseWithDefaults instantiates a new AddRequestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAddRequestResponseWithDefaults() *AddRequestResponse {
	this := AddRequestResponse{}
	return &this
}

// GetData returns the Data field value
func (o *AddRequestResponse) GetData() RequestRegistration {
	if o == nil {
...
func (o *AddRequestResponse) GetDataOk() (*RequestRegistration, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AddRequestResponse) SetData(v RequestRegistration) {
	o.Data = v
}

func (o AddRequestResponse) MarshalJSON() ([]byte, error) {
...
func (o AddRequestResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *AddRequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAddRequestResponse := _AddRequestResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddRequestResponse)

	if err != nil {
		return err
	}

	*o = AddRequestResponse(varAddRequestResponse)

	return err
}

type NullableAddRequestResponse struct {
	value *AddRequestResponse
	isSet bool
}

func (v NullableAddRequestResponse) Get() *AddRequestResponse {
	return v.value
}

func (v *NullableAddRequestResponse) Set(val *AddRequestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddRequestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddRequestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddRequestResponse(val *AddRequestResponse) *NullableAddRequestResponse {
	return &NullableAddRequestResponse{value: val, isSet: true}
}

func (v NullableAddRequestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddRequestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
