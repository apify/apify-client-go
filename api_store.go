...
type ApiStoreGetRequest struct {
	ctx context.Context
...
func (r ApiStoreGetRequest) Limit(limit float64) ApiStoreGetRequest {
	r.limit = &limit
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiStoreGetRequest) Offset(offset float64) ApiStoreGetRequest {
	r.offset = &offset
	return r
}

// String to search by. The search runs on the following fields: &#x60;title&#x60;, &#x60;name&#x60;, &#x60;description&#x60;, &#x60;username&#x60;, &#x60;readme&#x60;. 
func (r ApiStoreGetRequest) Search(search string) ApiStoreGetRequest {
	r.search = &search
	return r
}
...
func (r ApiStoreGetRequest) SortBy(sortBy string) ApiStoreGetRequest {
	r.sortBy = &sortBy
	return r
}

// Filters the results by the specified category.
func (r ApiStoreGetRequest) Category(category string) ApiStoreGetRequest {
	r.category = &category
	return r
}

// Filters the results by the specified username.
func (r ApiStoreGetRequest) Username(username string) ApiStoreGetRequest {
	r.username = &username
	return r
}

// Only return Actors with the specified pricing model. 
func (r ApiStoreGetRequest) PricingModel(pricingModel string) ApiStoreGetRequest {
...
func (r ApiStoreGetRequest) AllowsAgenticUsers(allowsAgenticUsers bool) ApiStoreGetRequest {
	r.allowsAgenticUsers = &allowsAgenticUsers
	return r
}
...
func (r ApiStoreGetRequest) ResponseFormat(responseFormat string) ApiStoreGetRequest {
...
func (r ApiStoreGetRequest) IncludeUnrunnableActors(includeUnrunnableActors bool) ApiStoreGetRequest {
	r.includeUnrunnableActors = &includeUnrunnableActors
	return r
}

func (r ApiStoreGetRequest) Execute() (*ListOfActorsInStoreResponse, *http.Response, error) {
	return r.ApiService.StoreGetExecute(r)
}

/*
StoreGet Get list of Actors in Store
...
It will not return more than 1,000 records.
 ...
 @return ApiStoreGetRequest
*/
func (a *StoreAPIService) StoreGet(ctx context.Context) ApiStoreGetRequest {
	return ApiStoreGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ListOfActorsInStoreResponse
func (a *StoreAPIService) StoreGetExecute(r ApiStoreGetRequest) (*ListOfActorsInStoreResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfActorsInStoreResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StoreAPIService.StoreGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/store"
	...
	if r.pricingModel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pricingModel", r.pricingModel, "form", "")
	}
	if r.allowsAgenticUsers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "allowsAgenticUsers", r.allowsAgenticUsers, "form", "")
	}
	if r.responseFormat != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "responseFormat", r.responseFormat, "form", "")
	} else {
		var defaultValue string = "full"
		parameterAddToHeaderOrQuery(localVarQueryParams, "responseFormat", defaultValue, "form", "")
		r.responseFormat = &defaultValue
	}
	if r.includeUnrunnableActors != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnrunnableActors", r.includeUnrunnableActors, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnrunnableActors", defaultValue, "form", "")
		r.includeUnrunnableActors = &defaultValue
	}
