...
// checks if the ListOfRunsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRunsResponse{}

// ListOfRunsResponse struct for ListOfRunsResponse
type ListOfRunsResponse struct {
	Data ListOfRuns `json:"data"`
}

type _ListOfRunsResponse ListOfRunsResponse

// NewListOfRunsResponse instantiates a new ListOfRunsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfRunsResponse(data ListOfRuns) *ListOfRunsResponse {
	this := ListOfRunsResponse{}
	this.Data = data
	return &this
}

// NewListOfRunsResponseWithDefaults instantiates a new ListOfRunsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfRunsResponseWithDefaults() *ListOfRunsResponse {
	this := ListOfRunsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfRunsResponse) GetData() ListOfRuns {
	if o == nil {
		var ret ListOfRuns
		return ret
	}
...
func (o *ListOfRunsResponse) GetDataOk() (*ListOfRuns, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfRunsResponse) SetData(v ListOfRuns) {
	o.Data = v
}

func (o ListOfRunsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfRunsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfRunsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRunsResponse := _ListOfRunsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRunsResponse)

	if err != nil {
		return err
	}

	*o = ListOfRunsResponse(varListOfRunsResponse)

	return err
}

type NullableListOfRunsResponse struct {
	value *ListOfRunsResponse
	isSet bool
}

func (v NullableListOfRunsResponse) Get() *ListOfRunsResponse {
	return v.value
}

func (v *NullableListOfRunsResponse) Set(val *ListOfRunsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRunsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRunsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRunsResponse(val *ListOfRunsResponse) *NullableListOfRunsResponse {
	return &NullableListOfRunsResponse{value: val, isSet: true}
}

func (v NullableListOfRunsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRunsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
