...
// StorageRequestQueuesRequestsAPIService StorageRequestQueuesRequestsAPI service
type StorageRequestQueuesRequestsAPIService service

type ApiRequestQueueRequestDeleteRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsAPIService
	queueId string
	requestId string
	clientKey *string
}
...
func (r ApiRequestQueueRequestDeleteRequest) ClientKey(clientKey string) ApiRequestQueueRequestDeleteRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueRequestDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.RequestQueueRequestDeleteExecute(r)
}

/*
RequestQueueRequestDelete Delete request
...
Deletes given request from queue.
 ...
 @return ApiRequestQueueRequestDeleteRequest
*/
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestDelete(ctx context.Context, queueId string, requestId string) ApiRequestQueueRequestDeleteRequest {
	return ApiRequestQueueRequestDeleteRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestDeleteExecute(r ApiRequestQueueRequestDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsAPIService.RequestQueueRequestDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/requests/{requestId}"
...
type ApiRequestQueueRequestGetRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsAPIService
	queueId string
	requestId string
...
func (r ApiRequestQueueRequestGetRequest) Execute() (*RequestResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestGetExecute(r)
}

/*
RequestQueueRequestGet Get request
...
Returns request from queue.
 ...
 @param queueId Queue ID or `username~queue-name`.
 @param requestId Request ID.
 @return ApiRequestQueueRequestGetRequest
*/
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestGet(ctx context.Context, queueId string, requestId string) ApiRequestQueueRequestGetRequest {
	return ApiRequestQueueRequestGetRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestGetExecute(r ApiRequestQueueRequestGetRequest) (*RequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsAPIService.RequestQueueRequestGet")
	if err != nil {
...
type ApiRequestQueueRequestPutRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsAPIService
	queueId string
	requestId string
...
// 
func (r ApiRequestQueueRequestPutRequest) Request(request Request) ApiRequestQueueRequestPutRequest {
	r.request = &request
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiRequestQueueRequestPutRequest) Forefront(forefront string) ApiRequestQueueRequestPutRequest {
	r.forefront = &forefront
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestPutRequest) ClientKey(clientKey string) ApiRequestQueueRequestPutRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueRequestPutRequest) Execute() (*UpdateRequestResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestPutExecute(r)
}

/*
RequestQueueRequestPut Update request
...
If `handledAt` is set, the request will be removed from head of the queue (and unlocked, if applicable).
 ...
 @param queueId Queue ID or `username~queue-name`.
 @param requestId Request ID.
 @return ApiRequestQueueRequestPutRequest
*/
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestPut(ctx context.Context, queueId string, requestId string) ApiRequestQueueRequestPutRequest {
	return ApiRequestQueueRequestPutRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestPutExecute(r ApiRequestQueueRequestPutRequest) (*UpdateRequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsAPIService.RequestQueueRequestPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRequestQueueRequestsGetRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsAPIService
	queueId string
	clientKey *string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestsGetRequest) ClientKey(clientKey string) ApiRequestQueueRequestsGetRequest {
	r.clientKey = &clientKey
	return r
}
...
// Deprecated
func (r ApiRequestQueueRequestsGetRequest) ExclusiveStartId(exclusiveStartId string) ApiRequestQueueRequestsGetRequest {
	r.exclusiveStartId = &exclusiveStartId
	return r
}

// Number of keys to be returned. Maximum value is &#x60;10000&#x60;.
func (r ApiRequestQueueRequestsGetRequest) Limit(limit float64) ApiRequestQueueRequestsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiRequestQueueRequestsGetRequest) Cursor(cursor string) ApiRequestQueueRequestsGetRequest {
	r.cursor = &cursor
	return r
}
...
func (r ApiRequestQueueRequestsGetRequest) Filter(filter []string) ApiRequestQueueRequestsGetRequest {
	r.filter = &filter
	return r
}

func (r ApiRequestQueueRequestsGetRequest) Execute() (*ListOfRequestsResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestsGetExecute(r)
}

/*
RequestQueueRequestsGet List requests
...
cursor (pagination by `exclusiveStartId` is deprecated) and limit parameters.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueRequestsGetRequest
*/
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestsGet(ctx context.Context, queueId string) ApiRequestQueueRequestsGetRequest {
	return ApiRequestQueueRequestsGetRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestsGetExecute(r ApiRequestQueueRequestsGetRequest) (*ListOfRequestsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsAPIService.RequestQueueRequestsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/requests"
	localVarPath = strings.Replace(localVarPath, "{"+"queueId"+"}", url.PathEscape(parameterValueToString(r.queueId, "queueId")), -1)
...
type ApiRequestQueueRequestsPostRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsAPIService
	queueId string
...
// 
func (r ApiRequestQueueRequestsPostRequest) RequestBase(requestBase RequestBase) ApiRequestQueueRequestsPostRequest {
	r.requestBase = &requestBase
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestsPostRequest) ClientKey(clientKey string) ApiRequestQueueRequestsPostRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiRequestQueueRequestsPostRequest) Forefront(forefront string) ApiRequestQueueRequestsPostRequest {
	r.forefront = &forefront
	return r
}

func (r ApiRequestQueueRequestsPostRequest) Execute() (*AddRequestResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestsPostExecute(r)
}

/*
RequestQueueRequestsPost Add request
...
returns an ID of existing request.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueRequestsPostRequest
*/
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestsPost(ctx context.Context, queueId string) ApiRequestQueueRequestsPostRequest {
	return ApiRequestQueueRequestsPostRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsAPIService) RequestQueueRequestsPostExecute(r ApiRequestQueueRequestsPostRequest) (*AddRequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsAPIService.RequestQueueRequestsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
