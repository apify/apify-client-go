...
// checks if the ActValidateInputPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActValidateInputPost200Response{}

// ActValidateInputPost200Response struct for ActValidateInputPost200Response
type ActValidateInputPost200Response struct {
	// Whether the input is valid according to the Actor's input schema.
	Valid bool `json:"valid"`
}

type _ActValidateInputPost200Response ActValidateInputPost200Response

// NewActValidateInputPost200Response instantiates a new ActValidateInputPost200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActValidateInputPost200Response(valid bool) *ActValidateInputPost200Response {
	this := ActValidateInputPost200Response{}
	this.Valid = valid
	return &this
}

// NewActValidateInputPost200ResponseWithDefaults instantiates a new ActValidateInputPost200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActValidateInputPost200ResponseWithDefaults() *ActValidateInputPost200Response {
	this := ActValidateInputPost200Response{}
	return &this
}

// GetValid returns the Valid field value
func (o *ActValidateInputPost200Response) GetValid() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *ActValidateInputPost200Response) GetValidOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Valid, true
...
func (o *ActValidateInputPost200Response) SetValid(v bool) {
	o.Valid = v
}

func (o ActValidateInputPost200Response) MarshalJSON() ([]byte, error) {
...
func (o ActValidateInputPost200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["valid"] = o.Valid
	return toSerialize, nil
}

func (o *ActValidateInputPost200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActValidateInputPost200Response := _ActValidateInputPost200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActValidateInputPost200Response)

	if err != nil {
		return err
	}

	*o = ActValidateInputPost200Response(varActValidateInputPost200Response)

	return err
}

type NullableActValidateInputPost200Response struct {
	value *ActValidateInputPost200Response
	isSet bool
}

func (v NullableActValidateInputPost200Response) Get() *ActValidateInputPost200Response {
	return v.value
}

func (v *NullableActValidateInputPost200Response) Set(val *ActValidateInputPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActValidateInputPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActValidateInputPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActValidateInputPost200Response(val *ActValidateInputPost200Response) *NullableActValidateInputPost200Response {
	return &NullableActValidateInputPost200Response{value: val, isSet: true}
}

func (v NullableActValidateInputPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActValidateInputPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
