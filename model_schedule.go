...
type Schedule struct {
	...
	// 
	Actions []ScheduleAction `json:"actions"`
}
...
func (o *Schedule) SetDescriptionNil() {
...
// SetNotifications gets a reference to the given ScheduleNotifications and assigns it to the Notifications field.
