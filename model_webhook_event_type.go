...
// WebhookEventType Type of event that triggers the webhook.
type WebhookEventType string

// List of WebhookEventType
const (
	ACTOR_BUILD_ABORTED WebhookEventType = "ACTOR.BUILD.ABORTED"
	ACTOR_BUILD_CREATED WebhookEventType = "ACTOR.BUILD.CREATED"
	ACTOR_BUILD_FAILED WebhookEventType = "ACTOR.BUILD.FAILED"
	ACTOR_BUILD_SUCCEEDED WebhookEventType = "ACTOR.BUILD.SUCCEEDED"
	ACTOR_BUILD_TIMED_OUT WebhookEventType = "ACTOR.BUILD.TIMED_OUT"
	ACTOR_RUN_ABORTED WebhookEventType = "ACTOR.RUN.ABORTED"
	ACTOR_RUN_CREATED WebhookEventType = "ACTOR.RUN.CREATED"
	ACTOR_RUN_FAILED WebhookEventType = "ACTOR.RUN.FAILED"
	ACTOR_RUN_RESURRECTED WebhookEventType = "ACTOR.RUN.RESURRECTED"
	ACTOR_RUN_SUCCEEDED WebhookEventType = "ACTOR.RUN.SUCCEEDED"
	ACTOR_RUN_TIMED_OUT WebhookEventType = "ACTOR.RUN.TIMED_OUT"
