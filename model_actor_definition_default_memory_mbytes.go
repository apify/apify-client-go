...
// ActorDefinitionDefaultMemoryMbytes - Specifies the default amount of memory in megabytes to be used when the Actor is started. Can be an integer or a [dynamic memory expression](/platform/actors/development/actor-definition/dynamic-actor-memory).
type ActorDefinitionDefaultMemoryMbytes struct {
	Int32 *int32
	String *string
}

// int32AsActorDefinitionDefaultMemoryMbytes is a convenience function that returns int32 wrapped in ActorDefinitionDefaultMemoryMbytes
func Int32AsActorDefinitionDefaultMemoryMbytes(v *int32) ActorDefinitionDefaultMemoryMbytes {
	return ActorDefinitionDefaultMemoryMbytes{
		Int32: v,
	}
}

// stringAsActorDefinitionDefaultMemoryMbytes is a convenience function that returns string wrapped in ActorDefinitionDefaultMemoryMbytes
func StringAsActorDefinitionDefaultMemoryMbytes(v *string) ActorDefinitionDefaultMemoryMbytes {
	return ActorDefinitionDefaultMemoryMbytes{
		String: v,
	}
}
...
func (dst *ActorDefinitionDefaultMemoryMbytes) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ActorDefinitionDefaultMemoryMbytes)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ActorDefinitionDefaultMemoryMbytes)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ActorDefinitionDefaultMemoryMbytes) MarshalJSON() ([]byte, error) {
	if src.Int32 != nil {
...
func (obj *ActorDefinitionDefaultMemoryMbytes) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Int32 != nil {
...
func (obj ActorDefinitionDefaultMemoryMbytes) GetActualInstanceValue() (interface{}) {
	if obj.Int32 != nil {
		return *obj.Int32
	}
...
type NullableActorDefinitionDefaultMemoryMbytes struct {
	value *ActorDefinitionDefaultMemoryMbytes
	isSet bool
}

func (v NullableActorDefinitionDefaultMemoryMbytes) Get() *ActorDefinitionDefaultMemoryMbytes {
	return v.value
}

func (v *NullableActorDefinitionDefaultMemoryMbytes) Set(val *ActorDefinitionDefaultMemoryMbytes) {
	v.value = val
	v.isSet = true
}

func (v NullableActorDefinitionDefaultMemoryMbytes) IsSet() bool {
	return v.isSet
}

func (v *NullableActorDefinitionDefaultMemoryMbytes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorDefinitionDefaultMemoryMbytes(val *ActorDefinitionDefaultMemoryMbytes) *NullableActorDefinitionDefaultMemoryMbytes {
	return &NullableActorDefinitionDefaultMemoryMbytes{value: val, isSet: true}
}

func (v NullableActorDefinitionDefaultMemoryMbytes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorDefinitionDefaultMemoryMbytes) UnmarshalJSON(src []byte) error {
	v.isSet = true
