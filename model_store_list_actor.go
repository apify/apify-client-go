...
// checks if the StoreListActor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreListActor{}

// StoreListActor struct for StoreListActor
type StoreListActor struct {
	...
	UserPictureUrl NullableString `json:"userPictureUrl,omitempty"`
	...
	IsWhiteListedForAgenticPayments NullableBool `json:"isWhiteListedForAgenticPayments,omitempty"`
...
type _StoreListActor StoreListActor
...
func (o *StoreListActor) SetPictureUrlNil() {
...
// GetUserPictureUrl returns the UserPictureUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *StoreListActor) GetUserPictureUrl() string {
	if o == nil || IsNil(o.UserPictureUrl.Get()) {
		var ret string
		return ret
	}
	return *o.UserPictureUrl.Get()
}
...
// SetUserPictureUrl gets a reference to the given NullableString and assigns it to the UserPictureUrl field.
func (o *StoreListActor) SetUserPictureUrl(v string) {
	o.UserPictureUrl.Set(&v)
}
// SetUserPictureUrlNil sets the value for UserPictureUrl to be an explicit nil
func (o *StoreListActor) SetUserPictureUrlNil() {
	o.UserPictureUrl.Set(nil)
}
...
func (o *StoreListActor) SetUrlNil() {
	o.Url.Set(nil)
}
...
// GetCurrentPricingInfo returns the CurrentPricingInfo field value
func (o *StoreListActor) GetCurrentPricingInfo() CurrentPricingInfo {
	if o == nil {
		var ret CurrentPricingInfo
		return ret
	}

	return o.CurrentPricingInfo
}

// GetCurrentPricingInfoOk returns a tuple with the CurrentPricingInfo field value
// and a boolean to check if the value has been set.
func (o *StoreListActor) GetCurrentPricingInfoOk() (*CurrentPricingInfo, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CurrentPricingInfo, true
}

// SetCurrentPricingInfo sets field value
func (o *StoreListActor) SetCurrentPricingInfo(v CurrentPricingInfo) {
	o.CurrentPricingInfo = v
}

// GetIsWhiteListedForAgenticPayments returns the IsWhiteListedForAgenticPayments field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *StoreListActor) GetIsWhiteListedForAgenticPayments() bool {
	if o == nil || IsNil(o.IsWhiteListedForAgenticPayments.Get()) {
		var ret bool
		return ret
	}
	return *o.IsWhiteListedForAgenticPayments.Get()
}

// GetIsWhiteListedForAgenticPaymentsOk returns a tuple with the IsWhiteListedForAgenticPayments field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StoreListActor) GetIsWhiteListedForAgenticPaymentsOk() (*bool, bool) {
	...
	return o.IsWhiteListedForAgenticPayments.Get(), o.IsWhiteListedForAgenticPayments.IsSet()
}
...
func (o *StoreListActor) HasIsWhiteListedForAgenticPayments() bool {
	if o != nil && o.IsWhiteListedForAgenticPayments.IsSet() {
		return true
	}
...
// SetIsWhiteListedForAgenticPayments gets a reference to the given NullableBool and assigns it to the IsWhiteListedForAgenticPayments field.
func (o *StoreListActor) SetIsWhiteListedForAgenticPayments(v bool) {
	o.IsWhiteListedForAgenticPayments.Set(&v)
}
...
func (o *StoreListActor) SetIsWhiteListedForAgenticPaymentsNil() {
	o.IsWhiteListedForAgenticPayments.Set(nil)
}
...
func (o *StoreListActor) UnsetIsWhiteListedForAgenticPayments() {
	o.IsWhiteListedForAgenticPayments.Unset()
}
...
func (o *StoreListActor) SetBadgeNil() {
	o.Badge.Set(nil)
}
...
func (o StoreListActor) MarshalJSON() ([]byte, error) {
...
func (o StoreListActor) ToMap() (map[string]interface{}, error) {
	...
	if o.UserPictureUrl.IsSet() {
		toSerialize["userPictureUrl"] = o.UserPictureUrl.Get()
	}
	if o.Url.IsSet() {
		toSerialize["url"] = o.Url.Get()
	}
	toSerialize["stats"] = o.Stats
	toSerialize["currentPricingInfo"] = o.CurrentPricingInfo
	if o.IsWhiteListedForAgenticPayments.IsSet() {
		toSerialize["isWhiteListedForAgenticPayments"] = o.IsWhiteListedForAgenticPayments.Get()
	}
...
func (o *StoreListActor) UnmarshalJSON(data []byte) (err error) {
	...
	varStoreListActor := _StoreListActor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStoreListActor)

	if err != nil {
		return err
	}

	*o = StoreListActor(varStoreListActor)

	return err
}

type NullableStoreListActor struct {
	value *StoreListActor
	isSet bool
}

func (v NullableStoreListActor) Get() *StoreListActor {
	return v.value
}

func (v *NullableStoreListActor) Set(val *StoreListActor) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreListActor) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreListActor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreListActor(val *StoreListActor) *NullableStoreListActor {
	return &NullableStoreListActor{value: val, isSet: true}
}

func (v NullableStoreListActor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreListActor) UnmarshalJSON(src []byte) error {
	v.isSet = true
