...
// checks if the KeyValueStoreKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyValueStoreKey{}

// KeyValueStoreKey struct for KeyValueStoreKey
...
type _KeyValueStoreKey KeyValueStoreKey
...
func NewKeyValueStoreKey(key string, size int32, recordPublicUrl string) *KeyValueStoreKey {
	this := KeyValueStoreKey{}
	this.Key = key
	this.Size = size
	this.RecordPublicUrl = recordPublicUrl
	return &this
}
...
// GetRecordPublicUrl returns the RecordPublicUrl field value
func (o *KeyValueStoreKey) GetRecordPublicUrl() string {
	...
	return o.RecordPublicUrl
}

// GetRecordPublicUrlOk returns a tuple with the RecordPublicUrl field value
// and a boolean to check if the value has been set.
func (o *KeyValueStoreKey) GetRecordPublicUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RecordPublicUrl, true
}

// SetRecordPublicUrl sets field value
func (o *KeyValueStoreKey) SetRecordPublicUrl(v string) {
	o.RecordPublicUrl = v
}

func (o KeyValueStoreKey) MarshalJSON() ([]byte, error) {
...
func (o KeyValueStoreKey) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["key"] = o.Key
	toSerialize["size"] = o.Size
	toSerialize["recordPublicUrl"] = o.RecordPublicUrl
	return toSerialize, nil
}

func (o *KeyValueStoreKey) UnmarshalJSON(data []byte) (err error) {
	...
	varKeyValueStoreKey := _KeyValueStoreKey{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeyValueStoreKey)

	if err != nil {
		return err
	}

	*o = KeyValueStoreKey(varKeyValueStoreKey)

	return err
}

type NullableKeyValueStoreKey struct {
	value *KeyValueStoreKey
	isSet bool
}

func (v NullableKeyValueStoreKey) Get() *KeyValueStoreKey {
	return v.value
}

func (v *NullableKeyValueStoreKey) Set(val *KeyValueStoreKey) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyValueStoreKey) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyValueStoreKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyValueStoreKey(val *KeyValueStoreKey) *NullableKeyValueStoreKey {
	return &NullableKeyValueStoreKey{value: val, isSet: true}
}

func (v NullableKeyValueStoreKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyValueStoreKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
