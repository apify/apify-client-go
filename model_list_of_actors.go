...
// checks if the ListOfActors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfActors{}

// ListOfActors struct for ListOfActors
...
type _ListOfActors ListOfActors

// NewListOfActors instantiates a new ListOfActors object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfActors(total int32, offset int32, limit int32, desc bool, count int32, items []ActorShort) *ListOfActors {
	this := ListOfActors{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
...
// NewListOfActorsWithDefaults instantiates a new ListOfActors object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfActorsWithDefaults() *ListOfActors {
	this := ListOfActors{}
	return &this
}

// GetTotal returns the Total field value
func (o *ListOfActors) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListOfActors) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ListOfActors) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ListOfActors) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfActors) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListOfActors) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ListOfActors) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfActors) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ListOfActors) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ListOfActors) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfActors) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ListOfActors) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ListOfActors) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfActors) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ListOfActors) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ListOfActors) GetItems() []ActorShort {
	if o == nil {
		var ret []ActorShort
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfActors) GetItemsOk() ([]ActorShort, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListOfActors) SetItems(v []ActorShort) {
	o.Items = v
}

func (o ListOfActors) MarshalJSON() ([]byte, error) {
...
func (o ListOfActors) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfActors) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfActors := _ListOfActors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfActors)

	if err != nil {
		return err
	}

	*o = ListOfActors(varListOfActors)

	return err
}

type NullableListOfActors struct {
	value *ListOfActors
	isSet bool
}

func (v NullableListOfActors) Get() *ListOfActors {
	return v.value
}

func (v *NullableListOfActors) Set(val *ListOfActors) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfActors) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfActors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfActors(val *ListOfActors) *NullableListOfActors {
	return &NullableListOfActors{value: val, isSet: true}
}

func (v NullableListOfActors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfActors) UnmarshalJSON(src []byte) error {
	v.isSet = true
