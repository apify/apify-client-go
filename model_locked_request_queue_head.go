...
// checks if the LockedRequestQueueHead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LockedRequestQueueHead{}

// LockedRequestQueueHead A batch of locked requests from the request queue head.
type LockedRequestQueueHead struct {
	...
	LockSecs int32 `json:"lockSecs"`
	// The array of locked requests from the request queue head.
	Items []LockedHeadRequest `json:"items"`
}

type _LockedRequestQueueHead LockedRequestQueueHead
...
// GetQueueModifiedAt returns the QueueModifiedAt field value
func (o *LockedRequestQueueHead) GetQueueModifiedAt() time.Time {
	...
	return o.QueueModifiedAt
}

// GetQueueModifiedAtOk returns a tuple with the QueueModifiedAt field value
// and a boolean to check if the value has been set.
func (o *LockedRequestQueueHead) GetQueueModifiedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.QueueModifiedAt, true
}

// SetQueueModifiedAt sets field value
func (o *LockedRequestQueueHead) SetQueueModifiedAt(v time.Time) {
	o.QueueModifiedAt = v
}

// GetQueueHasLockedRequests returns the QueueHasLockedRequests field value if set, zero value otherwise.
func (o *LockedRequestQueueHead) GetQueueHasLockedRequests() bool {
	if o == nil || IsNil(o.QueueHasLockedRequests) {
		var ret bool
		return ret
	}
	return *o.QueueHasLockedRequests
}

// GetQueueHasLockedRequestsOk returns a tuple with the QueueHasLockedRequests field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LockedRequestQueueHead) GetQueueHasLockedRequestsOk() (*bool, bool) {
	if o == nil || IsNil(o.QueueHasLockedRequests) {
		return nil, false
	}
	return o.QueueHasLockedRequests, true
}
...
// SetQueueHasLockedRequests gets a reference to the given bool and assigns it to the QueueHasLockedRequests field.
func (o *LockedRequestQueueHead) SetQueueHasLockedRequests(v bool) {
	o.QueueHasLockedRequests = &v
}
...
// GetLockSecs returns the LockSecs field value
...
// GetLockSecsOk returns a tuple with the LockSecs field value
// and a boolean to check if the value has been set.
func (o *LockedRequestQueueHead) GetLockSecsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LockSecs, true
}

// SetLockSecs sets field value
...
func (o LockedRequestQueueHead) MarshalJSON() ([]byte, error) {
...
func (o LockedRequestQueueHead) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["limit"] = o.Limit
	toSerialize["queueModifiedAt"] = o.QueueModifiedAt
	if !IsNil(o.QueueHasLockedRequests) {
		toSerialize["queueHasLockedRequests"] = o.QueueHasLockedRequests
	}
	if !IsNil(o.ClientKey) {
		toSerialize["clientKey"] = o.ClientKey
	}
	toSerialize["hadMultipleClients"] = o.HadMultipleClients
	toSerialize["lockSecs"] = o.LockSecs
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *LockedRequestQueueHead) UnmarshalJSON(data []byte) (err error) {
	...
	varLockedRequestQueueHead := _LockedRequestQueueHead{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLockedRequestQueueHead)

	if err != nil {
		return err
	}

	*o = LockedRequestQueueHead(varLockedRequestQueueHead)

	return err
}

type NullableLockedRequestQueueHead struct {
	value *LockedRequestQueueHead
	isSet bool
}

func (v NullableLockedRequestQueueHead) Get() *LockedRequestQueueHead {
	return v.value
}

func (v *NullableLockedRequestQueueHead) Set(val *LockedRequestQueueHead) {
	v.value = val
	v.isSet = true
}

func (v NullableLockedRequestQueueHead) IsSet() bool {
	return v.isSet
}

func (v *NullableLockedRequestQueueHead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLockedRequestQueueHead(val *LockedRequestQueueHead) *NullableLockedRequestQueueHead {
	return &NullableLockedRequestQueueHead{value: val, isSet: true}
}

func (v NullableLockedRequestQueueHead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLockedRequestQueueHead) UnmarshalJSON(src []byte) error {
	v.isSet = true
