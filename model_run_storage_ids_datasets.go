...
// checks if the RunStorageIdsDatasets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunStorageIdsDatasets{}

// RunStorageIdsDatasets Aliased dataset IDs for this run.
type RunStorageIdsDatasets struct {
	// ID of the default dataset for this run.
	Default *string `json:"default,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RunStorageIdsDatasets RunStorageIdsDatasets

// NewRunStorageIdsDatasets instantiates a new RunStorageIdsDatasets object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRunStorageIdsDatasets() *RunStorageIdsDatasets {
	this := RunStorageIdsDatasets{}
	return &this
}

// NewRunStorageIdsDatasetsWithDefaults instantiates a new RunStorageIdsDatasets object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRunStorageIdsDatasetsWithDefaults() *RunStorageIdsDatasets {
	this := RunStorageIdsDatasets{}
	return &this
}

// GetDefault returns the Default field value if set, zero value otherwise.
func (o *RunStorageIdsDatasets) GetDefault() string {
...
func (o *RunStorageIdsDatasets) GetDefaultOk() (*string, bool) {
	if o == nil || IsNil(o.Default) {
		return nil, false
	}
...
func (o *RunStorageIdsDatasets) HasDefault() bool {
	if o != nil && !IsNil(o.Default) {
		return true
	}
...
func (o *RunStorageIdsDatasets) SetDefault(v string) {
	o.Default = &v
}

func (o RunStorageIdsDatasets) MarshalJSON() ([]byte, error) {
...
func (o RunStorageIdsDatasets) ToMap() (map[string]interface{}, error) {
...
func (o *RunStorageIdsDatasets) UnmarshalJSON(data []byte) (err error) {
	varRunStorageIdsDatasets := _RunStorageIdsDatasets{}

	err = json.Unmarshal(data, &varRunStorageIdsDatasets)

	if err != nil {
		return err
	}

	*o = RunStorageIdsDatasets(varRunStorageIdsDatasets)
...
type NullableRunStorageIdsDatasets struct {
	value *RunStorageIdsDatasets
	isSet bool
}

func (v NullableRunStorageIdsDatasets) Get() *RunStorageIdsDatasets {
	return v.value
}

func (v *NullableRunStorageIdsDatasets) Set(val *RunStorageIdsDatasets) {
	v.value = val
	v.isSet = true
}

func (v NullableRunStorageIdsDatasets) IsSet() bool {
	return v.isSet
}

func (v *NullableRunStorageIdsDatasets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunStorageIdsDatasets(val *RunStorageIdsDatasets) *NullableRunStorageIdsDatasets {
	return &NullableRunStorageIdsDatasets{value: val, isSet: true}
}

func (v NullableRunStorageIdsDatasets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunStorageIdsDatasets) UnmarshalJSON(src []byte) error {
	v.isSet = true
