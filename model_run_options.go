...
// RunOptions struct for RunOptions
type RunOptions struct {
	Build string `json:"build"`
	TimeoutSecs int32 `json:"timeoutSecs"`
	MemoryMbytes int32 `json:"memoryMbytes"`
	DiskMbytes int32 `json:"diskMbytes"`
	MaxItems NullableInt32 `json:"maxItems,omitempty"`
	MaxTotalChargeUsd *float32 `json:"maxTotalChargeUsd,omitempty"`
}
...
// GetMemoryMbytes returns the MemoryMbytes field value
...
// GetMemoryMbytesOk returns a tuple with the MemoryMbytes field value
// and a boolean to check if the value has been set.
...
// SetMemoryMbytes sets field value
func (o *RunOptions) SetMemoryMbytes(v int32) {
	o.MemoryMbytes = v
}

// GetDiskMbytes returns the DiskMbytes field value
...
// GetDiskMbytesOk returns a tuple with the DiskMbytes field value
// and a boolean to check if the value has been set.
func (o *RunOptions) GetDiskMbytesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DiskMbytes, true
}

// SetDiskMbytes sets field value
...
func (o *RunOptions) SetMaxItemsNil() {
	o.MaxItems.Set(nil)
}
...
// GetMaxTotalChargeUsd returns the MaxTotalChargeUsd field value if set, zero value otherwise.
func (o *RunOptions) GetMaxTotalChargeUsd() float32 {
	if o == nil || IsNil(o.MaxTotalChargeUsd) {
		var ret float32
		return ret
	}
	return *o.MaxTotalChargeUsd
}
...
func (o *RunOptions) GetMaxTotalChargeUsdOk() (*float32, bool) {
	...
	return o.MaxTotalChargeUsd, true
}
...
// SetMaxTotalChargeUsd gets a reference to the given float32 and assigns it to the MaxTotalChargeUsd field.
func (o *RunOptions) SetMaxTotalChargeUsd(v float32) {
	o.MaxTotalChargeUsd = &v
}
...
func (o RunOptions) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["diskMbytes"] = o.DiskMbytes
	if o.MaxItems.IsSet() {
		toSerialize["maxItems"] = o.MaxItems.Get()
	}
	if !IsNil(o.MaxTotalChargeUsd) {
		toSerialize["maxTotalChargeUsd"] = o.MaxTotalChargeUsd
	}
