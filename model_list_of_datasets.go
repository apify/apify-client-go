...
// checks if the ListOfDatasets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfDatasets{}

// ListOfDatasets struct for ListOfDatasets
...
type _ListOfDatasets ListOfDatasets
...
func (o ListOfDatasets) MarshalJSON() ([]byte, error) {
...
func (o ListOfDatasets) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfDatasets) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfDatasets := _ListOfDatasets{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfDatasets)

	if err != nil {
		return err
	}

	*o = ListOfDatasets(varListOfDatasets)

	return err
}

type NullableListOfDatasets struct {
	value *ListOfDatasets
	isSet bool
}

func (v NullableListOfDatasets) Get() *ListOfDatasets {
	return v.value
}

func (v *NullableListOfDatasets) Set(val *ListOfDatasets) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfDatasets) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfDatasets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfDatasets(val *ListOfDatasets) *NullableListOfDatasets {
	return &NullableListOfDatasets{value: val, isSet: true}
}

func (v NullableListOfDatasets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfDatasets) UnmarshalJSON(src []byte) error {
	v.isSet = true
