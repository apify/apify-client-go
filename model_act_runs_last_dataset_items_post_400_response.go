...
// ActRunsLastDatasetItemsPost400Response struct for ActRunsLastDatasetItemsPost400Response
type ActRunsLastDatasetItemsPost400Response struct {
	ErrorResponse *ErrorResponse
	PutItemResponseError *PutItemResponseError
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ActRunsLastDatasetItemsPost400Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into PutItemResponseError
	err = json.Unmarshal(data, &dst.PutItemResponseError);
	if err == nil {
		jsonPutItemResponseError, _ := json.Marshal(dst.PutItemResponseError)
		if string(jsonPutItemResponseError) == "{}" { // empty struct
			dst.PutItemResponseError = nil
		} else {
			return nil // data stored in dst.PutItemResponseError, return on the first match
		}
	} else {
		dst.PutItemResponseError = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ActRunsLastDatasetItemsPost400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ActRunsLastDatasetItemsPost400Response) MarshalJSON() ([]byte, error) {
	if src.ErrorResponse != nil {
		return json.Marshal(&src.ErrorResponse)
	}

	if src.PutItemResponseError != nil {
		return json.Marshal(&src.PutItemResponseError)
	}
...
type NullableActRunsLastDatasetItemsPost400Response struct {
	value *ActRunsLastDatasetItemsPost400Response
	isSet bool
}

func (v NullableActRunsLastDatasetItemsPost400Response) Get() *ActRunsLastDatasetItemsPost400Response {
	return v.value
}

func (v *NullableActRunsLastDatasetItemsPost400Response) Set(val *ActRunsLastDatasetItemsPost400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActRunsLastDatasetItemsPost400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActRunsLastDatasetItemsPost400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActRunsLastDatasetItemsPost400Response(val *ActRunsLastDatasetItemsPost400Response) *NullableActRunsLastDatasetItemsPost400Response {
	return &NullableActRunsLastDatasetItemsPost400Response{value: val, isSet: true}
}

func (v NullableActRunsLastDatasetItemsPost400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActRunsLastDatasetItemsPost400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
