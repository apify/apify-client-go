...
// checks if the ListOfEnvVarsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfEnvVarsResponse{}

// ListOfEnvVarsResponse struct for ListOfEnvVarsResponse
type ListOfEnvVarsResponse struct {
	Data ListOfEnvVars `json:"data"`
}

type _ListOfEnvVarsResponse ListOfEnvVarsResponse

// NewListOfEnvVarsResponse instantiates a new ListOfEnvVarsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfEnvVarsResponse(data ListOfEnvVars) *ListOfEnvVarsResponse {
	this := ListOfEnvVarsResponse{}
	this.Data = data
	return &this
}

// NewListOfEnvVarsResponseWithDefaults instantiates a new ListOfEnvVarsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfEnvVarsResponseWithDefaults() *ListOfEnvVarsResponse {
	this := ListOfEnvVarsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfEnvVarsResponse) GetData() ListOfEnvVars {
	if o == nil {
		var ret ListOfEnvVars
		return ret
	}
...
func (o *ListOfEnvVarsResponse) GetDataOk() (*ListOfEnvVars, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfEnvVarsResponse) SetData(v ListOfEnvVars) {
	o.Data = v
}

func (o ListOfEnvVarsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfEnvVarsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfEnvVarsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfEnvVarsResponse := _ListOfEnvVarsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfEnvVarsResponse)

	if err != nil {
		return err
	}

	*o = ListOfEnvVarsResponse(varListOfEnvVarsResponse)

	return err
}

type NullableListOfEnvVarsResponse struct {
	value *ListOfEnvVarsResponse
	isSet bool
}

func (v NullableListOfEnvVarsResponse) Get() *ListOfEnvVarsResponse {
	return v.value
}

func (v *NullableListOfEnvVarsResponse) Set(val *ListOfEnvVarsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfEnvVarsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfEnvVarsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfEnvVarsResponse(val *ListOfEnvVarsResponse) *NullableListOfEnvVarsResponse {
	return &NullableListOfEnvVarsResponse{value: val, isSet: true}
}

func (v NullableListOfEnvVarsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfEnvVarsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
