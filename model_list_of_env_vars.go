...
// checks if the ListOfEnvVars type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfEnvVars{}

// ListOfEnvVars struct for ListOfEnvVars
...
type _ListOfEnvVars ListOfEnvVars
...
func (o ListOfEnvVars) MarshalJSON() ([]byte, error) {
...
func (o ListOfEnvVars) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfEnvVars) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfEnvVars := _ListOfEnvVars{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfEnvVars)

	if err != nil {
		return err
	}

	*o = ListOfEnvVars(varListOfEnvVars)

	return err
}

type NullableListOfEnvVars struct {
	value *ListOfEnvVars
	isSet bool
}

func (v NullableListOfEnvVars) Get() *ListOfEnvVars {
	return v.value
}

func (v *NullableListOfEnvVars) Set(val *ListOfEnvVars) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfEnvVars) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfEnvVars) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfEnvVars(val *ListOfEnvVars) *NullableListOfEnvVars {
	return &NullableListOfEnvVars{value: val, isSet: true}
}

func (v NullableListOfEnvVars) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfEnvVars) UnmarshalJSON(src []byte) error {
	v.isSet = true
