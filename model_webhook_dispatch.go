...
// checks if the WebhookDispatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookDispatch{}

// WebhookDispatch struct for WebhookDispatch
type WebhookDispatch struct {
	Id string `json:"id"`
	UserId string `json:"userId"`
	WebhookId string `json:"webhookId"`
	CreatedAt time.Time `json:"createdAt"`
	Status WebhookDispatchStatus `json:"status"`
	EventType WebhookEventType `json:"eventType"`
	EventData *EventData `json:"eventData,omitempty"`
	Webhook NullableWebhookDispatchWebhookSummary `json:"webhook,omitempty"`
	Calls []CallsInner `json:"calls,omitempty"`
}

type _WebhookDispatch WebhookDispatch
...
func (o *WebhookDispatch) GetWebhook() WebhookDispatchWebhookSummary {
	if o == nil || IsNil(o.Webhook.Get()) {
		var ret WebhookDispatchWebhookSummary
		return ret
	}
...
// SetWebhook gets a reference to the given NullableWebhookDispatchWebhookSummary and assigns it to the Webhook field.
func (o *WebhookDispatch) SetWebhook(v WebhookDispatchWebhookSummary) {
	o.Webhook.Set(&v)
}
// SetWebhookNil sets the value for Webhook to be an explicit nil
func (o *WebhookDispatch) SetWebhookNil() {
	o.Webhook.Set(nil)
}
...
// SetCalls gets a reference to the given []CallsInner and assigns it to the Calls field.
func (o *WebhookDispatch) SetCalls(v []CallsInner) {
	o.Calls = v
}

func (o WebhookDispatch) MarshalJSON() ([]byte, error) {
...
func (o WebhookDispatch) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookDispatch) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookDispatch := _WebhookDispatch{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookDispatch)

	if err != nil {
		return err
	}

	*o = WebhookDispatch(varWebhookDispatch)

	return err
}

type NullableWebhookDispatch struct {
	value *WebhookDispatch
	isSet bool
}

func (v NullableWebhookDispatch) Get() *WebhookDispatch {
	return v.value
}

func (v *NullableWebhookDispatch) Set(val *WebhookDispatch) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookDispatch) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookDispatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookDispatch(val *WebhookDispatch) *NullableWebhookDispatch {
	return &NullableWebhookDispatch{value: val, isSet: true}
}

func (v NullableWebhookDispatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookDispatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
