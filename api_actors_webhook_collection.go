...
// ActorsWebhookCollectionAPIService ActorsWebhookCollectionAPI service
type ActorsWebhookCollectionAPIService service

type ApiActWebhooksGetRequest struct {
	ctx context.Context
	ApiService *ActorsWebhookCollectionAPIService
	actorId string
	offset *float64
	limit *float64
	desc *bool
...
func (r ApiActWebhooksGetRequest) Offset(offset float64) ApiActWebhooksGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiActWebhooksGetRequest) Limit(limit float64) ApiActWebhooksGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActWebhooksGetRequest) Desc(desc bool) ApiActWebhooksGetRequest {
	r.desc = &desc
	return r
}

func (r ApiActWebhooksGetRequest) Execute() (*ListOfWebhooksResponse, *http.Response, error) {
	return r.ApiService.ActWebhooksGetExecute(r)
}

/*
ActWebhooksGet Get list of webhooks
...
order, to sort the records in descending order, use the `desc=1` parameter.
 ...
 @return ApiActWebhooksGetRequest
*/
func (a *ActorsWebhookCollectionAPIService) ActWebhooksGet(ctx context.Context, actorId string) ApiActWebhooksGetRequest {
	return ApiActWebhooksGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsWebhookCollectionAPIService) ActWebhooksGetExecute(r ApiActWebhooksGetRequest) (*ListOfWebhooksResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsWebhookCollectionAPIService.ActWebhooksGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/webhooks"
