...
// checks if the UpdateRequestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRequestResponse{}

// UpdateRequestResponse Response containing the result of updating a request in the request queue.
type UpdateRequestResponse struct {
	Data RequestRegistration `json:"data"`
}

type _UpdateRequestResponse UpdateRequestResponse

// NewUpdateRequestResponse instantiates a new UpdateRequestResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateRequestResponse(data RequestRegistration) *UpdateRequestResponse {
	this := UpdateRequestResponse{}
	this.Data = data
	return &this
}

// NewUpdateRequestResponseWithDefaults instantiates a new UpdateRequestResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateRequestResponseWithDefaults() *UpdateRequestResponse {
	this := UpdateRequestResponse{}
	return &this
}

// GetData returns the Data field value
func (o *UpdateRequestResponse) GetData() RequestRegistration {
	if o == nil {
		var ret RequestRegistration
		return ret
	}
...
func (o *UpdateRequestResponse) GetDataOk() (*RequestRegistration, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *UpdateRequestResponse) SetData(v RequestRegistration) {
	o.Data = v
}

func (o UpdateRequestResponse) MarshalJSON() ([]byte, error) {
...
func (o UpdateRequestResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *UpdateRequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateRequestResponse := _UpdateRequestResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateRequestResponse)

	if err != nil {
		return err
	}

	*o = UpdateRequestResponse(varUpdateRequestResponse)

	return err
}

type NullableUpdateRequestResponse struct {
	value *UpdateRequestResponse
	isSet bool
}

func (v NullableUpdateRequestResponse) Get() *UpdateRequestResponse {
	return v.value
}

func (v *NullableUpdateRequestResponse) Set(val *UpdateRequestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRequestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRequestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRequestResponse(val *UpdateRequestResponse) *NullableUpdateRequestResponse {
	return &NullableUpdateRequestResponse{value: val, isSet: true}
}

func (v NullableUpdateRequestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRequestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
