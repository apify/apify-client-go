...
// checks if the WebhookDispatchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookDispatchResponse{}

// WebhookDispatchResponse struct for WebhookDispatchResponse
type WebhookDispatchResponse struct {
	Data WebhookDispatch `json:"data"`
}

type _WebhookDispatchResponse WebhookDispatchResponse

// NewWebhookDispatchResponse instantiates a new WebhookDispatchResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebhookDispatchResponse(data WebhookDispatch) *WebhookDispatchResponse {
	this := WebhookDispatchResponse{}
	this.Data = data
	return &this
}

// NewWebhookDispatchResponseWithDefaults instantiates a new WebhookDispatchResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWebhookDispatchResponseWithDefaults() *WebhookDispatchResponse {
	this := WebhookDispatchResponse{}
	return &this
}

// GetData returns the Data field value
func (o *WebhookDispatchResponse) GetData() WebhookDispatch {
	if o == nil {
...
func (o *WebhookDispatchResponse) GetDataOk() (*WebhookDispatch, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *WebhookDispatchResponse) SetData(v WebhookDispatch) {
	o.Data = v
}

func (o WebhookDispatchResponse) MarshalJSON() ([]byte, error) {
...
func (o WebhookDispatchResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *WebhookDispatchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookDispatchResponse := _WebhookDispatchResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookDispatchResponse)

	if err != nil {
		return err
	}

	*o = WebhookDispatchResponse(varWebhookDispatchResponse)

	return err
}

type NullableWebhookDispatchResponse struct {
	value *WebhookDispatchResponse
	isSet bool
}

func (v NullableWebhookDispatchResponse) Get() *WebhookDispatchResponse {
	return v.value
}

func (v *NullableWebhookDispatchResponse) Set(val *WebhookDispatchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookDispatchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookDispatchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookDispatchResponse(val *WebhookDispatchResponse) *NullableWebhookDispatchResponse {
	return &NullableWebhookDispatchResponse{value: val, isSet: true}
}

func (v NullableWebhookDispatchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookDispatchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
