...
// checks if the CreateOrUpdateVersionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrUpdateVersionRequest{}

// CreateOrUpdateVersionRequest struct for CreateOrUpdateVersionRequest
type CreateOrUpdateVersionRequest struct {
	VersionNumber NullableString `json:"versionNumber,omitempty" validate:"regexp=^([0-9]|[1-9][0-9])\\\\.([0-9]|[1-9][0-9])$"`
	SourceType NullableVersionSourceType `json:"sourceType,omitempty"`
	// 
	EnvVars []EnvVarRequest `json:"envVars,omitempty"`
	ApplyEnvVarsToBuild NullableBool `json:"applyEnvVarsToBuild,omitempty"`
	BuildTag NullableString `json:"buildTag,omitempty"`
	SourceFiles []VersionSourceFilesInner `json:"sourceFiles,omitempty"`
	...
	TarballUrl NullableString `json:"tarballUrl,omitempty"`
	// URL of the GitHub Gist when sourceType is GITHUB_GIST.
	GitHubGistUrl NullableString `json:"gitHubGistUrl,omitempty"`
}
...
func NewCreateOrUpdateVersionRequest() *CreateOrUpdateVersionRequest {
	this := CreateOrUpdateVersionRequest{}
	return &this
}
...
func (o *CreateOrUpdateVersionRequest) SetVersionNumberNil() {
...
// SetSourceType gets a reference to the given NullableVersionSourceType and assigns it to the SourceType field.
func (o *CreateOrUpdateVersionRequest) SetSourceType(v VersionSourceType) {
	o.SourceType.Set(&v)
}
// SetSourceTypeNil sets the value for SourceType to be an explicit nil
func (o *CreateOrUpdateVersionRequest) SetSourceTypeNil() {
...
// GetEnvVars returns the EnvVars field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateOrUpdateVersionRequest) GetEnvVars() []EnvVarRequest {
	if o == nil {
		var ret []EnvVarRequest
		return ret
	}
	return o.EnvVars
}
...
// SetEnvVars gets a reference to the given []EnvVarRequest and assigns it to the EnvVars field.
func (o *CreateOrUpdateVersionRequest) SetEnvVars(v []EnvVarRequest) {
	o.EnvVars = v
}

// GetApplyEnvVarsToBuild returns the ApplyEnvVarsToBuild field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateOrUpdateVersionRequest) GetApplyEnvVarsToBuild() bool {
	if o == nil || IsNil(o.ApplyEnvVarsToBuild.Get()) {
		var ret bool
		return ret
	}
	return *o.ApplyEnvVarsToBuild.Get()
}

// GetApplyEnvVarsToBuildOk returns a tuple with the ApplyEnvVarsToBuild field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateOrUpdateVersionRequest) GetApplyEnvVarsToBuildOk() (*bool, bool) {
	...
	return o.ApplyEnvVarsToBuild.Get(), o.ApplyEnvVarsToBuild.IsSet()
}
...
func (o *CreateOrUpdateVersionRequest) HasApplyEnvVarsToBuild() bool {
	if o != nil && o.ApplyEnvVarsToBuild.IsSet() {
		return true
	}
...
// SetApplyEnvVarsToBuild gets a reference to the given NullableBool and assigns it to the ApplyEnvVarsToBuild field.
func (o *CreateOrUpdateVersionRequest) SetApplyEnvVarsToBuild(v bool) {
	o.ApplyEnvVarsToBuild.Set(&v)
}
// SetApplyEnvVarsToBuildNil sets the value for ApplyEnvVarsToBuild to be an explicit nil
func (o *CreateOrUpdateVersionRequest) SetApplyEnvVarsToBuildNil() {
	o.ApplyEnvVarsToBuild.Set(nil)
}
...
func (o *CreateOrUpdateVersionRequest) UnsetApplyEnvVarsToBuild() {
	o.ApplyEnvVarsToBuild.Unset()
}

// GetBuildTag returns the BuildTag field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateOrUpdateVersionRequest) GetBuildTag() string {
	if o == nil || IsNil(o.BuildTag.Get()) {
		var ret string
		return ret
	}
	return *o.BuildTag.Get()
}
...
// SetBuildTag gets a reference to the given NullableString and assigns it to the BuildTag field.
func (o *CreateOrUpdateVersionRequest) SetBuildTag(v string) {
	o.BuildTag.Set(&v)
}
// SetBuildTagNil sets the value for BuildTag to be an explicit nil
func (o *CreateOrUpdateVersionRequest) SetBuildTagNil() {
	o.BuildTag.Set(nil)
}
...
func (o *CreateOrUpdateVersionRequest) GetSourceFiles() []VersionSourceFilesInner {
	if o == nil || IsNil(o.SourceFiles) {
		var ret []VersionSourceFilesInner
		return ret
	}
...
// SetSourceFiles gets a reference to the given []VersionSourceFilesInner and assigns it to the SourceFiles field.
...
func (o *CreateOrUpdateVersionRequest) SetGitRepoUrlNil() {
...
// GetTarballUrl returns the TarballUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateOrUpdateVersionRequest) GetTarballUrl() string {
	if o == nil || IsNil(o.TarballUrl.Get()) {
		var ret string
		return ret
	}
...
// SetTarballUrl gets a reference to the given NullableString and assigns it to the TarballUrl field.
...
func (o *CreateOrUpdateVersionRequest) SetTarballUrlNil() {
	o.TarballUrl.Set(nil)
}
...
// GetGitHubGistUrl returns the GitHubGistUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateOrUpdateVersionRequest) GetGitHubGistUrl() string {
	if o == nil || IsNil(o.GitHubGistUrl.Get()) {
		var ret string
		return ret
	}
	return *o.GitHubGistUrl.Get()
}

// GetGitHubGistUrlOk returns a tuple with the GitHubGistUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetGitHubGistUrl gets a reference to the given NullableString and assigns it to the GitHubGistUrl field.
func (o *CreateOrUpdateVersionRequest) SetGitHubGistUrl(v string) {
	o.GitHubGistUrl.Set(&v)
}
// SetGitHubGistUrlNil sets the value for GitHubGistUrl to be an explicit nil
func (o *CreateOrUpdateVersionRequest) SetGitHubGistUrlNil() {
	o.GitHubGistUrl.Set(nil)
}
...
func (o *CreateOrUpdateVersionRequest) UnsetGitHubGistUrl() {
	o.GitHubGistUrl.Unset()
}

func (o CreateOrUpdateVersionRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateOrUpdateVersionRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.ApplyEnvVarsToBuild.IsSet() {
		toSerialize["applyEnvVarsToBuild"] = o.ApplyEnvVarsToBuild.Get()
	}
	if o.BuildTag.IsSet() {
		toSerialize["buildTag"] = o.BuildTag.Get()
	}
	...
	if o.TarballUrl.IsSet() {
		toSerialize["tarballUrl"] = o.TarballUrl.Get()
	}
	if o.GitHubGistUrl.IsSet() {
		toSerialize["gitHubGistUrl"] = o.GitHubGistUrl.Get()
	}
	return toSerialize, nil
}

type NullableCreateOrUpdateVersionRequest struct {
	value *CreateOrUpdateVersionRequest
	isSet bool
}

func (v NullableCreateOrUpdateVersionRequest) Get() *CreateOrUpdateVersionRequest {
	return v.value
}

func (v *NullableCreateOrUpdateVersionRequest) Set(val *CreateOrUpdateVersionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrUpdateVersionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrUpdateVersionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrUpdateVersionRequest(val *CreateOrUpdateVersionRequest) *NullableCreateOrUpdateVersionRequest {
	return &NullableCreateOrUpdateVersionRequest{value: val, isSet: true}
}

func (v NullableCreateOrUpdateVersionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrUpdateVersionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
