...
// ScheduleCreateAction - struct for ScheduleCreateAction
type ScheduleCreateAction struct {
	ScheduleCreateActionRunActor *ScheduleCreateActionRunActor
	ScheduleCreateActionRunActorTask *ScheduleCreateActionRunActorTask
}

// ScheduleCreateActionRunActorAsScheduleCreateAction is a convenience function that returns ScheduleCreateActionRunActor wrapped in ScheduleCreateAction
func ScheduleCreateActionRunActorAsScheduleCreateAction(v *ScheduleCreateActionRunActor) ScheduleCreateAction {
	return ScheduleCreateAction{
		ScheduleCreateActionRunActor: v,
	}
}

// ScheduleCreateActionRunActorTaskAsScheduleCreateAction is a convenience function that returns ScheduleCreateActionRunActorTask wrapped in ScheduleCreateAction
func ScheduleCreateActionRunActorTaskAsScheduleCreateAction(v *ScheduleCreateActionRunActorTask) ScheduleCreateAction {
	return ScheduleCreateAction{
		ScheduleCreateActionRunActorTask: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ScheduleCreateAction) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ScheduleCreateActionRunActor
	err = newStrictDecoder(data).Decode(&dst.ScheduleCreateActionRunActor)
	if err == nil {
		jsonScheduleCreateActionRunActor, _ := json.Marshal(dst.ScheduleCreateActionRunActor)
		if string(jsonScheduleCreateActionRunActor) == "{}" { // empty struct
			dst.ScheduleCreateActionRunActor = nil
		} else {
			if err = validator.Validate(dst.ScheduleCreateActionRunActor); err != nil {
				dst.ScheduleCreateActionRunActor = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into ScheduleCreateActionRunActorTask
	err = newStrictDecoder(data).Decode(&dst.ScheduleCreateActionRunActorTask)
	if err == nil {
		jsonScheduleCreateActionRunActorTask, _ := json.Marshal(dst.ScheduleCreateActionRunActorTask)
		if string(jsonScheduleCreateActionRunActorTask) == "{}" { // empty struct
			dst.ScheduleCreateActionRunActorTask = nil
		} else {
			if err = validator.Validate(dst.ScheduleCreateActionRunActorTask); err != nil {
				dst.ScheduleCreateActionRunActorTask = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ScheduleCreateAction)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ScheduleCreateAction)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ScheduleCreateAction) MarshalJSON() ([]byte, error) {
	if src.ScheduleCreateActionRunActor != nil {
		return json.Marshal(&src.ScheduleCreateActionRunActor)
	}

	if src.ScheduleCreateActionRunActorTask != nil {
		return json.Marshal(&src.ScheduleCreateActionRunActorTask)
	}
...
func (obj *ScheduleCreateAction) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ScheduleCreateActionRunActor != nil {
		return obj.ScheduleCreateActionRunActor
	}

	if obj.ScheduleCreateActionRunActorTask != nil {
		return obj.ScheduleCreateActionRunActorTask
	}
...
func (obj ScheduleCreateAction) GetActualInstanceValue() (interface{}) {
	if obj.ScheduleCreateActionRunActor != nil {
		return *obj.ScheduleCreateActionRunActor
	}
...
type NullableScheduleCreateAction struct {
	value *ScheduleCreateAction
	isSet bool
}

func (v NullableScheduleCreateAction) Get() *ScheduleCreateAction {
	return v.value
}

func (v *NullableScheduleCreateAction) Set(val *ScheduleCreateAction) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleCreateAction) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleCreateAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleCreateAction(val *ScheduleCreateAction) *NullableScheduleCreateAction {
	return &NullableScheduleCreateAction{value: val, isSet: true}
}

func (v NullableScheduleCreateAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleCreateAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
