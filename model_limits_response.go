...
// checks if the LimitsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LimitsResponse{}

// LimitsResponse struct for LimitsResponse
type LimitsResponse struct {
	Data AccountLimits `json:"data"`
}

type _LimitsResponse LimitsResponse

// NewLimitsResponse instantiates a new LimitsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLimitsResponse(data AccountLimits) *LimitsResponse {
	this := LimitsResponse{}
	this.Data = data
	return &this
}

// NewLimitsResponseWithDefaults instantiates a new LimitsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLimitsResponseWithDefaults() *LimitsResponse {
	this := LimitsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *LimitsResponse) GetData() AccountLimits {
	if o == nil {
...
func (o *LimitsResponse) GetDataOk() (*AccountLimits, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *LimitsResponse) SetData(v AccountLimits) {
	o.Data = v
}

func (o LimitsResponse) MarshalJSON() ([]byte, error) {
...
func (o LimitsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *LimitsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLimitsResponse := _LimitsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLimitsResponse)

	if err != nil {
		return err
	}

	*o = LimitsResponse(varLimitsResponse)

	return err
}

type NullableLimitsResponse struct {
	value *LimitsResponse
	isSet bool
}

func (v NullableLimitsResponse) Get() *LimitsResponse {
	return v.value
}

func (v *NullableLimitsResponse) Set(val *LimitsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLimitsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLimitsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLimitsResponse(val *LimitsResponse) *NullableLimitsResponse {
	return &NullableLimitsResponse{value: val, isSet: true}
}

func (v NullableLimitsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLimitsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
