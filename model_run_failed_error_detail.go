...
// checks if the RunFailedErrorDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunFailedErrorDetail{}

// RunFailedErrorDetail struct for RunFailedErrorDetail
...
func (o RunFailedErrorDetail) MarshalJSON() ([]byte, error) {
...
func (o RunFailedErrorDetail) ToMap() (map[string]interface{}, error) {
...
type NullableRunFailedErrorDetail struct {
	value *RunFailedErrorDetail
	isSet bool
}

func (v NullableRunFailedErrorDetail) Get() *RunFailedErrorDetail {
	return v.value
}

func (v *NullableRunFailedErrorDetail) Set(val *RunFailedErrorDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableRunFailedErrorDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableRunFailedErrorDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunFailedErrorDetail(val *RunFailedErrorDetail) *NullableRunFailedErrorDetail {
	return &NullableRunFailedErrorDetail{value: val, isSet: true}
}

func (v NullableRunFailedErrorDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunFailedErrorDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
