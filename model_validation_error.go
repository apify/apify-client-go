...
// GetInstancePath returns the InstancePath field value if set, zero value otherwise.
func (o *ValidationError) GetInstancePath() string {
	if o == nil || IsNil(o.InstancePath) {
		var ret string
		return ret
	}
...
// GetSchemaPath returns the SchemaPath field value if set, zero value otherwise.
func (o *ValidationError) GetSchemaPath() string {
	if o == nil || IsNil(o.SchemaPath) {
		var ret string
		return ret
	}
	return *o.SchemaPath
...
// GetSchemaPathOk returns a tuple with the SchemaPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSchemaPath gets a reference to the given string and assigns it to the SchemaPath field.
...
func (o ValidationError) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InstancePath) {
		toSerialize["instancePath"] = o.InstancePath
	}
	if !IsNil(o.SchemaPath) {
