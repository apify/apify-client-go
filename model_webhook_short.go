...
// checks if the WebhookShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookShort{}

// WebhookShort struct for WebhookShort
type WebhookShort struct {
	...
	IsApifyIntegration *bool `json:"isApifyIntegration,omitempty"`
...
type _WebhookShort WebhookShort
...
func (o *WebhookShort) SetIsAdHocNil() {
	o.IsAdHoc.Set(nil)
}
...
// GetIsApifyIntegration returns the IsApifyIntegration field value if set, zero value otherwise.
func (o *WebhookShort) GetIsApifyIntegration() bool {
	if o == nil || IsNil(o.IsApifyIntegration) {
		var ret bool
		return ret
	}
	return *o.IsApifyIntegration
}

// GetIsApifyIntegrationOk returns a tuple with the IsApifyIntegration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WebhookShort) GetIsApifyIntegrationOk() (*bool, bool) {
	if o == nil || IsNil(o.IsApifyIntegration) {
		return nil, false
	}
	return o.IsApifyIntegration, true
}
...
// SetIsApifyIntegration gets a reference to the given bool and assigns it to the IsApifyIntegration field.
func (o *WebhookShort) SetIsApifyIntegration(v bool) {
	o.IsApifyIntegration = &v
}
...
func (o *WebhookShort) SetShouldInterpolateStringsNil() {
...
// GetDoNotRetry returns the DoNotRetry field value
...
// GetDoNotRetryOk returns a tuple with the DoNotRetry field value
// and a boolean to check if the value has been set.
func (o *WebhookShort) GetDoNotRetryOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DoNotRetry, true
}

// SetDoNotRetry sets field value
...
func (o *WebhookShort) SetLastDispatchNil() {
...
func (o *WebhookShort) SetStatsNil() {
	o.Stats.Set(nil)
}
...
func (o WebhookShort) MarshalJSON() ([]byte, error) {
...
func (o WebhookShort) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsApifyIntegration) {
		toSerialize["isApifyIntegration"] = o.IsApifyIntegration
	}
	...
	toSerialize["doNotRetry"] = o.DoNotRetry
...
func (o *WebhookShort) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookShort := _WebhookShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookShort)

	if err != nil {
		return err
	}

	*o = WebhookShort(varWebhookShort)

	return err
}

type NullableWebhookShort struct {
	value *WebhookShort
	isSet bool
}

func (v NullableWebhookShort) Get() *WebhookShort {
	return v.value
}

func (v *NullableWebhookShort) Set(val *WebhookShort) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookShort) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookShort(val *WebhookShort) *NullableWebhookShort {
	return &NullableWebhookShort{value: val, isSet: true}
}

func (v NullableWebhookShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
