...
// checks if the BuildsMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildsMeta{}

// BuildsMeta struct for BuildsMeta
...
func (o BuildsMeta) MarshalJSON() ([]byte, error) {
...
func (o BuildsMeta) ToMap() (map[string]interface{}, error) {
...
func (o *BuildsMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varBuildsMeta := _BuildsMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBuildsMeta)

	if err != nil {
		return err
	}

	*o = BuildsMeta(varBuildsMeta)

	return err
}

type NullableBuildsMeta struct {
	value *BuildsMeta
	isSet bool
}

func (v NullableBuildsMeta) Get() *BuildsMeta {
	return v.value
}

func (v *NullableBuildsMeta) Set(val *BuildsMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildsMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildsMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildsMeta(val *BuildsMeta) *NullableBuildsMeta {
	return &NullableBuildsMeta{value: val, isSet: true}
}

func (v NullableBuildsMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildsMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
