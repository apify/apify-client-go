...
// All allowed values of RunOrigin enum
var AllowedRunOriginEnumValues = []RunOrigin{
	"DEVELOPMENT",
	"WEB",
	"API",
	"SCHEDULER",
...
func (v *RunOrigin) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := RunOrigin(value)
	for _, existing := range AllowedRunOriginEnumValues {
	...
	return fmt.Errorf("%+v is not a valid RunOrigin", value)
}

// NewRunOriginFromValue returns a pointer to a valid RunOrigin
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewRunOriginFromValue(v string) (*RunOrigin, error) {
	ev := RunOrigin(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for RunOrigin: valid values are %v", v, AllowedRunOriginEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v RunOrigin) IsValid() bool {
	for _, existing := range AllowedRunOriginEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to RunOrigin value
func (v RunOrigin) Ptr() *RunOrigin {
	return &v
}

type NullableRunOrigin struct {
	value *RunOrigin
	isSet bool
}

func (v NullableRunOrigin) Get() *RunOrigin {
	return v.value
}

func (v *NullableRunOrigin) Set(val *RunOrigin) {
	v.value = val
	v.isSet = true
}

func (v NullableRunOrigin) IsSet() bool {
	return v.isSet
}

func (v *NullableRunOrigin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunOrigin(val *RunOrigin) *NullableRunOrigin {
	return &NullableRunOrigin{value: val, isSet: true}
}

func (v NullableRunOrigin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunOrigin) UnmarshalJSON(src []byte) error {
	v.isSet = true
