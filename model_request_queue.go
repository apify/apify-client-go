...
// checks if the RequestQueue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestQueue{}

// RequestQueue A request queue object containing metadata and statistics.
...
type _RequestQueue RequestQueue
...
func (o *RequestQueue) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *RequestQueue) SetActIdNil() {
	o.ActId.Set(nil)
}
...
func (o *RequestQueue) SetActRunIdNil() {
	o.ActRunId.Set(nil)
}
...
func (o RequestQueue) MarshalJSON() ([]byte, error) {
...
func (o RequestQueue) ToMap() (map[string]interface{}, error) {
...
func (o *RequestQueue) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestQueue := _RequestQueue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestQueue)

	if err != nil {
		return err
	}

	*o = RequestQueue(varRequestQueue)

	return err
}

type NullableRequestQueue struct {
	value *RequestQueue
	isSet bool
}

func (v NullableRequestQueue) Get() *RequestQueue {
	return v.value
}

func (v *NullableRequestQueue) Set(val *RequestQueue) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestQueue) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestQueue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestQueue(val *RequestQueue) *NullableRequestQueue {
	return &NullableRequestQueue{value: val, isSet: true}
}

func (v NullableRequestQueue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestQueue) UnmarshalJSON(src []byte) error {
	v.isSet = true
