...
// checks if the ScheduleActionShortRunActor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleActionShortRunActor{}

// ScheduleActionShortRunActor struct for ScheduleActionShortRunActor
...
type _ScheduleActionShortRunActor ScheduleActionShortRunActor

// NewScheduleActionShortRunActor instantiates a new ScheduleActionShortRunActor object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleActionShortRunActor(id string, type_ interface{}, actorId string) *ScheduleActionShortRunActor {
	this := ScheduleActionShortRunActor{}
	this.Id = id
	this.Type = type_
...
// NewScheduleActionShortRunActorWithDefaults instantiates a new ScheduleActionShortRunActor object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleActionShortRunActorWithDefaults() *ScheduleActionShortRunActor {
	this := ScheduleActionShortRunActor{}
	return &this
}

// GetId returns the Id field value
func (o *ScheduleActionShortRunActor) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScheduleActionShortRunActor) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScheduleActionShortRunActor) SetId(v string) {
	o.Id = v
}

// GetType returns the Type field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ScheduleActionShortRunActor) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ScheduleActionShortRunActor) GetTypeOk() (*interface{}, bool) {
...
func (o *ScheduleActionShortRunActor) SetType(v interface{}) {
	o.Type = v
}

// GetActorId returns the ActorId field value
func (o *ScheduleActionShortRunActor) GetActorId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScheduleActionShortRunActor) GetActorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleActionShortRunActor) SetActorId(v string) {
	o.ActorId = v
}

func (o ScheduleActionShortRunActor) MarshalJSON() ([]byte, error) {
...
func (o ScheduleActionShortRunActor) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleActionShortRunActor) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleActionShortRunActor := _ScheduleActionShortRunActor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleActionShortRunActor)

	if err != nil {
		return err
	}

	*o = ScheduleActionShortRunActor(varScheduleActionShortRunActor)

	return err
}

type NullableScheduleActionShortRunActor struct {
	value *ScheduleActionShortRunActor
	isSet bool
}

func (v NullableScheduleActionShortRunActor) Get() *ScheduleActionShortRunActor {
	return v.value
}

func (v *NullableScheduleActionShortRunActor) Set(val *ScheduleActionShortRunActor) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionShortRunActor) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionShortRunActor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionShortRunActor(val *ScheduleActionShortRunActor) *NullableScheduleActionShortRunActor {
	return &NullableScheduleActionShortRunActor{value: val, isSet: true}
}

func (v NullableScheduleActionShortRunActor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionShortRunActor) UnmarshalJSON(src []byte) error {
	v.isSet = true
