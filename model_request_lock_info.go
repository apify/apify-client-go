...
// checks if the RequestLockInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestLockInfo{}

// RequestLockInfo Information about a request lock.
type RequestLockInfo struct {
	// The timestamp when the lock on this request expires.
	LockExpiresAt time.Time `json:"lockExpiresAt"`
}

type _RequestLockInfo RequestLockInfo
...
func (o RequestLockInfo) MarshalJSON() ([]byte, error) {
...
func (o RequestLockInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["lockExpiresAt"] = o.LockExpiresAt
	return toSerialize, nil
}

func (o *RequestLockInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestLockInfo := _RequestLockInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestLockInfo)

	if err != nil {
		return err
	}

	*o = RequestLockInfo(varRequestLockInfo)

	return err
}

type NullableRequestLockInfo struct {
	value *RequestLockInfo
	isSet bool
}

func (v NullableRequestLockInfo) Get() *RequestLockInfo {
	return v.value
}

func (v *NullableRequestLockInfo) Set(val *RequestLockInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestLockInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestLockInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestLockInfo(val *RequestLockInfo) *NullableRequestLockInfo {
	return &NullableRequestLockInfo{value: val, isSet: true}
}

func (v NullableRequestLockInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestLockInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
