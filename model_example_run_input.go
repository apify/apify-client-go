...
// checks if the ExampleRunInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExampleRunInput{}

// ExampleRunInput struct for ExampleRunInput
type ExampleRunInput struct {
	Body *string `json:"body,omitempty"`
	ContentType *string `json:"contentType,omitempty"`
}

// NewExampleRunInput instantiates a new ExampleRunInput object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewExampleRunInput() *ExampleRunInput {
	this := ExampleRunInput{}
	return &this
}

// NewExampleRunInputWithDefaults instantiates a new ExampleRunInput object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExampleRunInputWithDefaults() *ExampleRunInput {
	this := ExampleRunInput{}
	return &this
}

// GetBody returns the Body field value if set, zero value otherwise.
func (o *ExampleRunInput) GetBody() string {
...
func (o *ExampleRunInput) GetBodyOk() (*string, bool) {
	if o == nil || IsNil(o.Body) {
		return nil, false
	}
	return o.Body, true
...
func (o *ExampleRunInput) HasBody() bool {
	if o != nil && !IsNil(o.Body) {
		return true
	}
...
func (o *ExampleRunInput) SetBody(v string) {
	o.Body = &v
}

// GetContentType returns the ContentType field value if set, zero value otherwise.
func (o *ExampleRunInput) GetContentType() string {
...
// and a boolean to check if the value has been set.
func (o *ExampleRunInput) GetContentTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ContentType) {
		return nil, false
	}
...
func (o *ExampleRunInput) HasContentType() bool {
	if o != nil && !IsNil(o.ContentType) {
		return true
	}
...
func (o *ExampleRunInput) SetContentType(v string) {
	o.ContentType = &v
}

func (o ExampleRunInput) MarshalJSON() ([]byte, error) {
...
func (o ExampleRunInput) ToMap() (map[string]interface{}, error) {
...
type NullableExampleRunInput struct {
	value *ExampleRunInput
	isSet bool
}

func (v NullableExampleRunInput) Get() *ExampleRunInput {
	return v.value
}

func (v *NullableExampleRunInput) Set(val *ExampleRunInput) {
	v.value = val
	v.isSet = true
}

func (v NullableExampleRunInput) IsSet() bool {
	return v.isSet
}

func (v *NullableExampleRunInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExampleRunInput(val *ExampleRunInput) *NullableExampleRunInput {
	return &NullableExampleRunInput{value: val, isSet: true}
}

func (v NullableExampleRunInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExampleRunInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
