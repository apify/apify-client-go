...
// checks if the ScheduleActionRunActorTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleActionRunActorTask{}

// ScheduleActionRunActorTask struct for ScheduleActionRunActorTask
...
type _ScheduleActionRunActorTask ScheduleActionRunActorTask

// NewScheduleActionRunActorTask instantiates a new ScheduleActionRunActorTask object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleActionRunActorTask(id string, type_ interface{}, actorTaskId string) *ScheduleActionRunActorTask {
...
// NewScheduleActionRunActorTaskWithDefaults instantiates a new ScheduleActionRunActorTask object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleActionRunActorTaskWithDefaults() *ScheduleActionRunActorTask {
	this := ScheduleActionRunActorTask{}
	return &this
}

// GetId returns the Id field value
func (o *ScheduleActionRunActorTask) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScheduleActionRunActorTask) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScheduleActionRunActorTask) SetId(v string) {
	o.Id = v
}

// GetType returns the Type field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *ScheduleActionRunActorTask) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ScheduleActionRunActorTask) GetTypeOk() (*interface{}, bool) {
...
func (o *ScheduleActionRunActorTask) SetType(v interface{}) {
	o.Type = v
}

// GetActorTaskId returns the ActorTaskId field value
func (o *ScheduleActionRunActorTask) GetActorTaskId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScheduleActionRunActorTask) GetActorTaskIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleActionRunActorTask) SetActorTaskId(v string) {
	o.ActorTaskId = v
}

// GetInput returns the Input field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleActionRunActorTask) GetInput() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ScheduleActionRunActorTask) GetInputOk() (map[string]interface{}, bool) {
...
func (o *ScheduleActionRunActorTask) HasInput() bool {
	if o != nil && !IsNil(o.Input) {
		return true
	}
...
func (o *ScheduleActionRunActorTask) SetInput(v map[string]interface{}) {
	o.Input = v
}

func (o ScheduleActionRunActorTask) MarshalJSON() ([]byte, error) {
...
func (o ScheduleActionRunActorTask) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleActionRunActorTask) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleActionRunActorTask := _ScheduleActionRunActorTask{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleActionRunActorTask)

	if err != nil {
		return err
	}

	*o = ScheduleActionRunActorTask(varScheduleActionRunActorTask)

	return err
}

type NullableScheduleActionRunActorTask struct {
	value *ScheduleActionRunActorTask
	isSet bool
}

func (v NullableScheduleActionRunActorTask) Get() *ScheduleActionRunActorTask {
	return v.value
}

func (v *NullableScheduleActionRunActorTask) Set(val *ScheduleActionRunActorTask) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionRunActorTask) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionRunActorTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionRunActorTask(val *ScheduleActionRunActorTask) *NullableScheduleActionRunActorTask {
	return &NullableScheduleActionRunActorTask{value: val, isSet: true}
}

func (v NullableScheduleActionRunActorTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionRunActorTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
