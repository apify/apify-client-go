...
// checks if the ScheduleLogResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleLogResponse{}

// ScheduleLogResponse struct for ScheduleLogResponse
type ScheduleLogResponse struct {
	// 
	Data []ScheduleInvoked `json:"data"`
}

type _ScheduleLogResponse ScheduleLogResponse

// NewScheduleLogResponse instantiates a new ScheduleLogResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleLogResponse(data []ScheduleInvoked) *ScheduleLogResponse {
	this := ScheduleLogResponse{}
	this.Data = data
	return &this
}

// NewScheduleLogResponseWithDefaults instantiates a new ScheduleLogResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleLogResponseWithDefaults() *ScheduleLogResponse {
	this := ScheduleLogResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ScheduleLogResponse) GetData() []ScheduleInvoked {
	if o == nil {
		var ret []ScheduleInvoked
		return ret
	}
...
func (o *ScheduleLogResponse) GetDataOk() ([]ScheduleInvoked, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *ScheduleLogResponse) SetData(v []ScheduleInvoked) {
	o.Data = v
}

func (o ScheduleLogResponse) MarshalJSON() ([]byte, error) {
...
func (o ScheduleLogResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ScheduleLogResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleLogResponse := _ScheduleLogResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleLogResponse)

	if err != nil {
		return err
	}

	*o = ScheduleLogResponse(varScheduleLogResponse)

	return err
}

type NullableScheduleLogResponse struct {
	value *ScheduleLogResponse
	isSet bool
}

func (v NullableScheduleLogResponse) Get() *ScheduleLogResponse {
	return v.value
}

func (v *NullableScheduleLogResponse) Set(val *ScheduleLogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleLogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleLogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleLogResponse(val *ScheduleLogResponse) *NullableScheduleLogResponse {
	return &NullableScheduleLogResponse{value: val, isSet: true}
}

func (v NullableScheduleLogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleLogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
