...
// checks if the BrowserInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrowserInfoResponse{}

// BrowserInfoResponse struct for BrowserInfoResponse
type BrowserInfoResponse struct {
	// HTTP method of the request.
	Method string `json:"method"`
	// IP address of the client.
	ClientIp NullableString `json:"clientIp"`
	...
	Headers map[string]BrowserInfoResponseHeadersValue `json:"headers,omitempty"`
...
type _BrowserInfoResponse BrowserInfoResponse
...
// GetBodyLength returns the BodyLength field value
...
// GetBodyLengthOk returns a tuple with the BodyLength field value
// and a boolean to check if the value has been set.
func (o *BrowserInfoResponse) GetBodyLengthOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BodyLength, true
}

// SetBodyLength sets field value
...
func (o *BrowserInfoResponse) GetHeaders() map[string]BrowserInfoResponseHeadersValue {
	if o == nil || IsNil(o.Headers) {
		var ret map[string]BrowserInfoResponseHeadersValue
		return ret
	}
	return o.Headers
}
...
func (o *BrowserInfoResponse) GetHeadersOk() (map[string]BrowserInfoResponseHeadersValue, bool) {
	if o == nil || IsNil(o.Headers) {
		return map[string]BrowserInfoResponseHeadersValue{}, false
	}
...
// SetHeaders gets a reference to the given map[string]BrowserInfoResponseHeadersValue and assigns it to the Headers field.
func (o *BrowserInfoResponse) SetHeaders(v map[string]BrowserInfoResponseHeadersValue) {
	o.Headers = v
}

// GetRawHeaders returns the RawHeaders field value if set, zero value otherwise.
func (o *BrowserInfoResponse) GetRawHeaders() []string {
	if o == nil || IsNil(o.RawHeaders) {
		var ret []string
		return ret
	}
	return o.RawHeaders
...
// GetRawHeadersOk returns a tuple with the RawHeaders field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BrowserInfoResponse) GetRawHeadersOk() ([]string, bool) {
	if o == nil || IsNil(o.RawHeaders) {
		return nil, false
	}
	return o.RawHeaders, true
}
...
// SetRawHeaders gets a reference to the given []string and assigns it to the RawHeaders field.
func (o *BrowserInfoResponse) SetRawHeaders(v []string) {
	o.RawHeaders = v
}

func (o BrowserInfoResponse) MarshalJSON() ([]byte, error) {
...
func (o BrowserInfoResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["method"] = o.Method
	toSerialize["clientIp"] = o.ClientIp.Get()
	toSerialize["countryCode"] = o.CountryCode.Get()
	toSerialize["bodyLength"] = o.BodyLength
	if !IsNil(o.Headers) {
		toSerialize["headers"] = o.Headers
	}
	if !IsNil(o.RawHeaders) {
		toSerialize["rawHeaders"] = o.RawHeaders
	}
	return toSerialize, nil
}

func (o *BrowserInfoResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBrowserInfoResponse := _BrowserInfoResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBrowserInfoResponse)

	if err != nil {
		return err
	}

	*o = BrowserInfoResponse(varBrowserInfoResponse)

	return err
}

type NullableBrowserInfoResponse struct {
	value *BrowserInfoResponse
	isSet bool
}

func (v NullableBrowserInfoResponse) Get() *BrowserInfoResponse {
	return v.value
}

func (v *NullableBrowserInfoResponse) Set(val *BrowserInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBrowserInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBrowserInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrowserInfoResponse(val *BrowserInfoResponse) *NullableBrowserInfoResponse {
	return &NullableBrowserInfoResponse{value: val, isSet: true}
}

func (v NullableBrowserInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrowserInfoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
