...
// WebhooksWebhooksAPIService WebhooksWebhooksAPI service
type WebhooksWebhooksAPIService service

type ApiWebhookDeleteRequest struct {
	ctx context.Context
	ApiService *WebhooksWebhooksAPIService
	webhookId string
}

func (r ApiWebhookDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *WebhooksWebhooksAPIService) WebhookDelete(ctx context.Context, webhookId string) ApiWebhookDeleteRequest {
	return ApiWebhookDeleteRequest{
		ApiService: a,
		ctx: ctx,
		webhookId: webhookId,
...
func (a *WebhooksWebhooksAPIService) WebhookDeleteExecute(r ApiWebhookDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhookDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/webhooks/{webhookId}"
...
func (r ApiWebhookGetRequest) Execute() (*WebhookResponse, *http.Response, error) {
	return r.ApiService.WebhookGetExecute(r)
}

/*
WebhookGet Get webhook
...
*/
func (a *WebhooksWebhooksAPIService) WebhookGet(ctx context.Context, webhookId string) ApiWebhookGetRequest {
	return ApiWebhookGetRequest{
		ApiService: a,
		ctx: ctx,
		webhookId: webhookId,
...
func (a *WebhooksWebhooksAPIService) WebhookGetExecute(r ApiWebhookGetRequest) (*WebhookResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhookGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// 
func (r ApiWebhookPutRequest) WebhookUpdate(webhookUpdate WebhookUpdate) ApiWebhookPutRequest {
	r.webhookUpdate = &webhookUpdate
	return r
}

func (r ApiWebhookPutRequest) Execute() (*WebhookResponse, *http.Response, error) {
	return r.ApiService.WebhookPutExecute(r)
}

/*
WebhookPut Update webhook
...
*/
func (a *WebhooksWebhooksAPIService) WebhookPut(ctx context.Context, webhookId string) ApiWebhookPutRequest {
	return ApiWebhookPutRequest{
		ApiService: a,
		ctx: ctx,
		webhookId: webhookId,
...
// Execute executes the request
//  @return WebhookResponse
func (a *WebhooksWebhooksAPIService) WebhookPutExecute(r ApiWebhookPutRequest) (*WebhookResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhookPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiWebhookTestPostRequest struct {
	ctx context.Context
	ApiService *WebhooksWebhooksAPIService
	webhookId string
}

func (r ApiWebhookTestPostRequest) Execute() (*TestWebhookResponse, *http.Response, error) {
	return r.ApiService.WebhookTestPostExecute(r)
}

/*
WebhookTestPost Test webhook

Tests a webhook. Creates a webhook dispatch with a dummy payload.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param webhookId Webhook ID.
 @return ApiWebhookTestPostRequest
*/
func (a *WebhooksWebhooksAPIService) WebhookTestPost(ctx context.Context, webhookId string) ApiWebhookTestPostRequest {
	return ApiWebhookTestPostRequest{
		ApiService: a,
		ctx: ctx,
		webhookId: webhookId,
...
func (a *WebhooksWebhooksAPIService) WebhookTestPostExecute(r ApiWebhookTestPostRequest) (*TestWebhookResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhookTestPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/webhooks/{webhookId}/test"
	localVarPath = strings.Replace(localVarPath, "{"+"webhookId"+"}", url.PathEscape(parameterValueToString(r.webhookId, "webhookId")), -1)
...
type ApiWebhookWebhookDispatchesGetRequest struct {
	ctx context.Context
	ApiService *WebhooksWebhooksAPIService
	webhookId string
}

func (r ApiWebhookWebhookDispatchesGetRequest) Execute() (*ListOfWebhookDispatchesResponse, *http.Response, error) {
	return r.ApiService.WebhookWebhookDispatchesGetExecute(r)
}

/*
WebhookWebhookDispatchesGet Get collection

Gets a given webhook's list of dispatches.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param webhookId Webhook ID.
 @return ApiWebhookWebhookDispatchesGetRequest
*/
func (a *WebhooksWebhooksAPIService) WebhookWebhookDispatchesGet(ctx context.Context, webhookId string) ApiWebhookWebhookDispatchesGetRequest {
	return ApiWebhookWebhookDispatchesGetRequest{
		ApiService: a,
		ctx: ctx,
		webhookId: webhookId,
...
func (a *WebhooksWebhooksAPIService) WebhookWebhookDispatchesGetExecute(r ApiWebhookWebhookDispatchesGetRequest) (*ListOfWebhookDispatchesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfWebhookDispatchesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhookWebhookDispatchesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/webhooks/{webhookId}/dispatches"
	localVarPath = strings.Replace(localVarPath, "{"+"webhookId"+"}", url.PathEscape(parameterValueToString(r.webhookId, "webhookId")), -1)
...
func (r ApiWebhooksGetRequest) Offset(offset float64) ApiWebhooksGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiWebhooksGetRequest) Limit(limit float64) ApiWebhooksGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiWebhooksGetRequest) Desc(desc bool) ApiWebhooksGetRequest {
	r.desc = &desc
	return r
}

func (r ApiWebhooksGetRequest) Execute() (*ListOfWebhooksResponse, *http.Response, error) {
	return r.ApiService.WebhooksGetExecute(r)
}

/*
WebhooksGet Get list of webhooks
...
*/
func (a *WebhooksWebhooksAPIService) WebhooksGet(ctx context.Context) ApiWebhooksGetRequest {
	return ApiWebhooksGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOfWebhooksResponse
func (a *WebhooksWebhooksAPIService) WebhooksGetExecute(r ApiWebhooksGetRequest) (*ListOfWebhooksResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfWebhooksResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhooksGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// 
func (r ApiWebhooksPostRequest) WebhookCreate(webhookCreate WebhookCreate) ApiWebhooksPostRequest {
	r.webhookCreate = &webhookCreate
	return r
}

func (r ApiWebhooksPostRequest) Execute() (*WebhookResponse, *http.Response, error) {
...
*/
func (a *WebhooksWebhooksAPIService) WebhooksPost(ctx context.Context) ApiWebhooksPostRequest {
	return ApiWebhooksPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return WebhookResponse
func (a *WebhooksWebhooksAPIService) WebhooksPostExecute(r ApiWebhooksPostRequest) (*WebhookResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhooksAPIService.WebhooksPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
