...
// checks if the DatasetFieldStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetFieldStatistics{}

// DatasetFieldStatistics struct for DatasetFieldStatistics
...
func (o *DatasetFieldStatistics) SetMinNil() {
	o.Min.Set(nil)
}
...
func (o *DatasetFieldStatistics) SetMaxNil() {
	o.Max.Set(nil)
}
...
// GetNullCount returns the NullCount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DatasetFieldStatistics) GetNullCount() int32 {
	if o == nil || IsNil(o.NullCount.Get()) {
		var ret int32
		return ret
	}
	return *o.NullCount.Get()
}
...
// SetNullCount gets a reference to the given NullableInt32 and assigns it to the NullCount field.
func (o *DatasetFieldStatistics) SetNullCount(v int32) {
	o.NullCount.Set(&v)
}
// SetNullCountNil sets the value for NullCount to be an explicit nil
func (o *DatasetFieldStatistics) SetNullCountNil() {
	o.NullCount.Set(nil)
}
...
// GetEmptyCount returns the EmptyCount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DatasetFieldStatistics) GetEmptyCount() int32 {
	if o == nil || IsNil(o.EmptyCount.Get()) {
		var ret int32
		return ret
	}
	return *o.EmptyCount.Get()
}

// GetEmptyCountOk returns a tuple with the EmptyCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetEmptyCount gets a reference to the given NullableInt32 and assigns it to the EmptyCount field.
func (o *DatasetFieldStatistics) SetEmptyCount(v int32) {
	o.EmptyCount.Set(&v)
}
// SetEmptyCountNil sets the value for EmptyCount to be an explicit nil
func (o *DatasetFieldStatistics) SetEmptyCountNil() {
	o.EmptyCount.Set(nil)
}
...
func (o DatasetFieldStatistics) MarshalJSON() ([]byte, error) {
...
func (o DatasetFieldStatistics) ToMap() (map[string]interface{}, error) {
	...
	if o.NullCount.IsSet() {
		toSerialize["nullCount"] = o.NullCount.Get()
	}
	if o.EmptyCount.IsSet() {
		toSerialize["emptyCount"] = o.EmptyCount.Get()
	}
	return toSerialize, nil
}

type NullableDatasetFieldStatistics struct {
	value *DatasetFieldStatistics
	isSet bool
}

func (v NullableDatasetFieldStatistics) Get() *DatasetFieldStatistics {
	return v.value
}

func (v *NullableDatasetFieldStatistics) Set(val *DatasetFieldStatistics) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetFieldStatistics) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetFieldStatistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetFieldStatistics(val *DatasetFieldStatistics) *NullableDatasetFieldStatistics {
	return &NullableDatasetFieldStatistics{value: val, isSet: true}
}

func (v NullableDatasetFieldStatistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetFieldStatistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
