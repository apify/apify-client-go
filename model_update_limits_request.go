...
// checks if the UpdateLimitsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateLimitsRequest{}

// UpdateLimitsRequest struct for UpdateLimitsRequest
...
// GetMaxMonthlyUsageUsd returns the MaxMonthlyUsageUsd field value if set, zero value otherwise.
func (o *UpdateLimitsRequest) GetMaxMonthlyUsageUsd() float32 {
	if o == nil || IsNil(o.MaxMonthlyUsageUsd) {
		var ret float32
		return ret
	}
...
// GetMaxMonthlyUsageUsdOk returns a tuple with the MaxMonthlyUsageUsd field value if set, nil otherwise
...
// SetMaxMonthlyUsageUsd gets a reference to the given float32 and assigns it to the MaxMonthlyUsageUsd field.
func (o *UpdateLimitsRequest) SetMaxMonthlyUsageUsd(v float32) {
	o.MaxMonthlyUsageUsd = &v
}

// GetDataRetentionDays returns the DataRetentionDays field value if set, zero value otherwise.
func (o *UpdateLimitsRequest) GetDataRetentionDays() int32 {
	if o == nil || IsNil(o.DataRetentionDays) {
		var ret int32
		return ret
	}
...
// GetDataRetentionDaysOk returns a tuple with the DataRetentionDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDataRetentionDays gets a reference to the given int32 and assigns it to the DataRetentionDays field.
func (o *UpdateLimitsRequest) SetDataRetentionDays(v int32) {
	o.DataRetentionDays = &v
}

func (o UpdateLimitsRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateLimitsRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MaxMonthlyUsageUsd) {
		toSerialize["maxMonthlyUsageUsd"] = o.MaxMonthlyUsageUsd
	}
	if !IsNil(o.DataRetentionDays) {
		toSerialize["dataRetentionDays"] = o.DataRetentionDays
	}
	return toSerialize, nil
}

type NullableUpdateLimitsRequest struct {
	value *UpdateLimitsRequest
	isSet bool
}

func (v NullableUpdateLimitsRequest) Get() *UpdateLimitsRequest {
	return v.value
}

func (v *NullableUpdateLimitsRequest) Set(val *UpdateLimitsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateLimitsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateLimitsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateLimitsRequest(val *UpdateLimitsRequest) *NullableUpdateLimitsRequest {
	return &NullableUpdateLimitsRequest{value: val, isSet: true}
}

func (v NullableUpdateLimitsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateLimitsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
