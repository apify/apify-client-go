...
// GetIsStatusMessageTerminal returns the IsStatusMessageTerminal field value if set, zero value otherwise.
func (o *UpdateRunRequest) GetIsStatusMessageTerminal() bool {
	if o == nil || IsNil(o.IsStatusMessageTerminal) {
		var ret bool
		return ret
	}
	return *o.IsStatusMessageTerminal
}
...
func (o *UpdateRunRequest) GetIsStatusMessageTerminalOk() (*bool, bool) {
	...
	return o.IsStatusMessageTerminal, true
}
...
// SetIsStatusMessageTerminal gets a reference to the given bool and assigns it to the IsStatusMessageTerminal field.
func (o *UpdateRunRequest) SetIsStatusMessageTerminal(v bool) {
	o.IsStatusMessageTerminal = &v
}
...
func (o UpdateRunRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsStatusMessageTerminal) {
		toSerialize["isStatusMessageTerminal"] = o.IsStatusMessageTerminal
	}
