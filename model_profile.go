...
func (o *Profile) GetPictureUrl() string {
...
// and a boolean to check if the value has been set.
func (o *Profile) GetPictureUrlOk() (*string, bool) {
	if o == nil || IsNil(o.PictureUrl) {
		return nil, false
	}
...
func (o *Profile) HasPictureUrl() bool {
	if o != nil && !IsNil(o.PictureUrl) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Profile) GetGithubUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.GithubUsername) {
		return nil, false
	}
...
func (o *Profile) HasGithubUsername() bool {
	if o != nil && !IsNil(o.GithubUsername) {
		return true
	}
...
func (o *Profile) SetGithubUsername(v string) {
	o.GithubUsername = &v
}

// GetWebsiteUrl returns the WebsiteUrl field value if set, zero value otherwise.
func (o *Profile) GetWebsiteUrl() string {
...
// and a boolean to check if the value has been set.
func (o *Profile) GetWebsiteUrlOk() (*string, bool) {
	if o == nil || IsNil(o.WebsiteUrl) {
		return nil, false
	}
...
func (o *Profile) HasWebsiteUrl() bool {
	if o != nil && !IsNil(o.WebsiteUrl) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Profile) GetTwitterUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.TwitterUsername) {
		return nil, false
	}
...
func (o *Profile) HasTwitterUsername() bool {
	if o != nil && !IsNil(o.TwitterUsername) {
		return true
	}
...
func (o *Profile) SetTwitterUsername(v string) {
	o.TwitterUsername = &v
}
...
func (o Profile) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TwitterUsername) {
		toSerialize["twitterUsername"] = o.TwitterUsername
	}
