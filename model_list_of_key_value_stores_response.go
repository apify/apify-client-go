...
// checks if the ListOfKeyValueStoresResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfKeyValueStoresResponse{}

// ListOfKeyValueStoresResponse struct for ListOfKeyValueStoresResponse
type ListOfKeyValueStoresResponse struct {
	Data ListOfKeyValueStores `json:"data"`
}

type _ListOfKeyValueStoresResponse ListOfKeyValueStoresResponse

// NewListOfKeyValueStoresResponse instantiates a new ListOfKeyValueStoresResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfKeyValueStoresResponse(data ListOfKeyValueStores) *ListOfKeyValueStoresResponse {
	this := ListOfKeyValueStoresResponse{}
	this.Data = data
	return &this
}

// NewListOfKeyValueStoresResponseWithDefaults instantiates a new ListOfKeyValueStoresResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfKeyValueStoresResponseWithDefaults() *ListOfKeyValueStoresResponse {
	this := ListOfKeyValueStoresResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfKeyValueStoresResponse) GetData() ListOfKeyValueStores {
	if o == nil {
		var ret ListOfKeyValueStores
		return ret
	}
...
func (o *ListOfKeyValueStoresResponse) GetDataOk() (*ListOfKeyValueStores, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfKeyValueStoresResponse) SetData(v ListOfKeyValueStores) {
	o.Data = v
}

func (o ListOfKeyValueStoresResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfKeyValueStoresResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfKeyValueStoresResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfKeyValueStoresResponse := _ListOfKeyValueStoresResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfKeyValueStoresResponse)

	if err != nil {
		return err
	}

	*o = ListOfKeyValueStoresResponse(varListOfKeyValueStoresResponse)

	return err
}

type NullableListOfKeyValueStoresResponse struct {
	value *ListOfKeyValueStoresResponse
	isSet bool
}

func (v NullableListOfKeyValueStoresResponse) Get() *ListOfKeyValueStoresResponse {
	return v.value
}

func (v *NullableListOfKeyValueStoresResponse) Set(val *ListOfKeyValueStoresResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfKeyValueStoresResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfKeyValueStoresResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfKeyValueStoresResponse(val *ListOfKeyValueStoresResponse) *NullableListOfKeyValueStoresResponse {
	return &NullableListOfKeyValueStoresResponse{value: val, isSet: true}
}

func (v NullableListOfKeyValueStoresResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfKeyValueStoresResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
