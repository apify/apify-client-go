...
// checks if the AddedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedRequest{}

// AddedRequest Information about a request that was successfully added to a request queue.
...
type _AddedRequest AddedRequest
...
func (o AddedRequest) MarshalJSON() ([]byte, error) {
...
func (o AddedRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AddedRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAddedRequest := _AddedRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddedRequest)

	if err != nil {
		return err
	}

	*o = AddedRequest(varAddedRequest)

	return err
}

type NullableAddedRequest struct {
	value *AddedRequest
	isSet bool
}

func (v NullableAddedRequest) Get() *AddedRequest {
	return v.value
}

func (v *NullableAddedRequest) Set(val *AddedRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedRequest(val *AddedRequest) *NullableAddedRequest {
	return &NullableAddedRequest{value: val, isSet: true}
}

func (v NullableAddedRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
