...
// checks if the DatasetSchemaValidationError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetSchemaValidationError{}

// DatasetSchemaValidationError struct for DatasetSchemaValidationError
type DatasetSchemaValidationError struct {
	// The type of the error.
	Type *string `json:"type,omitempty"`
	// A human-readable message describing the error.
	Message *string `json:"message,omitempty"`
	Data *SchemaValidationErrorData `json:"data,omitempty"`
}
...
func NewDatasetSchemaValidationError() *DatasetSchemaValidationError {
	this := DatasetSchemaValidationError{}
	return &this
}
...
func (o *DatasetSchemaValidationError) GetData() SchemaValidationErrorData {
	if o == nil || IsNil(o.Data) {
		var ret SchemaValidationErrorData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given SchemaValidationErrorData and assigns it to the Data field.
func (o *DatasetSchemaValidationError) SetData(v SchemaValidationErrorData) {
	o.Data = &v
}

func (o DatasetSchemaValidationError) MarshalJSON() ([]byte, error) {
...
func (o DatasetSchemaValidationError) ToMap() (map[string]interface{}, error) {
...
type NullableDatasetSchemaValidationError struct {
	value *DatasetSchemaValidationError
	isSet bool
}

func (v NullableDatasetSchemaValidationError) Get() *DatasetSchemaValidationError {
	return v.value
}

func (v *NullableDatasetSchemaValidationError) Set(val *DatasetSchemaValidationError) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetSchemaValidationError) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetSchemaValidationError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetSchemaValidationError(val *DatasetSchemaValidationError) *NullableDatasetSchemaValidationError {
	return &NullableDatasetSchemaValidationError{value: val, isSet: true}
}

func (v NullableDatasetSchemaValidationError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetSchemaValidationError) UnmarshalJSON(src []byte) error {
	v.isSet = true
