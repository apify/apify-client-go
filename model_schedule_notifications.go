...
// checks if the ScheduleNotifications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleNotifications{}

// ScheduleNotifications Notification settings for this schedule.
type ScheduleNotifications struct {
	Email *bool `json:"email,omitempty"`
}

// NewScheduleNotifications instantiates a new ScheduleNotifications object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleNotifications() *ScheduleNotifications {
	this := ScheduleNotifications{}
	return &this
}

// NewScheduleNotificationsWithDefaults instantiates a new ScheduleNotifications object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleNotificationsWithDefaults() *ScheduleNotifications {
	this := ScheduleNotifications{}
	return &this
}

// GetEmail returns the Email field value if set, zero value otherwise.
func (o *ScheduleNotifications) GetEmail() bool {
...
func (o *ScheduleNotifications) GetEmailOk() (*bool, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *ScheduleNotifications) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *ScheduleNotifications) SetEmail(v bool) {
	o.Email = &v
}

func (o ScheduleNotifications) MarshalJSON() ([]byte, error) {
...
func (o ScheduleNotifications) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleNotifications struct {
	value *ScheduleNotifications
	isSet bool
}

func (v NullableScheduleNotifications) Get() *ScheduleNotifications {
	return v.value
}

func (v *NullableScheduleNotifications) Set(val *ScheduleNotifications) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleNotifications) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleNotifications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleNotifications(val *ScheduleNotifications) *NullableScheduleNotifications {
	return &NullableScheduleNotifications{value: val, isSet: true}
}

func (v NullableScheduleNotifications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleNotifications) UnmarshalJSON(src []byte) error {
	v.isSet = true
