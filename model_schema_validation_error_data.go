...
// checks if the SchemaValidationErrorData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaValidationErrorData{}

// SchemaValidationErrorData struct for SchemaValidationErrorData
...
type _SchemaValidationErrorData SchemaValidationErrorData
...
func NewSchemaValidationErrorData(invalidItems []InvalidItem) *SchemaValidationErrorData {
	this := SchemaValidationErrorData{}
...
// GetInvalidItems returns the InvalidItems field value
func (o *SchemaValidationErrorData) GetInvalidItems() []InvalidItem {
	...
	return o.InvalidItems
}

// GetInvalidItemsOk returns a tuple with the InvalidItems field value
// and a boolean to check if the value has been set.
func (o *SchemaValidationErrorData) GetInvalidItemsOk() ([]InvalidItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.InvalidItems, true
}

// SetInvalidItems sets field value
func (o *SchemaValidationErrorData) SetInvalidItems(v []InvalidItem) {
	o.InvalidItems = v
}

func (o SchemaValidationErrorData) MarshalJSON() ([]byte, error) {
...
func (o SchemaValidationErrorData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["invalidItems"] = o.InvalidItems
	return toSerialize, nil
}

func (o *SchemaValidationErrorData) UnmarshalJSON(data []byte) (err error) {
	...
	varSchemaValidationErrorData := _SchemaValidationErrorData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchemaValidationErrorData)

	if err != nil {
		return err
	}

	*o = SchemaValidationErrorData(varSchemaValidationErrorData)

	return err
}

type NullableSchemaValidationErrorData struct {
	value *SchemaValidationErrorData
	isSet bool
}

func (v NullableSchemaValidationErrorData) Get() *SchemaValidationErrorData {
	return v.value
}

func (v *NullableSchemaValidationErrorData) Set(val *SchemaValidationErrorData) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemaValidationErrorData) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemaValidationErrorData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemaValidationErrorData(val *SchemaValidationErrorData) *NullableSchemaValidationErrorData {
	return &NullableSchemaValidationErrorData{value: val, isSet: true}
}

func (v NullableSchemaValidationErrorData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemaValidationErrorData) UnmarshalJSON(src []byte) error {
	v.isSet = true
