...
// checks if the RequestDraft type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestDraft{}

// RequestDraft A request that failed to be processed during a request queue operation and can be retried.
...
type _RequestDraft RequestDraft
...
func (o RequestDraft) MarshalJSON() ([]byte, error) {
...
func (o RequestDraft) ToMap() (map[string]interface{}, error) {
...
func (o *RequestDraft) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestDraft := _RequestDraft{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestDraft)

	if err != nil {
		return err
	}

	*o = RequestDraft(varRequestDraft)

	return err
}

type NullableRequestDraft struct {
	value *RequestDraft
	isSet bool
}

func (v NullableRequestDraft) Get() *RequestDraft {
	return v.value
}

func (v *NullableRequestDraft) Set(val *RequestDraft) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestDraft) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestDraft) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestDraft(val *RequestDraft) *NullableRequestDraft {
	return &NullableRequestDraft{value: val, isSet: true}
}

func (v NullableRequestDraft) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestDraft) UnmarshalJSON(src []byte) error {
	v.isSet = true
