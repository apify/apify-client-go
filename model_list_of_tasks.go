...
// checks if the ListOfTasks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfTasks{}

// ListOfTasks struct for ListOfTasks
type ListOfTasks struct {
	...
	Items []TaskShort `json:"items"`
}

type _ListOfTasks ListOfTasks
...
func (o ListOfTasks) MarshalJSON() ([]byte, error) {
...
func (o ListOfTasks) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfTasks) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfTasks := _ListOfTasks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfTasks)

	if err != nil {
		return err
	}

	*o = ListOfTasks(varListOfTasks)

	return err
}

type NullableListOfTasks struct {
	value *ListOfTasks
	isSet bool
}

func (v NullableListOfTasks) Get() *ListOfTasks {
	return v.value
}

func (v *NullableListOfTasks) Set(val *ListOfTasks) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfTasks) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfTasks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfTasks(val *ListOfTasks) *NullableListOfTasks {
	return &NullableListOfTasks{value: val, isSet: true}
}

func (v NullableListOfTasks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfTasks) UnmarshalJSON(src []byte) error {
	v.isSet = true
