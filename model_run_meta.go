...
// checks if the RunMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunMeta{}

// RunMeta struct for RunMeta
type RunMeta struct {
...
func (o *RunMeta) SetUserAgentNil() {
	o.UserAgent.Set(nil)
}
...
func (o *RunMeta) SetScheduleIdNil() {
...
func (o *RunMeta) SetScheduledAtNil() {
...
func (o RunMeta) MarshalJSON() ([]byte, error) {
...
func (o RunMeta) ToMap() (map[string]interface{}, error) {
...
func (o *RunMeta) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varRunMeta)

	if err != nil {
		return err
	}

	*o = RunMeta(varRunMeta)

	return err
}

type NullableRunMeta struct {
	value *RunMeta
	isSet bool
}

func (v NullableRunMeta) Get() *RunMeta {
	return v.value
}

func (v *NullableRunMeta) Set(val *RunMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableRunMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableRunMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunMeta(val *RunMeta) *NullableRunMeta {
	return &NullableRunMeta{value: val, isSet: true}
}

func (v NullableRunMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
