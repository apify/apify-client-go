...
// StorageDatasetsAPIService StorageDatasetsAPI service
type StorageDatasetsAPIService service

type ApiDatasetDeleteRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
}

func (r ApiDatasetDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.DatasetDeleteExecute(r)
}

/*
DatasetDelete Delete dataset

Deletes a specific dataset.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetDeleteRequest
*/
func (a *StorageDatasetsAPIService) DatasetDelete(ctx context.Context, datasetId string) ApiDatasetDeleteRequest {
	return ApiDatasetDeleteRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
func (a *StorageDatasetsAPIService) DatasetDeleteExecute(r ApiDatasetDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/datasets/{datasetId}"
...
type ApiDatasetGetRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
}

func (r ApiDatasetGetRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.DatasetGetExecute(r)
}
...
There is a short period (up to 5 seconds) during which these counters may not match with exact counts in dataset items.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetGetRequest
*/
func (a *StorageDatasetsAPIService) DatasetGet(ctx context.Context, datasetId string) ApiDatasetGetRequest {
	return ApiDatasetGetRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
func (a *StorageDatasetsAPIService) DatasetGetExecute(r ApiDatasetGetRequest) (*DatasetResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DatasetResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetGet")
	if err != nil {
...
type ApiDatasetItemsGetRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
	format *string
...
func (r ApiDatasetItemsGetRequest) Format(format string) ApiDatasetItemsGetRequest {
	r.format = &format
	return r
}
...
func (r ApiDatasetItemsGetRequest) Clean(clean bool) ApiDatasetItemsGetRequest {
	r.clean = &clean
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiDatasetItemsGetRequest) Offset(offset float64) ApiDatasetItemsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. By default there is no limit.
func (r ApiDatasetItemsGetRequest) Limit(limit float64) ApiDatasetItemsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiDatasetItemsGetRequest) Fields(fields string) ApiDatasetItemsGetRequest {
	r.fields = &fields
	return r
}
...
func (r ApiDatasetItemsGetRequest) OutputFields(outputFields string) ApiDatasetItemsGetRequest {
	r.outputFields = &outputFields
	return r
}

// A comma-separated list of fields which should be omitted from the items.
func (r ApiDatasetItemsGetRequest) Omit(omit string) ApiDatasetItemsGetRequest {
	r.omit = &omit
	return r
}
...
func (r ApiDatasetItemsGetRequest) Unwind(unwind string) ApiDatasetItemsGetRequest {
	r.unwind = &unwind
	return r
}
...
func (r ApiDatasetItemsGetRequest) Flatten(flatten string) ApiDatasetItemsGetRequest {
	r.flatten = &flatten
	return r
}
...
func (r ApiDatasetItemsGetRequest) Desc(desc bool) ApiDatasetItemsGetRequest {
	r.desc = &desc
	return r
}
...
func (r ApiDatasetItemsGetRequest) Attachment(attachment bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) Delimiter(delimiter string) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) Bom(bom bool) ApiDatasetItemsGetRequest {
	r.bom = &bom
	return r
}

// Overrides default root element name of &#x60;xml&#x60; output. By default the root element is &#x60;items&#x60;. 
func (r ApiDatasetItemsGetRequest) XmlRoot(xmlRoot string) ApiDatasetItemsGetRequest {
	r.xmlRoot = &xmlRoot
	return r
}
...
func (r ApiDatasetItemsGetRequest) XmlRow(xmlRow string) ApiDatasetItemsGetRequest {
	r.xmlRow = &xmlRow
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then header row in the &#x60;csv&#x60; format is skipped.
func (r ApiDatasetItemsGetRequest) SkipHeaderRow(skipHeaderRow bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) SkipHidden(skipHidden bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) SkipEmpty(skipEmpty bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) Simplified(simplified bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) View(view string) ApiDatasetItemsGetRequest {
	r.view = &view
	return r
}
...
func (r ApiDatasetItemsGetRequest) SkipFailedPages(skipFailedPages bool) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) FeedTitle(feedTitle string) ApiDatasetItemsGetRequest {
...
func (r ApiDatasetItemsGetRequest) FeedDescription(feedDescription string) ApiDatasetItemsGetRequest {
	r.feedDescription = &feedDescription
	return r
}

// Signature used for the access.
func (r ApiDatasetItemsGetRequest) Signature(signature string) ApiDatasetItemsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiDatasetItemsGetRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
	return r.ApiService.DatasetItemsGetExecute(r)
}

/*
DatasetItemsGet Get dataset items
...
Note that only the order of **Items** is reversed, but not the order of the `unwind` array elements.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetItemsGetRequest
*/
func (a *StorageDatasetsAPIService) DatasetItemsGet(ctx context.Context, datasetId string) ApiDatasetItemsGetRequest {
	return ApiDatasetItemsGetRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
func (a *StorageDatasetsAPIService) DatasetItemsGetExecute(r ApiDatasetItemsGetRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetItemsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/datasets/{datasetId}/items"
	localVarPath = strings.Replace(localVarPath, "{"+"datasetId"+"}", url.PathEscape(parameterValueToString(r.datasetId, "datasetId")), -1)
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"application/json", "application/jsonl", "text/csv", "text/html", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/rss+xml", "application/xml"}
...
type ApiDatasetItemsHeadRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
	format *string
...
// Format of the results, possible values are: &#x60;json&#x60;, &#x60;jsonl&#x60;, &#x60;csv&#x60;, &#x60;html&#x60;, &#x60;xlsx&#x60;, &#x60;xml&#x60; and &#x60;rss&#x60;. The default value is &#x60;json&#x60;. 
func (r ApiDatasetItemsHeadRequest) Format(format string) ApiDatasetItemsHeadRequest {
	r.format = &format
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the API endpoint returns only non-empty items and skips hidden fields (i.e. fields starting with the # character). The &#x60;clean&#x60; parameter is just a shortcut for &#x60;skipHidden&#x3D;true&#x60; and &#x60;skipEmpty&#x3D;true&#x60; parameters. Note that since some objects might be skipped from the output, that the result might contain less items than the &#x60;limit&#x60; value. 
func (r ApiDatasetItemsHeadRequest) Clean(clean bool) ApiDatasetItemsHeadRequest {
	r.clean = &clean
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiDatasetItemsHeadRequest) Offset(offset float64) ApiDatasetItemsHeadRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. By default there is no limit.
func (r ApiDatasetItemsHeadRequest) Limit(limit float64) ApiDatasetItemsHeadRequest {
	r.limit = &limit
	return r
}

// A comma-separated list of fields which should be picked from the items, only these fields will remain in the resulting record objects. Note that the fields in the outputted items are sorted the same way as they are specified in the &#x60;fields&#x60; query parameter. You can use this feature to effectively fix the output format. 
func (r ApiDatasetItemsHeadRequest) Fields(fields string) ApiDatasetItemsHeadRequest {
	r.fields = &fields
	return r
}

// A comma-separated list of output field names that positionally rename the fields specified in the &#x60;fields&#x60; parameter. For example, &#x60;?fields&#x3D;headline,url&amp;outputFields&#x3D;title,link&#x60; renames &#x60;headline&#x60; to &#x60;title&#x60; and &#x60;url&#x60; to &#x60;link&#x60; in the output. The number of names in &#x60;outputFields&#x60; must match the number of names in &#x60;fields&#x60;. Requires the &#x60;fields&#x60; parameter to be specified as well. 
func (r ApiDatasetItemsHeadRequest) OutputFields(outputFields string) ApiDatasetItemsHeadRequest {
	r.outputFields = &outputFields
	return r
}

// A comma-separated list of fields which should be omitted from the items.
func (r ApiDatasetItemsHeadRequest) Omit(omit string) ApiDatasetItemsHeadRequest {
	r.omit = &omit
	return r
}

// A comma-separated list of fields which should be unwound, in order which they should be processed. Each field should be either an array or an object. If the field is an array then every element of the array will become a separate record and merged with parent object. If the unwound field is an object then it is merged with the parent object. If the unwound field is missing or its value is neither an array nor an object and therefore cannot be merged with a parent object then the item gets preserved as it is. Note that the unwound items ignore the &#x60;desc&#x60; parameter. 
func (r ApiDatasetItemsHeadRequest) Unwind(unwind string) ApiDatasetItemsHeadRequest {
	r.unwind = &unwind
	return r
}

// A comma-separated list of fields which should transform nested objects into flat structures.  For example, with &#x60;flatten&#x3D;\&quot;foo\&quot;&#x60; the object &#x60;{\&quot;foo\&quot;:{\&quot;bar\&quot;: \&quot;hello\&quot;}}&#x60; is turned into &#x60;{\&quot;foo.bar\&quot;: \&quot;hello\&quot;}&#x60;.  The original object with properties is replaced with the flattened object. 
func (r ApiDatasetItemsHeadRequest) Flatten(flatten string) ApiDatasetItemsHeadRequest {
	r.flatten = &flatten
	return r
}

// By default, results are returned in the same order as they were stored. To reverse the order, set this parameter to &#x60;true&#x60; or &#x60;1&#x60;. 
func (r ApiDatasetItemsHeadRequest) Desc(desc bool) ApiDatasetItemsHeadRequest {
	r.desc = &desc
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the response will define the &#x60;Content-Disposition: attachment&#x60; header, forcing a web browser to download the file rather than to display it. By default this header is not present. 
func (r ApiDatasetItemsHeadRequest) Attachment(attachment bool) ApiDatasetItemsHeadRequest {
	r.attachment = &attachment
	return r
}

// A delimiter character for CSV files, only used if &#x60;format&#x3D;csv&#x60;. You might need to URL-encode the character (e.g. use &#x60;%09&#x60; for tab or &#x60;%3B&#x60; for semicolon). The default delimiter is a simple comma (&#x60;,&#x60;). 
func (r ApiDatasetItemsHeadRequest) Delimiter(delimiter string) ApiDatasetItemsHeadRequest {
	r.delimiter = &delimiter
	return r
}

// All text responses are encoded in UTF-8 encoding. By default, the &#x60;format&#x3D;csv&#x60; files are prefixed with the UTF-8 Byte Order Mark (BOM), while &#x60;json&#x60;, &#x60;jsonl&#x60;, &#x60;xml&#x60;, &#x60;html&#x60; and &#x60;rss&#x60; files are not.  If you want to override this default behavior, specify &#x60;bom&#x3D;1&#x60; query parameter to include the BOM or &#x60;bom&#x3D;0&#x60; to skip it. 
func (r ApiDatasetItemsHeadRequest) Bom(bom bool) ApiDatasetItemsHeadRequest {
	r.bom = &bom
	return r
}

// Overrides default root element name of &#x60;xml&#x60; output. By default the root element is &#x60;items&#x60;. 
func (r ApiDatasetItemsHeadRequest) XmlRoot(xmlRoot string) ApiDatasetItemsHeadRequest {
	r.xmlRoot = &xmlRoot
	return r
}

// Overrides default element name that wraps each page or page function result object in &#x60;xml&#x60; output. By default the element name is &#x60;item&#x60;. 
func (r ApiDatasetItemsHeadRequest) XmlRow(xmlRow string) ApiDatasetItemsHeadRequest {
	r.xmlRow = &xmlRow
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then header row in the &#x60;csv&#x60; format is skipped.
func (r ApiDatasetItemsHeadRequest) SkipHeaderRow(skipHeaderRow bool) ApiDatasetItemsHeadRequest {
	r.skipHeaderRow = &skipHeaderRow
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then hidden fields are skipped from the output, i.e. fields starting with the &#x60;#&#x60; character. 
func (r ApiDatasetItemsHeadRequest) SkipHidden(skipHidden bool) ApiDatasetItemsHeadRequest {
	r.skipHidden = &skipHidden
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then empty items are skipped from the output.  Note that if used, the results might contain less items than the limit value. 
func (r ApiDatasetItemsHeadRequest) SkipEmpty(skipEmpty bool) ApiDatasetItemsHeadRequest {
	r.skipEmpty = &skipEmpty
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then, the endpoint applies the &#x60;fields&#x3D;url,pageFunctionResult,errorInfo&#x60; and &#x60;unwind&#x3D;pageFunctionResult&#x60; query parameters. This feature is used to emulate simplified results provided by the legacy Apify Crawler product and it&#39;s not recommended to use it in new integrations. 
func (r ApiDatasetItemsHeadRequest) Simplified(simplified bool) ApiDatasetItemsHeadRequest {
	r.simplified = &simplified
	return r
}

// Defines the view configuration for dataset items based on the schema definition. This parameter determines how the data will be filtered and presented. For complete specification details, see the [dataset schema documentation](/platform/actors/development/actor-definition/dataset-schema). 
func (r ApiDatasetItemsHeadRequest) View(view string) ApiDatasetItemsHeadRequest {
	r.view = &view
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then, the all the items with errorInfo property will be skipped from the output.  This feature is here to emulate functionality of API version 1 used for the legacy Apify Crawler product and it&#39;s not recommended to use it in new integrations. 
func (r ApiDatasetItemsHeadRequest) SkipFailedPages(skipFailedPages bool) ApiDatasetItemsHeadRequest {
	r.skipFailedPages = &skipFailedPages
	return r
}

// Overrides the auto-generated RSS channel &#x60;&lt;title&gt;&#x60; element. Only used when &#x60;format&#x3D;rss&#x60;. If not provided, the title defaults to &#x60;Dataset &lt;label&gt;&#x60;. 
func (r ApiDatasetItemsHeadRequest) FeedTitle(feedTitle string) ApiDatasetItemsHeadRequest {
	r.feedTitle = &feedTitle
	return r
}

// Overrides the auto-generated RSS channel &#x60;&lt;description&gt;&#x60; element. Only used when &#x60;format&#x3D;rss&#x60;. If not provided, the description defaults to &#x60;Items in dataset with id \&quot;&lt;datasetId&gt;\&quot;.&#x60; 
func (r ApiDatasetItemsHeadRequest) FeedDescription(feedDescription string) ApiDatasetItemsHeadRequest {
	r.feedDescription = &feedDescription
	return r
}

// Signature used for the access.
func (r ApiDatasetItemsHeadRequest) Signature(signature string) ApiDatasetItemsHeadRequest {
	r.signature = &signature
	return r
}

func (r ApiDatasetItemsHeadRequest) Execute() (*http.Response, error) {
	return r.ApiService.DatasetItemsHeadExecute(r)
}

/*
DatasetItemsHead Get dataset items headers
...
This is useful to check pagination metadata or verify access without downloading the full dataset.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetItemsHeadRequest
*/
func (a *StorageDatasetsAPIService) DatasetItemsHead(ctx context.Context, datasetId string) ApiDatasetItemsHeadRequest {
	return ApiDatasetItemsHeadRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
// Execute executes the request
func (a *StorageDatasetsAPIService) DatasetItemsHeadExecute(r ApiDatasetItemsHeadRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetItemsHead")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiDatasetItemsPostRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
	actRunsLastDatasetItemsPostRequest *ActRunsLastDatasetItemsPostRequest
}

// 
func (r ApiDatasetItemsPostRequest) ActRunsLastDatasetItemsPostRequest(actRunsLastDatasetItemsPostRequest ActRunsLastDatasetItemsPostRequest) ApiDatasetItemsPostRequest {
	r.actRunsLastDatasetItemsPostRequest = &actRunsLastDatasetItemsPostRequest
	return r
}

func (r ApiDatasetItemsPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.DatasetItemsPostExecute(r)
}

/*
DatasetItemsPost Store items
...
**IMPORTANT:** The limit of request payload size for the dataset is 5 MB. If the array exceeds the size, you'll need to split it into a number of smaller arrays.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetItemsPostRequest
*/
func (a *StorageDatasetsAPIService) DatasetItemsPost(ctx context.Context, datasetId string) ApiDatasetItemsPostRequest {
	return ApiDatasetItemsPostRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *StorageDatasetsAPIService) DatasetItemsPostExecute(r ApiDatasetItemsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetItemsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.actRunsLastDatasetItemsPostRequest == nil {
		return localVarReturnValue, nil, reportError("actRunsLastDatasetItemsPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.actRunsLastDatasetItemsPostRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ActRunsLastDatasetItemsPost400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type ApiDatasetPutRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
...
// 
func (r ApiDatasetPutRequest) UpdateDatasetRequest(updateDatasetRequest UpdateDatasetRequest) ApiDatasetPutRequest {
	r.updateDatasetRequest = &updateDatasetRequest
	return r
}

func (r ApiDatasetPutRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.DatasetPutExecute(r)
}

/*
DatasetPut Update dataset
...
The response is the updated dataset object, as returned by the [Get dataset](/api/v2/dataset-get) API endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetPutRequest
*/
func (a *StorageDatasetsAPIService) DatasetPut(ctx context.Context, datasetId string) ApiDatasetPutRequest {
	return ApiDatasetPutRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
// Execute executes the request
//  @return DatasetResponse
func (a *StorageDatasetsAPIService) DatasetPutExecute(r ApiDatasetPutRequest) (*DatasetResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiDatasetStatisticsGetRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	datasetId string
}

func (r ApiDatasetStatisticsGetRequest) Execute() (*DatasetStatisticsResponse, *http.Response, error) {
	return r.ApiService.DatasetStatisticsGetExecute(r)
}

/*
DatasetStatisticsGet Get dataset statistics
...
Provides only [field statistics](https://docs.apify.com/platform/actors/development/actor-definition/dataset-schema/validation#dataset-field-statistics).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param datasetId Dataset ID or `username~dataset-name`.
 @return ApiDatasetStatisticsGetRequest
*/
func (a *StorageDatasetsAPIService) DatasetStatisticsGet(ctx context.Context, datasetId string) ApiDatasetStatisticsGetRequest {
	return ApiDatasetStatisticsGetRequest{
		ApiService: a,
		ctx: ctx,
		datasetId: datasetId,
...
func (a *StorageDatasetsAPIService) DatasetStatisticsGetExecute(r ApiDatasetStatisticsGetRequest) (*DatasetStatisticsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DatasetStatisticsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetStatisticsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/datasets/{datasetId}/statistics"
	localVarPath = strings.Replace(localVarPath, "{"+"datasetId"+"}", url.PathEscape(parameterValueToString(r.datasetId, "datasetId")), -1)
...
type ApiDatasetsGetRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	offset *float64
	limit *float64
...
// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiDatasetsGetRequest) Offset(offset float64) ApiDatasetsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiDatasetsGetRequest) Limit(limit float64) ApiDatasetsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiDatasetsGetRequest) Desc(desc bool) ApiDatasetsGetRequest {
	r.desc = &desc
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then all the storages are returned. By default, only named storages are returned. 
func (r ApiDatasetsGetRequest) Unnamed(unnamed bool) ApiDatasetsGetRequest {
	r.unnamed = &unnamed
	return r
}

// Filter by ownership. If this parameter is omitted, all accessible datasets are returned.  - &#x60;ownedByMe&#x60;: Return only datasets owned by the user. - &#x60;sharedWithMe&#x60;: Return only datasets shared with the user by other users. 
func (r ApiDatasetsGetRequest) Ownership(ownership StorageOwnership) ApiDatasetsGetRequest {
	r.ownership = &ownership
	return r
}

func (r ApiDatasetsGetRequest) Execute() (*ListOfDatasetsResponse, *http.Response, error) {
	return r.ApiService.DatasetsGetExecute(r)
}

/*
DatasetsGet Get list of datasets
...
parameters and it will not return more than 1000 array elements.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDatasetsGetRequest
*/
func (a *StorageDatasetsAPIService) DatasetsGet(ctx context.Context) ApiDatasetsGetRequest {
	return ApiDatasetsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOfDatasetsResponse
func (a *StorageDatasetsAPIService) DatasetsGetExecute(r ApiDatasetsGetRequest) (*ListOfDatasetsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfDatasetsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/datasets"
	...
	if r.unnamed != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "unnamed", r.unnamed, "form", "")
	}
	if r.ownership != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ownership", r.ownership, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiDatasetsPostRequest struct {
	ctx context.Context
	ApiService *StorageDatasetsAPIService
	name *string
}
...
func (r ApiDatasetsPostRequest) Name(name string) ApiDatasetsPostRequest {
	r.name = &name
	return r
}

func (r ApiDatasetsPostRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.DatasetsPostExecute(r)
}

/*
DatasetsPost Create dataset
...
If a dataset with the given name already exists then returns its object.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDatasetsPostRequest
*/
func (a *StorageDatasetsAPIService) DatasetsPost(ctx context.Context) ApiDatasetsPostRequest {
	return ApiDatasetsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DatasetResponse
func (a *StorageDatasetsAPIService) DatasetsPostExecute(r ApiDatasetsPostRequest) (*DatasetResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageDatasetsAPIService.DatasetsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
