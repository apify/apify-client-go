...
// StorageRequestQueuesAPIService StorageRequestQueuesAPI service
type StorageRequestQueuesAPIService service

type ApiRequestQueueDeleteRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	queueId string
}

func (r ApiRequestQueueDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.RequestQueueDeleteExecute(r)
}

/*
RequestQueueDelete Delete request queue

Deletes given queue.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueDeleteRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueueDelete(ctx context.Context, queueId string) ApiRequestQueueDeleteRequest {
	return ApiRequestQueueDeleteRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesAPIService) RequestQueueDeleteExecute(r ApiRequestQueueDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueueDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}"
...
type ApiRequestQueueGetRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	queueId string
}

func (r ApiRequestQueueGetRequest) Execute() (*RequestQueueResponse, *http.Response, error) {
	return r.ApiService.RequestQueueGetExecute(r)
}

/*
RequestQueueGet Get request queue

Returns queue object for given queue ID.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueGetRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueueGet(ctx context.Context, queueId string) ApiRequestQueueGetRequest {
	return ApiRequestQueueGetRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesAPIService) RequestQueueGetExecute(r ApiRequestQueueGetRequest) (*RequestQueueResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueueGet")
	if err != nil {
...
type ApiRequestQueuePutRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	queueId string
...
// 
func (r ApiRequestQueuePutRequest) UpdateRequestQueueRequest(updateRequestQueueRequest UpdateRequestQueueRequest) ApiRequestQueuePutRequest {
	r.updateRequestQueueRequest = &updateRequestQueueRequest
	return r
}

func (r ApiRequestQueuePutRequest) Execute() (*RequestQueueResponse, *http.Response, error) {
	return r.ApiService.RequestQueuePutExecute(r)
}

/*
RequestQueuePut Update request queue
...
[Get request queue](#/reference/request-queues/queue-collection/get-request-queue) API endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueuePutRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueuePut(ctx context.Context, queueId string) ApiRequestQueuePutRequest {
	return ApiRequestQueuePutRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
// Execute executes the request
//  @return RequestQueueResponse
func (a *StorageRequestQueuesAPIService) RequestQueuePutExecute(r ApiRequestQueuePutRequest) (*RequestQueueResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueuePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRequestQueueRequestsBatchDeleteRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	queueId string
	contentType *string
...
// 
func (r ApiRequestQueueRequestsBatchDeleteRequest) ContentType(contentType string) ApiRequestQueueRequestsBatchDeleteRequest {
	r.contentType = &contentType
	return r
}

// 
func (r ApiRequestQueueRequestsBatchDeleteRequest) RequestDraftDelete(requestDraftDelete []RequestDraftDelete) ApiRequestQueueRequestsBatchDeleteRequest {
...
func (r ApiRequestQueueRequestsBatchDeleteRequest) ClientKey(clientKey string) ApiRequestQueueRequestsBatchDeleteRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueRequestsBatchDeleteRequest) Execute() (*BatchDeleteResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestsBatchDeleteExecute(r)
}

/*
RequestQueueRequestsBatchDelete Delete requests
...
either of them to identify the request.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueRequestsBatchDeleteRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueueRequestsBatchDelete(ctx context.Context, queueId string) ApiRequestQueueRequestsBatchDeleteRequest {
	return ApiRequestQueueRequestsBatchDeleteRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesAPIService) RequestQueueRequestsBatchDeleteExecute(r ApiRequestQueueRequestsBatchDeleteRequest) (*BatchDeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueueRequestsBatchDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/requests/batch"
	localVarPath = strings.Replace(localVarPath, "{"+"queueId"+"}", url.PathEscape(parameterValueToString(r.queueId, "queueId")), -1)
...
type ApiRequestQueueRequestsBatchPostRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	queueId string
...
// 
func (r ApiRequestQueueRequestsBatchPostRequest) RequestBase(requestBase []RequestBase) ApiRequestQueueRequestsBatchPostRequest {
	r.requestBase = &requestBase
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestsBatchPostRequest) ClientKey(clientKey string) ApiRequestQueueRequestsBatchPostRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiRequestQueueRequestsBatchPostRequest) Forefront(forefront string) ApiRequestQueueRequestsBatchPostRequest {
	r.forefront = &forefront
	return r
}

func (r ApiRequestQueueRequestsBatchPostRequest) Execute() (*BatchAddResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestsBatchPostExecute(r)
}

/*
RequestQueueRequestsBatchPost Add requests
...
*/
func (a *StorageRequestQueuesAPIService) RequestQueueRequestsBatchPost(ctx context.Context, queueId string) ApiRequestQueueRequestsBatchPostRequest {
	return ApiRequestQueueRequestsBatchPostRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesAPIService) RequestQueueRequestsBatchPostExecute(r ApiRequestQueueRequestsBatchPostRequest) (*BatchAddResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueueRequestsBatchPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRequestQueuesGetRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	offset *float64
	limit *float64
...
func (r ApiRequestQueuesGetRequest) Offset(offset float64) ApiRequestQueuesGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiRequestQueuesGetRequest) Limit(limit float64) ApiRequestQueuesGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiRequestQueuesGetRequest) Desc(desc bool) ApiRequestQueuesGetRequest {
	r.desc = &desc
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then all the storages are returned. By default, only named storages are returned. 
func (r ApiRequestQueuesGetRequest) Unnamed(unnamed bool) ApiRequestQueuesGetRequest {
	r.unnamed = &unnamed
	return r
}

// Filter by ownership. If this parameter is omitted, all accessible request queues are returned.  - &#x60;ownedByMe&#x60;: Return only request queues owned by the user. - &#x60;sharedWithMe&#x60;: Return only request queues shared with the user by other users. 
func (r ApiRequestQueuesGetRequest) Ownership(ownership StorageOwnership) ApiRequestQueuesGetRequest {
	r.ownership = &ownership
	return r
}

func (r ApiRequestQueuesGetRequest) Execute() (*ListOfRequestQueuesResponse, *http.Response, error) {
	return r.ApiService.RequestQueuesGetExecute(r)
}

/*
RequestQueuesGet Get list of request queues
...
array elements.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRequestQueuesGetRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueuesGet(ctx context.Context) ApiRequestQueuesGetRequest {
	return ApiRequestQueuesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOfRequestQueuesResponse
func (a *StorageRequestQueuesAPIService) RequestQueuesGetExecute(r ApiRequestQueuesGetRequest) (*ListOfRequestQueuesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfRequestQueuesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueuesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues"
...
type ApiRequestQueuesPostRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesAPIService
	name *string
}
...
func (r ApiRequestQueuesPostRequest) Name(name string) ApiRequestQueuesPostRequest {
	r.name = &name
	return r
}

func (r ApiRequestQueuesPostRequest) Execute() (*RequestQueueResponse, *http.Response, error) {
	return r.ApiService.RequestQueuesPostExecute(r)
}

/*
RequestQueuesPost Create request queue
...
its object.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRequestQueuesPostRequest
*/
func (a *StorageRequestQueuesAPIService) RequestQueuesPost(ctx context.Context) ApiRequestQueuesPostRequest {
	return ApiRequestQueuesPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RequestQueueResponse
func (a *StorageRequestQueuesAPIService) RequestQueuesPostExecute(r ApiRequestQueuesPostRequest) (*RequestQueueResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesAPIService.RequestQueuesPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
