...
// ActorRunPricingInfo - struct for ActorRunPricingInfo
type ActorRunPricingInfo struct {
	FlatPricePerMonthActorPricingInfo *FlatPricePerMonthActorPricingInfo
	FreeActorPricingInfo *FreeActorPricingInfo
	PayPerEventActorPricingInfo *PayPerEventActorPricingInfo
	PricePerDatasetItemActorPricingInfo *PricePerDatasetItemActorPricingInfo
}

// FlatPricePerMonthActorPricingInfoAsActorRunPricingInfo is a convenience function that returns FlatPricePerMonthActorPricingInfo wrapped in ActorRunPricingInfo
func FlatPricePerMonthActorPricingInfoAsActorRunPricingInfo(v *FlatPricePerMonthActorPricingInfo) ActorRunPricingInfo {
	return ActorRunPricingInfo{
		FlatPricePerMonthActorPricingInfo: v,
	}
}

// FreeActorPricingInfoAsActorRunPricingInfo is a convenience function that returns FreeActorPricingInfo wrapped in ActorRunPricingInfo
func FreeActorPricingInfoAsActorRunPricingInfo(v *FreeActorPricingInfo) ActorRunPricingInfo {
	return ActorRunPricingInfo{
		FreeActorPricingInfo: v,
	}
}

// PayPerEventActorPricingInfoAsActorRunPricingInfo is a convenience function that returns PayPerEventActorPricingInfo wrapped in ActorRunPricingInfo
func PayPerEventActorPricingInfoAsActorRunPricingInfo(v *PayPerEventActorPricingInfo) ActorRunPricingInfo {
	return ActorRunPricingInfo{
		PayPerEventActorPricingInfo: v,
	}
}

// PricePerDatasetItemActorPricingInfoAsActorRunPricingInfo is a convenience function that returns PricePerDatasetItemActorPricingInfo wrapped in ActorRunPricingInfo
func PricePerDatasetItemActorPricingInfoAsActorRunPricingInfo(v *PricePerDatasetItemActorPricingInfo) ActorRunPricingInfo {
	return ActorRunPricingInfo{
		PricePerDatasetItemActorPricingInfo: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ActorRunPricingInfo) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into FlatPricePerMonthActorPricingInfo
	err = newStrictDecoder(data).Decode(&dst.FlatPricePerMonthActorPricingInfo)
	if err == nil {
		jsonFlatPricePerMonthActorPricingInfo, _ := json.Marshal(dst.FlatPricePerMonthActorPricingInfo)
		if string(jsonFlatPricePerMonthActorPricingInfo) == "{}" { // empty struct
			dst.FlatPricePerMonthActorPricingInfo = nil
		} else {
			if err = validator.Validate(dst.FlatPricePerMonthActorPricingInfo); err != nil {
				dst.FlatPricePerMonthActorPricingInfo = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into FreeActorPricingInfo
	err = newStrictDecoder(data).Decode(&dst.FreeActorPricingInfo)
	if err == nil {
		jsonFreeActorPricingInfo, _ := json.Marshal(dst.FreeActorPricingInfo)
		if string(jsonFreeActorPricingInfo) == "{}" { // empty struct
			dst.FreeActorPricingInfo = nil
		} else {
			if err = validator.Validate(dst.FreeActorPricingInfo); err != nil {
				dst.FreeActorPricingInfo = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into PayPerEventActorPricingInfo
	err = newStrictDecoder(data).Decode(&dst.PayPerEventActorPricingInfo)
	if err == nil {
		jsonPayPerEventActorPricingInfo, _ := json.Marshal(dst.PayPerEventActorPricingInfo)
		if string(jsonPayPerEventActorPricingInfo) == "{}" { // empty struct
			dst.PayPerEventActorPricingInfo = nil
		} else {
			if err = validator.Validate(dst.PayPerEventActorPricingInfo); err != nil {
				dst.PayPerEventActorPricingInfo = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into PricePerDatasetItemActorPricingInfo
	err = newStrictDecoder(data).Decode(&dst.PricePerDatasetItemActorPricingInfo)
	if err == nil {
		jsonPricePerDatasetItemActorPricingInfo, _ := json.Marshal(dst.PricePerDatasetItemActorPricingInfo)
		if string(jsonPricePerDatasetItemActorPricingInfo) == "{}" { // empty struct
			dst.PricePerDatasetItemActorPricingInfo = nil
		} else {
			if err = validator.Validate(dst.PricePerDatasetItemActorPricingInfo); err != nil {
				dst.PricePerDatasetItemActorPricingInfo = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ActorRunPricingInfo)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ActorRunPricingInfo)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ActorRunPricingInfo) MarshalJSON() ([]byte, error) {
	if src.FlatPricePerMonthActorPricingInfo != nil {
		return json.Marshal(&src.FlatPricePerMonthActorPricingInfo)
	}

	if src.FreeActorPricingInfo != nil {
		return json.Marshal(&src.FreeActorPricingInfo)
	}

	if src.PayPerEventActorPricingInfo != nil {
		return json.Marshal(&src.PayPerEventActorPricingInfo)
	}

	if src.PricePerDatasetItemActorPricingInfo != nil {
		return json.Marshal(&src.PricePerDatasetItemActorPricingInfo)
	}
...
func (obj *ActorRunPricingInfo) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.FlatPricePerMonthActorPricingInfo != nil {
		return obj.FlatPricePerMonthActorPricingInfo
	}

	if obj.FreeActorPricingInfo != nil {
		return obj.FreeActorPricingInfo
	}

	if obj.PayPerEventActorPricingInfo != nil {
		return obj.PayPerEventActorPricingInfo
	}

	if obj.PricePerDatasetItemActorPricingInfo != nil {
		return obj.PricePerDatasetItemActorPricingInfo
	}
...
func (obj ActorRunPricingInfo) GetActualInstanceValue() (interface{}) {
	if obj.FlatPricePerMonthActorPricingInfo != nil {
		return *obj.FlatPricePerMonthActorPricingInfo
	}
...
type NullableActorRunPricingInfo struct {
	value *ActorRunPricingInfo
	isSet bool
}

func (v NullableActorRunPricingInfo) Get() *ActorRunPricingInfo {
	return v.value
}

func (v *NullableActorRunPricingInfo) Set(val *ActorRunPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableActorRunPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableActorRunPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorRunPricingInfo(val *ActorRunPricingInfo) *NullableActorRunPricingInfo {
	return &NullableActorRunPricingInfo{value: val, isSet: true}
}

func (v NullableActorRunPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorRunPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
