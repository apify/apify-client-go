...
func (r ApiUserGetRequest) Execute() (*PublicUserDataResponse, *http.Response, error) {
	return r.ApiService.UserGetExecute(r)
}

/*
UserGet Get public user data
...
*/
func (a *UsersAPIService) UserGet(ctx context.Context, userId string) ApiUserGetRequest {
	return ApiUserGetRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UsersAPIService) UserGetExecute(r ApiUserGetRequest) (*PublicUserDataResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PublicUserDataResponse
	)
...
func (r ApiUsersMeGetRequest) Execute() (*PrivateUserDataResponse, *http.Response, error) {
	return r.ApiService.UsersMeGetExecute(r)
}

/*
UsersMeGet Get private user data
...
func (a *UsersAPIService) UsersMeGetExecute(r ApiUsersMeGetRequest) (*PrivateUserDataResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PrivateUserDataResponse
	)
...
type ApiUsersMeLimitsGetRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
}

func (r ApiUsersMeLimitsGetRequest) Execute() (*LimitsResponse, *http.Response, error) {
	return r.ApiService.UsersMeLimitsGetExecute(r)
}

/*
UsersMeLimitsGet Get limits
...
includes the current usage cycle, a summary of your limits, and your current usage.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUsersMeLimitsGetRequest
*/
func (a *UsersAPIService) UsersMeLimitsGet(ctx context.Context) ApiUsersMeLimitsGetRequest {
	return ApiUsersMeLimitsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsersAPIService) UsersMeLimitsGetExecute(r ApiUsersMeLimitsGetRequest) (*LimitsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *LimitsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UsersMeLimitsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/users/me/limits"
...
type ApiUsersMeLimitsPutRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
	updateLimitsRequest *UpdateLimitsRequest
}

// 
func (r ApiUsersMeLimitsPutRequest) UpdateLimitsRequest(updateLimitsRequest UpdateLimitsRequest) ApiUsersMeLimitsPutRequest {
	r.updateLimitsRequest = &updateLimitsRequest
	return r
}

func (r ApiUsersMeLimitsPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.UsersMeLimitsPutExecute(r)
}

/*
UsersMeLimitsPut Update limits
...
Specifically the: `maxMonthlyUsageUsd` and `dataRetentionDays` limits (see request body schema for more details).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUsersMeLimitsPutRequest
*/
func (a *UsersAPIService) UsersMeLimitsPut(ctx context.Context) ApiUsersMeLimitsPutRequest {
	return ApiUsersMeLimitsPutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsersAPIService) UsersMeLimitsPutExecute(r ApiUsersMeLimitsPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UsersMeLimitsPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.updateLimitsRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiUsersMeUsageMonthlyGetRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
	date *string
}
...
func (r ApiUsersMeUsageMonthlyGetRequest) Date(date string) ApiUsersMeUsageMonthlyGetRequest {
	r.date = &date
	return r
}

func (r ApiUsersMeUsageMonthlyGetRequest) Execute() (*MonthlyUsageResponse, *http.Response, error) {
	return r.ApiService.UsersMeUsageMonthlyGetExecute(r)
}

/*
UsersMeUsageMonthlyGet Get monthly usage
...
includes that date.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUsersMeUsageMonthlyGetRequest
*/
func (a *UsersAPIService) UsersMeUsageMonthlyGet(ctx context.Context) ApiUsersMeUsageMonthlyGetRequest {
	return ApiUsersMeUsageMonthlyGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsersAPIService) UsersMeUsageMonthlyGetExecute(r ApiUsersMeUsageMonthlyGetRequest) (*MonthlyUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MonthlyUsageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UsersMeUsageMonthlyGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/users/me/usage/monthly"
