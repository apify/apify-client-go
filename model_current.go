...
type Current struct {
	...
	MonthlyProxySerps int32 `json:"monthlyProxySerps"`
	...
	ActorTaskCount int32 `json:"actorTaskCount"`
	ActiveActorJobCount int32 `json:"activeActorJobCount"`
...
// GetMonthlyUsageUsd returns the MonthlyUsageUsd field value
func (o *Current) GetMonthlyUsageUsd() float32 {
	...
	return o.MonthlyUsageUsd
}

// GetMonthlyUsageUsdOk returns a tuple with the MonthlyUsageUsd field value
// and a boolean to check if the value has been set.
func (o *Current) GetMonthlyUsageUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyUsageUsd, true
}

// SetMonthlyUsageUsd sets field value
func (o *Current) SetMonthlyUsageUsd(v float32) {
	o.MonthlyUsageUsd = v
}

// GetMonthlyActorComputeUnits returns the MonthlyActorComputeUnits field value
func (o *Current) GetMonthlyActorComputeUnits() float32 {
	...
	return o.MonthlyActorComputeUnits
}

// GetMonthlyActorComputeUnitsOk returns a tuple with the MonthlyActorComputeUnits field value
// and a boolean to check if the value has been set.
func (o *Current) GetMonthlyActorComputeUnitsOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyActorComputeUnits, true
}

// SetMonthlyActorComputeUnits sets field value
func (o *Current) SetMonthlyActorComputeUnits(v float32) {
	o.MonthlyActorComputeUnits = v
}

// GetMonthlyExternalDataTransferGbytes returns the MonthlyExternalDataTransferGbytes field value
func (o *Current) GetMonthlyExternalDataTransferGbytes() float32 {
	...
	return o.MonthlyExternalDataTransferGbytes
}

// GetMonthlyExternalDataTransferGbytesOk returns a tuple with the MonthlyExternalDataTransferGbytes field value
// and a boolean to check if the value has been set.
func (o *Current) GetMonthlyExternalDataTransferGbytesOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyExternalDataTransferGbytes, true
}

// SetMonthlyExternalDataTransferGbytes sets field value
func (o *Current) SetMonthlyExternalDataTransferGbytes(v float32) {
	o.MonthlyExternalDataTransferGbytes = v
}

// GetMonthlyProxySerps returns the MonthlyProxySerps field value
func (o *Current) GetMonthlyProxySerps() int32 {
	...
	return o.MonthlyProxySerps
}

// GetMonthlyProxySerpsOk returns a tuple with the MonthlyProxySerps field value
// and a boolean to check if the value has been set.
func (o *Current) GetMonthlyProxySerpsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyProxySerps, true
}

// SetMonthlyProxySerps sets field value
func (o *Current) SetMonthlyProxySerps(v int32) {
	o.MonthlyProxySerps = v
}

// GetMonthlyResidentialProxyGbytes returns the MonthlyResidentialProxyGbytes field value
func (o *Current) GetMonthlyResidentialProxyGbytes() float32 {
	...
	return o.MonthlyResidentialProxyGbytes
}

// GetMonthlyResidentialProxyGbytesOk returns a tuple with the MonthlyResidentialProxyGbytes field value
// and a boolean to check if the value has been set.
func (o *Current) GetMonthlyResidentialProxyGbytesOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyResidentialProxyGbytes, true
}

// SetMonthlyResidentialProxyGbytes sets field value
func (o *Current) SetMonthlyResidentialProxyGbytes(v float32) {
	o.MonthlyResidentialProxyGbytes = v
}

// GetActorMemoryGbytes returns the ActorMemoryGbytes field value
func (o *Current) GetActorMemoryGbytes() float32 {
	...
	return o.ActorMemoryGbytes
}

// GetActorMemoryGbytesOk returns a tuple with the ActorMemoryGbytes field value
// and a boolean to check if the value has been set.
func (o *Current) GetActorMemoryGbytesOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActorMemoryGbytes, true
}

// SetActorMemoryGbytes sets field value
func (o *Current) SetActorMemoryGbytes(v float32) {
	o.ActorMemoryGbytes = v
}

// GetActorCount returns the ActorCount field value
...
// GetActorCountOk returns a tuple with the ActorCount field value
// and a boolean to check if the value has been set.
...
// SetActorCount sets field value
func (o *Current) SetActorCount(v int32) {
	o.ActorCount = v
}

// GetActorTaskCount returns the ActorTaskCount field value
func (o *Current) GetActorTaskCount() int32 {
	...
	return o.ActorTaskCount
}

// GetActorTaskCountOk returns a tuple with the ActorTaskCount field value
// and a boolean to check if the value has been set.
func (o *Current) GetActorTaskCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActorTaskCount, true
}

// SetActorTaskCount sets field value
func (o *Current) SetActorTaskCount(v int32) {
	o.ActorTaskCount = v
}

// GetActiveActorJobCount returns the ActiveActorJobCount field value
func (o *Current) GetActiveActorJobCount() int32 {
	...
	return o.ActiveActorJobCount
}

// GetActiveActorJobCountOk returns a tuple with the ActiveActorJobCount field value
// and a boolean to check if the value has been set.
func (o *Current) GetActiveActorJobCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActiveActorJobCount, true
}

// SetActiveActorJobCount sets field value
func (o *Current) SetActiveActorJobCount(v int32) {
	o.ActiveActorJobCount = v
}
...
func (o Current) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["monthlyUsageUsd"] = o.MonthlyUsageUsd
	toSerialize["monthlyActorComputeUnits"] = o.MonthlyActorComputeUnits
	toSerialize["monthlyExternalDataTransferGbytes"] = o.MonthlyExternalDataTransferGbytes
	toSerialize["monthlyProxySerps"] = o.MonthlyProxySerps
	toSerialize["monthlyResidentialProxyGbytes"] = o.MonthlyResidentialProxyGbytes
	toSerialize["actorMemoryGbytes"] = o.ActorMemoryGbytes
	toSerialize["actorCount"] = o.ActorCount
	toSerialize["actorTaskCount"] = o.ActorTaskCount
	toSerialize["activeActorJobCount"] = o.ActiveActorJobCount
