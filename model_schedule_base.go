...
// checks if the ScheduleBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleBase{}

// ScheduleBase struct for ScheduleBase
...
type _ScheduleBase ScheduleBase
...
func (o *ScheduleBase) SetNextRunAtNil() {
	o.NextRunAt.Set(nil)
}
...
func (o *ScheduleBase) SetLastRunAtNil() {
	o.LastRunAt.Set(nil)
}
...
func (o ScheduleBase) MarshalJSON() ([]byte, error) {
...
func (o ScheduleBase) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleBase) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleBase := _ScheduleBase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleBase)

	if err != nil {
		return err
	}

	*o = ScheduleBase(varScheduleBase)

	return err
}

type NullableScheduleBase struct {
	value *ScheduleBase
	isSet bool
}

func (v NullableScheduleBase) Get() *ScheduleBase {
	return v.value
}

func (v *NullableScheduleBase) Set(val *ScheduleBase) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleBase) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleBase(val *ScheduleBase) *NullableScheduleBase {
	return &NullableScheduleBase{value: val, isSet: true}
}

func (v NullableScheduleBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
