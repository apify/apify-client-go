...
// checks if the InvalidItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidItem{}

// InvalidItem struct for InvalidItem
type InvalidItem struct {
	// The position of the invalid item in the array.
	ItemPosition *int32 `json:"itemPosition,omitempty"`
...
// GetItemPosition returns the ItemPosition field value if set, zero value otherwise.
func (o *InvalidItem) GetItemPosition() int32 {
	if o == nil || IsNil(o.ItemPosition) {
		var ret int32
		return ret
	}
...
// GetItemPositionOk returns a tuple with the ItemPosition field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvalidItem) GetItemPositionOk() (*int32, bool) {
	if o == nil || IsNil(o.ItemPosition) {
		return nil, false
	}
	return o.ItemPosition, true
}
...
// SetItemPosition gets a reference to the given int32 and assigns it to the ItemPosition field.
...
func (o InvalidItem) MarshalJSON() ([]byte, error) {
...
func (o InvalidItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ItemPosition) {
		toSerialize["itemPosition"] = o.ItemPosition
	}
...
type NullableInvalidItem struct {
	value *InvalidItem
	isSet bool
}

func (v NullableInvalidItem) Get() *InvalidItem {
	return v.value
}

func (v *NullableInvalidItem) Set(val *InvalidItem) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidItem) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidItem(val *InvalidItem) *NullableInvalidItem {
	return &NullableInvalidItem{value: val, isSet: true}
}

func (v NullableInvalidItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
