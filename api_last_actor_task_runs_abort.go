...
// LastActorTaskRunsAbortAPIService LastActorTaskRunsAbortAPI service
type LastActorTaskRunsAbortAPIService service

type ApiActorTaskRunsLastAbortPostRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsAbortAPIService
	actorTaskId string
	status *string
	gracefully *bool
}
...
func (r ApiActorTaskRunsLastAbortPostRequest) Status(status string) ApiActorTaskRunsLastAbortPostRequest {
	r.status = &status
	return r
}
...
func (r ApiActorTaskRunsLastAbortPostRequest) Gracefully(gracefully bool) ApiActorTaskRunsLastAbortPostRequest {
	r.gracefully = &gracefully
	return r
}

func (r ApiActorTaskRunsLastAbortPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastAbortPostExecute(r)
}

/*
ActorTaskRunsLastAbortPost Abort Actor task's last run
...
does nothing.
 ...
 @return ApiActorTaskRunsLastAbortPostRequest
*/
func (a *LastActorTaskRunsAbortAPIService) ActorTaskRunsLastAbortPost(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastAbortPostRequest {
	return ApiActorTaskRunsLastAbortPostRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return RunResponse
func (a *LastActorTaskRunsAbortAPIService) ActorTaskRunsLastAbortPostExecute(r ApiActorTaskRunsLastAbortPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsAbortAPIService.ActorTaskRunsLastAbortPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/abort"
