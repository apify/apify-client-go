...
// checks if the ScheduleActionRunInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleActionRunInput{}

// ScheduleActionRunInput struct for ScheduleActionRunInput
type ScheduleActionRunInput struct {
	Body NullableString `json:"body,omitempty"`
	ContentType NullableString `json:"contentType,omitempty"`
}

// NewScheduleActionRunInput instantiates a new ScheduleActionRunInput object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleActionRunInput() *ScheduleActionRunInput {
	this := ScheduleActionRunInput{}
	return &this
}

// NewScheduleActionRunInputWithDefaults instantiates a new ScheduleActionRunInput object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleActionRunInputWithDefaults() *ScheduleActionRunInput {
	this := ScheduleActionRunInput{}
	return &this
}

// GetBody returns the Body field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleActionRunInput) GetBody() string {
...
func (o *ScheduleActionRunInput) GetBodyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleActionRunInput) HasBody() bool {
...
func (o *ScheduleActionRunInput) SetBody(v string) {
	o.Body.Set(&v)
}
// SetBodyNil sets the value for Body to be an explicit nil
func (o *ScheduleActionRunInput) SetBodyNil() {
	o.Body.Set(nil)
}

// UnsetBody ensures that no value is present for Body, not even an explicit nil
func (o *ScheduleActionRunInput) UnsetBody() {
	o.Body.Unset()
}

// GetContentType returns the ContentType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleActionRunInput) GetContentType() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ScheduleActionRunInput) GetContentTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduleActionRunInput) HasContentType() bool {
...
func (o *ScheduleActionRunInput) SetContentType(v string) {
	o.ContentType.Set(&v)
}
// SetContentTypeNil sets the value for ContentType to be an explicit nil
func (o *ScheduleActionRunInput) SetContentTypeNil() {
	o.ContentType.Set(nil)
}

// UnsetContentType ensures that no value is present for ContentType, not even an explicit nil
func (o *ScheduleActionRunInput) UnsetContentType() {
	o.ContentType.Unset()
}

func (o ScheduleActionRunInput) MarshalJSON() ([]byte, error) {
...
func (o ScheduleActionRunInput) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleActionRunInput struct {
	value *ScheduleActionRunInput
	isSet bool
}

func (v NullableScheduleActionRunInput) Get() *ScheduleActionRunInput {
	return v.value
}

func (v *NullableScheduleActionRunInput) Set(val *ScheduleActionRunInput) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionRunInput) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionRunInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionRunInput(val *ScheduleActionRunInput) *NullableScheduleActionRunInput {
	return &NullableScheduleActionRunInput{value: val, isSet: true}
}

func (v NullableScheduleActionRunInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionRunInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
