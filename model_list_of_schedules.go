...
// checks if the ListOfSchedules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfSchedules{}

// ListOfSchedules struct for ListOfSchedules
type ListOfSchedules struct {
	...
	Items []ScheduleShort `json:"items"`
}

type _ListOfSchedules ListOfSchedules

// NewListOfSchedules instantiates a new ListOfSchedules object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfSchedules(total int32, offset int32, limit int32, desc bool, count int32, items []ScheduleShort) *ListOfSchedules {
...
// NewListOfSchedulesWithDefaults instantiates a new ListOfSchedules object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfSchedulesWithDefaults() *ListOfSchedules {
	this := ListOfSchedules{}
	return &this
}

// GetTotal returns the Total field value
func (o *ListOfSchedules) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListOfSchedules) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ListOfSchedules) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ListOfSchedules) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfSchedules) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListOfSchedules) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ListOfSchedules) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfSchedules) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ListOfSchedules) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ListOfSchedules) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfSchedules) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ListOfSchedules) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ListOfSchedules) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfSchedules) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ListOfSchedules) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ListOfSchedules) GetItems() []ScheduleShort {
	if o == nil {
		var ret []ScheduleShort
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfSchedules) GetItemsOk() ([]ScheduleShort, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListOfSchedules) SetItems(v []ScheduleShort) {
	o.Items = v
}

func (o ListOfSchedules) MarshalJSON() ([]byte, error) {
...
func (o ListOfSchedules) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfSchedules) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfSchedules := _ListOfSchedules{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfSchedules)

	if err != nil {
		return err
	}

	*o = ListOfSchedules(varListOfSchedules)

	return err
}

type NullableListOfSchedules struct {
	value *ListOfSchedules
	isSet bool
}

func (v NullableListOfSchedules) Get() *ListOfSchedules {
	return v.value
}

func (v *NullableListOfSchedules) Set(val *ListOfSchedules) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfSchedules) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfSchedules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfSchedules(val *ListOfSchedules) *NullableListOfSchedules {
	return &NullableListOfSchedules{value: val, isSet: true}
}

func (v NullableListOfSchedules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfSchedules) UnmarshalJSON(src []byte) error {
	v.isSet = true
