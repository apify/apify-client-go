...
type WebhookStats struct {
	TotalDispatches int32 `json:"totalDispatches"`
}

type _WebhookStats WebhookStats

// NewWebhookStats instantiates a new WebhookStats object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebhookStats(totalDispatches int32) *WebhookStats {
	this := WebhookStats{}
...
// GetTotalDispatches returns the TotalDispatches field value
func (o *WebhookStats) GetTotalDispatches() int32 {
	if o == nil {
		var ret int32
		return ret
	}

	return o.TotalDispatches
}

// GetTotalDispatchesOk returns a tuple with the TotalDispatches field value
// and a boolean to check if the value has been set.
func (o *WebhookStats) GetTotalDispatchesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalDispatches, true
}

// SetTotalDispatches sets field value
func (o *WebhookStats) SetTotalDispatches(v int32) {
	o.TotalDispatches = v
}
...
func (o WebhookStats) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["totalDispatches"] = o.TotalDispatches
	return toSerialize, nil
}

func (o *WebhookStats) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookStats := _WebhookStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookStats)

	if err != nil {
		return err
	}

	*o = WebhookStats(varWebhookStats)
