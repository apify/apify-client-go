...
// checks if the PutItemResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutItemResponseError{}

// PutItemResponseError struct for PutItemResponseError
type PutItemResponseError struct {
	Error DatasetSchemaValidationError `json:"error"`
}

type _PutItemResponseError PutItemResponseError

// NewPutItemResponseError instantiates a new PutItemResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPutItemResponseError(error_ DatasetSchemaValidationError) *PutItemResponseError {
	this := PutItemResponseError{}
	this.Error = error_
	return &this
}

// NewPutItemResponseErrorWithDefaults instantiates a new PutItemResponseError object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPutItemResponseErrorWithDefaults() *PutItemResponseError {
	this := PutItemResponseError{}
	return &this
}

// GetError returns the Error field value
func (o *PutItemResponseError) GetError() DatasetSchemaValidationError {
	if o == nil {
		var ret DatasetSchemaValidationError
		return ret
	}
...
func (o *PutItemResponseError) GetErrorOk() (*DatasetSchemaValidationError, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *PutItemResponseError) SetError(v DatasetSchemaValidationError) {
	o.Error = v
}

func (o PutItemResponseError) MarshalJSON() ([]byte, error) {
...
func (o PutItemResponseError) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["error"] = o.Error
	return toSerialize, nil
}

func (o *PutItemResponseError) UnmarshalJSON(data []byte) (err error) {
	...
	varPutItemResponseError := _PutItemResponseError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutItemResponseError)

	if err != nil {
		return err
	}

	*o = PutItemResponseError(varPutItemResponseError)

	return err
}

type NullablePutItemResponseError struct {
	value *PutItemResponseError
	isSet bool
}

func (v NullablePutItemResponseError) Get() *PutItemResponseError {
	return v.value
}

func (v *NullablePutItemResponseError) Set(val *PutItemResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullablePutItemResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullablePutItemResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutItemResponseError(val *PutItemResponseError) *NullablePutItemResponseError {
	return &NullablePutItemResponseError{value: val, isSet: true}
}

func (v NullablePutItemResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutItemResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
