...
// checks if the DeletedRequestById type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletedRequestById{}
...
type _DeletedRequestById DeletedRequestById
...
func (o DeletedRequestById) MarshalJSON() ([]byte, error) {
...
func (o DeletedRequestById) ToMap() (map[string]interface{}, error) {
...
func (o *DeletedRequestById) UnmarshalJSON(data []byte) (err error) {
	...
	varDeletedRequestById := _DeletedRequestById{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeletedRequestById)

	if err != nil {
		return err
	}

	*o = DeletedRequestById(varDeletedRequestById)

	return err
}

type NullableDeletedRequestById struct {
	value *DeletedRequestById
	isSet bool
}

func (v NullableDeletedRequestById) Get() *DeletedRequestById {
	return v.value
}

func (v *NullableDeletedRequestById) Set(val *DeletedRequestById) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletedRequestById) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletedRequestById) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletedRequestById(val *DeletedRequestById) *NullableDeletedRequestById {
	return &NullableDeletedRequestById{value: val, isSet: true}
}

func (v NullableDeletedRequestById) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletedRequestById) UnmarshalJSON(src []byte) error {
	v.isSet = true
