...
// checks if the DatasetStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetStats{}
...
type DatasetStats struct {
	...
	InflatedBytes *int32 `json:"inflatedBytes,omitempty"`
}
...
// GetInflatedBytes returns the InflatedBytes field value if set, zero value otherwise.
func (o *DatasetStats) GetInflatedBytes() int32 {
	if o == nil || IsNil(o.InflatedBytes) {
		var ret int32
		return ret
	}
	return *o.InflatedBytes
}

// GetInflatedBytesOk returns a tuple with the InflatedBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DatasetStats) GetInflatedBytesOk() (*int32, bool) {
	if o == nil || IsNil(o.InflatedBytes) {
		return nil, false
	}
	return o.InflatedBytes, true
}
...
// SetInflatedBytes gets a reference to the given int32 and assigns it to the InflatedBytes field.
func (o *DatasetStats) SetInflatedBytes(v int32) {
	o.InflatedBytes = &v
}

func (o DatasetStats) MarshalJSON() ([]byte, error) {
...
func (o DatasetStats) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InflatedBytes) {
		toSerialize["inflatedBytes"] = o.InflatedBytes
	}
	return toSerialize, nil
}

type NullableDatasetStats struct {
	value *DatasetStats
	isSet bool
}

func (v NullableDatasetStats) Get() *DatasetStats {
	return v.value
}

func (v *NullableDatasetStats) Set(val *DatasetStats) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetStats) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetStats(val *DatasetStats) *NullableDatasetStats {
	return &NullableDatasetStats{value: val, isSet: true}
}

func (v NullableDatasetStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
