...
type TaskOptions struct {
	...
	MaxTotalChargeUsd NullableFloat32 `json:"maxTotalChargeUsd,omitempty"`
	RestartOnError NullableBool `json:"restartOnError,omitempty"`
}
...
func (o *TaskOptions) SetBuildNil() {
	o.Build.Set(nil)
}
...
func (o *TaskOptions) SetTimeoutSecsNil() {
...
func (o *TaskOptions) SetMaxItemsNil() {
	o.MaxItems.Set(nil)
}
...
// GetMaxTotalChargeUsd returns the MaxTotalChargeUsd field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskOptions) GetMaxTotalChargeUsd() float32 {
	if o == nil || IsNil(o.MaxTotalChargeUsd.Get()) {
		var ret float32
		return ret
	}
	return *o.MaxTotalChargeUsd.Get()
}

// GetMaxTotalChargeUsdOk returns a tuple with the MaxTotalChargeUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetMaxTotalChargeUsd gets a reference to the given NullableFloat32 and assigns it to the MaxTotalChargeUsd field.
func (o *TaskOptions) SetMaxTotalChargeUsd(v float32) {
	o.MaxTotalChargeUsd.Set(&v)
}
// SetMaxTotalChargeUsdNil sets the value for MaxTotalChargeUsd to be an explicit nil
func (o *TaskOptions) SetMaxTotalChargeUsdNil() {
	o.MaxTotalChargeUsd.Set(nil)
}
...
func (o *TaskOptions) UnsetMaxTotalChargeUsd() {
	o.MaxTotalChargeUsd.Unset()
}

// GetRestartOnError returns the RestartOnError field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskOptions) GetRestartOnError() bool {
	if o == nil || IsNil(o.RestartOnError.Get()) {
		var ret bool
		return ret
	}
	return *o.RestartOnError.Get()
}
...
// SetRestartOnError gets a reference to the given NullableBool and assigns it to the RestartOnError field.
func (o *TaskOptions) SetRestartOnError(v bool) {
	o.RestartOnError.Set(&v)
}
// SetRestartOnErrorNil sets the value for RestartOnError to be an explicit nil
func (o *TaskOptions) SetRestartOnErrorNil() {
	o.RestartOnError.Set(nil)
}
...
func (o TaskOptions) ToMap() (map[string]interface{}, error) {
	...
	if o.MaxTotalChargeUsd.IsSet() {
		toSerialize["maxTotalChargeUsd"] = o.MaxTotalChargeUsd.Get()
	}
	if o.RestartOnError.IsSet() {
		toSerialize["restartOnError"] = o.RestartOnError.Get()
	}
