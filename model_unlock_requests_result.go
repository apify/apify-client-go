...
// checks if the UnlockRequestsResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnlockRequestsResult{}

// UnlockRequestsResult Result of unlocking requests in the request queue.
type UnlockRequestsResult struct {
	// Number of requests that were successfully unlocked.
	UnlockedCount int32 `json:"unlockedCount"`
}

type _UnlockRequestsResult UnlockRequestsResult

// NewUnlockRequestsResult instantiates a new UnlockRequestsResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUnlockRequestsResult(unlockedCount int32) *UnlockRequestsResult {
	this := UnlockRequestsResult{}
	this.UnlockedCount = unlockedCount
	return &this
}

// NewUnlockRequestsResultWithDefaults instantiates a new UnlockRequestsResult object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUnlockRequestsResultWithDefaults() *UnlockRequestsResult {
	this := UnlockRequestsResult{}
	return &this
}

// GetUnlockedCount returns the UnlockedCount field value
func (o *UnlockRequestsResult) GetUnlockedCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}

	return o.UnlockedCount
}

// GetUnlockedCountOk returns a tuple with the UnlockedCount field value
// and a boolean to check if the value has been set.
func (o *UnlockRequestsResult) GetUnlockedCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UnlockedCount, true
}

// SetUnlockedCount sets field value
func (o *UnlockRequestsResult) SetUnlockedCount(v int32) {
	o.UnlockedCount = v
}

func (o UnlockRequestsResult) MarshalJSON() ([]byte, error) {
...
func (o UnlockRequestsResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["unlockedCount"] = o.UnlockedCount
	return toSerialize, nil
}

func (o *UnlockRequestsResult) UnmarshalJSON(data []byte) (err error) {
	...
	varUnlockRequestsResult := _UnlockRequestsResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUnlockRequestsResult)

	if err != nil {
		return err
	}

	*o = UnlockRequestsResult(varUnlockRequestsResult)

	return err
}

type NullableUnlockRequestsResult struct {
	value *UnlockRequestsResult
	isSet bool
}

func (v NullableUnlockRequestsResult) Get() *UnlockRequestsResult {
	return v.value
}

func (v *NullableUnlockRequestsResult) Set(val *UnlockRequestsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlockRequestsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlockRequestsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlockRequestsResult(val *UnlockRequestsResult) *NullableUnlockRequestsResult {
	return &NullableUnlockRequestsResult{value: val, isSet: true}
}

func (v NullableUnlockRequestsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlockRequestsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
