...
// checks if the ActorTaskWebhooksGet200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskWebhooksGet200ResponseData{}

// ActorTaskWebhooksGet200ResponseData struct for ActorTaskWebhooksGet200ResponseData
type ActorTaskWebhooksGet200ResponseData struct {
...
type _ActorTaskWebhooksGet200ResponseData ActorTaskWebhooksGet200ResponseData

// NewActorTaskWebhooksGet200ResponseData instantiates a new ActorTaskWebhooksGet200ResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskWebhooksGet200ResponseData(total int32, offset int32, limit int32, desc bool, count int32, items []Webhook) *ActorTaskWebhooksGet200ResponseData {
...
// NewActorTaskWebhooksGet200ResponseDataWithDefaults instantiates a new ActorTaskWebhooksGet200ResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskWebhooksGet200ResponseDataWithDefaults() *ActorTaskWebhooksGet200ResponseData {
	this := ActorTaskWebhooksGet200ResponseData{}
	return &this
}

// GetTotal returns the Total field value
func (o *ActorTaskWebhooksGet200ResponseData) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ActorTaskWebhooksGet200ResponseData) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ActorTaskWebhooksGet200ResponseData) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ActorTaskWebhooksGet200ResponseData) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskWebhooksGet200ResponseData) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ActorTaskWebhooksGet200ResponseData) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ActorTaskWebhooksGet200ResponseData) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskWebhooksGet200ResponseData) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ActorTaskWebhooksGet200ResponseData) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ActorTaskWebhooksGet200ResponseData) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskWebhooksGet200ResponseData) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ActorTaskWebhooksGet200ResponseData) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ActorTaskWebhooksGet200ResponseData) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskWebhooksGet200ResponseData) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ActorTaskWebhooksGet200ResponseData) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ActorTaskWebhooksGet200ResponseData) GetItems() []Webhook {
	if o == nil {
		var ret []Webhook
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskWebhooksGet200ResponseData) GetItemsOk() ([]Webhook, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ActorTaskWebhooksGet200ResponseData) SetItems(v []Webhook) {
	o.Items = v
}

func (o ActorTaskWebhooksGet200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskWebhooksGet200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *ActorTaskWebhooksGet200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskWebhooksGet200ResponseData := _ActorTaskWebhooksGet200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskWebhooksGet200ResponseData)

	if err != nil {
		return err
	}

	*o = ActorTaskWebhooksGet200ResponseData(varActorTaskWebhooksGet200ResponseData)

	return err
}

type NullableActorTaskWebhooksGet200ResponseData struct {
	value *ActorTaskWebhooksGet200ResponseData
	isSet bool
}

func (v NullableActorTaskWebhooksGet200ResponseData) Get() *ActorTaskWebhooksGet200ResponseData {
	return v.value
}

func (v *NullableActorTaskWebhooksGet200ResponseData) Set(val *ActorTaskWebhooksGet200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskWebhooksGet200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskWebhooksGet200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskWebhooksGet200ResponseData(val *ActorTaskWebhooksGet200ResponseData) *NullableActorTaskWebhooksGet200ResponseData {
	return &NullableActorTaskWebhooksGet200ResponseData{value: val, isSet: true}
}

func (v NullableActorTaskWebhooksGet200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskWebhooksGet200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
