...
// checks if the ListOfTasksResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfTasksResponse{}

// ListOfTasksResponse struct for ListOfTasksResponse
type ListOfTasksResponse struct {
	Data ListOfTasks `json:"data"`
}

type _ListOfTasksResponse ListOfTasksResponse

// NewListOfTasksResponse instantiates a new ListOfTasksResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfTasksResponse(data ListOfTasks) *ListOfTasksResponse {
	this := ListOfTasksResponse{}
	this.Data = data
	return &this
}

// NewListOfTasksResponseWithDefaults instantiates a new ListOfTasksResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfTasksResponseWithDefaults() *ListOfTasksResponse {
	this := ListOfTasksResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfTasksResponse) GetData() ListOfTasks {
	if o == nil {
		var ret ListOfTasks
		return ret
	}
...
func (o *ListOfTasksResponse) GetDataOk() (*ListOfTasks, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfTasksResponse) SetData(v ListOfTasks) {
	o.Data = v
}

func (o ListOfTasksResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfTasksResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfTasksResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfTasksResponse := _ListOfTasksResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfTasksResponse)

	if err != nil {
		return err
	}

	*o = ListOfTasksResponse(varListOfTasksResponse)

	return err
}

type NullableListOfTasksResponse struct {
	value *ListOfTasksResponse
	isSet bool
}

func (v NullableListOfTasksResponse) Get() *ListOfTasksResponse {
	return v.value
}

func (v *NullableListOfTasksResponse) Set(val *ListOfTasksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfTasksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfTasksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfTasksResponse(val *ListOfTasksResponse) *NullableListOfTasksResponse {
	return &NullableListOfTasksResponse{value: val, isSet: true}
}

func (v NullableListOfTasksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfTasksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
