...
// checks if the ProlongRequestLockResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProlongRequestLockResponse{}
...
type ProlongRequestLockResponse struct {
	Data RequestLockInfo `json:"data"`
}

type _ProlongRequestLockResponse ProlongRequestLockResponse

// NewProlongRequestLockResponse instantiates a new ProlongRequestLockResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewProlongRequestLockResponse(data RequestLockInfo) *ProlongRequestLockResponse {
	this := ProlongRequestLockResponse{}
	this.Data = data
	return &this
}

// NewProlongRequestLockResponseWithDefaults instantiates a new ProlongRequestLockResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProlongRequestLockResponseWithDefaults() *ProlongRequestLockResponse {
	this := ProlongRequestLockResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ProlongRequestLockResponse) GetData() RequestLockInfo {
	if o == nil {
		var ret RequestLockInfo
		return ret
	}
...
func (o *ProlongRequestLockResponse) GetDataOk() (*RequestLockInfo, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ProlongRequestLockResponse) SetData(v RequestLockInfo) {
	o.Data = v
}

func (o ProlongRequestLockResponse) MarshalJSON() ([]byte, error) {
...
func (o ProlongRequestLockResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ProlongRequestLockResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varProlongRequestLockResponse := _ProlongRequestLockResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProlongRequestLockResponse)

	if err != nil {
		return err
	}

	*o = ProlongRequestLockResponse(varProlongRequestLockResponse)

	return err
}

type NullableProlongRequestLockResponse struct {
	value *ProlongRequestLockResponse
	isSet bool
}

func (v NullableProlongRequestLockResponse) Get() *ProlongRequestLockResponse {
	return v.value
}

func (v *NullableProlongRequestLockResponse) Set(val *ProlongRequestLockResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProlongRequestLockResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProlongRequestLockResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProlongRequestLockResponse(val *ProlongRequestLockResponse) *NullableProlongRequestLockResponse {
	return &NullableProlongRequestLockResponse{value: val, isSet: true}
}

func (v NullableProlongRequestLockResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProlongRequestLockResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
