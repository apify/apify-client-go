...
// checks if the MonthlyUsageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonthlyUsageResponse{}

// MonthlyUsageResponse struct for MonthlyUsageResponse
type MonthlyUsageResponse struct {
	Data MonthlyUsage `json:"data"`
}

type _MonthlyUsageResponse MonthlyUsageResponse

// NewMonthlyUsageResponse instantiates a new MonthlyUsageResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMonthlyUsageResponse(data MonthlyUsage) *MonthlyUsageResponse {
	this := MonthlyUsageResponse{}
	this.Data = data
	return &this
}

// NewMonthlyUsageResponseWithDefaults instantiates a new MonthlyUsageResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMonthlyUsageResponseWithDefaults() *MonthlyUsageResponse {
	this := MonthlyUsageResponse{}
	return &this
}

// GetData returns the Data field value
func (o *MonthlyUsageResponse) GetData() MonthlyUsage {
	if o == nil {
		var ret MonthlyUsage
		return ret
	}
...
func (o *MonthlyUsageResponse) GetDataOk() (*MonthlyUsage, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *MonthlyUsageResponse) SetData(v MonthlyUsage) {
	o.Data = v
}

func (o MonthlyUsageResponse) MarshalJSON() ([]byte, error) {
...
func (o MonthlyUsageResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *MonthlyUsageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMonthlyUsageResponse := _MonthlyUsageResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonthlyUsageResponse)

	if err != nil {
		return err
	}

	*o = MonthlyUsageResponse(varMonthlyUsageResponse)

	return err
}

type NullableMonthlyUsageResponse struct {
	value *MonthlyUsageResponse
	isSet bool
}

func (v NullableMonthlyUsageResponse) Get() *MonthlyUsageResponse {
	return v.value
}

func (v *NullableMonthlyUsageResponse) Set(val *MonthlyUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMonthlyUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMonthlyUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonthlyUsageResponse(val *MonthlyUsageResponse) *NullableMonthlyUsageResponse {
	return &NullableMonthlyUsageResponse{value: val, isSet: true}
}

func (v NullableMonthlyUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonthlyUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
