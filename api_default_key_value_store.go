...
// DefaultKeyValueStoreAPIService DefaultKeyValueStoreAPI service
type DefaultKeyValueStoreAPIService service

type ApiActorRunKeyValueStoreDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
}

func (r ApiActorRunKeyValueStoreDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreDeleteExecute(r)
}

/*
ActorRunKeyValueStoreDelete Delete default store
...
[Delete store](/api/v2/key-value-store-delete) endpoint.
 ...
 @return ApiActorRunKeyValueStoreDeleteRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreDelete(ctx context.Context, runId string) ApiActorRunKeyValueStoreDeleteRequest {
	return ApiActorRunKeyValueStoreDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreDeleteExecute(r ApiActorRunKeyValueStoreDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/key-value-store"
...
type ApiActorRunKeyValueStoreGetRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
}

func (r ApiActorRunKeyValueStoreGetRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreGetExecute(r)
}

/*
ActorRunKeyValueStoreGet Get default store
...
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreGetExecute(r ApiActorRunKeyValueStoreGetRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreGet")
	if err != nil {
...
type ApiActorRunKeyValueStoreKeysGetRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
...
func (r ApiActorRunKeyValueStoreKeysGetRequest) ExclusiveStartKey(exclusiveStartKey string) ApiActorRunKeyValueStoreKeysGetRequest {
	r.exclusiveStartKey = &exclusiveStartKey
	return r
}

// Number of keys to be returned.
func (r ApiActorRunKeyValueStoreKeysGetRequest) Limit(limit float32) ApiActorRunKeyValueStoreKeysGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorRunKeyValueStoreKeysGetRequest) Collection(collection string) ApiActorRunKeyValueStoreKeysGetRequest {
	r.collection = &collection
	return r
}

// Limit the results to keys that start with a specific prefix.
func (r ApiActorRunKeyValueStoreKeysGetRequest) Prefix(prefix string) ApiActorRunKeyValueStoreKeysGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActorRunKeyValueStoreKeysGetRequest) Signature(signature string) ApiActorRunKeyValueStoreKeysGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActorRunKeyValueStoreKeysGetRequest) Execute() (*ListOfKeysResponse, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreKeysGetExecute(r)
}

/*
ActorRunKeyValueStoreKeysGet Get default store's list of keys
...
[Get list of keys](/api/v2/key-value-store-keys-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunKeyValueStoreKeysGetRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreKeysGet(ctx context.Context, runId string) ApiActorRunKeyValueStoreKeysGetRequest {
	return ApiActorRunKeyValueStoreKeysGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreKeysGetExecute(r ApiActorRunKeyValueStoreKeysGetRequest) (*ListOfKeysResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreKeysGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/key-value-store/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunKeyValueStorePutRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
...
// 
func (r ApiActorRunKeyValueStorePutRequest) UpdateStoreRequest(updateStoreRequest UpdateStoreRequest) ApiActorRunKeyValueStorePutRequest {
	r.updateStoreRequest = &updateStoreRequest
	return r
}

func (r ApiActorRunKeyValueStorePutRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStorePutExecute(r)
}

/*
ActorRunKeyValueStorePut Update default store
...
[Update store](/api/v2/key-value-store-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunKeyValueStorePutRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStorePut(ctx context.Context, runId string) ApiActorRunKeyValueStorePutRequest {
	return ApiActorRunKeyValueStorePutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return KeyValueStoreResponse
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStorePutExecute(r ApiActorRunKeyValueStorePutRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStorePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunKeyValueStoreRecordDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
	recordKey string
...
func (r ApiActorRunKeyValueStoreRecordDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreRecordDeleteExecute(r)
}

/*
ActorRunKeyValueStoreRecordDelete Delete default store's record
...
[Delete record](/api/v2/key-value-store-record-delete) endpoint.
 ...
 @return ApiActorRunKeyValueStoreRecordDeleteRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordDelete(ctx context.Context, runId string, recordKey string) ApiActorRunKeyValueStoreRecordDeleteRequest {
	return ApiActorRunKeyValueStoreRecordDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordDeleteExecute(r ApiActorRunKeyValueStoreRecordDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreRecordDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/key-value-store/records/{recordKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunKeyValueStoreRecordGetRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
	recordKey string
...
// Signature used for the access.
func (r ApiActorRunKeyValueStoreRecordGetRequest) Signature(signature string) ApiActorRunKeyValueStoreRecordGetRequest {
	r.signature = &signature
	return r
}
...
func (r ApiActorRunKeyValueStoreRecordGetRequest) Attachment(attachment bool) ApiActorRunKeyValueStoreRecordGetRequest {
	r.attachment = &attachment
	return r
}

func (r ApiActorRunKeyValueStoreRecordGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreRecordGetExecute(r)
}

/*
ActorRunKeyValueStoreRecordGet Get default store's record
...
[Get record](/api/v2/key-value-store-record-get) endpoint.
 ...
 @param runId Actor run ID.
 @param recordKey Key of the record.
 @return ApiActorRunKeyValueStoreRecordGetRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordGet(ctx context.Context, runId string, recordKey string) ApiActorRunKeyValueStoreRecordGetRequest {
	return ApiActorRunKeyValueStoreRecordGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordGetExecute(r ApiActorRunKeyValueStoreRecordGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreRecordGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunKeyValueStoreRecordPostRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
	recordKey string
...
// 
func (r ApiActorRunKeyValueStoreRecordPostRequest) RequestBody(requestBody map[string]interface{}) ApiActorRunKeyValueStoreRecordPostRequest {
	r.requestBody = &requestBody
	return r
}

// 
func (r ApiActorRunKeyValueStoreRecordPostRequest) ContentEncoding(contentEncoding string) ApiActorRunKeyValueStoreRecordPostRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActorRunKeyValueStoreRecordPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreRecordPostExecute(r)
}

/*
ActorRunKeyValueStoreRecordPost Store record in default store (POST)
...
[Store record](/api/v2/key-value-store-record-post) endpoint.
 ...
 @param runId Actor run ID.
 @param recordKey Key of the record.
 @return ApiActorRunKeyValueStoreRecordPostRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordPost(ctx context.Context, runId string, recordKey string) ApiActorRunKeyValueStoreRecordPostRequest {
	return ApiActorRunKeyValueStoreRecordPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordPostExecute(r ApiActorRunKeyValueStoreRecordPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreRecordPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunKeyValueStoreRecordPutRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
	recordKey string
...
// 
func (r ApiActorRunKeyValueStoreRecordPutRequest) RequestBody(requestBody map[string]interface{}) ApiActorRunKeyValueStoreRecordPutRequest {
	r.requestBody = &requestBody
	return r
}

// 
func (r ApiActorRunKeyValueStoreRecordPutRequest) ContentEncoding(contentEncoding string) ApiActorRunKeyValueStoreRecordPutRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActorRunKeyValueStoreRecordPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreRecordPutExecute(r)
}

/*
ActorRunKeyValueStoreRecordPut Store record in default store
...
[Store record](/api/v2/key-value-store-record-put) endpoint.
 ...
 @param runId Actor run ID.
 @param recordKey Key of the record.
 @return ApiActorRunKeyValueStoreRecordPutRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordPut(ctx context.Context, runId string, recordKey string) ApiActorRunKeyValueStoreRecordPutRequest {
	return ApiActorRunKeyValueStoreRecordPutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordPutExecute(r ApiActorRunKeyValueStoreRecordPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreRecordPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunKeyValueStoreRecordsGetRequest struct {
	ctx context.Context
	ApiService *DefaultKeyValueStoreAPIService
	runId string
	collection *string
...
func (r ApiActorRunKeyValueStoreRecordsGetRequest) Collection(collection string) ApiActorRunKeyValueStoreRecordsGetRequest {
	r.collection = &collection
	return r
}

// If specified, only records whose key starts with the given prefix are included in the archive. 
func (r ApiActorRunKeyValueStoreRecordsGetRequest) Prefix(prefix string) ApiActorRunKeyValueStoreRecordsGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActorRunKeyValueStoreRecordsGetRequest) Signature(signature string) ApiActorRunKeyValueStoreRecordsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActorRunKeyValueStoreRecordsGetRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.ActorRunKeyValueStoreRecordsGetExecute(r)
}

/*
ActorRunKeyValueStoreRecordsGet Download default store's records
...
[Download records](/api/v2/key-value-store-records-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunKeyValueStoreRecordsGetRequest
*/
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordsGet(ctx context.Context, runId string) ApiActorRunKeyValueStoreRecordsGetRequest {
	return ApiActorRunKeyValueStoreRecordsGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return *os.File
func (a *DefaultKeyValueStoreAPIService) ActorRunKeyValueStoreRecordsGetExecute(r ApiActorRunKeyValueStoreRecordsGetRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultKeyValueStoreAPIService.ActorRunKeyValueStoreRecordsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/key-value-store/records"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
