...
// checks if the SourceCodeFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceCodeFolder{}
...
type _SourceCodeFolder SourceCodeFolder
...
func (o SourceCodeFolder) MarshalJSON() ([]byte, error) {
...
func (o SourceCodeFolder) ToMap() (map[string]interface{}, error) {
...
func (o *SourceCodeFolder) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceCodeFolder := _SourceCodeFolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSourceCodeFolder)

	if err != nil {
		return err
	}

	*o = SourceCodeFolder(varSourceCodeFolder)

	return err
}

type NullableSourceCodeFolder struct {
	value *SourceCodeFolder
	isSet bool
}

func (v NullableSourceCodeFolder) Get() *SourceCodeFolder {
	return v.value
}

func (v *NullableSourceCodeFolder) Set(val *SourceCodeFolder) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceCodeFolder) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceCodeFolder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceCodeFolder(val *SourceCodeFolder) *NullableSourceCodeFolder {
	return &NullableSourceCodeFolder{value: val, isSet: true}
}

func (v NullableSourceCodeFolder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceCodeFolder) UnmarshalJSON(src []byte) error {
	v.isSet = true
