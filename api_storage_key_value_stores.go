...
// StorageKeyValueStoresAPIService StorageKeyValueStoresAPI service
type StorageKeyValueStoresAPIService service

type ApiKeyValueStoreDeleteRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
}

func (r ApiKeyValueStoreDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.KeyValueStoreDeleteExecute(r)
}

/*
KeyValueStoreDelete Delete store

Deletes a key-value store.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param storeId Key-value store ID or `username~store-name`.
 @return ApiKeyValueStoreDeleteRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreDelete(ctx context.Context, storeId string) ApiKeyValueStoreDeleteRequest {
	return ApiKeyValueStoreDeleteRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
func (a *StorageKeyValueStoresAPIService) KeyValueStoreDeleteExecute(r ApiKeyValueStoreDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/key-value-stores/{storeId}"
...
type ApiKeyValueStoreGetRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
}

func (r ApiKeyValueStoreGetRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.KeyValueStoreGetExecute(r)
}

/*
KeyValueStoreGet Get store
...
store.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param storeId Key-value store ID or `username~store-name`.
 @return ApiKeyValueStoreGetRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreGet(ctx context.Context, storeId string) ApiKeyValueStoreGetRequest {
	return ApiKeyValueStoreGetRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
func (a *StorageKeyValueStoresAPIService) KeyValueStoreGetExecute(r ApiKeyValueStoreGetRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreGet")
	if err != nil {
...
type ApiKeyValueStoreKeysGetRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
...
func (r ApiKeyValueStoreKeysGetRequest) ExclusiveStartKey(exclusiveStartKey string) ApiKeyValueStoreKeysGetRequest {
	r.exclusiveStartKey = &exclusiveStartKey
	return r
}

// Number of keys to be returned.
func (r ApiKeyValueStoreKeysGetRequest) Limit(limit float32) ApiKeyValueStoreKeysGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiKeyValueStoreKeysGetRequest) Collection(collection string) ApiKeyValueStoreKeysGetRequest {
	r.collection = &collection
	return r
}

// Limit the results to keys that start with a specific prefix.
func (r ApiKeyValueStoreKeysGetRequest) Prefix(prefix string) ApiKeyValueStoreKeysGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiKeyValueStoreKeysGetRequest) Signature(signature string) ApiKeyValueStoreKeysGetRequest {
	r.signature = &signature
	return r
}

func (r ApiKeyValueStoreKeysGetRequest) Execute() (*ListOfKeysResponse, *http.Response, error) {
	return r.ApiService.KeyValueStoreKeysGetExecute(r)
}

/*
KeyValueStoreKeysGet Get list of keys
...
- see [Pagination](/api/v2#using-key) for more details.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param storeId Key-value store ID or `username~store-name`.
 @return ApiKeyValueStoreKeysGetRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreKeysGet(ctx context.Context, storeId string) ApiKeyValueStoreKeysGetRequest {
	return ApiKeyValueStoreKeysGetRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
func (a *StorageKeyValueStoresAPIService) KeyValueStoreKeysGetExecute(r ApiKeyValueStoreKeysGetRequest) (*ListOfKeysResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreKeysGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/key-value-stores/{storeId}/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"storeId"+"}", url.PathEscape(parameterValueToString(r.storeId, "storeId")), -1)
...
type ApiKeyValueStorePutRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
...
// 
func (r ApiKeyValueStorePutRequest) UpdateStoreRequest(updateStoreRequest UpdateStoreRequest) ApiKeyValueStorePutRequest {
	r.updateStoreRequest = &updateStoreRequest
	return r
}

func (r ApiKeyValueStorePutRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.KeyValueStorePutExecute(r)
}

/*
KeyValueStorePut Update store
...
store](#/reference/key-value-stores/store-object/get-store) API endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param storeId Key-value store ID or `username~store-name`.
 @return ApiKeyValueStorePutRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStorePut(ctx context.Context, storeId string) ApiKeyValueStorePutRequest {
	return ApiKeyValueStorePutRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
//  @return KeyValueStoreResponse
func (a *StorageKeyValueStoresAPIService) KeyValueStorePutExecute(r ApiKeyValueStorePutRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStorePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKeyValueStoreRecordDeleteRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	recordKey string
...
func (r ApiKeyValueStoreRecordDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.KeyValueStoreRecordDeleteExecute(r)
}

/*
KeyValueStoreRecordDelete Delete record
...
Removes a record specified by a key from the key-value store.
 ...
 @return ApiKeyValueStoreRecordDeleteRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordDelete(ctx context.Context, storeId string, recordKey string) ApiKeyValueStoreRecordDeleteRequest {
	return ApiKeyValueStoreRecordDeleteRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordDeleteExecute(r ApiKeyValueStoreRecordDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/key-value-stores/{storeId}/records/{recordKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"storeId"+"}", url.PathEscape(parameterValueToString(r.storeId, "storeId")), -1)
...
type ApiKeyValueStoreRecordGetRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	recordKey string
...
func (r ApiKeyValueStoreRecordGetRequest) Attachment(attachment bool) ApiKeyValueStoreRecordGetRequest {
	r.attachment = &attachment
	return r
}

// Signature used for the access.
func (r ApiKeyValueStoreRecordGetRequest) Signature(signature string) ApiKeyValueStoreRecordGetRequest {
	r.signature = &signature
	return r
}

func (r ApiKeyValueStoreRecordGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.KeyValueStoreRecordGetExecute(r)
}

/*
KeyValueStoreRecordGet Get record
...
content without any modifications, use the `attachment` query parameter.
 ...
 @param storeId Key-value store ID or `username~store-name`.
 @param recordKey Key of the record.
 @return ApiKeyValueStoreRecordGetRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordGet(ctx context.Context, storeId string, recordKey string) ApiKeyValueStoreRecordGetRequest {
	return ApiKeyValueStoreRecordGetRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordGetExecute(r ApiKeyValueStoreRecordGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKeyValueStoreRecordHeadRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	recordKey string
...
func (r ApiKeyValueStoreRecordHeadRequest) Execute() (*http.Response, error) {
	return r.ApiService.KeyValueStoreRecordHeadExecute(r)
}

/*
KeyValueStoreRecordHead Check if a record exists
...
Check if a value is stored in the key-value store under a specific key.
 ...
 @param storeId Key-value store ID or `username~store-name`.
 @param recordKey Key of the record.
 @return ApiKeyValueStoreRecordHeadRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordHead(ctx context.Context, storeId string, recordKey string) ApiKeyValueStoreRecordHeadRequest {
	return ApiKeyValueStoreRecordHeadRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordHeadExecute(r ApiKeyValueStoreRecordHeadRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordHead")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKeyValueStoreRecordPostRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	recordKey string
...
// 
func (r ApiKeyValueStoreRecordPostRequest) ContentEncoding(contentEncoding string) ApiKeyValueStoreRecordPostRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiKeyValueStoreRecordPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.KeyValueStoreRecordPostExecute(r)
}

/*
KeyValueStoreRecordPost Store record (POST)
...
This endpoint is an alias for the [`PUT` record](#tag/Key-value-storesRecord/operation/keyValueStore_record_put) method and behaves identically.
 ...
 @param storeId Key-value store ID or `username~store-name`.
 @param recordKey Key of the record.
 @return ApiKeyValueStoreRecordPostRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordPost(ctx context.Context, storeId string, recordKey string) ApiKeyValueStoreRecordPostRequest {
	return ApiKeyValueStoreRecordPostRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordPostExecute(r ApiKeyValueStoreRecordPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKeyValueStoreRecordPutRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	recordKey string
...
// 
func (r ApiKeyValueStoreRecordPutRequest) ContentEncoding(contentEncoding string) ApiKeyValueStoreRecordPutRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiKeyValueStoreRecordPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.KeyValueStoreRecordPutExecute(r)
}

/*
KeyValueStoreRecordPut Store record
...
* Brotli compression: `Content-Encoding: br`
 ...
 @param storeId Key-value store ID or `username~store-name`.
 @param recordKey Key of the record.
 @return ApiKeyValueStoreRecordPutRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordPut(ctx context.Context, storeId string, recordKey string) ApiKeyValueStoreRecordPutRequest {
	return ApiKeyValueStoreRecordPutRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordPutExecute(r ApiKeyValueStoreRecordPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiKeyValueStoreRecordsGetRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	storeId string
	collection *string
...
func (r ApiKeyValueStoreRecordsGetRequest) Collection(collection string) ApiKeyValueStoreRecordsGetRequest {
	r.collection = &collection
	return r
}

// If specified, only records whose key starts with the given prefix are included in the archive. 
func (r ApiKeyValueStoreRecordsGetRequest) Prefix(prefix string) ApiKeyValueStoreRecordsGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiKeyValueStoreRecordsGetRequest) Signature(signature string) ApiKeyValueStoreRecordsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiKeyValueStoreRecordsGetRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.KeyValueStoreRecordsGetExecute(r)
}

/*
KeyValueStoreRecordsGet Download records
...
You can optionally filter the records by `collection` or `prefix` to download only a subset of the store.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param storeId Key-value store ID or `username~store-name`.
 @return ApiKeyValueStoreRecordsGetRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordsGet(ctx context.Context, storeId string) ApiKeyValueStoreRecordsGetRequest {
	return ApiKeyValueStoreRecordsGetRequest{
		ApiService: a,
		ctx: ctx,
		storeId: storeId,
...
// Execute executes the request
//  @return *os.File
func (a *StorageKeyValueStoresAPIService) KeyValueStoreRecordsGetExecute(r ApiKeyValueStoreRecordsGetRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoreRecordsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/key-value-stores/{storeId}/records"
	localVarPath = strings.Replace(localVarPath, "{"+"storeId"+"}", url.PathEscape(parameterValueToString(r.storeId, "storeId")), -1)
...
type ApiKeyValueStoresGetRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	offset *float64
	limit *float64
...
func (r ApiKeyValueStoresGetRequest) Offset(offset float64) ApiKeyValueStoresGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiKeyValueStoresGetRequest) Limit(limit float64) ApiKeyValueStoresGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiKeyValueStoresGetRequest) Desc(desc bool) ApiKeyValueStoresGetRequest {
	r.desc = &desc
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then all the storages are returned. By default, only named storages are returned. 
func (r ApiKeyValueStoresGetRequest) Unnamed(unnamed bool) ApiKeyValueStoresGetRequest {
	r.unnamed = &unnamed
	return r
}

// Filter by ownership. If this parameter is omitted, all accessible key-value stores are returned.  - &#x60;ownedByMe&#x60;: Return only key-value stores owned by the user. - &#x60;sharedWithMe&#x60;: Return only key-value stores shared with the user by other users. 
func (r ApiKeyValueStoresGetRequest) Ownership(ownership StorageOwnership) ApiKeyValueStoresGetRequest {
	r.ownership = &ownership
	return r
}

func (r ApiKeyValueStoresGetRequest) Execute() (*ListOfKeyValueStoresResponse, *http.Response, error) {
	return r.ApiService.KeyValueStoresGetExecute(r)
}

/*
KeyValueStoresGet Get list of key-value stores
...
the `desc=1` parameter.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiKeyValueStoresGetRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoresGet(ctx context.Context) ApiKeyValueStoresGetRequest {
	return ApiKeyValueStoresGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *StorageKeyValueStoresAPIService) KeyValueStoresGetExecute(r ApiKeyValueStoresGetRequest) (*ListOfKeyValueStoresResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfKeyValueStoresResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoresGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/key-value-stores"
...
type ApiKeyValueStoresPostRequest struct {
	ctx context.Context
	ApiService *StorageKeyValueStoresAPIService
	name *string
}
...
func (r ApiKeyValueStoresPostRequest) Name(name string) ApiKeyValueStoresPostRequest {
	r.name = &name
	return r
}

func (r ApiKeyValueStoresPostRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.KeyValueStoresPostExecute(r)
}

/*
KeyValueStoresPost Create key-value store
...
new one and returns the existing object instead.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiKeyValueStoresPostRequest
*/
func (a *StorageKeyValueStoresAPIService) KeyValueStoresPost(ctx context.Context) ApiKeyValueStoresPostRequest {
	return ApiKeyValueStoresPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return KeyValueStoreResponse
func (a *StorageKeyValueStoresAPIService) KeyValueStoresPostExecute(r ApiKeyValueStoresPostRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageKeyValueStoresAPIService.KeyValueStoresPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
