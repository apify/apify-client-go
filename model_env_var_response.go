...
// checks if the EnvVarResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvVarResponse{}

// EnvVarResponse struct for EnvVarResponse
type EnvVarResponse struct {
	Data EnvVar `json:"data"`
}

type _EnvVarResponse EnvVarResponse

// NewEnvVarResponse instantiates a new EnvVarResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEnvVarResponse(data EnvVar) *EnvVarResponse {
	this := EnvVarResponse{}
	this.Data = data
	return &this
}

// NewEnvVarResponseWithDefaults instantiates a new EnvVarResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEnvVarResponseWithDefaults() *EnvVarResponse {
	this := EnvVarResponse{}
	return &this
}

// GetData returns the Data field value
func (o *EnvVarResponse) GetData() EnvVar {
	if o == nil {
		var ret EnvVar
		return ret
	}
...
func (o *EnvVarResponse) GetDataOk() (*EnvVar, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *EnvVarResponse) SetData(v EnvVar) {
	o.Data = v
}

func (o EnvVarResponse) MarshalJSON() ([]byte, error) {
...
func (o EnvVarResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *EnvVarResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvVarResponse := _EnvVarResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEnvVarResponse)

	if err != nil {
		return err
	}

	*o = EnvVarResponse(varEnvVarResponse)

	return err
}

type NullableEnvVarResponse struct {
	value *EnvVarResponse
	isSet bool
}

func (v NullableEnvVarResponse) Get() *EnvVarResponse {
	return v.value
}

func (v *NullableEnvVarResponse) Set(val *EnvVarResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvVarResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvVarResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvVarResponse(val *EnvVarResponse) *NullableEnvVarResponse {
	return &NullableEnvVarResponse{value: val, isSet: true}
}

func (v NullableEnvVarResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvVarResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
