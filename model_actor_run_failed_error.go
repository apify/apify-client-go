...
// checks if the ActorRunFailedError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorRunFailedError{}

// ActorRunFailedError struct for ActorRunFailedError
type ActorRunFailedError struct {
	Error *RunFailedErrorDetail `json:"error,omitempty"`
}
...
// SetError gets a reference to the given RunFailedErrorDetail and assigns it to the Error field.
func (o *ActorRunFailedError) SetError(v RunFailedErrorDetail) {
	o.Error = &v
}

func (o ActorRunFailedError) MarshalJSON() ([]byte, error) {
...
func (o ActorRunFailedError) ToMap() (map[string]interface{}, error) {
...
type NullableActorRunFailedError struct {
	value *ActorRunFailedError
	isSet bool
}

func (v NullableActorRunFailedError) Get() *ActorRunFailedError {
	return v.value
}

func (v *NullableActorRunFailedError) Set(val *ActorRunFailedError) {
	v.value = val
	v.isSet = true
}

func (v NullableActorRunFailedError) IsSet() bool {
	return v.isSet
}

func (v *NullableActorRunFailedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorRunFailedError(val *ActorRunFailedError) *NullableActorRunFailedError {
	return &NullableActorRunFailedError{value: val, isSet: true}
}

func (v NullableActorRunFailedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorRunFailedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
