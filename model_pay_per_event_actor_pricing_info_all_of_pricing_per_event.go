...
// checks if the PayPerEventActorPricingInfoAllOfPricingPerEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayPerEventActorPricingInfoAllOfPricingPerEvent{}

// PayPerEventActorPricingInfoAllOfPricingPerEvent struct for PayPerEventActorPricingInfoAllOfPricingPerEvent
type PayPerEventActorPricingInfoAllOfPricingPerEvent struct {
	ActorChargeEvents map[string]ActorChargeEvent `json:"actorChargeEvents,omitempty"`
}

// NewPayPerEventActorPricingInfoAllOfPricingPerEvent instantiates a new PayPerEventActorPricingInfoAllOfPricingPerEvent object
...
func NewPayPerEventActorPricingInfoAllOfPricingPerEvent() *PayPerEventActorPricingInfoAllOfPricingPerEvent {
	this := PayPerEventActorPricingInfoAllOfPricingPerEvent{}
	return &this
}

// NewPayPerEventActorPricingInfoAllOfPricingPerEventWithDefaults instantiates a new PayPerEventActorPricingInfoAllOfPricingPerEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPayPerEventActorPricingInfoAllOfPricingPerEventWithDefaults() *PayPerEventActorPricingInfoAllOfPricingPerEvent {
	this := PayPerEventActorPricingInfoAllOfPricingPerEvent{}
	return &this
}

// GetActorChargeEvents returns the ActorChargeEvents field value if set, zero value otherwise.
func (o *PayPerEventActorPricingInfoAllOfPricingPerEvent) GetActorChargeEvents() map[string]ActorChargeEvent {
	if o == nil || IsNil(o.ActorChargeEvents) {
		var ret map[string]ActorChargeEvent
		return ret
	}
	return o.ActorChargeEvents
}

// GetActorChargeEventsOk returns a tuple with the ActorChargeEvents field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PayPerEventActorPricingInfoAllOfPricingPerEvent) GetActorChargeEventsOk() (map[string]ActorChargeEvent, bool) {
	if o == nil || IsNil(o.ActorChargeEvents) {
		return map[string]ActorChargeEvent{}, false
	}
	return o.ActorChargeEvents, true
}

// HasActorChargeEvents returns a boolean if a field has been set.
func (o *PayPerEventActorPricingInfoAllOfPricingPerEvent) HasActorChargeEvents() bool {
	if o != nil && !IsNil(o.ActorChargeEvents) {
		return true
	}
...
// SetActorChargeEvents gets a reference to the given map[string]ActorChargeEvent and assigns it to the ActorChargeEvents field.
func (o *PayPerEventActorPricingInfoAllOfPricingPerEvent) SetActorChargeEvents(v map[string]ActorChargeEvent) {
	o.ActorChargeEvents = v
}

func (o PayPerEventActorPricingInfoAllOfPricingPerEvent) MarshalJSON() ([]byte, error) {
...
func (o PayPerEventActorPricingInfoAllOfPricingPerEvent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ActorChargeEvents) {
		toSerialize["actorChargeEvents"] = o.ActorChargeEvents
	}
	return toSerialize, nil
}

type NullablePayPerEventActorPricingInfoAllOfPricingPerEvent struct {
	value *PayPerEventActorPricingInfoAllOfPricingPerEvent
	isSet bool
}

func (v NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) Get() *PayPerEventActorPricingInfoAllOfPricingPerEvent {
	return v.value
}

func (v *NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) Set(val *PayPerEventActorPricingInfoAllOfPricingPerEvent) {
	v.value = val
	v.isSet = true
}

func (v NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) IsSet() bool {
	return v.isSet
}

func (v *NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayPerEventActorPricingInfoAllOfPricingPerEvent(val *PayPerEventActorPricingInfoAllOfPricingPerEvent) *NullablePayPerEventActorPricingInfoAllOfPricingPerEvent {
	return &NullablePayPerEventActorPricingInfoAllOfPricingPerEvent{value: val, isSet: true}
}

func (v NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayPerEventActorPricingInfoAllOfPricingPerEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
