...
// checks if the ListOfKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfKeys{}

// ListOfKeys struct for ListOfKeys
type ListOfKeys struct {
	// 
	Items []KeyValueStoreKey `json:"items"`
	Count int32 `json:"count"`
	Limit int32 `json:"limit"`
	ExclusiveStartKey NullableString `json:"exclusiveStartKey,omitempty"`
	IsTruncated bool `json:"isTruncated"`
	NextExclusiveStartKey NullableString `json:"nextExclusiveStartKey,omitempty"`
}

type _ListOfKeys ListOfKeys
...
// GetExclusiveStartKey returns the ExclusiveStartKey field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListOfKeys) GetExclusiveStartKey() string {
	if o == nil || IsNil(o.ExclusiveStartKey.Get()) {
		var ret string
		return ret
	}
	return *o.ExclusiveStartKey.Get()
}

// GetExclusiveStartKeyOk returns a tuple with the ExclusiveStartKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetExclusiveStartKey gets a reference to the given NullableString and assigns it to the ExclusiveStartKey field.
func (o *ListOfKeys) SetExclusiveStartKey(v string) {
	o.ExclusiveStartKey.Set(&v)
}
// SetExclusiveStartKeyNil sets the value for ExclusiveStartKey to be an explicit nil
func (o *ListOfKeys) SetExclusiveStartKeyNil() {
	o.ExclusiveStartKey.Set(nil)
}
...
// GetNextExclusiveStartKey returns the NextExclusiveStartKey field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListOfKeys) GetNextExclusiveStartKey() string {
	if o == nil || IsNil(o.NextExclusiveStartKey.Get()) {
		var ret string
		return ret
	}
	return *o.NextExclusiveStartKey.Get()
}

// GetNextExclusiveStartKeyOk returns a tuple with the NextExclusiveStartKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetNextExclusiveStartKey gets a reference to the given NullableString and assigns it to the NextExclusiveStartKey field.
func (o *ListOfKeys) SetNextExclusiveStartKey(v string) {
	o.NextExclusiveStartKey.Set(&v)
}
// SetNextExclusiveStartKeyNil sets the value for NextExclusiveStartKey to be an explicit nil
func (o *ListOfKeys) SetNextExclusiveStartKeyNil() {
	o.NextExclusiveStartKey.Set(nil)
}
...
func (o *ListOfKeys) UnsetNextExclusiveStartKey() {
	o.NextExclusiveStartKey.Unset()
}

func (o ListOfKeys) MarshalJSON() ([]byte, error) {
...
func (o ListOfKeys) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	toSerialize["count"] = o.Count
	toSerialize["limit"] = o.Limit
	if o.ExclusiveStartKey.IsSet() {
		toSerialize["exclusiveStartKey"] = o.ExclusiveStartKey.Get()
	}
	toSerialize["isTruncated"] = o.IsTruncated
	if o.NextExclusiveStartKey.IsSet() {
		toSerialize["nextExclusiveStartKey"] = o.NextExclusiveStartKey.Get()
	}
	return toSerialize, nil
}

func (o *ListOfKeys) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfKeys := _ListOfKeys{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfKeys)

	if err != nil {
		return err
	}

	*o = ListOfKeys(varListOfKeys)

	return err
}

type NullableListOfKeys struct {
	value *ListOfKeys
	isSet bool
}

func (v NullableListOfKeys) Get() *ListOfKeys {
	return v.value
}

func (v *NullableListOfKeys) Set(val *ListOfKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfKeys(val *ListOfKeys) *NullableListOfKeys {
	return &NullableListOfKeys{value: val, isSet: true}
}

func (v NullableListOfKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
