...
// checks if the UpdateActorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateActorRequest{}

// UpdateActorRequest struct for UpdateActorRequest
type UpdateActorRequest struct {
	Name *string `json:"name,omitempty"`
	Description NullableString `json:"description,omitempty"`
	IsPublic *bool `json:"isPublic,omitempty"`
	ActorPermissionLevel NullableActorPermissionLevel `json:"actorPermissionLevel,omitempty"`
...
func (o *UpdateActorRequest) SetDescriptionNil() {
...
// GetActorPermissionLevel returns the ActorPermissionLevel field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateActorRequest) GetActorPermissionLevel() ActorPermissionLevel {
	if o == nil || IsNil(o.ActorPermissionLevel.Get()) {
		var ret ActorPermissionLevel
		return ret
	}
	return *o.ActorPermissionLevel.Get()
}
...
// SetActorPermissionLevel gets a reference to the given NullableActorPermissionLevel and assigns it to the ActorPermissionLevel field.
func (o *UpdateActorRequest) SetActorPermissionLevel(v ActorPermissionLevel) {
	o.ActorPermissionLevel.Set(&v)
}
// SetActorPermissionLevelNil sets the value for ActorPermissionLevel to be an explicit nil
func (o *UpdateActorRequest) SetActorPermissionLevelNil() {
	o.ActorPermissionLevel.Set(nil)
}
...
func (o *UpdateActorRequest) SetSeoTitleNil() {
	o.SeoTitle.Set(nil)
}
...
func (o *UpdateActorRequest) SetSeoDescriptionNil() {
...
func (o *UpdateActorRequest) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *UpdateActorRequest) GetVersions() []CreateOrUpdateVersionRequest {
	if o == nil || IsNil(o.Versions) {
		var ret []CreateOrUpdateVersionRequest
		return ret
	}
	return o.Versions
}
...
// SetVersions gets a reference to the given []CreateOrUpdateVersionRequest and assigns it to the Versions field.
...
// GetDefaultRunOptions returns the DefaultRunOptions field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateActorRequest) GetDefaultRunOptions() DefaultRunOptions {
	if o == nil || IsNil(o.DefaultRunOptions.Get()) {
		var ret DefaultRunOptions
		return ret
	}
	return *o.DefaultRunOptions.Get()
}

// GetDefaultRunOptionsOk returns a tuple with the DefaultRunOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetDefaultRunOptions gets a reference to the given NullableDefaultRunOptions and assigns it to the DefaultRunOptions field.
func (o *UpdateActorRequest) SetDefaultRunOptions(v DefaultRunOptions) {
	o.DefaultRunOptions.Set(&v)
}
// SetDefaultRunOptionsNil sets the value for DefaultRunOptions to be an explicit nil
func (o *UpdateActorRequest) SetDefaultRunOptionsNil() {
	o.DefaultRunOptions.Set(nil)
}
...
func (o *UpdateActorRequest) UnsetDefaultRunOptions() {
	o.DefaultRunOptions.Unset()
}

// GetTaggedBuilds returns the TaggedBuilds field value if set, zero value otherwise.
func (o *UpdateActorRequest) GetTaggedBuilds() map[string]BuildTag {
	if o == nil || IsNil(o.TaggedBuilds) {
		var ret map[string]BuildTag
		return ret
	}
...
func (o *UpdateActorRequest) GetTaggedBuildsOk() (map[string]BuildTag, bool) {
	if o == nil || IsNil(o.TaggedBuilds) {
		return map[string]BuildTag{}, false
	}
...
// SetTaggedBuilds gets a reference to the given map[string]BuildTag and assigns it to the TaggedBuilds field.
...
func (o *UpdateActorRequest) SetActorStandbyNil() {
...
func (o *UpdateActorRequest) SetExampleRunInputNil() {
...
func (o *UpdateActorRequest) SetIsDeprecatedNil() {
...
func (o UpdateActorRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateActorRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.ActorPermissionLevel.IsSet() {
		toSerialize["actorPermissionLevel"] = o.ActorPermissionLevel.Get()
	}
	if o.SeoTitle.IsSet() {
	...
	if o.DefaultRunOptions.IsSet() {
		toSerialize["defaultRunOptions"] = o.DefaultRunOptions.Get()
	}
	if !IsNil(o.TaggedBuilds) {
...
type NullableUpdateActorRequest struct {
	value *UpdateActorRequest
	isSet bool
}

func (v NullableUpdateActorRequest) Get() *UpdateActorRequest {
	return v.value
}

func (v *NullableUpdateActorRequest) Set(val *UpdateActorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateActorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateActorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateActorRequest(val *UpdateActorRequest) *NullableUpdateActorRequest {
	return &NullableUpdateActorRequest{value: val, isSet: true}
}

func (v NullableUpdateActorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateActorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
