...
// checks if the ListOfKeyValueStores type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfKeyValueStores{}

// ListOfKeyValueStores struct for ListOfKeyValueStores
...
type _ListOfKeyValueStores ListOfKeyValueStores
...
// GetUnnamed returns the Unnamed field value if set, zero value otherwise.
func (o *ListOfKeyValueStores) GetUnnamed() bool {
	if o == nil || IsNil(o.Unnamed) {
		var ret bool
		return ret
	}
	return *o.Unnamed
...
// GetUnnamedOk returns a tuple with the Unnamed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListOfKeyValueStores) GetUnnamedOk() (*bool, bool) {
	if o == nil || IsNil(o.Unnamed) {
		return nil, false
	}
	return o.Unnamed, true
}
...
// SetUnnamed gets a reference to the given bool and assigns it to the Unnamed field.
...
func (o ListOfKeyValueStores) MarshalJSON() ([]byte, error) {
...
func (o ListOfKeyValueStores) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfKeyValueStores) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfKeyValueStores := _ListOfKeyValueStores{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfKeyValueStores)

	if err != nil {
		return err
	}

	*o = ListOfKeyValueStores(varListOfKeyValueStores)

	return err
}

type NullableListOfKeyValueStores struct {
	value *ListOfKeyValueStores
	isSet bool
}

func (v NullableListOfKeyValueStores) Get() *ListOfKeyValueStores {
	return v.value
}

func (v *NullableListOfKeyValueStores) Set(val *ListOfKeyValueStores) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfKeyValueStores) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfKeyValueStores) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfKeyValueStores(val *ListOfKeyValueStores) *NullableListOfKeyValueStores {
	return &NullableListOfKeyValueStores{value: val, isSet: true}
}

func (v NullableListOfKeyValueStores) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfKeyValueStores) UnmarshalJSON(src []byte) error {
	v.isSet = true
