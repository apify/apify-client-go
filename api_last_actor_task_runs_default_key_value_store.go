...
// LastActorTaskRunsDefaultKeyValueStoreAPIService LastActorTaskRunsDefaultKeyValueStoreAPI service
type LastActorTaskRunsDefaultKeyValueStoreAPIService service

type ApiActorTaskRunsLastKeyValueStoreDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	status *string
}

// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreDeleteRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreDeleteExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreDelete Delete last task run's default store
...
[Delete store](/api/v2/key-value-store-delete) endpoint.
 ...
 @return ApiActorTaskRunsLastKeyValueStoreDeleteRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreDelete(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastKeyValueStoreDeleteRequest {
	return ApiActorTaskRunsLastKeyValueStoreDeleteRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreDeleteExecute(r ApiActorTaskRunsLastKeyValueStoreDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store"
...
type ApiActorTaskRunsLastKeyValueStoreGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreGetRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreGetRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreGetRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreGetExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreGet Get last task run's default store
...
[Get store](/api/v2/key-value-store-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastKeyValueStoreGetRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreGet(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastKeyValueStoreGetRequest {
	return ApiActorTaskRunsLastKeyValueStoreGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreGetExecute(r ApiActorTaskRunsLastKeyValueStoreGetRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *KeyValueStoreResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreGet")
	if err != nil {
...
type ApiActorTaskRunsLastKeyValueStoreKeysGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.status = &status
	return r
}

// All keys up to this one (including) are skipped from the result.
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) ExclusiveStartKey(exclusiveStartKey string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.exclusiveStartKey = &exclusiveStartKey
	return r
}

// Number of keys to be returned.
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Limit(limit float32) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Collection(collection string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.collection = &collection
	return r
}

// Limit the results to keys that start with a specific prefix.
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Prefix(prefix string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Signature(signature string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) Execute() (*ListOfKeysResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreKeysGetExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreKeysGet Get last task run's default store's list of keys
...
[Get list of keys](/api/v2/key-value-store-keys-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastKeyValueStoreKeysGetRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreKeysGet(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastKeyValueStoreKeysGetRequest {
	return ApiActorTaskRunsLastKeyValueStoreKeysGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return ListOfKeysResponse
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreKeysGetExecute(r ApiActorTaskRunsLastKeyValueStoreKeysGetRequest) (*ListOfKeysResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfKeysResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreKeysGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"actorTaskId"+"}", url.PathEscape(parameterValueToString(r.actorTaskId, "actorTaskId")), -1)
	...
	if r.exclusiveStartKey != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exclusiveStartKey", r.exclusiveStartKey, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	} else {
		var defaultValue float32 = 1000
...
type ApiActorTaskRunsLastKeyValueStorePutRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
...
// 
func (r ApiActorTaskRunsLastKeyValueStorePutRequest) UpdateStoreRequest(updateStoreRequest UpdateStoreRequest) ApiActorTaskRunsLastKeyValueStorePutRequest {
	r.updateStoreRequest = &updateStoreRequest
	return r
}

// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStorePutRequest) Status(status string) ApiActorTaskRunsLastKeyValueStorePutRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastKeyValueStorePutRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStorePutExecute(r)
}

/*
ActorTaskRunsLastKeyValueStorePut Update last task run's default store
...
[Update store](/api/v2/key-value-store-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastKeyValueStorePutRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStorePut(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastKeyValueStorePutRequest {
	return ApiActorTaskRunsLastKeyValueStorePutRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return KeyValueStoreResponse
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStorePutExecute(r ApiActorTaskRunsLastKeyValueStorePutRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStorePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	recordKey string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreRecordDeleteExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreRecordDelete Delete last task run's default store's record
...
[Delete record](/api/v2/key-value-store-record-delete) endpoint.
 ...
 @return ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordDelete(ctx context.Context, actorTaskId string, recordKey string) ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest {
	return ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordDeleteExecute(r ApiActorTaskRunsLastKeyValueStoreRecordDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreRecordDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/records/{recordKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"actorTaskId"+"}", url.PathEscape(parameterValueToString(r.actorTaskId, "actorTaskId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"recordKey"+"}", url.PathEscape(parameterValueToString(r.recordKey, "recordKey")), -1)
...
type ApiActorTaskRunsLastKeyValueStoreRecordGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	recordKey string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreRecordGetRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreRecordGetRequest {
	r.status = &status
	return r
}

// Signature used for the access.
func (r ApiActorTaskRunsLastKeyValueStoreRecordGetRequest) Signature(signature string) ApiActorTaskRunsLastKeyValueStoreRecordGetRequest {
	r.signature = &signature
	return r
}
...
func (r ApiActorTaskRunsLastKeyValueStoreRecordGetRequest) Attachment(attachment bool) ApiActorTaskRunsLastKeyValueStoreRecordGetRequest {
	r.attachment = &attachment
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreRecordGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreRecordGetExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreRecordGet Get last task run's default store's record
...
[Get record](/api/v2/key-value-store-record-get) endpoint.
 ...
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @param recordKey Key of the record.
 @return ApiActorTaskRunsLastKeyValueStoreRecordGetRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordGet(ctx context.Context, actorTaskId string, recordKey string) ApiActorTaskRunsLastKeyValueStoreRecordGetRequest {
	return ApiActorTaskRunsLastKeyValueStoreRecordGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordGetExecute(r ApiActorTaskRunsLastKeyValueStoreRecordGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreRecordGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorTaskRunsLastKeyValueStoreRecordPostRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	recordKey string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreRecordPostRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreRecordPostRequest {
	r.status = &status
	return r
}

// 
func (r ApiActorTaskRunsLastKeyValueStoreRecordPostRequest) ContentEncoding(contentEncoding string) ApiActorTaskRunsLastKeyValueStoreRecordPostRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreRecordPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreRecordPostExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreRecordPost Store record in last task run's default store (POST)
...
[Store record](/api/v2/key-value-store-record-post) endpoint.
 ...
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @param recordKey Key of the record.
 @return ApiActorTaskRunsLastKeyValueStoreRecordPostRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordPost(ctx context.Context, actorTaskId string, recordKey string) ApiActorTaskRunsLastKeyValueStoreRecordPostRequest {
	return ApiActorTaskRunsLastKeyValueStoreRecordPostRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordPostExecute(r ApiActorTaskRunsLastKeyValueStoreRecordPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreRecordPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.contentEncoding != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "Content-Encoding", r.contentEncoding, "simple", "")
	}
	// body params
...
type ApiActorTaskRunsLastKeyValueStoreRecordPutRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	recordKey string
...
// 
func (r ApiActorTaskRunsLastKeyValueStoreRecordPutRequest) RequestBody(requestBody map[string]interface{}) ApiActorTaskRunsLastKeyValueStoreRecordPutRequest {
	r.requestBody = &requestBody
	return r
}

// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreRecordPutRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreRecordPutRequest {
	r.status = &status
	return r
}

// 
func (r ApiActorTaskRunsLastKeyValueStoreRecordPutRequest) ContentEncoding(contentEncoding string) ApiActorTaskRunsLastKeyValueStoreRecordPutRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreRecordPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreRecordPutExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreRecordPut Store record in last task run's default store
...
[Store record](/api/v2/key-value-store-record-put) endpoint.
 ...
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @param recordKey Key of the record.
 @return ApiActorTaskRunsLastKeyValueStoreRecordPutRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordPut(ctx context.Context, actorTaskId string, recordKey string) ApiActorTaskRunsLastKeyValueStoreRecordPutRequest {
	return ApiActorTaskRunsLastKeyValueStoreRecordPutRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordPutExecute(r ApiActorTaskRunsLastKeyValueStoreRecordPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreRecordPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultKeyValueStoreAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) Status(status string) ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest {
	r.status = &status
	return r
}
...
func (r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) Collection(collection string) ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest {
	r.collection = &collection
	return r
}

// If specified, only records whose key starts with the given prefix are included in the archive. 
func (r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) Prefix(prefix string) ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) Signature(signature string) ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastKeyValueStoreRecordsGetExecute(r)
}

/*
ActorTaskRunsLastKeyValueStoreRecordsGet Download last task run's default store's records
...
[Download records](/api/v2/key-value-store-records-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest
*/
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordsGet(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest {
	return ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return *os.File
func (a *LastActorTaskRunsDefaultKeyValueStoreAPIService) ActorTaskRunsLastKeyValueStoreRecordsGetExecute(r ApiActorTaskRunsLastKeyValueStoreRecordsGetRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultKeyValueStoreAPIService.ActorTaskRunsLastKeyValueStoreRecordsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store/records"
	localVarPath = strings.Replace(localVarPath, "{"+"actorTaskId"+"}", url.PathEscape(parameterValueToString(r.actorTaskId, "actorTaskId")), -1)
