...
// checks if the ListOfStoreActors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfStoreActors{}

// ListOfStoreActors struct for ListOfStoreActors
...
type _ListOfStoreActors ListOfStoreActors
...
func (o ListOfStoreActors) MarshalJSON() ([]byte, error) {
...
func (o ListOfStoreActors) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfStoreActors) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfStoreActors := _ListOfStoreActors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfStoreActors)

	if err != nil {
		return err
	}

	*o = ListOfStoreActors(varListOfStoreActors)

	return err
}

type NullableListOfStoreActors struct {
	value *ListOfStoreActors
	isSet bool
}

func (v NullableListOfStoreActors) Get() *ListOfStoreActors {
	return v.value
}

func (v *NullableListOfStoreActors) Set(val *ListOfStoreActors) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfStoreActors) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfStoreActors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfStoreActors(val *ListOfStoreActors) *NullableListOfStoreActors {
	return &NullableListOfStoreActors{value: val, isSet: true}
}

func (v NullableListOfStoreActors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfStoreActors) UnmarshalJSON(src []byte) error {
	v.isSet = true
