...
// checks if the ListOfWebhookDispatches type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfWebhookDispatches{}

// ListOfWebhookDispatches struct for ListOfWebhookDispatches
...
type _ListOfWebhookDispatches ListOfWebhookDispatches

// NewListOfWebhookDispatches instantiates a new ListOfWebhookDispatches object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfWebhookDispatches(total int32, offset int32, limit int32, desc bool, count int32, items []WebhookDispatch) *ListOfWebhookDispatches {
	this := ListOfWebhookDispatches{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
	this.Desc = desc
...
// NewListOfWebhookDispatchesWithDefaults instantiates a new ListOfWebhookDispatches object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfWebhookDispatchesWithDefaults() *ListOfWebhookDispatches {
	this := ListOfWebhookDispatches{}
	return &this
}

// GetTotal returns the Total field value
func (o *ListOfWebhookDispatches) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListOfWebhookDispatches) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ListOfWebhookDispatches) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ListOfWebhookDispatches) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfWebhookDispatches) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListOfWebhookDispatches) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ListOfWebhookDispatches) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfWebhookDispatches) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ListOfWebhookDispatches) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ListOfWebhookDispatches) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfWebhookDispatches) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ListOfWebhookDispatches) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ListOfWebhookDispatches) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfWebhookDispatches) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ListOfWebhookDispatches) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ListOfWebhookDispatches) GetItems() []WebhookDispatch {
	if o == nil {
		var ret []WebhookDispatch
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfWebhookDispatches) GetItemsOk() ([]WebhookDispatch, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListOfWebhookDispatches) SetItems(v []WebhookDispatch) {
	o.Items = v
}

func (o ListOfWebhookDispatches) MarshalJSON() ([]byte, error) {
...
func (o ListOfWebhookDispatches) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfWebhookDispatches) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfWebhookDispatches := _ListOfWebhookDispatches{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfWebhookDispatches)

	if err != nil {
		return err
	}

	*o = ListOfWebhookDispatches(varListOfWebhookDispatches)

	return err
}

type NullableListOfWebhookDispatches struct {
	value *ListOfWebhookDispatches
	isSet bool
}

func (v NullableListOfWebhookDispatches) Get() *ListOfWebhookDispatches {
	return v.value
}

func (v *NullableListOfWebhookDispatches) Set(val *ListOfWebhookDispatches) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfWebhookDispatches) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfWebhookDispatches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfWebhookDispatches(val *ListOfWebhookDispatches) *NullableListOfWebhookDispatches {
	return &NullableListOfWebhookDispatches{value: val, isSet: true}
}

func (v NullableListOfWebhookDispatches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfWebhookDispatches) UnmarshalJSON(src []byte) error {
	v.isSet = true
