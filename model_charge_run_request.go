...
// checks if the ChargeRunRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChargeRunRequest{}

// ChargeRunRequest struct for ChargeRunRequest
type ChargeRunRequest struct {
	EventName string `json:"eventName"`
	Count int32 `json:"count"`
}

type _ChargeRunRequest ChargeRunRequest
...
func (o ChargeRunRequest) MarshalJSON() ([]byte, error) {
...
func (o ChargeRunRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ChargeRunRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varChargeRunRequest := _ChargeRunRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChargeRunRequest)

	if err != nil {
		return err
	}

	*o = ChargeRunRequest(varChargeRunRequest)

	return err
}

type NullableChargeRunRequest struct {
	value *ChargeRunRequest
	isSet bool
}

func (v NullableChargeRunRequest) Get() *ChargeRunRequest {
	return v.value
}

func (v *NullableChargeRunRequest) Set(val *ChargeRunRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChargeRunRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChargeRunRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChargeRunRequest(val *ChargeRunRequest) *NullableChargeRunRequest {
	return &NullableChargeRunRequest{value: val, isSet: true}
}

func (v NullableChargeRunRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChargeRunRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
