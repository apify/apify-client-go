...
// ScheduleAction - struct for ScheduleAction
type ScheduleAction struct {
	ScheduleActionRunActor *ScheduleActionRunActor
	ScheduleActionRunActorTask *ScheduleActionRunActorTask
}

// ScheduleActionRunActorAsScheduleAction is a convenience function that returns ScheduleActionRunActor wrapped in ScheduleAction
func ScheduleActionRunActorAsScheduleAction(v *ScheduleActionRunActor) ScheduleAction {
	return ScheduleAction{
		ScheduleActionRunActor: v,
	}
}

// ScheduleActionRunActorTaskAsScheduleAction is a convenience function that returns ScheduleActionRunActorTask wrapped in ScheduleAction
func ScheduleActionRunActorTaskAsScheduleAction(v *ScheduleActionRunActorTask) ScheduleAction {
	return ScheduleAction{
		ScheduleActionRunActorTask: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ScheduleAction) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ScheduleActionRunActor
	err = newStrictDecoder(data).Decode(&dst.ScheduleActionRunActor)
	if err == nil {
		jsonScheduleActionRunActor, _ := json.Marshal(dst.ScheduleActionRunActor)
		if string(jsonScheduleActionRunActor) == "{}" { // empty struct
			dst.ScheduleActionRunActor = nil
		} else {
			if err = validator.Validate(dst.ScheduleActionRunActor); err != nil {
				dst.ScheduleActionRunActor = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into ScheduleActionRunActorTask
	err = newStrictDecoder(data).Decode(&dst.ScheduleActionRunActorTask)
	if err == nil {
		jsonScheduleActionRunActorTask, _ := json.Marshal(dst.ScheduleActionRunActorTask)
		if string(jsonScheduleActionRunActorTask) == "{}" { // empty struct
			dst.ScheduleActionRunActorTask = nil
		} else {
			if err = validator.Validate(dst.ScheduleActionRunActorTask); err != nil {
				dst.ScheduleActionRunActorTask = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ScheduleAction)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ScheduleAction)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ScheduleAction) MarshalJSON() ([]byte, error) {
	if src.ScheduleActionRunActor != nil {
		return json.Marshal(&src.ScheduleActionRunActor)
	}

	if src.ScheduleActionRunActorTask != nil {
		return json.Marshal(&src.ScheduleActionRunActorTask)
	}
...
func (obj *ScheduleAction) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ScheduleActionRunActor != nil {
		return obj.ScheduleActionRunActor
	}

	if obj.ScheduleActionRunActorTask != nil {
		return obj.ScheduleActionRunActorTask
	}
...
func (obj ScheduleAction) GetActualInstanceValue() (interface{}) {
	if obj.ScheduleActionRunActor != nil {
		return *obj.ScheduleActionRunActor
	}
