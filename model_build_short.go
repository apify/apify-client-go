...
// checks if the BuildShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildShort{}

// BuildShort struct for BuildShort
type BuildShort struct {
	...
	Meta *BuildsMeta `json:"meta,omitempty"`
}

type _BuildShort BuildShort
...
// GetActId returns the ActId field value if set, zero value otherwise.
func (o *BuildShort) GetActId() string {
	if o == nil || IsNil(o.ActId) {
		var ret string
		return ret
	}
	return *o.ActId
...
// SetActId gets a reference to the given string and assigns it to the ActId field.
...
func (o *BuildShort) SetFinishedAtNil() {
...
// SetMeta gets a reference to the given BuildsMeta and assigns it to the Meta field.
func (o *BuildShort) SetMeta(v BuildsMeta) {
	o.Meta = &v
}

func (o BuildShort) MarshalJSON() ([]byte, error) {
...
func (o BuildShort) ToMap() (map[string]interface{}, error) {
...
func (o *BuildShort) UnmarshalJSON(data []byte) (err error) {
	...
	varBuildShort := _BuildShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBuildShort)

	if err != nil {
		return err
	}

	*o = BuildShort(varBuildShort)

	return err
}

type NullableBuildShort struct {
	value *BuildShort
	isSet bool
}

func (v NullableBuildShort) Get() *BuildShort {
	return v.value
}

func (v *NullableBuildShort) Set(val *BuildShort) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildShort) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildShort(val *BuildShort) *NullableBuildShort {
	return &NullableBuildShort{value: val, isSet: true}
}

func (v NullableBuildShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
