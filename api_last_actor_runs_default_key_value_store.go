...
// LastActorRunsDefaultKeyValueStoreAPIService LastActorRunsDefaultKeyValueStoreAPI service
type LastActorRunsDefaultKeyValueStoreAPIService service

type ApiActRunsLastKeyValueStoreDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	status *string
}

// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreDeleteRequest) Status(status string) ApiActRunsLastKeyValueStoreDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastKeyValueStoreDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreDeleteExecute(r)
}

/*
ActRunsLastKeyValueStoreDelete Delete last run's default store
...
[Delete store](/api/v2/key-value-store-delete) endpoint.
 ...
 @return ApiActRunsLastKeyValueStoreDeleteRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreDelete(ctx context.Context, actorId string) ApiActRunsLastKeyValueStoreDeleteRequest {
	return ApiActRunsLastKeyValueStoreDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreDeleteExecute(r ApiActRunsLastKeyValueStoreDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/key-value-store"
...
type ApiActRunsLastKeyValueStoreGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreGetRequest) Status(status string) ApiActRunsLastKeyValueStoreGetRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastKeyValueStoreGetRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreGetExecute(r)
}

/*
ActRunsLastKeyValueStoreGet Get last run's default store
...
[Get store](/api/v2/key-value-store-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastKeyValueStoreGetRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreGet(ctx context.Context, actorId string) ApiActRunsLastKeyValueStoreGetRequest {
	return ApiActRunsLastKeyValueStoreGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreGetExecute(r ApiActRunsLastKeyValueStoreGetRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreGet")
	if err != nil {
...
type ApiActRunsLastKeyValueStoreKeysGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Status(status string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.status = &status
	return r
}

// All keys up to this one (including) are skipped from the result.
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) ExclusiveStartKey(exclusiveStartKey string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.exclusiveStartKey = &exclusiveStartKey
	return r
}

// Number of keys to be returned.
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Limit(limit float32) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Collection(collection string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.collection = &collection
	return r
}

// Limit the results to keys that start with a specific prefix.
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Prefix(prefix string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Signature(signature string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActRunsLastKeyValueStoreKeysGetRequest) Execute() (*ListOfKeysResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreKeysGetExecute(r)
}

/*
ActRunsLastKeyValueStoreKeysGet Get last run's default store's list of keys
...
[Get list of keys](/api/v2/key-value-store-keys-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastKeyValueStoreKeysGetRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreKeysGet(ctx context.Context, actorId string) ApiActRunsLastKeyValueStoreKeysGetRequest {
	return ApiActRunsLastKeyValueStoreKeysGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreKeysGetExecute(r ApiActRunsLastKeyValueStoreKeysGetRequest) (*ListOfKeysResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreKeysGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/key-value-store/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActRunsLastKeyValueStorePutRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
...
// 
func (r ApiActRunsLastKeyValueStorePutRequest) UpdateStoreRequest(updateStoreRequest UpdateStoreRequest) ApiActRunsLastKeyValueStorePutRequest {
	r.updateStoreRequest = &updateStoreRequest
	return r
}

// Filter for the run status.
func (r ApiActRunsLastKeyValueStorePutRequest) Status(status string) ApiActRunsLastKeyValueStorePutRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastKeyValueStorePutRequest) Execute() (*KeyValueStoreResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStorePutExecute(r)
}

/*
ActRunsLastKeyValueStorePut Update last run's default store
...
[Update store](/api/v2/key-value-store-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastKeyValueStorePutRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStorePut(ctx context.Context, actorId string) ApiActRunsLastKeyValueStorePutRequest {
	return ApiActRunsLastKeyValueStorePutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return KeyValueStoreResponse
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStorePutExecute(r ApiActRunsLastKeyValueStorePutRequest) (*KeyValueStoreResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStorePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastKeyValueStoreRecordDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	recordKey string
...
// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreRecordDeleteRequest) Status(status string) ApiActRunsLastKeyValueStoreRecordDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActRunsLastKeyValueStoreRecordDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreRecordDeleteExecute(r)
}

/*
ActRunsLastKeyValueStoreRecordDelete Delete last run's default store's record
...
[Delete record](/api/v2/key-value-store-record-delete) endpoint.
 ...
 @return ApiActRunsLastKeyValueStoreRecordDeleteRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordDelete(ctx context.Context, actorId string, recordKey string) ApiActRunsLastKeyValueStoreRecordDeleteRequest {
	return ApiActRunsLastKeyValueStoreRecordDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordDeleteExecute(r ApiActRunsLastKeyValueStoreRecordDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreRecordDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/key-value-store/records/{recordKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActRunsLastKeyValueStoreRecordGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	recordKey string
...
// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreRecordGetRequest) Status(status string) ApiActRunsLastKeyValueStoreRecordGetRequest {
	r.status = &status
	return r
}

// Signature used for the access.
func (r ApiActRunsLastKeyValueStoreRecordGetRequest) Signature(signature string) ApiActRunsLastKeyValueStoreRecordGetRequest {
	r.signature = &signature
	return r
}
...
func (r ApiActRunsLastKeyValueStoreRecordGetRequest) Attachment(attachment bool) ApiActRunsLastKeyValueStoreRecordGetRequest {
	r.attachment = &attachment
	return r
}

func (r ApiActRunsLastKeyValueStoreRecordGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreRecordGetExecute(r)
}

/*
ActRunsLastKeyValueStoreRecordGet Get last run's default store's record
...
[Get record](/api/v2/key-value-store-record-get) endpoint.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param recordKey Key of the record.
 @return ApiActRunsLastKeyValueStoreRecordGetRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordGet(ctx context.Context, actorId string, recordKey string) ApiActRunsLastKeyValueStoreRecordGetRequest {
	return ApiActRunsLastKeyValueStoreRecordGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordGetExecute(r ApiActRunsLastKeyValueStoreRecordGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreRecordGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastKeyValueStoreRecordPostRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	recordKey string
...
// 
func (r ApiActRunsLastKeyValueStoreRecordPostRequest) RequestBody(requestBody map[string]interface{}) ApiActRunsLastKeyValueStoreRecordPostRequest {
	r.requestBody = &requestBody
	return r
}

// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreRecordPostRequest) Status(status string) ApiActRunsLastKeyValueStoreRecordPostRequest {
	r.status = &status
	return r
}

// 
func (r ApiActRunsLastKeyValueStoreRecordPostRequest) ContentEncoding(contentEncoding string) ApiActRunsLastKeyValueStoreRecordPostRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActRunsLastKeyValueStoreRecordPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreRecordPostExecute(r)
}

/*
ActRunsLastKeyValueStoreRecordPost Store record in last run's default store (POST)
...
[Store record](/api/v2/key-value-store-record-post) endpoint.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param recordKey Key of the record.
 @return ApiActRunsLastKeyValueStoreRecordPostRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordPost(ctx context.Context, actorId string, recordKey string) ApiActRunsLastKeyValueStoreRecordPostRequest {
	return ApiActRunsLastKeyValueStoreRecordPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordPostExecute(r ApiActRunsLastKeyValueStoreRecordPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreRecordPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastKeyValueStoreRecordPutRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	recordKey string
...
// 
func (r ApiActRunsLastKeyValueStoreRecordPutRequest) RequestBody(requestBody map[string]interface{}) ApiActRunsLastKeyValueStoreRecordPutRequest {
	r.requestBody = &requestBody
	return r
}

// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreRecordPutRequest) Status(status string) ApiActRunsLastKeyValueStoreRecordPutRequest {
	r.status = &status
	return r
}

// 
func (r ApiActRunsLastKeyValueStoreRecordPutRequest) ContentEncoding(contentEncoding string) ApiActRunsLastKeyValueStoreRecordPutRequest {
	r.contentEncoding = &contentEncoding
	return r
}

func (r ApiActRunsLastKeyValueStoreRecordPutRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreRecordPutExecute(r)
}

/*
ActRunsLastKeyValueStoreRecordPut Store record in last run's default store
...
[Store record](/api/v2/key-value-store-record-put) endpoint.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param recordKey Key of the record.
 @return ApiActRunsLastKeyValueStoreRecordPutRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordPut(ctx context.Context, actorId string, recordKey string) ApiActRunsLastKeyValueStoreRecordPutRequest {
	return ApiActRunsLastKeyValueStoreRecordPutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordPutExecute(r ApiActRunsLastKeyValueStoreRecordPutRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreRecordPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActRunsLastKeyValueStoreRecordsGetRequest struct {
	ctx context.Context
	ApiService *LastActorRunsDefaultKeyValueStoreAPIService
	actorId string
	status *string
...
// Filter for the run status.
func (r ApiActRunsLastKeyValueStoreRecordsGetRequest) Status(status string) ApiActRunsLastKeyValueStoreRecordsGetRequest {
	r.status = &status
	return r
}
...
func (r ApiActRunsLastKeyValueStoreRecordsGetRequest) Collection(collection string) ApiActRunsLastKeyValueStoreRecordsGetRequest {
	r.collection = &collection
	return r
}

// If specified, only records whose key starts with the given prefix are included in the archive. 
func (r ApiActRunsLastKeyValueStoreRecordsGetRequest) Prefix(prefix string) ApiActRunsLastKeyValueStoreRecordsGetRequest {
	r.prefix = &prefix
	return r
}

// Signature used for the access.
func (r ApiActRunsLastKeyValueStoreRecordsGetRequest) Signature(signature string) ApiActRunsLastKeyValueStoreRecordsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActRunsLastKeyValueStoreRecordsGetRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.ActRunsLastKeyValueStoreRecordsGetExecute(r)
}

/*
ActRunsLastKeyValueStoreRecordsGet Download last run's default store's records
...
[Download records](/api/v2/key-value-store-records-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActRunsLastKeyValueStoreRecordsGetRequest
*/
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordsGet(ctx context.Context, actorId string) ApiActRunsLastKeyValueStoreRecordsGetRequest {
	return ApiActRunsLastKeyValueStoreRecordsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return *os.File
func (a *LastActorRunsDefaultKeyValueStoreAPIService) ActRunsLastKeyValueStoreRecordsGetExecute(r ApiActRunsLastKeyValueStoreRecordsGetRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsDefaultKeyValueStoreAPIService.ActRunsLastKeyValueStoreRecordsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/key-value-store/records"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
