...
// checks if the FreeActorPricingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FreeActorPricingInfo{}

// FreeActorPricingInfo struct for FreeActorPricingInfo
...
type _FreeActorPricingInfo FreeActorPricingInfo
...
func (o FreeActorPricingInfo) MarshalJSON() ([]byte, error) {
...
func (o FreeActorPricingInfo) ToMap() (map[string]interface{}, error) {
...
func (o *FreeActorPricingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varFreeActorPricingInfo := _FreeActorPricingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFreeActorPricingInfo)

	if err != nil {
		return err
	}

	*o = FreeActorPricingInfo(varFreeActorPricingInfo)

	return err
}

type NullableFreeActorPricingInfo struct {
	value *FreeActorPricingInfo
	isSet bool
}

func (v NullableFreeActorPricingInfo) Get() *FreeActorPricingInfo {
	return v.value
}

func (v *NullableFreeActorPricingInfo) Set(val *FreeActorPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableFreeActorPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableFreeActorPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFreeActorPricingInfo(val *FreeActorPricingInfo) *NullableFreeActorPricingInfo {
	return &NullableFreeActorPricingInfo{value: val, isSet: true}
}

func (v NullableFreeActorPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFreeActorPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
