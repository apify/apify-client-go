...
// checks if the ScheduleActionRunActor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleActionRunActor{}

// ScheduleActionRunActor struct for ScheduleActionRunActor
...
type _ScheduleActionRunActor ScheduleActionRunActor
...
func (o *ScheduleActionRunActor) SetRunInputNil() {
	o.RunInput.Set(nil)
}
...
func (o *ScheduleActionRunActor) SetRunOptionsNil() {
...
func (o ScheduleActionRunActor) MarshalJSON() ([]byte, error) {
...
func (o ScheduleActionRunActor) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleActionRunActor) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleActionRunActor := _ScheduleActionRunActor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleActionRunActor)

	if err != nil {
		return err
	}

	*o = ScheduleActionRunActor(varScheduleActionRunActor)

	return err
}

type NullableScheduleActionRunActor struct {
	value *ScheduleActionRunActor
	isSet bool
}

func (v NullableScheduleActionRunActor) Get() *ScheduleActionRunActor {
	return v.value
}

func (v *NullableScheduleActionRunActor) Set(val *ScheduleActionRunActor) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionRunActor) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionRunActor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionRunActor(val *ScheduleActionRunActor) *NullableScheduleActionRunActor {
	return &NullableScheduleActionRunActor{value: val, isSet: true}
}

func (v NullableScheduleActionRunActor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionRunActor) UnmarshalJSON(src []byte) error {
	v.isSet = true
