...
// ActorsActorBuildsAPIService ActorsActorBuildsAPI service
type ActorsActorBuildsAPIService service

type ApiActBuildAbortPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
	buildId string
}

func (r ApiActBuildAbortPostRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActBuildAbortPostExecute(r)
}

/*
ActBuildAbortPost Abort build
...
`FINISHED`, `FAILED`, `ABORTING` and `TIMED-OUT` this call does nothing.
 ...
 @param buildId ID of the build, found in the build's Info tab.
 @return ApiActBuildAbortPostRequest

Deprecated
*/
func (a *ActorsActorBuildsAPIService) ActBuildAbortPost(ctx context.Context, actorId string, buildId string) ApiActBuildAbortPostRequest {
	return ApiActBuildAbortPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Deprecated
func (a *ActorsActorBuildsAPIService) ActBuildAbortPostExecute(r ApiActBuildAbortPostRequest) (*BuildResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActBuildAbortPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/builds/{buildId}/abort"
...
type ApiActBuildDefaultGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
...
// The maximum number of seconds the server waits for the build to finish. By default it is &#x60;0&#x60;, the maximum value is &#x60;60&#x60;. &lt;!-- MAX_ACTOR_JOB_ASYNC_WAIT_SECS --&gt; If the build finishes in time then the returned build object will have a terminal status (e.g. &#x60;SUCCEEDED&#x60;), otherwise it will have a transitional status (e.g. &#x60;RUNNING&#x60;). 
func (r ApiActBuildDefaultGetRequest) WaitForFinish(waitForFinish float64) ApiActBuildDefaultGetRequest {
	r.waitForFinish = &waitForFinish
	return r
}

func (r ApiActBuildDefaultGetRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActBuildDefaultGetExecute(r)
}

/*
ActBuildDefaultGet Get default build
...
However, if you access the endpoint without a token, certain attributes (e.g., `usageUsd` and `usageTotalUsd`) will be hidden.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActBuildDefaultGetRequest
*/
func (a *ActorsActorBuildsAPIService) ActBuildDefaultGet(ctx context.Context, actorId string) ApiActBuildDefaultGetRequest {
	return ApiActBuildDefaultGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return BuildResponse
func (a *ActorsActorBuildsAPIService) ActBuildDefaultGetExecute(r ApiActBuildDefaultGetRequest) (*BuildResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActBuildDefaultGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/builds/default"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActBuildGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
	buildId string
...
// The maximum number of seconds the server waits for the build to finish. By default it is &#x60;0&#x60;, the maximum value is &#x60;60&#x60;. &lt;!-- MAX_ACTOR_JOB_ASYNC_WAIT_SECS --&gt; If the build finishes in time then the returned build object will have a terminal status (e.g. &#x60;SUCCEEDED&#x60;), otherwise it will have a transitional status (e.g. &#x60;RUNNING&#x60;). 
func (r ApiActBuildGetRequest) WaitForFinish(waitForFinish float64) ApiActBuildGetRequest {
	r.waitForFinish = &waitForFinish
	return r
}

func (r ApiActBuildGetRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActBuildGetExecute(r)
}

/*
ActBuildGet Get build
...
if you access the endpoint without the token, certain attributes, such as `usageUsd` and `usageTotalUsd`, will be hidden.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param buildId ID of the build, found in the build's Info tab.
 @return ApiActBuildGetRequest

Deprecated
*/
func (a *ActorsActorBuildsAPIService) ActBuildGet(ctx context.Context, actorId string, buildId string) ApiActBuildGetRequest {
	return ApiActBuildGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
//  @return BuildResponse
// Deprecated
func (a *ActorsActorBuildsAPIService) ActBuildGetExecute(r ApiActBuildGetRequest) (*BuildResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActBuildGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/builds/{buildId}"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"buildId"+"}", url.PathEscape(parameterValueToString(r.buildId, "buildId")), -1)
...
type ApiActBuildsGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
	offset *float64
...
func (r ApiActBuildsGetRequest) Offset(offset float64) ApiActBuildsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiActBuildsGetRequest) Limit(limit float64) ApiActBuildsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActBuildsGetRequest) Desc(desc bool) ApiActBuildsGetRequest {
	r.desc = &desc
	return r
}

func (r ApiActBuildsGetRequest) Execute() (*ListOfBuildsResponse, *http.Response, error) {
	return r.ApiService.ActBuildsGetExecute(r)
}

/*
ActBuildsGet Get list of builds
...
the `desc=1` parameter.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActBuildsGetRequest
*/
func (a *ActorsActorBuildsAPIService) ActBuildsGet(ctx context.Context, actorId string) ApiActBuildsGetRequest {
	return ApiActBuildsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return ListOfBuildsResponse
func (a *ActorsActorBuildsAPIService) ActBuildsGetExecute(r ApiActBuildsGetRequest) (*ListOfBuildsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfBuildsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActBuildsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/builds"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActBuildsPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
	version *string
...
func (r ApiActBuildsPostRequest) Version(version string) ApiActBuildsPostRequest {
	r.version = &version
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60;, the system will use a cache to speed up the build process. By default, cache is not used. 
func (r ApiActBuildsPostRequest) UseCache(useCache bool) ApiActBuildsPostRequest {
	r.useCache = &useCache
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the Actor is built with beta versions of Apify NPM packages. By default, the build uses &#x60;latest&#x60; packages. 
func (r ApiActBuildsPostRequest) BetaPackages(betaPackages bool) ApiActBuildsPostRequest {
	r.betaPackages = &betaPackages
	return r
}

// Tag to be applied to the build on success. By default, the tag is taken from Actor version&#39;s &#x60;buildTag&#x60; property. 
func (r ApiActBuildsPostRequest) Tag(tag string) ApiActBuildsPostRequest {
	r.tag = &tag
	return r
}

// The maximum number of seconds the server waits for the build to finish. By default it is &#x60;0&#x60;, the maximum value is &#x60;60&#x60;. &lt;!-- MAX_ACTOR_JOB_ASYNC_WAIT_SECS --&gt; If the build finishes in time then the returned build object will have a terminal status (e.g. &#x60;SUCCEEDED&#x60;), otherwise it will have a transitional status (e.g. &#x60;RUNNING&#x60;). 
func (r ApiActBuildsPostRequest) WaitForFinish(waitForFinish float64) ApiActBuildsPostRequest {
	r.waitForFinish = &waitForFinish
	return r
}

func (r ApiActBuildsPostRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActBuildsPostExecute(r)
}

/*
ActBuildsPost Build Actor
...
[Get build](#/reference/actors/build-object/get-build) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActBuildsPostRequest
*/
func (a *ActorsActorBuildsAPIService) ActBuildsPost(ctx context.Context, actorId string) ApiActBuildsPostRequest {
	return ApiActBuildsPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return BuildResponse
func (a *ActorsActorBuildsAPIService) ActBuildsPostExecute(r ApiActBuildsPostRequest) (*BuildResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActBuildsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.useCache != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "useCache", r.useCache, "form", "")
	}
	if r.betaPackages != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "betaPackages", r.betaPackages, "form", "")
	}
	if r.tag != nil {
...
type ApiActOpenapiJsonGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorBuildsAPIService
	actorId string
	buildId string
...
func (r ApiActOpenapiJsonGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActOpenapiJsonGetExecute(r)
}

/*
ActOpenapiJsonGet Get OpenAPI definition
...
:::
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param buildId ID of the build, found in the build's Info tab. Use the special value `default` to get the OpenAPI schema for the Actor's default build. 
 @return ApiActOpenapiJsonGetRequest
*/
func (a *ActorsActorBuildsAPIService) ActOpenapiJsonGet(ctx context.Context, actorId string, buildId string) ApiActOpenapiJsonGetRequest {
	return ApiActOpenapiJsonGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsActorBuildsAPIService) ActOpenapiJsonGetExecute(r ApiActOpenapiJsonGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorBuildsAPIService.ActOpenapiJsonGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/builds/{buildId}/openapi.json"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"buildId"+"}", url.PathEscape(parameterValueToString(r.buildId, "buildId")), -1)
