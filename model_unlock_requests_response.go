...
// checks if the UnlockRequestsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnlockRequestsResponse{}

// UnlockRequestsResponse Response containing the result of unlocking requests.
type UnlockRequestsResponse struct {
	Data UnlockRequestsResult `json:"data"`
}

type _UnlockRequestsResponse UnlockRequestsResponse

// NewUnlockRequestsResponse instantiates a new UnlockRequestsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUnlockRequestsResponse(data UnlockRequestsResult) *UnlockRequestsResponse {
	this := UnlockRequestsResponse{}
	this.Data = data
	return &this
}

// NewUnlockRequestsResponseWithDefaults instantiates a new UnlockRequestsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUnlockRequestsResponseWithDefaults() *UnlockRequestsResponse {
	this := UnlockRequestsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *UnlockRequestsResponse) GetData() UnlockRequestsResult {
	if o == nil {
		var ret UnlockRequestsResult
		return ret
	}
...
func (o *UnlockRequestsResponse) GetDataOk() (*UnlockRequestsResult, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *UnlockRequestsResponse) SetData(v UnlockRequestsResult) {
	o.Data = v
}

func (o UnlockRequestsResponse) MarshalJSON() ([]byte, error) {
...
func (o UnlockRequestsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *UnlockRequestsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUnlockRequestsResponse := _UnlockRequestsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUnlockRequestsResponse)

	if err != nil {
		return err
	}

	*o = UnlockRequestsResponse(varUnlockRequestsResponse)

	return err
}

type NullableUnlockRequestsResponse struct {
	value *UnlockRequestsResponse
	isSet bool
}

func (v NullableUnlockRequestsResponse) Get() *UnlockRequestsResponse {
	return v.value
}

func (v *NullableUnlockRequestsResponse) Set(val *UnlockRequestsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlockRequestsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlockRequestsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlockRequestsResponse(val *UnlockRequestsResponse) *NullableUnlockRequestsResponse {
	return &NullableUnlockRequestsResponse{value: val, isSet: true}
}

func (v NullableUnlockRequestsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlockRequestsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
