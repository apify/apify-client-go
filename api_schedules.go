...
func (r ApiScheduleDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ScheduleDeleteExecute(r)
}
...
Deletes a schedule.
 ...
 @return ApiScheduleDeleteRequest
*/
func (a *SchedulesAPIService) ScheduleDelete(ctx context.Context, scheduleId string) ApiScheduleDeleteRequest {
	return ApiScheduleDeleteRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SchedulesAPIService) ScheduleDeleteExecute(r ApiScheduleDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SchedulesAPIService.ScheduleDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/schedules/{scheduleId}"
...
func (r ApiScheduleGetRequest) Execute() (*ScheduleResponse, *http.Response, error) {
	return r.ApiService.ScheduleGetExecute(r)
}

/*
ScheduleGet Get schedule
...
*/
func (a *SchedulesAPIService) ScheduleGet(ctx context.Context, scheduleId string) ApiScheduleGetRequest {
	return ApiScheduleGetRequest{
		ApiService: a,
		ctx: ctx,
		scheduleId: scheduleId,
...
func (a *SchedulesAPIService) ScheduleGetExecute(r ApiScheduleGetRequest) (*ScheduleResponse, *http.Response, error) {
	var (
...
type ApiScheduleLogGetRequest struct {
	ctx context.Context
	ApiService *SchedulesAPIService
	scheduleId string
}

func (r ApiScheduleLogGetRequest) Execute() (*ScheduleLogResponse, *http.Response, error) {
	return r.ApiService.ScheduleLogGetExecute(r)
}

/*
ScheduleLogGet Get schedule log
...
1000 invocations of the schedule.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param scheduleId Schedule ID.
 @return ApiScheduleLogGetRequest
*/
func (a *SchedulesAPIService) ScheduleLogGet(ctx context.Context, scheduleId string) ApiScheduleLogGetRequest {
	return ApiScheduleLogGetRequest{
		ApiService: a,
		ctx: ctx,
		scheduleId: scheduleId,
...
func (a *SchedulesAPIService) ScheduleLogGetExecute(r ApiScheduleLogGetRequest) (*ScheduleLogResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ScheduleLogResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SchedulesAPIService.ScheduleLogGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/schedules/{scheduleId}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"scheduleId"+"}", url.PathEscape(parameterValueToString(r.scheduleId, "scheduleId")), -1)
...
type ApiSchedulePutRequest struct {
	ctx context.Context
	ApiService *SchedulesAPIService
	scheduleId string
...
// 
func (r ApiSchedulePutRequest) ScheduleCreate(scheduleCreate ScheduleCreate) ApiSchedulePutRequest {
	r.scheduleCreate = &scheduleCreate
	return r
}

func (r ApiSchedulePutRequest) Execute() (*ScheduleResponse, *http.Response, error) {
	return r.ApiService.SchedulePutExecute(r)
}

/*
SchedulePut Update schedule
...
info](#/introduction/authentication)).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param scheduleId Schedule ID.
 @return ApiSchedulePutRequest
*/
func (a *SchedulesAPIService) SchedulePut(ctx context.Context, scheduleId string) ApiSchedulePutRequest {
	return ApiSchedulePutRequest{
		ApiService: a,
		ctx: ctx,
		scheduleId: scheduleId,
...
// Execute executes the request
//  @return ScheduleResponse
func (a *SchedulesAPIService) SchedulePutExecute(r ApiSchedulePutRequest) (*ScheduleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SchedulesAPIService.SchedulePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSchedulesGetRequest) Offset(offset float64) ApiSchedulesGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiSchedulesGetRequest) Limit(limit float64) ApiSchedulesGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiSchedulesGetRequest) Desc(desc bool) ApiSchedulesGetRequest {
	r.desc = &desc
	return r
}

func (r ApiSchedulesGetRequest) Execute() (*ListOfSchedulesResponse, *http.Response, error) {
	return r.ApiService.SchedulesGetExecute(r)
}

/*
SchedulesGet Get list of schedules
...
// Execute executes the request
//  @return ListOfSchedulesResponse
func (a *SchedulesAPIService) SchedulesGetExecute(r ApiSchedulesGetRequest) (*ListOfSchedulesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfSchedulesResponse
	)
	...
	localVarPath := localBasePath + "/v2/schedules"
...
type ApiSchedulesPostRequest struct {
	ctx context.Context
	ApiService *SchedulesAPIService
	scheduleCreate *ScheduleCreate
}
...
// 
func (r ApiSchedulesPostRequest) ScheduleCreate(scheduleCreate ScheduleCreate) ApiSchedulesPostRequest {
	r.scheduleCreate = &scheduleCreate
	return r
}

func (r ApiSchedulesPostRequest) Execute() (*ScheduleResponse, *http.Response, error) {
	return r.ApiService.SchedulesPostExecute(r)
}

/*
SchedulesPost Create schedule
...
info](#/introduction/authentication)).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSchedulesPostRequest
*/
func (a *SchedulesAPIService) SchedulesPost(ctx context.Context) ApiSchedulesPostRequest {
	return ApiSchedulesPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ScheduleResponse
func (a *SchedulesAPIService) SchedulesPostExecute(r ApiSchedulesPostRequest) (*ScheduleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SchedulesAPIService.SchedulesPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
