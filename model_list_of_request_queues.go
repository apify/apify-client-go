...
// checks if the ListOfRequestQueues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRequestQueues{}

// ListOfRequestQueues A paginated list of request queues.
...
type _ListOfRequestQueues ListOfRequestQueues
...
func (o ListOfRequestQueues) MarshalJSON() ([]byte, error) {
...
func (o ListOfRequestQueues) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfRequestQueues) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRequestQueues := _ListOfRequestQueues{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRequestQueues)

	if err != nil {
		return err
	}

	*o = ListOfRequestQueues(varListOfRequestQueues)

	return err
}

type NullableListOfRequestQueues struct {
	value *ListOfRequestQueues
	isSet bool
}

func (v NullableListOfRequestQueues) Get() *ListOfRequestQueues {
	return v.value
}

func (v *NullableListOfRequestQueues) Set(val *ListOfRequestQueues) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRequestQueues) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRequestQueues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRequestQueues(val *ListOfRequestQueues) *NullableListOfRequestQueues {
	return &NullableListOfRequestQueues{value: val, isSet: true}
}

func (v NullableListOfRequestQueues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRequestQueues) UnmarshalJSON(src []byte) error {
	v.isSet = true
