...
// checks if the BuildActVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildActVersion{}

// BuildActVersion Snapshot of the Actor version that this build was created from.
type BuildActVersion struct {
	SourceType *VersionSourceType `json:"sourceType,omitempty"`
	BuildTag *string `json:"buildTag,omitempty"`
	VersionNumber *string `json:"versionNumber,omitempty" validate:"regexp=^([0-9]|[1-9][0-9])\\\\.([0-9]|[1-9][0-9])$"`
	...
	SourceFiles []SourceCodeFile `json:"sourceFiles,omitempty"`
}
...
// SetSourceType gets a reference to the given VersionSourceType and assigns it to the SourceType field.
...
// SetSourceFiles gets a reference to the given []SourceCodeFile and assigns it to the SourceFiles field.
func (o *BuildActVersion) SetSourceFiles(v []SourceCodeFile) {
	o.SourceFiles = v
}

func (o BuildActVersion) MarshalJSON() ([]byte, error) {
...
func (o BuildActVersion) ToMap() (map[string]interface{}, error) {
...
type NullableBuildActVersion struct {
	value *BuildActVersion
	isSet bool
}

func (v NullableBuildActVersion) Get() *BuildActVersion {
	return v.value
}

func (v *NullableBuildActVersion) Set(val *BuildActVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildActVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildActVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildActVersion(val *BuildActVersion) *NullableBuildActVersion {
	return &NullableBuildActVersion{value: val, isSet: true}
}

func (v NullableBuildActVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildActVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
