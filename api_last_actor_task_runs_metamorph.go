...
// LastActorTaskRunsMetamorphAPIService LastActorTaskRunsMetamorphAPI service
type LastActorTaskRunsMetamorphAPIService service

type ApiActorTaskRunsLastMetamorphPostRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsMetamorphAPIService
	actorTaskId string
...
func (r ApiActorTaskRunsLastMetamorphPostRequest) TargetActorId(targetActorId string) ApiActorTaskRunsLastMetamorphPostRequest {
	r.targetActorId = &targetActorId
	return r
}

// Filter for the run status.
func (r ApiActorTaskRunsLastMetamorphPostRequest) Status(status string) ApiActorTaskRunsLastMetamorphPostRequest {
	r.status = &status
	return r
}
...
func (r ApiActorTaskRunsLastMetamorphPostRequest) Build(build string) ApiActorTaskRunsLastMetamorphPostRequest {
	r.build = &build
	return r
}

func (r ApiActorTaskRunsLastMetamorphPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastMetamorphPostExecute(r)
}

/*
ActorTaskRunsLastMetamorphPost Metamorph Actor task's last run
...
on the Actor task's last run.
 ...
 @return ApiActorTaskRunsLastMetamorphPostRequest
*/
func (a *LastActorTaskRunsMetamorphAPIService) ActorTaskRunsLastMetamorphPost(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastMetamorphPostRequest {
	return ApiActorTaskRunsLastMetamorphPostRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return RunResponse
func (a *LastActorTaskRunsMetamorphAPIService) ActorTaskRunsLastMetamorphPostExecute(r ApiActorTaskRunsLastMetamorphPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsMetamorphAPIService.ActorTaskRunsLastMetamorphPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/metamorph"
