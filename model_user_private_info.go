...
// checks if the UserPrivateInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserPrivateInfo{}

// UserPrivateInfo struct for UserPrivateInfo
...
type _UserPrivateInfo UserPrivateInfo
...
// GetEffectivePlatformFeatures returns the EffectivePlatformFeatures field value
func (o *UserPrivateInfo) GetEffectivePlatformFeatures() EffectivePlatformFeatures {
	if o == nil {
		var ret EffectivePlatformFeatures
		return ret
	}

	return o.EffectivePlatformFeatures
}

// GetEffectivePlatformFeaturesOk returns a tuple with the EffectivePlatformFeatures field value
// and a boolean to check if the value has been set.
func (o *UserPrivateInfo) GetEffectivePlatformFeaturesOk() (*EffectivePlatformFeatures, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EffectivePlatformFeatures, true
}

// SetEffectivePlatformFeatures sets field value
func (o *UserPrivateInfo) SetEffectivePlatformFeatures(v EffectivePlatformFeatures) {
	o.EffectivePlatformFeatures = v
}
...
// GetIsPaying returns the IsPaying field value
...
// GetIsPayingOk returns a tuple with the IsPaying field value
// and a boolean to check if the value has been set.
func (o *UserPrivateInfo) GetIsPayingOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsPaying, true
}

// SetIsPaying sets field value
func (o *UserPrivateInfo) SetIsPaying(v bool) {
	o.IsPaying = v
}

func (o UserPrivateInfo) MarshalJSON() ([]byte, error) {
...
func (o UserPrivateInfo) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["effectivePlatformFeatures"] = o.EffectivePlatformFeatures
	toSerialize["createdAt"] = o.CreatedAt
	toSerialize["isPaying"] = o.IsPaying
	return toSerialize, nil
}

func (o *UserPrivateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varUserPrivateInfo := _UserPrivateInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserPrivateInfo)

	if err != nil {
		return err
	}

	*o = UserPrivateInfo(varUserPrivateInfo)

	return err
}

type NullableUserPrivateInfo struct {
	value *UserPrivateInfo
	isSet bool
}

func (v NullableUserPrivateInfo) Get() *UserPrivateInfo {
	return v.value
}

func (v *NullableUserPrivateInfo) Set(val *UserPrivateInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableUserPrivateInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableUserPrivateInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserPrivateInfo(val *UserPrivateInfo) *NullableUserPrivateInfo {
	return &NullableUserPrivateInfo{value: val, isSet: true}
}

func (v NullableUserPrivateInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserPrivateInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
