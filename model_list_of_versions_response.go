...
// checks if the ListOfVersionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfVersionsResponse{}

// ListOfVersionsResponse struct for ListOfVersionsResponse
type ListOfVersionsResponse struct {
	Data ListOfVersions `json:"data"`
}

type _ListOfVersionsResponse ListOfVersionsResponse

// NewListOfVersionsResponse instantiates a new ListOfVersionsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfVersionsResponse(data ListOfVersions) *ListOfVersionsResponse {
	this := ListOfVersionsResponse{}
	this.Data = data
	return &this
}

// NewListOfVersionsResponseWithDefaults instantiates a new ListOfVersionsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfVersionsResponseWithDefaults() *ListOfVersionsResponse {
	this := ListOfVersionsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfVersionsResponse) GetData() ListOfVersions {
	if o == nil {
		var ret ListOfVersions
		return ret
	}
...
func (o *ListOfVersionsResponse) GetDataOk() (*ListOfVersions, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfVersionsResponse) SetData(v ListOfVersions) {
	o.Data = v
}

func (o ListOfVersionsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfVersionsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfVersionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfVersionsResponse := _ListOfVersionsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfVersionsResponse)

	if err != nil {
		return err
	}

	*o = ListOfVersionsResponse(varListOfVersionsResponse)

	return err
}

type NullableListOfVersionsResponse struct {
	value *ListOfVersionsResponse
	isSet bool
}

func (v NullableListOfVersionsResponse) Get() *ListOfVersionsResponse {
	return v.value
}

func (v *NullableListOfVersionsResponse) Set(val *ListOfVersionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfVersionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfVersionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfVersionsResponse(val *ListOfVersionsResponse) *NullableListOfVersionsResponse {
	return &NullableListOfVersionsResponse{value: val, isSet: true}
}

func (v NullableListOfVersionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfVersionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
