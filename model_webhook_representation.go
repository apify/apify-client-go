...
// checks if the WebhookRepresentation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookRepresentation{}

// WebhookRepresentation Minimal representation of an ad-hoc webhook attached to a single Actor run or build via the `webhooks` query parameter. The query parameter value is a Base64-encoded JSON array whose items match this schema. Persistent webhook fields (e.g. `condition`) are not used here. 
type WebhookRepresentation struct {
	...
	PayloadTemplate NullableString `json:"payloadTemplate,omitempty"`
	// Optional template for the HTTP headers sent by the webhook.
	HeadersTemplate NullableString `json:"headersTemplate,omitempty"`
	// Flag to also interpolate `{{...}}` variables inside string values of the payload and headers templates.
	ShouldInterpolateStrings NullableBool `json:"shouldInterpolateStrings,omitempty"`
	...
	IgnoreSslErrors NullableBool `json:"ignoreSslErrors,omitempty"`
	// Flag to skip retrying the webhook request on failure.
	DoNotRetry NullableBool `json:"doNotRetry,omitempty"`
}

type _WebhookRepresentation WebhookRepresentation
...
func (o *WebhookRepresentation) GetPayloadTemplate() string {
	if o == nil || IsNil(o.PayloadTemplate.Get()) {
		var ret string
		return ret
	}
	return *o.PayloadTemplate.Get()
}
...
func (o *WebhookRepresentation) GetPayloadTemplateOk() (*string, bool) {
	...
	return o.PayloadTemplate.Get(), o.PayloadTemplate.IsSet()
}

// HasPayloadTemplate returns a boolean if a field has been set.
func (o *WebhookRepresentation) HasPayloadTemplate() bool {
	if o != nil && o.PayloadTemplate.IsSet() {
		return true
	}
...
// SetPayloadTemplate gets a reference to the given NullableString and assigns it to the PayloadTemplate field.
func (o *WebhookRepresentation) SetPayloadTemplate(v string) {
	o.PayloadTemplate.Set(&v)
}
// SetPayloadTemplateNil sets the value for PayloadTemplate to be an explicit nil
func (o *WebhookRepresentation) SetPayloadTemplateNil() {
	o.PayloadTemplate.Set(nil)
}
...
func (o *WebhookRepresentation) UnsetPayloadTemplate() {
	o.PayloadTemplate.Unset()
}

// GetHeadersTemplate returns the HeadersTemplate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookRepresentation) GetHeadersTemplate() string {
	if o == nil || IsNil(o.HeadersTemplate.Get()) {
		var ret string
		return ret
	}
	return *o.HeadersTemplate.Get()
}
...
// SetHeadersTemplate gets a reference to the given NullableString and assigns it to the HeadersTemplate field.
func (o *WebhookRepresentation) SetHeadersTemplate(v string) {
	o.HeadersTemplate.Set(&v)
}
// SetHeadersTemplateNil sets the value for HeadersTemplate to be an explicit nil
func (o *WebhookRepresentation) SetHeadersTemplateNil() {
	o.HeadersTemplate.Set(nil)
}
...
func (o *WebhookRepresentation) UnsetHeadersTemplate() {
	o.HeadersTemplate.Unset()
}

// GetShouldInterpolateStrings returns the ShouldInterpolateStrings field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookRepresentation) GetShouldInterpolateStrings() bool {
	if o == nil || IsNil(o.ShouldInterpolateStrings.Get()) {
		var ret bool
		return ret
	}
	return *o.ShouldInterpolateStrings.Get()
}

// GetShouldInterpolateStringsOk returns a tuple with the ShouldInterpolateStrings field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookRepresentation) GetShouldInterpolateStringsOk() (*bool, bool) {
	...
	return o.ShouldInterpolateStrings.Get(), o.ShouldInterpolateStrings.IsSet()
}
...
func (o *WebhookRepresentation) HasShouldInterpolateStrings() bool {
	if o != nil && o.ShouldInterpolateStrings.IsSet() {
		return true
	}
...
// SetShouldInterpolateStrings gets a reference to the given NullableBool and assigns it to the ShouldInterpolateStrings field.
func (o *WebhookRepresentation) SetShouldInterpolateStrings(v bool) {
	o.ShouldInterpolateStrings.Set(&v)
}
// SetShouldInterpolateStringsNil sets the value for ShouldInterpolateStrings to be an explicit nil
func (o *WebhookRepresentation) SetShouldInterpolateStringsNil() {
	o.ShouldInterpolateStrings.Set(nil)
}
...
func (o *WebhookRepresentation) UnsetShouldInterpolateStrings() {
	o.ShouldInterpolateStrings.Unset()
}
...
// GetIgnoreSslErrors returns the IgnoreSslErrors field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookRepresentation) GetIgnoreSslErrors() bool {
	if o == nil || IsNil(o.IgnoreSslErrors.Get()) {
		var ret bool
		return ret
	}
	return *o.IgnoreSslErrors.Get()
}
...
// SetIgnoreSslErrors gets a reference to the given NullableBool and assigns it to the IgnoreSslErrors field.
func (o *WebhookRepresentation) SetIgnoreSslErrors(v bool) {
	o.IgnoreSslErrors.Set(&v)
}
// SetIgnoreSslErrorsNil sets the value for IgnoreSslErrors to be an explicit nil
func (o *WebhookRepresentation) SetIgnoreSslErrorsNil() {
	o.IgnoreSslErrors.Set(nil)
}
...
func (o *WebhookRepresentation) UnsetIgnoreSslErrors() {
	o.IgnoreSslErrors.Unset()
}

// GetDoNotRetry returns the DoNotRetry field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookRepresentation) GetDoNotRetry() bool {
	if o == nil || IsNil(o.DoNotRetry.Get()) {
		var ret bool
		return ret
	}
	return *o.DoNotRetry.Get()
}

// GetDoNotRetryOk returns a tuple with the DoNotRetry field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetDoNotRetry gets a reference to the given NullableBool and assigns it to the DoNotRetry field.
func (o *WebhookRepresentation) SetDoNotRetry(v bool) {
	o.DoNotRetry.Set(&v)
}
// SetDoNotRetryNil sets the value for DoNotRetry to be an explicit nil
func (o *WebhookRepresentation) SetDoNotRetryNil() {
	o.DoNotRetry.Set(nil)
}
...
func (o WebhookRepresentation) MarshalJSON() ([]byte, error) {
...
func (o WebhookRepresentation) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["eventTypes"] = o.EventTypes
	toSerialize["requestUrl"] = o.RequestUrl
	if o.PayloadTemplate.IsSet() {
		toSerialize["payloadTemplate"] = o.PayloadTemplate.Get()
	}
	if o.HeadersTemplate.IsSet() {
		toSerialize["headersTemplate"] = o.HeadersTemplate.Get()
	}
	if o.ShouldInterpolateStrings.IsSet() {
		toSerialize["shouldInterpolateStrings"] = o.ShouldInterpolateStrings.Get()
	}
	if o.IdempotencyKey.IsSet() {
		toSerialize["idempotencyKey"] = o.IdempotencyKey.Get()
	}
	if o.IgnoreSslErrors.IsSet() {
		toSerialize["ignoreSslErrors"] = o.IgnoreSslErrors.Get()
	}
	if o.DoNotRetry.IsSet() {
		toSerialize["doNotRetry"] = o.DoNotRetry.Get()
	}
	return toSerialize, nil
}

func (o *WebhookRepresentation) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookRepresentation := _WebhookRepresentation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookRepresentation)

	if err != nil {
		return err
	}

	*o = WebhookRepresentation(varWebhookRepresentation)

	return err
}

type NullableWebhookRepresentation struct {
	value *WebhookRepresentation
	isSet bool
}

func (v NullableWebhookRepresentation) Get() *WebhookRepresentation {
	return v.value
}

func (v *NullableWebhookRepresentation) Set(val *WebhookRepresentation) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookRepresentation) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookRepresentation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookRepresentation(val *WebhookRepresentation) *NullableWebhookRepresentation {
	return &NullableWebhookRepresentation{value: val, isSet: true}
}

func (v NullableWebhookRepresentation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookRepresentation) UnmarshalJSON(src []byte) error {
	v.isSet = true
