...
// checks if the ActorTaskRunsGet200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskRunsGet200ResponseData{}

// ActorTaskRunsGet200ResponseData struct for ActorTaskRunsGet200ResponseData
type ActorTaskRunsGet200ResponseData struct {
...
type _ActorTaskRunsGet200ResponseData ActorTaskRunsGet200ResponseData

// NewActorTaskRunsGet200ResponseData instantiates a new ActorTaskRunsGet200ResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskRunsGet200ResponseData(total int32, offset int32, limit int32, desc bool, count int32, items []RunShort) *ActorTaskRunsGet200ResponseData {
	this := ActorTaskRunsGet200ResponseData{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
	this.Desc = desc
...
// NewActorTaskRunsGet200ResponseDataWithDefaults instantiates a new ActorTaskRunsGet200ResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskRunsGet200ResponseDataWithDefaults() *ActorTaskRunsGet200ResponseData {
	this := ActorTaskRunsGet200ResponseData{}
	return &this
}

// GetTotal returns the Total field value
func (o *ActorTaskRunsGet200ResponseData) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ActorTaskRunsGet200ResponseData) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ActorTaskRunsGet200ResponseData) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ActorTaskRunsGet200ResponseData) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskRunsGet200ResponseData) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ActorTaskRunsGet200ResponseData) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ActorTaskRunsGet200ResponseData) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskRunsGet200ResponseData) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ActorTaskRunsGet200ResponseData) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ActorTaskRunsGet200ResponseData) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskRunsGet200ResponseData) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ActorTaskRunsGet200ResponseData) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ActorTaskRunsGet200ResponseData) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskRunsGet200ResponseData) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ActorTaskRunsGet200ResponseData) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ActorTaskRunsGet200ResponseData) GetItems() []RunShort {
	if o == nil {
		var ret []RunShort
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ActorTaskRunsGet200ResponseData) GetItemsOk() ([]RunShort, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ActorTaskRunsGet200ResponseData) SetItems(v []RunShort) {
	o.Items = v
}

func (o ActorTaskRunsGet200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskRunsGet200ResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *ActorTaskRunsGet200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskRunsGet200ResponseData := _ActorTaskRunsGet200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskRunsGet200ResponseData)

	if err != nil {
		return err
	}

	*o = ActorTaskRunsGet200ResponseData(varActorTaskRunsGet200ResponseData)

	return err
}

type NullableActorTaskRunsGet200ResponseData struct {
	value *ActorTaskRunsGet200ResponseData
	isSet bool
}

func (v NullableActorTaskRunsGet200ResponseData) Get() *ActorTaskRunsGet200ResponseData {
	return v.value
}

func (v *NullableActorTaskRunsGet200ResponseData) Set(val *ActorTaskRunsGet200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskRunsGet200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskRunsGet200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskRunsGet200ResponseData(val *ActorTaskRunsGet200ResponseData) *NullableActorTaskRunsGet200ResponseData {
	return &NullableActorTaskRunsGet200ResponseData{value: val, isSet: true}
}

func (v NullableActorTaskRunsGet200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskRunsGet200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
