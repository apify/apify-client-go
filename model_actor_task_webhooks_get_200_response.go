...
// checks if the ActorTaskWebhooksGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskWebhooksGet200Response{}

// ActorTaskWebhooksGet200Response struct for ActorTaskWebhooksGet200Response
type ActorTaskWebhooksGet200Response struct {
	Data ActorTaskWebhooksGet200ResponseData `json:"data"`
}

type _ActorTaskWebhooksGet200Response ActorTaskWebhooksGet200Response

// NewActorTaskWebhooksGet200Response instantiates a new ActorTaskWebhooksGet200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskWebhooksGet200Response(data ActorTaskWebhooksGet200ResponseData) *ActorTaskWebhooksGet200Response {
	this := ActorTaskWebhooksGet200Response{}
	this.Data = data
	return &this
}

// NewActorTaskWebhooksGet200ResponseWithDefaults instantiates a new ActorTaskWebhooksGet200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskWebhooksGet200ResponseWithDefaults() *ActorTaskWebhooksGet200Response {
	this := ActorTaskWebhooksGet200Response{}
	return &this
}

// GetData returns the Data field value
func (o *ActorTaskWebhooksGet200Response) GetData() ActorTaskWebhooksGet200ResponseData {
	if o == nil {
		var ret ActorTaskWebhooksGet200ResponseData
		return ret
	}
...
func (o *ActorTaskWebhooksGet200Response) GetDataOk() (*ActorTaskWebhooksGet200ResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ActorTaskWebhooksGet200Response) SetData(v ActorTaskWebhooksGet200ResponseData) {
	o.Data = v
}

func (o ActorTaskWebhooksGet200Response) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskWebhooksGet200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ActorTaskWebhooksGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskWebhooksGet200Response := _ActorTaskWebhooksGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskWebhooksGet200Response)

	if err != nil {
		return err
	}

	*o = ActorTaskWebhooksGet200Response(varActorTaskWebhooksGet200Response)

	return err
}

type NullableActorTaskWebhooksGet200Response struct {
	value *ActorTaskWebhooksGet200Response
	isSet bool
}

func (v NullableActorTaskWebhooksGet200Response) Get() *ActorTaskWebhooksGet200Response {
	return v.value
}

func (v *NullableActorTaskWebhooksGet200Response) Set(val *ActorTaskWebhooksGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskWebhooksGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskWebhooksGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskWebhooksGet200Response(val *ActorTaskWebhooksGet200Response) *NullableActorTaskWebhooksGet200Response {
	return &NullableActorTaskWebhooksGet200Response{value: val, isSet: true}
}

func (v NullableActorTaskWebhooksGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskWebhooksGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
