...
// checks if the RequestQueueStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestQueueStats{}

// RequestQueueStats Statistics about request queue operations and storage.
type RequestQueueStats struct {
	...
	HeadItemReadCount *int32 `json:"headItemReadCount,omitempty"`
	...
	WriteCount *int32 `json:"writeCount,omitempty"`
}
...
// GetDeleteCount returns the DeleteCount field value if set, zero value otherwise.
func (o *RequestQueueStats) GetDeleteCount() int32 {
	if o == nil || IsNil(o.DeleteCount) {
		var ret int32
		return ret
	}
...
// GetDeleteCountOk returns a tuple with the DeleteCount field value if set, nil otherwise
...
// SetDeleteCount gets a reference to the given int32 and assigns it to the DeleteCount field.
func (o *RequestQueueStats) SetDeleteCount(v int32) {
	o.DeleteCount = &v
}

// GetHeadItemReadCount returns the HeadItemReadCount field value if set, zero value otherwise.
func (o *RequestQueueStats) GetHeadItemReadCount() int32 {
	if o == nil || IsNil(o.HeadItemReadCount) {
		var ret int32
		return ret
	}
	return *o.HeadItemReadCount
}

// GetHeadItemReadCountOk returns a tuple with the HeadItemReadCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RequestQueueStats) GetHeadItemReadCountOk() (*int32, bool) {
	if o == nil || IsNil(o.HeadItemReadCount) {
		return nil, false
	}
	return o.HeadItemReadCount, true
}
...
// SetHeadItemReadCount gets a reference to the given int32 and assigns it to the HeadItemReadCount field.
func (o *RequestQueueStats) SetHeadItemReadCount(v int32) {
	o.HeadItemReadCount = &v
}
...
// SetWriteCount gets a reference to the given int32 and assigns it to the WriteCount field.
func (o *RequestQueueStats) SetWriteCount(v int32) {
	o.WriteCount = &v
}

func (o RequestQueueStats) MarshalJSON() ([]byte, error) {
...
func (o RequestQueueStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DeleteCount) {
		toSerialize["deleteCount"] = o.DeleteCount
	}
	if !IsNil(o.HeadItemReadCount) {
		toSerialize["headItemReadCount"] = o.HeadItemReadCount
	}
...
type NullableRequestQueueStats struct {
	value *RequestQueueStats
	isSet bool
}

func (v NullableRequestQueueStats) Get() *RequestQueueStats {
	return v.value
}

func (v *NullableRequestQueueStats) Set(val *RequestQueueStats) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestQueueStats) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestQueueStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestQueueStats(val *RequestQueueStats) *NullableRequestQueueStats {
	return &NullableRequestQueueStats{value: val, isSet: true}
}

func (v NullableRequestQueueStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestQueueStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
