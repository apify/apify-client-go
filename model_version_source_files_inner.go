...
// VersionSourceFilesInner struct for VersionSourceFilesInner
type VersionSourceFilesInner struct {
	SourceCodeFile *SourceCodeFile
	SourceCodeFolder *SourceCodeFolder
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *VersionSourceFilesInner) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into SourceCodeFile
	err = json.Unmarshal(data, &dst.SourceCodeFile);
	if err == nil {
		jsonSourceCodeFile, _ := json.Marshal(dst.SourceCodeFile)
		if string(jsonSourceCodeFile) == "{}" { // empty struct
			dst.SourceCodeFile = nil
		} else {
			return nil // data stored in dst.SourceCodeFile, return on the first match
		}
	} else {
		dst.SourceCodeFile = nil
	}

	// try to unmarshal JSON data into SourceCodeFolder
	err = json.Unmarshal(data, &dst.SourceCodeFolder);
	if err == nil {
		jsonSourceCodeFolder, _ := json.Marshal(dst.SourceCodeFolder)
		if string(jsonSourceCodeFolder) == "{}" { // empty struct
			dst.SourceCodeFolder = nil
		} else {
			return nil // data stored in dst.SourceCodeFolder, return on the first match
		}
	} else {
		dst.SourceCodeFolder = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(VersionSourceFilesInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src VersionSourceFilesInner) MarshalJSON() ([]byte, error) {
	if src.SourceCodeFile != nil {
		return json.Marshal(&src.SourceCodeFile)
	}

	if src.SourceCodeFolder != nil {
		return json.Marshal(&src.SourceCodeFolder)
	}
...
type NullableVersionSourceFilesInner struct {
	value *VersionSourceFilesInner
	isSet bool
}

func (v NullableVersionSourceFilesInner) Get() *VersionSourceFilesInner {
	return v.value
}

func (v *NullableVersionSourceFilesInner) Set(val *VersionSourceFilesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionSourceFilesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionSourceFilesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionSourceFilesInner(val *VersionSourceFilesInner) *NullableVersionSourceFilesInner {
	return &NullableVersionSourceFilesInner{value: val, isSet: true}
}

func (v NullableVersionSourceFilesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionSourceFilesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
