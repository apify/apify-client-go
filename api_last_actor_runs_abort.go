...
// LastActorRunsAbortAPIService LastActorRunsAbortAPI service
type LastActorRunsAbortAPIService service

type ApiActRunsLastAbortPostRequest struct {
	ctx context.Context
	ApiService *LastActorRunsAbortAPIService
	actorId string
	status *string
	gracefully *bool
}
...
func (r ApiActRunsLastAbortPostRequest) Status(status string) ApiActRunsLastAbortPostRequest {
	r.status = &status
	return r
}
...
func (r ApiActRunsLastAbortPostRequest) Gracefully(gracefully bool) ApiActRunsLastAbortPostRequest {
	r.gracefully = &gracefully
	return r
}

func (r ApiActRunsLastAbortPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastAbortPostExecute(r)
}

/*
ActRunsLastAbortPost Abort Actor's last run
...
does nothing.
 ...
 @return ApiActRunsLastAbortPostRequest
*/
func (a *LastActorRunsAbortAPIService) ActRunsLastAbortPost(ctx context.Context, actorId string) ApiActRunsLastAbortPostRequest {
	return ApiActRunsLastAbortPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
//  @return RunResponse
func (a *LastActorRunsAbortAPIService) ActRunsLastAbortPostExecute(r ApiActRunsLastAbortPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsAbortAPIService.ActRunsLastAbortPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/abort"
