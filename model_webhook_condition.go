...
// checks if the WebhookCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookCondition{}

// WebhookCondition struct for WebhookCondition
type WebhookCondition struct {
	...
	ActorRunId NullableString `json:"actorRunId,omitempty"`
}

// NewWebhookCondition instantiates a new WebhookCondition object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebhookCondition() *WebhookCondition {
	this := WebhookCondition{}
	return &this
}

// NewWebhookConditionWithDefaults instantiates a new WebhookCondition object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWebhookConditionWithDefaults() *WebhookCondition {
	this := WebhookCondition{}
	return &this
}

// GetActorId returns the ActorId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookCondition) GetActorId() string {
...
func (o *WebhookCondition) GetActorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebhookCondition) HasActorId() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookCondition) GetActorTaskIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebhookCondition) HasActorTaskId() bool {
...
func (o *WebhookCondition) SetActorTaskId(v string) {
	o.ActorTaskId.Set(&v)
}
// SetActorTaskIdNil sets the value for ActorTaskId to be an explicit nil
func (o *WebhookCondition) SetActorTaskIdNil() {
	o.ActorTaskId.Set(nil)
}

// UnsetActorTaskId ensures that no value is present for ActorTaskId, not even an explicit nil
func (o *WebhookCondition) UnsetActorTaskId() {
	o.ActorTaskId.Unset()
}

// GetActorRunId returns the ActorRunId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebhookCondition) GetActorRunId() string {
	if o == nil || IsNil(o.ActorRunId.Get()) {
		var ret string
		return ret
	}
	return *o.ActorRunId.Get()
}

// GetActorRunIdOk returns a tuple with the ActorRunId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookCondition) GetActorRunIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ActorRunId.Get(), o.ActorRunId.IsSet()
}

// HasActorRunId returns a boolean if a field has been set.
func (o *WebhookCondition) HasActorRunId() bool {
	if o != nil && o.ActorRunId.IsSet() {
		return true
	}
...
// SetActorRunId gets a reference to the given NullableString and assigns it to the ActorRunId field.
func (o *WebhookCondition) SetActorRunId(v string) {
	o.ActorRunId.Set(&v)
}
// SetActorRunIdNil sets the value for ActorRunId to be an explicit nil
func (o *WebhookCondition) SetActorRunIdNil() {
	o.ActorRunId.Set(nil)
}

// UnsetActorRunId ensures that no value is present for ActorRunId, not even an explicit nil
func (o *WebhookCondition) UnsetActorRunId() {
	o.ActorRunId.Unset()
}

func (o WebhookCondition) MarshalJSON() ([]byte, error) {
...
func (o WebhookCondition) ToMap() (map[string]interface{}, error) {
	...
	if o.ActorRunId.IsSet() {
		toSerialize["actorRunId"] = o.ActorRunId.Get()
	}
	return toSerialize, nil
}

type NullableWebhookCondition struct {
	value *WebhookCondition
	isSet bool
}

func (v NullableWebhookCondition) Get() *WebhookCondition {
	return v.value
}

func (v *NullableWebhookCondition) Set(val *WebhookCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookCondition(val *WebhookCondition) *NullableWebhookCondition {
	return &NullableWebhookCondition{value: val, isSet: true}
}

func (v NullableWebhookCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
