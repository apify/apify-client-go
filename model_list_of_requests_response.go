...
// checks if the ListOfRequestsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRequestsResponse{}

// ListOfRequestsResponse Response containing a list of requests from the request queue.
type ListOfRequestsResponse struct {
	Data ListOfRequests `json:"data"`
}

type _ListOfRequestsResponse ListOfRequestsResponse

// NewListOfRequestsResponse instantiates a new ListOfRequestsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfRequestsResponse(data ListOfRequests) *ListOfRequestsResponse {
	this := ListOfRequestsResponse{}
	this.Data = data
	return &this
}

// NewListOfRequestsResponseWithDefaults instantiates a new ListOfRequestsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfRequestsResponseWithDefaults() *ListOfRequestsResponse {
	this := ListOfRequestsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfRequestsResponse) GetData() ListOfRequests {
	if o == nil {
		var ret ListOfRequests
		return ret
	}
...
func (o *ListOfRequestsResponse) GetDataOk() (*ListOfRequests, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfRequestsResponse) SetData(v ListOfRequests) {
	o.Data = v
}

func (o ListOfRequestsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfRequestsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfRequestsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRequestsResponse := _ListOfRequestsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRequestsResponse)

	if err != nil {
		return err
	}

	*o = ListOfRequestsResponse(varListOfRequestsResponse)

	return err
}

type NullableListOfRequestsResponse struct {
	value *ListOfRequestsResponse
	isSet bool
}

func (v NullableListOfRequestsResponse) Get() *ListOfRequestsResponse {
	return v.value
}

func (v *NullableListOfRequestsResponse) Set(val *ListOfRequestsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRequestsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRequestsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRequestsResponse(val *ListOfRequestsResponse) *NullableListOfRequestsResponse {
	return &NullableListOfRequestsResponse{value: val, isSet: true}
}

func (v NullableListOfRequestsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRequestsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
