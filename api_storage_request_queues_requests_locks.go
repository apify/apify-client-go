...
// StorageRequestQueuesRequestsLocksAPIService StorageRequestQueuesRequestsLocksAPI service
type StorageRequestQueuesRequestsLocksAPIService service

type ApiRequestQueueHeadGetRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsLocksAPIService
	queueId string
	limit *float64
	clientKey *string
}
...
func (r ApiRequestQueueHeadGetRequest) Limit(limit float64) ApiRequestQueueHeadGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiRequestQueueHeadGetRequest) ClientKey(clientKey string) ApiRequestQueueHeadGetRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueHeadGetRequest) Execute() (*HeadResponse, *http.Response, error) {
	return r.ApiService.RequestQueueHeadGetExecute(r)
}

/*
RequestQueueHeadGet Get head
...
optimize performance of certain operations.
 ...
 @return ApiRequestQueueHeadGetRequest
*/
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueHeadGet(ctx context.Context, queueId string) ApiRequestQueueHeadGetRequest {
	return ApiRequestQueueHeadGetRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
//  @return HeadResponse
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueHeadGetExecute(r ApiRequestQueueHeadGetRequest) (*HeadResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsLocksAPIService.RequestQueueHeadGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/head"
...
type ApiRequestQueueHeadLockPostRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsLocksAPIService
	queueId string
	lockSecs *float64
...
func (r ApiRequestQueueHeadLockPostRequest) LockSecs(lockSecs float64) ApiRequestQueueHeadLockPostRequest {
	r.lockSecs = &lockSecs
	return r
}

// How many items from the queue should be returned.
func (r ApiRequestQueueHeadLockPostRequest) Limit(limit float64) ApiRequestQueueHeadLockPostRequest {
	r.limit = &limit
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueHeadLockPostRequest) ClientKey(clientKey string) ApiRequestQueueHeadLockPostRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueHeadLockPostRequest) Execute() (*HeadAndLockResponse, *http.Response, error) {
	return r.ApiService.RequestQueueHeadLockPostExecute(r)
}

/*
RequestQueueHeadLockPost Get head and lock
...
`clientKey`).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueHeadLockPostRequest
*/
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueHeadLockPost(ctx context.Context, queueId string) ApiRequestQueueHeadLockPostRequest {
	return ApiRequestQueueHeadLockPostRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueHeadLockPostExecute(r ApiRequestQueueHeadLockPostRequest) (*HeadAndLockResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsLocksAPIService.RequestQueueHeadLockPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/head/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"queueId"+"}", url.PathEscape(parameterValueToString(r.queueId, "queueId")), -1)
...
type ApiRequestQueueRequestLockDeleteRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsLocksAPIService
	queueId string
	requestId string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestLockDeleteRequest) ClientKey(clientKey string) ApiRequestQueueRequestLockDeleteRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end after lock was removed. 
func (r ApiRequestQueueRequestLockDeleteRequest) Forefront(forefront string) ApiRequestQueueRequestLockDeleteRequest {
	r.forefront = &forefront
	return r
}

func (r ApiRequestQueueRequestLockDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.RequestQueueRequestLockDeleteExecute(r)
}

/*
RequestQueueRequestLockDelete Delete request lock
...
*/
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestLockDelete(ctx context.Context, queueId string, requestId string) ApiRequestQueueRequestLockDeleteRequest {
	return ApiRequestQueueRequestLockDeleteRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
// Execute executes the request
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestLockDeleteExecute(r ApiRequestQueueRequestLockDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsLocksAPIService.RequestQueueRequestLockDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/requests/{requestId}/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"queueId"+"}", url.PathEscape(parameterValueToString(r.queueId, "queueId")), -1)
...
type ApiRequestQueueRequestLockPutRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsLocksAPIService
	queueId string
	requestId string
...
// How long the requests will be locked for (in seconds).
func (r ApiRequestQueueRequestLockPutRequest) LockSecs(lockSecs float64) ApiRequestQueueRequestLockPutRequest {
	r.lockSecs = &lockSecs
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestLockPutRequest) ClientKey(clientKey string) ApiRequestQueueRequestLockPutRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end after lock expires. 
func (r ApiRequestQueueRequestLockPutRequest) Forefront(forefront string) ApiRequestQueueRequestLockPutRequest {
	r.forefront = &forefront
	return r
}

func (r ApiRequestQueueRequestLockPutRequest) Execute() (*ProlongRequestLockResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestLockPutExecute(r)
}

/*
RequestQueueRequestLockPut Prolong request lock
...
You can delete or prolong the lock only for requests that were locked by the same client key or from the same Actor run.
 ...
 @param queueId Queue ID or `username~queue-name`.
 @param requestId Request ID.
 @return ApiRequestQueueRequestLockPutRequest
*/
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestLockPut(ctx context.Context, queueId string, requestId string) ApiRequestQueueRequestLockPutRequest {
	return ApiRequestQueueRequestLockPutRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestLockPutExecute(r ApiRequestQueueRequestLockPutRequest) (*ProlongRequestLockResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsLocksAPIService.RequestQueueRequestLockPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRequestQueueRequestsUnlockPostRequest struct {
	ctx context.Context
	ApiService *StorageRequestQueuesRequestsLocksAPIService
	queueId string
	clientKey *string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiRequestQueueRequestsUnlockPostRequest) ClientKey(clientKey string) ApiRequestQueueRequestsUnlockPostRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiRequestQueueRequestsUnlockPostRequest) Execute() (*UnlockRequestsResponse, *http.Response, error) {
	return r.ApiService.RequestQueueRequestsUnlockPostExecute(r)
}

/*
RequestQueueRequestsUnlockPost Unlock requests
...
* If the client is outside of an Actor run, it unlocks all requests locked using the same clientKey.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param queueId Queue ID or `username~queue-name`.
 @return ApiRequestQueueRequestsUnlockPostRequest
*/
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestsUnlockPost(ctx context.Context, queueId string) ApiRequestQueueRequestsUnlockPostRequest {
	return ApiRequestQueueRequestsUnlockPostRequest{
		ApiService: a,
		ctx: ctx,
		queueId: queueId,
...
func (a *StorageRequestQueuesRequestsLocksAPIService) RequestQueueRequestsUnlockPostExecute(r ApiRequestQueueRequestsUnlockPostRequest) (*UnlockRequestsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StorageRequestQueuesRequestsLocksAPIService.RequestQueueRequestsUnlockPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/request-queues/{queueId}/requests/unlock"
	localVarPath = strings.Replace(localVarPath, "{"+"queueId"+"}", url.PathEscape(parameterValueToString(r.queueId, "queueId")), -1)
