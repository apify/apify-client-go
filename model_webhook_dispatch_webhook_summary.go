...
// checks if the WebhookDispatchWebhookSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookDispatchWebhookSummary{}

// WebhookDispatchWebhookSummary A summary of the webhook that triggered this dispatch.
type WebhookDispatchWebhookSummary struct {
...
func NewWebhookDispatchWebhookSummary() *WebhookDispatchWebhookSummary {
	this := WebhookDispatchWebhookSummary{}
	return &this
}
...
// SetCondition gets a reference to the given WebhookCondition and assigns it to the Condition field.
...
// GetIsAdHoc returns the IsAdHoc field value if set, zero value otherwise.
func (o *WebhookDispatchWebhookSummary) GetIsAdHoc() bool {
	if o == nil || IsNil(o.IsAdHoc) {
		var ret bool
		return ret
	}
	return *o.IsAdHoc
...
// SetIsAdHoc gets a reference to the given bool and assigns it to the IsAdHoc field.
func (o *WebhookDispatchWebhookSummary) SetIsAdHoc(v bool) {
	o.IsAdHoc = &v
}

func (o WebhookDispatchWebhookSummary) MarshalJSON() ([]byte, error) {
...
func (o WebhookDispatchWebhookSummary) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsAdHoc) {
		toSerialize["isAdHoc"] = o.IsAdHoc
	}
	return toSerialize, nil
}

type NullableWebhookDispatchWebhookSummary struct {
	value *WebhookDispatchWebhookSummary
	isSet bool
}

func (v NullableWebhookDispatchWebhookSummary) Get() *WebhookDispatchWebhookSummary {
	return v.value
}

func (v *NullableWebhookDispatchWebhookSummary) Set(val *WebhookDispatchWebhookSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookDispatchWebhookSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookDispatchWebhookSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookDispatchWebhookSummary(val *WebhookDispatchWebhookSummary) *NullableWebhookDispatchWebhookSummary {
	return &NullableWebhookDispatchWebhookSummary{value: val, isSet: true}
}

func (v NullableWebhookDispatchWebhookSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookDispatchWebhookSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
