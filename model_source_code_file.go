...
// checks if the SourceCodeFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceCodeFile{}

// SourceCodeFile struct for SourceCodeFile
type SourceCodeFile struct {
	Format *SourceCodeFileFormat `json:"format,omitempty"`
	Content *string `json:"content,omitempty"`
	Name string `json:"name"`
}

type _SourceCodeFile SourceCodeFile
...
// SetFormat gets a reference to the given SourceCodeFileFormat and assigns it to the Format field.
...
func (o SourceCodeFile) MarshalJSON() ([]byte, error) {
...
func (o SourceCodeFile) ToMap() (map[string]interface{}, error) {
...
func (o *SourceCodeFile) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceCodeFile := _SourceCodeFile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSourceCodeFile)

	if err != nil {
		return err
	}

	*o = SourceCodeFile(varSourceCodeFile)

	return err
}

type NullableSourceCodeFile struct {
	value *SourceCodeFile
	isSet bool
}

func (v NullableSourceCodeFile) Get() *SourceCodeFile {
	return v.value
}

func (v *NullableSourceCodeFile) Set(val *SourceCodeFile) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceCodeFile) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceCodeFile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceCodeFile(val *SourceCodeFile) *NullableSourceCodeFile {
	return &NullableSourceCodeFile{value: val, isSet: true}
}

func (v NullableSourceCodeFile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceCodeFile) UnmarshalJSON(src []byte) error {
	v.isSet = true
