...
type ApiActDeleteRequest struct {
	ctx context.Context
	ApiService *ActorsAPIService
	actorId string
}

func (r ApiActDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActDeleteExecute(r)
}

/*
ActDelete Delete Actor

Deletes an Actor.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActDeleteRequest
*/
func (a *ActorsAPIService) ActDelete(ctx context.Context, actorId string) ApiActDeleteRequest {
	return ApiActDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsAPIService) ActDeleteExecute(r ApiActDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}"
...
type ApiActGetRequest struct {
	ctx context.Context
	ApiService *ActorsAPIService
	actorId string
}

func (r ApiActGetRequest) Execute() (*ActorResponse, *http.Response, error) {
	return r.ApiService.ActGetExecute(r)
}
...
Gets an object that contains all the details about a specific Actor.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActGetRequest
*/
func (a *ActorsAPIService) ActGet(ctx context.Context, actorId string) ApiActGetRequest {
	return ApiActGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsAPIService) ActGetExecute(r ApiActGetRequest) (*ActorResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// 
func (r ApiActPutRequest) UpdateActorRequest(updateActorRequest UpdateActorRequest) ApiActPutRequest {
	r.updateActorRequest = &updateActorRequest
	return r
}

func (r ApiActPutRequest) Execute() (*ActorResponse, *http.Response, error) {
	return r.ApiService.ActPutExecute(r)
}
...
package](https://github.com/apify/apify-shared-js/blob/2d43ebc41ece9ad31cd6525bd523fb86939bf860/packages/consts/src/consts.ts#L452-L471).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActPutRequest
*/
func (a *ActorsAPIService) ActPut(ctx context.Context, actorId string) ApiActPutRequest {
	return ApiActPutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return ActorResponse
func (a *ActorsAPIService) ActPutExecute(r ApiActPutRequest) (*ActorResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateActorRequest == nil {
		return localVarReturnValue, nil, reportError("updateActorRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateActorRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiActValidateInputPostRequest struct {
	ctx context.Context
	ApiService *ActorsAPIService
	actorId string
...
func (r ApiActValidateInputPostRequest) Body(body map[string]interface{}) ApiActValidateInputPostRequest {
	r.body = &body
	return r
}

// Optional tag or number of the Actor build to use for input schema validation. By default, the &#x60;latest&#x60; build tag is used. 
func (r ApiActValidateInputPostRequest) Build(build string) ApiActValidateInputPostRequest {
	r.build = &build
	return r
}

func (r ApiActValidateInputPostRequest) Execute() (*ActValidateInputPost200Response, *http.Response, error) {
	return r.ApiService.ActValidateInputPostExecute(r)
}

/*
ActValidateInputPost Validate Actor input
...
the `latest` build tag is used by default.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActValidateInputPostRequest
*/
func (a *ActorsAPIService) ActValidateInputPost(ctx context.Context, actorId string) ApiActValidateInputPostRequest {
	return ApiActValidateInputPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsAPIService) ActValidateInputPostExecute(r ApiActValidateInputPostRequest) (*ActValidateInputPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ActValidateInputPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActValidateInputPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/validate-input"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
func (r ApiActsGetRequest) My(my bool) ApiActsGetRequest {
	r.my = &my
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiActsGetRequest) Offset(offset float64) ApiActsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiActsGetRequest) Limit(limit float64) ApiActsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActsGetRequest) Desc(desc bool) ApiActsGetRequest {
	r.desc = &desc
	return r
}
...
func (r ApiActsGetRequest) SortBy(sortBy string) ApiActsGetRequest {
	r.sortBy = &sortBy
	return r
}

func (r ApiActsGetRequest) Execute() (*ListOfActorsResponse, *http.Response, error) {
	return r.ApiService.ActsGetExecute(r)
}

/*
ActsGet Get list of Actors
...
In this case, descending order means the most recently run Actor appears first.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiActsGetRequest
*/
func (a *ActorsAPIService) ActsGet(ctx context.Context) ApiActsGetRequest {
	return ApiActsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOfActorsResponse
func (a *ActorsAPIService) ActsGetExecute(r ApiActsGetRequest) (*ListOfActorsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfActorsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors"
	...
	if r.my != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "my", r.my, "form", "")
	}
	if r.offset != nil {
...
type ApiActsPostRequest struct {
	ctx context.Context
	ApiService *ActorsAPIService
...
// 
func (r ApiActsPostRequest) CreateActorRequest(createActorRequest CreateActorRequest) ApiActsPostRequest {
	r.createActorRequest = &createActorRequest
	return r
}

func (r ApiActsPostRequest) Execute() (*ActorResponse, *http.Response, error) {
	return r.ApiService.ActsPostExecute(r)
}

/*
ActsPost Create Actor
...
package](https://github.com/apify/apify-shared-js/blob/2d43ebc41ece9ad31cd6525bd523fb86939bf860/packages/consts/src/consts.ts#L452-L471).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiActsPostRequest
*/
func (a *ActorsAPIService) ActsPost(ctx context.Context) ApiActsPostRequest {
	return ApiActsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ActorResponse
func (a *ActorsAPIService) ActsPostExecute(r ApiActsPostRequest) (*ActorResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsAPIService.ActsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createActorRequest == nil {
		return localVarReturnValue, nil, reportError("createActorRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createActorRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
