...
// checks if the TaskShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskShort{}

// TaskShort struct for TaskShort
type TaskShort struct {
	Id string `json:"id"`
	UserId string `json:"userId"`
	ActId string `json:"actId"`
	ActName NullableString `json:"actName,omitempty"`
	Name string `json:"name"`
	Username NullableString `json:"username,omitempty"`
	ActUsername NullableString `json:"actUsername,omitempty"`
	CreatedAt time.Time `json:"createdAt"`
	ModifiedAt time.Time `json:"modifiedAt"`
	Stats NullableTaskStats `json:"stats,omitempty"`
}

type _TaskShort TaskShort
...
// GetActName returns the ActName field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskShort) GetActName() string {
	if o == nil || IsNil(o.ActName.Get()) {
		var ret string
		return ret
	}
	return *o.ActName.Get()
}

// GetActNameOk returns a tuple with the ActName field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetActName gets a reference to the given NullableString and assigns it to the ActName field.
func (o *TaskShort) SetActName(v string) {
	o.ActName.Set(&v)
}
// SetActNameNil sets the value for ActName to be an explicit nil
func (o *TaskShort) SetActNameNil() {
	o.ActName.Set(nil)
}
...
func (o *TaskShort) SetUsernameNil() {
	o.Username.Set(nil)
}
...
// GetActUsername returns the ActUsername field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskShort) GetActUsername() string {
	if o == nil || IsNil(o.ActUsername.Get()) {
		var ret string
		return ret
	}
	return *o.ActUsername.Get()
}

// GetActUsernameOk returns a tuple with the ActUsername field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetActUsername gets a reference to the given NullableString and assigns it to the ActUsername field.
func (o *TaskShort) SetActUsername(v string) {
	o.ActUsername.Set(&v)
}
// SetActUsernameNil sets the value for ActUsername to be an explicit nil
func (o *TaskShort) SetActUsernameNil() {
	o.ActUsername.Set(nil)
}
...
// SetStats gets a reference to the given NullableTaskStats and assigns it to the Stats field.
func (o *TaskShort) SetStats(v TaskStats) {
	o.Stats.Set(&v)
}
// SetStatsNil sets the value for Stats to be an explicit nil
func (o *TaskShort) SetStatsNil() {
	o.Stats.Set(nil)
}
...
func (o TaskShort) MarshalJSON() ([]byte, error) {
...
func (o TaskShort) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["userId"] = o.UserId
	toSerialize["actId"] = o.ActId
	if o.ActName.IsSet() {
		toSerialize["actName"] = o.ActName.Get()
	}
	toSerialize["name"] = o.Name
	if o.Username.IsSet() {
		toSerialize["username"] = o.Username.Get()
	}
	if o.ActUsername.IsSet() {
		toSerialize["actUsername"] = o.ActUsername.Get()
	}
...
func (o *TaskShort) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskShort := _TaskShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskShort)

	if err != nil {
		return err
	}

	*o = TaskShort(varTaskShort)

	return err
}

type NullableTaskShort struct {
	value *TaskShort
	isSet bool
}

func (v NullableTaskShort) Get() *TaskShort {
	return v.value
}

func (v *NullableTaskShort) Set(val *TaskShort) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskShort) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskShort(val *TaskShort) *NullableTaskShort {
	return &NullableTaskShort{value: val, isSet: true}
}

func (v NullableTaskShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
