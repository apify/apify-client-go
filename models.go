...
type Task struct {
	...
	ModifiedAt *time.Time `json:"modifiedAt"`
	// IsPublic reports whether the task is published on its public landing page. It is derived
	// from PublicConfig.PublishedAt; use TaskClient.Publish/Unpublish to change it.
