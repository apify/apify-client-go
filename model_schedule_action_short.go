...
// ScheduleActionShort - struct for ScheduleActionShort
type ScheduleActionShort struct {
	ScheduleActionShortRunActor *ScheduleActionShortRunActor
	ScheduleActionShortRunActorTask *ScheduleActionShortRunActorTask
}

// ScheduleActionShortRunActorAsScheduleActionShort is a convenience function that returns ScheduleActionShortRunActor wrapped in ScheduleActionShort
func ScheduleActionShortRunActorAsScheduleActionShort(v *ScheduleActionShortRunActor) ScheduleActionShort {
	return ScheduleActionShort{
		ScheduleActionShortRunActor: v,
	}
}

// ScheduleActionShortRunActorTaskAsScheduleActionShort is a convenience function that returns ScheduleActionShortRunActorTask wrapped in ScheduleActionShort
func ScheduleActionShortRunActorTaskAsScheduleActionShort(v *ScheduleActionShortRunActorTask) ScheduleActionShort {
	return ScheduleActionShort{
		ScheduleActionShortRunActorTask: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ScheduleActionShort) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ScheduleActionShortRunActor
	err = newStrictDecoder(data).Decode(&dst.ScheduleActionShortRunActor)
	if err == nil {
		jsonScheduleActionShortRunActor, _ := json.Marshal(dst.ScheduleActionShortRunActor)
		if string(jsonScheduleActionShortRunActor) == "{}" { // empty struct
			dst.ScheduleActionShortRunActor = nil
		} else {
			if err = validator.Validate(dst.ScheduleActionShortRunActor); err != nil {
				dst.ScheduleActionShortRunActor = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into ScheduleActionShortRunActorTask
	err = newStrictDecoder(data).Decode(&dst.ScheduleActionShortRunActorTask)
	if err == nil {
		jsonScheduleActionShortRunActorTask, _ := json.Marshal(dst.ScheduleActionShortRunActorTask)
		if string(jsonScheduleActionShortRunActorTask) == "{}" { // empty struct
			dst.ScheduleActionShortRunActorTask = nil
		} else {
			if err = validator.Validate(dst.ScheduleActionShortRunActorTask); err != nil {
				dst.ScheduleActionShortRunActorTask = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ScheduleActionShort)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ScheduleActionShort)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ScheduleActionShort) MarshalJSON() ([]byte, error) {
	if src.ScheduleActionShortRunActor != nil {
		return json.Marshal(&src.ScheduleActionShortRunActor)
	}

	if src.ScheduleActionShortRunActorTask != nil {
		return json.Marshal(&src.ScheduleActionShortRunActorTask)
	}
...
func (obj *ScheduleActionShort) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ScheduleActionShortRunActor != nil {
		return obj.ScheduleActionShortRunActor
	}

	if obj.ScheduleActionShortRunActorTask != nil {
		return obj.ScheduleActionShortRunActorTask
	}
...
func (obj ScheduleActionShort) GetActualInstanceValue() (interface{}) {
	if obj.ScheduleActionShortRunActor != nil {
		return *obj.ScheduleActionShortRunActor
	}
...
type NullableScheduleActionShort struct {
	value *ScheduleActionShort
	isSet bool
}

func (v NullableScheduleActionShort) Get() *ScheduleActionShort {
	return v.value
}

func (v *NullableScheduleActionShort) Set(val *ScheduleActionShort) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleActionShort) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleActionShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleActionShort(val *ScheduleActionShort) *NullableScheduleActionShort {
	return &NullableScheduleActionShort{value: val, isSet: true}
}

func (v NullableScheduleActionShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleActionShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
