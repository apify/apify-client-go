...
// checks if the ActorStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorStats{}

// ActorStats struct for ActorStats
type ActorStats struct {
	TotalBuilds *int32 `json:"totalBuilds,omitempty"`
	TotalRuns *int32 `json:"totalRuns,omitempty"`
	TotalUsers *int32 `json:"totalUsers,omitempty"`
	TotalUsers7Days *int32 `json:"totalUsers7Days,omitempty"`
	TotalUsers30Days *int32 `json:"totalUsers30Days,omitempty"`
	TotalUsers90Days *int32 `json:"totalUsers90Days,omitempty"`
	TotalMetamorphs *int32 `json:"totalMetamorphs,omitempty"`
	LastRunStartedAt *time.Time `json:"lastRunStartedAt,omitempty"`
	ActorReviewCount *int32 `json:"actorReviewCount,omitempty"`
	ActorReviewRating *float32 `json:"actorReviewRating,omitempty"`
	BookmarkCount *int32 `json:"bookmarkCount,omitempty"`
	PublicActorRunStats30Days *ActorStatsPublicActorRunStats30Days `json:"publicActorRunStats30Days,omitempty"`
}
...
// GetTotalBuilds returns the TotalBuilds field value if set, zero value otherwise.
func (o *ActorStats) GetTotalBuilds() int32 {
	if o == nil || IsNil(o.TotalBuilds) {
		var ret int32
		return ret
	}
	return *o.TotalBuilds
}

// GetTotalBuildsOk returns a tuple with the TotalBuilds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetTotalBuildsOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalBuilds) {
		return nil, false
	}
	return o.TotalBuilds, true
}
...
// SetTotalBuilds gets a reference to the given int32 and assigns it to the TotalBuilds field.
...
// SetTotalRuns gets a reference to the given int32 and assigns it to the TotalRuns field.
...
// GetTotalUsers7Days returns the TotalUsers7Days field value if set, zero value otherwise.
func (o *ActorStats) GetTotalUsers7Days() int32 {
	if o == nil || IsNil(o.TotalUsers7Days) {
		var ret int32
		return ret
	}
	return *o.TotalUsers7Days
}

// GetTotalUsers7DaysOk returns a tuple with the TotalUsers7Days field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetTotalUsers7DaysOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalUsers7Days) {
		return nil, false
	}
	return o.TotalUsers7Days, true
}
...
// SetTotalUsers7Days gets a reference to the given int32 and assigns it to the TotalUsers7Days field.
func (o *ActorStats) SetTotalUsers7Days(v int32) {
	o.TotalUsers7Days = &v
}

// GetTotalUsers30Days returns the TotalUsers30Days field value if set, zero value otherwise.
func (o *ActorStats) GetTotalUsers30Days() int32 {
	if o == nil || IsNil(o.TotalUsers30Days) {
		var ret int32
		return ret
	}
	return *o.TotalUsers30Days
}

// GetTotalUsers30DaysOk returns a tuple with the TotalUsers30Days field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetTotalUsers30DaysOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalUsers30Days) {
		return nil, false
	}
	return o.TotalUsers30Days, true
}
...
// SetTotalUsers30Days gets a reference to the given int32 and assigns it to the TotalUsers30Days field.
func (o *ActorStats) SetTotalUsers30Days(v int32) {
	o.TotalUsers30Days = &v
}

// GetTotalUsers90Days returns the TotalUsers90Days field value if set, zero value otherwise.
func (o *ActorStats) GetTotalUsers90Days() int32 {
	if o == nil || IsNil(o.TotalUsers90Days) {
		var ret int32
		return ret
	}
	return *o.TotalUsers90Days
}

// GetTotalUsers90DaysOk returns a tuple with the TotalUsers90Days field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetTotalUsers90DaysOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalUsers90Days) {
		return nil, false
	}
	return o.TotalUsers90Days, true
}
...
// SetTotalUsers90Days gets a reference to the given int32 and assigns it to the TotalUsers90Days field.
func (o *ActorStats) SetTotalUsers90Days(v int32) {
	o.TotalUsers90Days = &v
}

// GetTotalMetamorphs returns the TotalMetamorphs field value if set, zero value otherwise.
func (o *ActorStats) GetTotalMetamorphs() int32 {
	if o == nil || IsNil(o.TotalMetamorphs) {
		var ret int32
		return ret
	}
	return *o.TotalMetamorphs
}

// GetTotalMetamorphsOk returns a tuple with the TotalMetamorphs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetTotalMetamorphsOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalMetamorphs) {
		return nil, false
	}
	return o.TotalMetamorphs, true
}
...
// SetTotalMetamorphs gets a reference to the given int32 and assigns it to the TotalMetamorphs field.
func (o *ActorStats) SetTotalMetamorphs(v int32) {
	o.TotalMetamorphs = &v
}

// GetLastRunStartedAt returns the LastRunStartedAt field value if set, zero value otherwise.
func (o *ActorStats) GetLastRunStartedAt() time.Time {
	if o == nil || IsNil(o.LastRunStartedAt) {
		var ret time.Time
		return ret
	}
	return *o.LastRunStartedAt
}

// GetLastRunStartedAtOk returns a tuple with the LastRunStartedAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetLastRunStartedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastRunStartedAt) {
		return nil, false
	}
	return o.LastRunStartedAt, true
}
...
// SetLastRunStartedAt gets a reference to the given time.Time and assigns it to the LastRunStartedAt field.
func (o *ActorStats) SetLastRunStartedAt(v time.Time) {
	o.LastRunStartedAt = &v
}

// GetActorReviewCount returns the ActorReviewCount field value if set, zero value otherwise.
func (o *ActorStats) GetActorReviewCount() int32 {
	if o == nil || IsNil(o.ActorReviewCount) {
		var ret int32
		return ret
	}
	return *o.ActorReviewCount
}

// GetActorReviewCountOk returns a tuple with the ActorReviewCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetActorReviewCountOk() (*int32, bool) {
	if o == nil || IsNil(o.ActorReviewCount) {
		return nil, false
	}
	return o.ActorReviewCount, true
}
...
// SetActorReviewCount gets a reference to the given int32 and assigns it to the ActorReviewCount field.
func (o *ActorStats) SetActorReviewCount(v int32) {
	o.ActorReviewCount = &v
}

// GetActorReviewRating returns the ActorReviewRating field value if set, zero value otherwise.
func (o *ActorStats) GetActorReviewRating() float32 {
	if o == nil || IsNil(o.ActorReviewRating) {
		var ret float32
		return ret
	}
	return *o.ActorReviewRating
}

// GetActorReviewRatingOk returns a tuple with the ActorReviewRating field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetActorReviewRatingOk() (*float32, bool) {
	if o == nil || IsNil(o.ActorReviewRating) {
		return nil, false
	}
	return o.ActorReviewRating, true
}
...
// SetActorReviewRating gets a reference to the given float32 and assigns it to the ActorReviewRating field.
func (o *ActorStats) SetActorReviewRating(v float32) {
	o.ActorReviewRating = &v
}

// GetBookmarkCount returns the BookmarkCount field value if set, zero value otherwise.
func (o *ActorStats) GetBookmarkCount() int32 {
	if o == nil || IsNil(o.BookmarkCount) {
		var ret int32
		return ret
	}
...
// GetBookmarkCountOk returns a tuple with the BookmarkCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBookmarkCount gets a reference to the given int32 and assigns it to the BookmarkCount field.
func (o *ActorStats) SetBookmarkCount(v int32) {
	o.BookmarkCount = &v
}

// GetPublicActorRunStats30Days returns the PublicActorRunStats30Days field value if set, zero value otherwise.
func (o *ActorStats) GetPublicActorRunStats30Days() ActorStatsPublicActorRunStats30Days {
	if o == nil || IsNil(o.PublicActorRunStats30Days) {
		var ret ActorStatsPublicActorRunStats30Days
		return ret
	}
	return *o.PublicActorRunStats30Days
}

// GetPublicActorRunStats30DaysOk returns a tuple with the PublicActorRunStats30Days field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStats) GetPublicActorRunStats30DaysOk() (*ActorStatsPublicActorRunStats30Days, bool) {
	if o == nil || IsNil(o.PublicActorRunStats30Days) {
		return nil, false
	}
	return o.PublicActorRunStats30Days, true
}
...
// SetPublicActorRunStats30Days gets a reference to the given ActorStatsPublicActorRunStats30Days and assigns it to the PublicActorRunStats30Days field.
func (o *ActorStats) SetPublicActorRunStats30Days(v ActorStatsPublicActorRunStats30Days) {
	o.PublicActorRunStats30Days = &v
}

func (o ActorStats) MarshalJSON() ([]byte, error) {
...
func (o ActorStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TotalBuilds) {
		toSerialize["totalBuilds"] = o.TotalBuilds
	}
	...
	if !IsNil(o.TotalUsers7Days) {
		toSerialize["totalUsers7Days"] = o.TotalUsers7Days
	}
	if !IsNil(o.TotalUsers30Days) {
		toSerialize["totalUsers30Days"] = o.TotalUsers30Days
	}
	if !IsNil(o.TotalUsers90Days) {
		toSerialize["totalUsers90Days"] = o.TotalUsers90Days
	}
	if !IsNil(o.TotalMetamorphs) {
		toSerialize["totalMetamorphs"] = o.TotalMetamorphs
	}
	if !IsNil(o.LastRunStartedAt) {
		toSerialize["lastRunStartedAt"] = o.LastRunStartedAt
	}
	if !IsNil(o.ActorReviewCount) {
		toSerialize["actorReviewCount"] = o.ActorReviewCount
	}
	if !IsNil(o.ActorReviewRating) {
		toSerialize["actorReviewRating"] = o.ActorReviewRating
	}
	if !IsNil(o.BookmarkCount) {
		toSerialize["bookmarkCount"] = o.BookmarkCount
	}
	if !IsNil(o.PublicActorRunStats30Days) {
		toSerialize["publicActorRunStats30Days"] = o.PublicActorRunStats30Days
	}
	return toSerialize, nil
}

type NullableActorStats struct {
	value *ActorStats
	isSet bool
}

func (v NullableActorStats) Get() *ActorStats {
	return v.value
}

func (v *NullableActorStats) Set(val *ActorStats) {
	v.value = val
	v.isSet = true
}

func (v NullableActorStats) IsSet() bool {
	return v.isSet
}

func (v *NullableActorStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorStats(val *ActorStats) *NullableActorStats {
	return &NullableActorStats{value: val, isSet: true}
}

func (v NullableActorStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
