...
// VersionSourceType the model 'VersionSourceType'
type VersionSourceType string

// List of VersionSourceType
const (
	SOURCE_FILES VersionSourceType = "SOURCE_FILES"
	GIT_REPO VersionSourceType = "GIT_REPO"
	TARBALL VersionSourceType = "TARBALL"
	GITHUB_GIST VersionSourceType = "GITHUB_GIST"
	SOURCE_CODE VersionSourceType = "SOURCE_CODE"
)

// All allowed values of VersionSourceType enum
var AllowedVersionSourceTypeEnumValues = []VersionSourceType{
	"SOURCE_FILES",
	"GIT_REPO",
	"TARBALL",
	"GITHUB_GIST",
...
func (v *VersionSourceType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := VersionSourceType(value)
	for _, existing := range AllowedVersionSourceTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid VersionSourceType", value)
}

// NewVersionSourceTypeFromValue returns a pointer to a valid VersionSourceType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewVersionSourceTypeFromValue(v string) (*VersionSourceType, error) {
	ev := VersionSourceType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for VersionSourceType: valid values are %v", v, AllowedVersionSourceTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v VersionSourceType) IsValid() bool {
	for _, existing := range AllowedVersionSourceTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to VersionSourceType value
func (v VersionSourceType) Ptr() *VersionSourceType {
	return &v
}

type NullableVersionSourceType struct {
	value *VersionSourceType
	isSet bool
}

func (v NullableVersionSourceType) Get() *VersionSourceType {
	return v.value
}

func (v *NullableVersionSourceType) Set(val *VersionSourceType) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionSourceType) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionSourceType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionSourceType(val *VersionSourceType) *NullableVersionSourceType {
	return &NullableVersionSourceType{value: val, isSet: true}
}

func (v NullableVersionSourceType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionSourceType) UnmarshalJSON(src []byte) error {
	v.isSet = true
