...
// SourceCodeFileFormat the model 'SourceCodeFileFormat'
type SourceCodeFileFormat string

// List of SourceCodeFileFormat
const (
	BASE64 SourceCodeFileFormat = "BASE64"
	TEXT SourceCodeFileFormat = "TEXT"
)

// All allowed values of SourceCodeFileFormat enum
var AllowedSourceCodeFileFormatEnumValues = []SourceCodeFileFormat{
	"BASE64",
	"TEXT",
}

func (v *SourceCodeFileFormat) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := SourceCodeFileFormat(value)
	...
	return fmt.Errorf("%+v is not a valid SourceCodeFileFormat", value)
}

// NewSourceCodeFileFormatFromValue returns a pointer to a valid SourceCodeFileFormat
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewSourceCodeFileFormatFromValue(v string) (*SourceCodeFileFormat, error) {
	ev := SourceCodeFileFormat(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for SourceCodeFileFormat: valid values are %v", v, AllowedSourceCodeFileFormatEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v SourceCodeFileFormat) IsValid() bool {
	for _, existing := range AllowedSourceCodeFileFormatEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to SourceCodeFileFormat value
func (v SourceCodeFileFormat) Ptr() *SourceCodeFileFormat {
	return &v
}

type NullableSourceCodeFileFormat struct {
	value *SourceCodeFileFormat
	isSet bool
}

func (v NullableSourceCodeFileFormat) Get() *SourceCodeFileFormat {
	return v.value
}

func (v *NullableSourceCodeFileFormat) Set(val *SourceCodeFileFormat) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceCodeFileFormat) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceCodeFileFormat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceCodeFileFormat(val *SourceCodeFileFormat) *NullableSourceCodeFileFormat {
	return &NullableSourceCodeFileFormat{value: val, isSet: true}
}

func (v NullableSourceCodeFileFormat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceCodeFileFormat) UnmarshalJSON(src []byte) error {
	v.isSet = true
