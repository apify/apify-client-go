...
// LastActorTaskRunsDefaultDatasetAPIService LastActorTaskRunsDefaultDatasetAPI service
type LastActorTaskRunsDefaultDatasetAPIService service

type ApiActorTaskRunsLastDatasetDeleteRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
	status *string
}

// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetDeleteRequest) Status(status string) ApiActorTaskRunsLastDatasetDeleteRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastDatasetDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetDeleteExecute(r)
}

/*
ActorTaskRunsLastDatasetDelete Delete last task run's default dataset
...
[Delete dataset](/api/v2/dataset-delete) endpoint.
 ...
 @return ApiActorTaskRunsLastDatasetDeleteRequest
*/
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetDelete(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastDatasetDeleteRequest {
	return ApiActorTaskRunsLastDatasetDeleteRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetDeleteExecute(r ApiActorTaskRunsLastDatasetDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/dataset"
...
type ApiActorTaskRunsLastDatasetGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetGetRequest) Status(status string) ApiActorTaskRunsLastDatasetGetRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastDatasetGetRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetGetExecute(r)
}

/*
ActorTaskRunsLastDatasetGet Get last task run's default dataset
...
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetGetExecute(r ApiActorTaskRunsLastDatasetGetRequest) (*DatasetResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetGet")
	if err != nil {
...
type ApiActorTaskRunsLastDatasetItemsGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Status(status string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.status = &status
	return r
}

// Format of the results, possible values are: &#x60;json&#x60;, &#x60;jsonl&#x60;, &#x60;csv&#x60;, &#x60;html&#x60;, &#x60;xlsx&#x60;, &#x60;xml&#x60; and &#x60;rss&#x60;. The default value is &#x60;json&#x60;. 
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Format(format string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.format = &format
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Clean(clean bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.clean = &clean
	return r
}

// Number of items that should be skipped at the start. The default value is &#x60;0&#x60;. 
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Offset(offset float64) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. By default there is no limit.
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Limit(limit float64) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Fields(fields string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.fields = &fields
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) OutputFields(outputFields string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.outputFields = &outputFields
	return r
}

// A comma-separated list of fields which should be omitted from the items.
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Omit(omit string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.omit = &omit
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Unwind(unwind string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.unwind = &unwind
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Flatten(flatten string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.flatten = &flatten
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Desc(desc bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.desc = &desc
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Attachment(attachment bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Delimiter(delimiter string) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Bom(bom bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.bom = &bom
	return r
}

// Overrides default root element name of &#x60;xml&#x60; output. By default the root element is &#x60;items&#x60;. 
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) XmlRoot(xmlRoot string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.xmlRoot = &xmlRoot
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) XmlRow(xmlRow string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.xmlRow = &xmlRow
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then header row in the &#x60;csv&#x60; format is skipped.
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) SkipHeaderRow(skipHeaderRow bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) SkipHidden(skipHidden bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) SkipEmpty(skipEmpty bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Simplified(simplified bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) View(view string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.view = &view
	return r
}
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) SkipFailedPages(skipFailedPages bool) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) FeedTitle(feedTitle string) ApiActorTaskRunsLastDatasetItemsGetRequest {
...
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) FeedDescription(feedDescription string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.feedDescription = &feedDescription
	return r
}

// Signature used for the access.
func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Signature(signature string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	r.signature = &signature
	return r
}

func (r ApiActorTaskRunsLastDatasetItemsGetRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetItemsGetExecute(r)
}

/*
ActorTaskRunsLastDatasetItemsGet Get last task run's dataset items
...
[Get dataset items](/api/v2/dataset-items-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastDatasetItemsGetRequest
*/
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetItemsGet(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastDatasetItemsGetRequest {
	return ApiActorTaskRunsLastDatasetItemsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetItemsGetExecute(r ApiActorTaskRunsLastDatasetItemsGetRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetItemsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/dataset/items"
	localVarPath = strings.Replace(localVarPath, "{"+"actorTaskId"+"}", url.PathEscape(parameterValueToString(r.actorTaskId, "actorTaskId")), -1)
...
type ApiActorTaskRunsLastDatasetItemsPostRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
...
// 
func (r ApiActorTaskRunsLastDatasetItemsPostRequest) ActRunsLastDatasetItemsPostRequest(actRunsLastDatasetItemsPostRequest ActRunsLastDatasetItemsPostRequest) ApiActorTaskRunsLastDatasetItemsPostRequest {
	r.actRunsLastDatasetItemsPostRequest = &actRunsLastDatasetItemsPostRequest
	return r
}

// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetItemsPostRequest) Status(status string) ApiActorTaskRunsLastDatasetItemsPostRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastDatasetItemsPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetItemsPostExecute(r)
}

/*
ActorTaskRunsLastDatasetItemsPost Store items in last task run's dataset
...
[Store items](/api/v2/dataset-items-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastDatasetItemsPostRequest
*/
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetItemsPost(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastDatasetItemsPostRequest {
	return ApiActorTaskRunsLastDatasetItemsPostRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetItemsPostExecute(r ApiActorTaskRunsLastDatasetItemsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetItemsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorTaskRunsLastDatasetPutRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
...
// 
func (r ApiActorTaskRunsLastDatasetPutRequest) UpdateDatasetRequest(updateDatasetRequest UpdateDatasetRequest) ApiActorTaskRunsLastDatasetPutRequest {
	r.updateDatasetRequest = &updateDatasetRequest
	return r
}

// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetPutRequest) Status(status string) ApiActorTaskRunsLastDatasetPutRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastDatasetPutRequest) Execute() (*DatasetResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetPutExecute(r)
}

/*
ActorTaskRunsLastDatasetPut Update last task run's default dataset
...
[Update dataset](/api/v2/dataset-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastDatasetPutRequest
*/
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetPut(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastDatasetPutRequest {
	return ApiActorTaskRunsLastDatasetPutRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
// Execute executes the request
//  @return DatasetResponse
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetPutExecute(r ApiActorTaskRunsLastDatasetPutRequest) (*DatasetResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorTaskRunsLastDatasetStatisticsGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsDefaultDatasetAPIService
	actorTaskId string
	status *string
...
// Filter for the run status.
func (r ApiActorTaskRunsLastDatasetStatisticsGetRequest) Status(status string) ApiActorTaskRunsLastDatasetStatisticsGetRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastDatasetStatisticsGetRequest) Execute() (*DatasetStatisticsResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastDatasetStatisticsGetExecute(r)
}

/*
ActorTaskRunsLastDatasetStatisticsGet Get last task run's dataset statistics
...
[Get dataset statistics](/api/v2/dataset-statistics-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorTaskId Task ID or a tilde-separated owner's username and task's name.
 @return ApiActorTaskRunsLastDatasetStatisticsGetRequest
*/
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetStatisticsGet(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastDatasetStatisticsGetRequest {
	return ApiActorTaskRunsLastDatasetStatisticsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorTaskId: actorTaskId,
...
func (a *LastActorTaskRunsDefaultDatasetAPIService) ActorTaskRunsLastDatasetStatisticsGetExecute(r ApiActorTaskRunsLastDatasetStatisticsGetRequest) (*DatasetStatisticsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsDefaultDatasetAPIService.ActorTaskRunsLastDatasetStatisticsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/dataset/statistics"
	localVarPath = strings.Replace(localVarPath, "{"+"actorTaskId"+"}", url.PathEscape(parameterValueToString(r.actorTaskId, "actorTaskId")), -1)
