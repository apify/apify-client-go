...
type Task struct {
	...
	Options NullableTaskOptions `json:"options,omitempty"`
...
// SetOptions gets a reference to the given NullableTaskOptions and assigns it to the Options field.
func (o *Task) SetOptions(v TaskOptions) {
	o.Options.Set(&v)
}
// SetOptionsNil sets the value for Options to be an explicit nil
func (o *Task) SetOptionsNil() {
	o.Options.Set(nil)
}
...
func (o *Task) SetActorStandbyNil() {
