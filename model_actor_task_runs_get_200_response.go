...
// checks if the ActorTaskRunsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskRunsGet200Response{}

// ActorTaskRunsGet200Response struct for ActorTaskRunsGet200Response
type ActorTaskRunsGet200Response struct {
	Data ActorTaskRunsGet200ResponseData `json:"data"`
}

type _ActorTaskRunsGet200Response ActorTaskRunsGet200Response

// NewActorTaskRunsGet200Response instantiates a new ActorTaskRunsGet200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskRunsGet200Response(data ActorTaskRunsGet200ResponseData) *ActorTaskRunsGet200Response {
	this := ActorTaskRunsGet200Response{}
	this.Data = data
	return &this
}

// NewActorTaskRunsGet200ResponseWithDefaults instantiates a new ActorTaskRunsGet200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskRunsGet200ResponseWithDefaults() *ActorTaskRunsGet200Response {
	this := ActorTaskRunsGet200Response{}
	return &this
}

// GetData returns the Data field value
func (o *ActorTaskRunsGet200Response) GetData() ActorTaskRunsGet200ResponseData {
	if o == nil {
		var ret ActorTaskRunsGet200ResponseData
		return ret
	}
...
func (o *ActorTaskRunsGet200Response) GetDataOk() (*ActorTaskRunsGet200ResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ActorTaskRunsGet200Response) SetData(v ActorTaskRunsGet200ResponseData) {
	o.Data = v
}

func (o ActorTaskRunsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskRunsGet200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ActorTaskRunsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskRunsGet200Response := _ActorTaskRunsGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskRunsGet200Response)

	if err != nil {
		return err
	}

	*o = ActorTaskRunsGet200Response(varActorTaskRunsGet200Response)

	return err
}

type NullableActorTaskRunsGet200Response struct {
	value *ActorTaskRunsGet200Response
	isSet bool
}

func (v NullableActorTaskRunsGet200Response) Get() *ActorTaskRunsGet200Response {
	return v.value
}

func (v *NullableActorTaskRunsGet200Response) Set(val *ActorTaskRunsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskRunsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskRunsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskRunsGet200Response(val *ActorTaskRunsGet200Response) *NullableActorTaskRunsGet200Response {
	return &NullableActorTaskRunsGet200Response{value: val, isSet: true}
}

func (v NullableActorTaskRunsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskRunsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
