...
// checks if the CallsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallsInner{}

// CallsInner struct for CallsInner
type CallsInner struct {
...
func (o *CallsInner) SetStartedAtNil() {
	o.StartedAt.Set(nil)
}
...
func (o *CallsInner) SetFinishedAtNil() {
...
func (o *CallsInner) SetResponseStatusNil() {
...
func (o *CallsInner) SetResponseBodyNil() {
...
func (o CallsInner) MarshalJSON() ([]byte, error) {
...
func (o CallsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCallsInner struct {
	value *CallsInner
	isSet bool
}

func (v NullableCallsInner) Get() *CallsInner {
	return v.value
}

func (v *NullableCallsInner) Set(val *CallsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCallsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCallsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallsInner(val *CallsInner) *NullableCallsInner {
	return &NullableCallsInner{value: val, isSet: true}
}

func (v NullableCallsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
