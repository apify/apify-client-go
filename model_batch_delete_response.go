...
// checks if the BatchDeleteResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchDeleteResponse{}
...
type _BatchDeleteResponse BatchDeleteResponse

// NewBatchDeleteResponse instantiates a new BatchDeleteResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBatchDeleteResponse(data BatchDeleteResult) *BatchDeleteResponse {
	this := BatchDeleteResponse{}
	this.Data = data
	return &this
}

// NewBatchDeleteResponseWithDefaults instantiates a new BatchDeleteResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBatchDeleteResponseWithDefaults() *BatchDeleteResponse {
	this := BatchDeleteResponse{}
	return &this
}

// GetData returns the Data field value
func (o *BatchDeleteResponse) GetData() BatchDeleteResult {
	if o == nil {
		var ret BatchDeleteResult
		return ret
	}
...
func (o *BatchDeleteResponse) GetDataOk() (*BatchDeleteResult, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *BatchDeleteResponse) SetData(v BatchDeleteResult) {
	o.Data = v
}

func (o BatchDeleteResponse) MarshalJSON() ([]byte, error) {
...
func (o BatchDeleteResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *BatchDeleteResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchDeleteResponse := _BatchDeleteResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchDeleteResponse)

	if err != nil {
		return err
	}

	*o = BatchDeleteResponse(varBatchDeleteResponse)

	return err
}

type NullableBatchDeleteResponse struct {
	value *BatchDeleteResponse
	isSet bool
}

func (v NullableBatchDeleteResponse) Get() *BatchDeleteResponse {
	return v.value
}

func (v *NullableBatchDeleteResponse) Set(val *BatchDeleteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchDeleteResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchDeleteResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchDeleteResponse(val *BatchDeleteResponse) *NullableBatchDeleteResponse {
	return &NullableBatchDeleteResponse{value: val, isSet: true}
}

func (v NullableBatchDeleteResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchDeleteResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
