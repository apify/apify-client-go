...
// checks if the ActorDefinitionStorages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorDefinitionStorages{}

// ActorDefinitionStorages struct for ActorDefinitionStorages
type ActorDefinitionStorages struct {
...
// NewActorDefinitionStorages instantiates a new ActorDefinitionStorages object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorDefinitionStorages() *ActorDefinitionStorages {
	this := ActorDefinitionStorages{}
	return &this
}

// NewActorDefinitionStoragesWithDefaults instantiates a new ActorDefinitionStorages object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorDefinitionStoragesWithDefaults() *ActorDefinitionStorages {
	this := ActorDefinitionStorages{}
	return &this
}

// GetDataset returns the Dataset field value if set, zero value otherwise.
func (o *ActorDefinitionStorages) GetDataset() map[string]interface{} {
...
func (o *ActorDefinitionStorages) GetDatasetOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Dataset) {
...
func (o *ActorDefinitionStorages) HasDataset() bool {
	if o != nil && !IsNil(o.Dataset) {
		return true
	}
...
func (o *ActorDefinitionStorages) SetDataset(v map[string]interface{}) {
	o.Dataset = v
}

func (o ActorDefinitionStorages) MarshalJSON() ([]byte, error) {
...
func (o ActorDefinitionStorages) ToMap() (map[string]interface{}, error) {
...
type NullableActorDefinitionStorages struct {
	value *ActorDefinitionStorages
	isSet bool
}

func (v NullableActorDefinitionStorages) Get() *ActorDefinitionStorages {
	return v.value
}

func (v *NullableActorDefinitionStorages) Set(val *ActorDefinitionStorages) {
	v.value = val
	v.isSet = true
}

func (v NullableActorDefinitionStorages) IsSet() bool {
	return v.isSet
}

func (v *NullableActorDefinitionStorages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorDefinitionStorages(val *ActorDefinitionStorages) *NullableActorDefinitionStorages {
	return &NullableActorDefinitionStorages{value: val, isSet: true}
}

func (v NullableActorDefinitionStorages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorDefinitionStorages) UnmarshalJSON(src []byte) error {
	v.isSet = true
