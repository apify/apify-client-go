...
// checks if the TieredPricingPerEventEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TieredPricingPerEventEntry{}

// TieredPricingPerEventEntry A single tier's price-per-event entry.
type TieredPricingPerEventEntry struct {
	// Price per event in USD for this tier.
	TieredEventPriceUsd float32 `json:"tieredEventPriceUsd"`
}

type _TieredPricingPerEventEntry TieredPricingPerEventEntry

// NewTieredPricingPerEventEntry instantiates a new TieredPricingPerEventEntry object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTieredPricingPerEventEntry(tieredEventPriceUsd float32) *TieredPricingPerEventEntry {
	this := TieredPricingPerEventEntry{}
	this.TieredEventPriceUsd = tieredEventPriceUsd
	return &this
}

// NewTieredPricingPerEventEntryWithDefaults instantiates a new TieredPricingPerEventEntry object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTieredPricingPerEventEntryWithDefaults() *TieredPricingPerEventEntry {
	this := TieredPricingPerEventEntry{}
	return &this
}

// GetTieredEventPriceUsd returns the TieredEventPriceUsd field value
func (o *TieredPricingPerEventEntry) GetTieredEventPriceUsd() float32 {
	if o == nil {
		var ret float32
		return ret
	}

	return o.TieredEventPriceUsd
}

// GetTieredEventPriceUsdOk returns a tuple with the TieredEventPriceUsd field value
// and a boolean to check if the value has been set.
func (o *TieredPricingPerEventEntry) GetTieredEventPriceUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TieredEventPriceUsd, true
}

// SetTieredEventPriceUsd sets field value
func (o *TieredPricingPerEventEntry) SetTieredEventPriceUsd(v float32) {
	o.TieredEventPriceUsd = v
}

func (o TieredPricingPerEventEntry) MarshalJSON() ([]byte, error) {
...
func (o TieredPricingPerEventEntry) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["tieredEventPriceUsd"] = o.TieredEventPriceUsd
	return toSerialize, nil
}

func (o *TieredPricingPerEventEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varTieredPricingPerEventEntry := _TieredPricingPerEventEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTieredPricingPerEventEntry)

	if err != nil {
		return err
	}

	*o = TieredPricingPerEventEntry(varTieredPricingPerEventEntry)

	return err
}

type NullableTieredPricingPerEventEntry struct {
	value *TieredPricingPerEventEntry
	isSet bool
}

func (v NullableTieredPricingPerEventEntry) Get() *TieredPricingPerEventEntry {
	return v.value
}

func (v *NullableTieredPricingPerEventEntry) Set(val *TieredPricingPerEventEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableTieredPricingPerEventEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableTieredPricingPerEventEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTieredPricingPerEventEntry(val *TieredPricingPerEventEntry) *NullableTieredPricingPerEventEntry {
	return &NullableTieredPricingPerEventEntry{value: val, isSet: true}
}

func (v NullableTieredPricingPerEventEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTieredPricingPerEventEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
