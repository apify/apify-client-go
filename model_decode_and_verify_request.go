...
// checks if the DecodeAndVerifyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DecodeAndVerifyRequest{}

// DecodeAndVerifyRequest struct for DecodeAndVerifyRequest
type DecodeAndVerifyRequest struct {
	Encoded string `json:"encoded"`
}

type _DecodeAndVerifyRequest DecodeAndVerifyRequest

// NewDecodeAndVerifyRequest instantiates a new DecodeAndVerifyRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDecodeAndVerifyRequest(encoded string) *DecodeAndVerifyRequest {
	this := DecodeAndVerifyRequest{}
	this.Encoded = encoded
	return &this
}

// NewDecodeAndVerifyRequestWithDefaults instantiates a new DecodeAndVerifyRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDecodeAndVerifyRequestWithDefaults() *DecodeAndVerifyRequest {
	this := DecodeAndVerifyRequest{}
	return &this
}

// GetEncoded returns the Encoded field value
func (o *DecodeAndVerifyRequest) GetEncoded() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DecodeAndVerifyRequest) GetEncodedOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DecodeAndVerifyRequest) SetEncoded(v string) {
	o.Encoded = v
}

func (o DecodeAndVerifyRequest) MarshalJSON() ([]byte, error) {
...
func (o DecodeAndVerifyRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["encoded"] = o.Encoded
	return toSerialize, nil
}

func (o *DecodeAndVerifyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDecodeAndVerifyRequest := _DecodeAndVerifyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDecodeAndVerifyRequest)

	if err != nil {
		return err
	}

	*o = DecodeAndVerifyRequest(varDecodeAndVerifyRequest)

	return err
}

type NullableDecodeAndVerifyRequest struct {
	value *DecodeAndVerifyRequest
	isSet bool
}

func (v NullableDecodeAndVerifyRequest) Get() *DecodeAndVerifyRequest {
	return v.value
}

func (v *NullableDecodeAndVerifyRequest) Set(val *DecodeAndVerifyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeAndVerifyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeAndVerifyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeAndVerifyRequest(val *DecodeAndVerifyRequest) *NullableDecodeAndVerifyRequest {
	return &NullableDecodeAndVerifyRequest{value: val, isSet: true}
}

func (v NullableDecodeAndVerifyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeAndVerifyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
