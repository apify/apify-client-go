...
// checks if the CommonActorPricingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonActorPricingInfo{}

// CommonActorPricingInfo struct for CommonActorPricingInfo
...
type _CommonActorPricingInfo CommonActorPricingInfo
...
func (o *CommonActorPricingInfo) SetNotifiedAboutFutureChangeAtNil() {
...
func (o *CommonActorPricingInfo) SetNotifiedAboutChangeAtNil() {
...
func (o *CommonActorPricingInfo) SetReasonForChangeNil() {
...
func (o CommonActorPricingInfo) MarshalJSON() ([]byte, error) {
...
func (o CommonActorPricingInfo) ToMap() (map[string]interface{}, error) {
...
func (o *CommonActorPricingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonActorPricingInfo := _CommonActorPricingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonActorPricingInfo)

	if err != nil {
		return err
	}

	*o = CommonActorPricingInfo(varCommonActorPricingInfo)

	return err
}

type NullableCommonActorPricingInfo struct {
	value *CommonActorPricingInfo
	isSet bool
}

func (v NullableCommonActorPricingInfo) Get() *CommonActorPricingInfo {
	return v.value
}

func (v *NullableCommonActorPricingInfo) Set(val *CommonActorPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCommonActorPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCommonActorPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommonActorPricingInfo(val *CommonActorPricingInfo) *NullableCommonActorPricingInfo {
	return &NullableCommonActorPricingInfo{value: val, isSet: true}
}

func (v NullableCommonActorPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommonActorPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
