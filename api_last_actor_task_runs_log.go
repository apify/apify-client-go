...
// LastActorTaskRunsLogAPIService LastActorTaskRunsLogAPI service
type LastActorTaskRunsLogAPIService service

type ApiActorTaskLastLogGetRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsLogAPIService
	actorTaskId string
	stream *bool
	download *bool
	raw *bool
...
func (r ApiActorTaskLastLogGetRequest) Stream(stream bool) ApiActorTaskLastLogGetRequest {
	r.stream = &stream
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the web browser will download the log file rather than open it in a tab. 
func (r ApiActorTaskLastLogGetRequest) Download(download bool) ApiActorTaskLastLogGetRequest {
	r.download = &download
	return r
}
...
func (r ApiActorTaskLastLogGetRequest) Raw(raw bool) ApiActorTaskLastLogGetRequest {
	r.raw = &raw
	return r
}

func (r ApiActorTaskLastLogGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.ActorTaskLastLogGetExecute(r)
}

/*
ActorTaskLastLogGet Get last Actor task run's log
...
This endpoint is a shortcut for getting last Actor task run's log. Same as [Get log](/api/v2/log-get) endpoint.
 ...
 @return ApiActorTaskLastLogGetRequest
*/
func (a *LastActorTaskRunsLogAPIService) ActorTaskLastLogGet(ctx context.Context, actorTaskId string) ApiActorTaskLastLogGetRequest {
	return ApiActorTaskLastLogGetRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return string
func (a *LastActorTaskRunsLogAPIService) ActorTaskLastLogGetExecute(r ApiActorTaskLastLogGetRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsLogAPIService.ActorTaskLastLogGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/log"
