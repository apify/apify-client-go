...
// checks if the PayPerEventActorPricingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayPerEventActorPricingInfo{}

// PayPerEventActorPricingInfo struct for PayPerEventActorPricingInfo
type PayPerEventActorPricingInfo struct {
	...
	PricingPerEvent PayPerEventActorPricingInfoAllOfPricingPerEvent `json:"pricingPerEvent"`
	MinimalMaxTotalChargeUsd NullableFloat32 `json:"minimalMaxTotalChargeUsd,omitempty"`
}

type _PayPerEventActorPricingInfo PayPerEventActorPricingInfo
...
func NewPayPerEventActorPricingInfo(apifyMarginPercentage float32, createdAt time.Time, startedAt time.Time, pricingModel string, pricingPerEvent PayPerEventActorPricingInfoAllOfPricingPerEvent) *PayPerEventActorPricingInfo {
	this := PayPerEventActorPricingInfo{}
...
// GetPricingPerEvent returns the PricingPerEvent field value
func (o *PayPerEventActorPricingInfo) GetPricingPerEvent() PayPerEventActorPricingInfoAllOfPricingPerEvent {
	if o == nil {
		var ret PayPerEventActorPricingInfoAllOfPricingPerEvent
		return ret
	}
...
// GetPricingPerEventOk returns a tuple with the PricingPerEvent field value
// and a boolean to check if the value has been set.
...
// SetPricingPerEvent sets field value
...
func (o *PayPerEventActorPricingInfo) SetMinimalMaxTotalChargeUsdNil() {
...
func (o PayPerEventActorPricingInfo) MarshalJSON() ([]byte, error) {
...
func (o PayPerEventActorPricingInfo) ToMap() (map[string]interface{}, error) {
...
func (o *PayPerEventActorPricingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPayPerEventActorPricingInfo := _PayPerEventActorPricingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPayPerEventActorPricingInfo)

	if err != nil {
		return err
	}

	*o = PayPerEventActorPricingInfo(varPayPerEventActorPricingInfo)

	return err
}

type NullablePayPerEventActorPricingInfo struct {
	value *PayPerEventActorPricingInfo
	isSet bool
}

func (v NullablePayPerEventActorPricingInfo) Get() *PayPerEventActorPricingInfo {
	return v.value
}

func (v *NullablePayPerEventActorPricingInfo) Set(val *PayPerEventActorPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePayPerEventActorPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePayPerEventActorPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayPerEventActorPricingInfo(val *PayPerEventActorPricingInfo) *NullablePayPerEventActorPricingInfo {
	return &NullablePayPerEventActorPricingInfo{value: val, isSet: true}
}

func (v NullablePayPerEventActorPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayPerEventActorPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
