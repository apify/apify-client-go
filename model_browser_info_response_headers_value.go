...
// BrowserInfoResponseHeadersValue - struct for BrowserInfoResponseHeadersValue
type BrowserInfoResponseHeadersValue struct {
	ArrayOfString *[]string
	String *string
}

// []stringAsBrowserInfoResponseHeadersValue is a convenience function that returns []string wrapped in BrowserInfoResponseHeadersValue
func ArrayOfStringAsBrowserInfoResponseHeadersValue(v *[]string) BrowserInfoResponseHeadersValue {
	return BrowserInfoResponseHeadersValue{
		ArrayOfString: v,
	}
}

// stringAsBrowserInfoResponseHeadersValue is a convenience function that returns string wrapped in BrowserInfoResponseHeadersValue
func StringAsBrowserInfoResponseHeadersValue(v *string) BrowserInfoResponseHeadersValue {
	return BrowserInfoResponseHeadersValue{
		String: v,
	}
}
...
func (dst *BrowserInfoResponseHeadersValue) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(BrowserInfoResponseHeadersValue)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(BrowserInfoResponseHeadersValue)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src BrowserInfoResponseHeadersValue) MarshalJSON() ([]byte, error) {
...
func (obj *BrowserInfoResponseHeadersValue) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj BrowserInfoResponseHeadersValue) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfString != nil {
		return *obj.ArrayOfString
	}
...
type NullableBrowserInfoResponseHeadersValue struct {
	value *BrowserInfoResponseHeadersValue
	isSet bool
}

func (v NullableBrowserInfoResponseHeadersValue) Get() *BrowserInfoResponseHeadersValue {
	return v.value
}

func (v *NullableBrowserInfoResponseHeadersValue) Set(val *BrowserInfoResponseHeadersValue) {
	v.value = val
	v.isSet = true
}

func (v NullableBrowserInfoResponseHeadersValue) IsSet() bool {
	return v.isSet
}

func (v *NullableBrowserInfoResponseHeadersValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrowserInfoResponseHeadersValue(val *BrowserInfoResponseHeadersValue) *NullableBrowserInfoResponseHeadersValue {
	return &NullableBrowserInfoResponseHeadersValue{value: val, isSet: true}
}

func (v NullableBrowserInfoResponseHeadersValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrowserInfoResponseHeadersValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
