...
type AccountLimits struct {
	MonthlyUsageCycle UsageCycle `json:"monthlyUsageCycle"`
...
func NewAccountLimits(monthlyUsageCycle UsageCycle, limits Limits, current Current) *AccountLimits {
	this := AccountLimits{}
	this.MonthlyUsageCycle = monthlyUsageCycle
	this.Limits = limits
...
// GetMonthlyUsageCycle returns the MonthlyUsageCycle field value
func (o *AccountLimits) GetMonthlyUsageCycle() UsageCycle {
	...
	return o.MonthlyUsageCycle
}

// GetMonthlyUsageCycleOk returns a tuple with the MonthlyUsageCycle field value
// and a boolean to check if the value has been set.
func (o *AccountLimits) GetMonthlyUsageCycleOk() (*UsageCycle, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MonthlyUsageCycle, true
}

// SetMonthlyUsageCycle sets field value
func (o *AccountLimits) SetMonthlyUsageCycle(v UsageCycle) {
	o.MonthlyUsageCycle = v
}
...
func (o AccountLimits) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["monthlyUsageCycle"] = o.MonthlyUsageCycle
