...
// checks if the ScheduleCreateActionRunActor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleCreateActionRunActor{}

// ScheduleCreateActionRunActor struct for ScheduleCreateActionRunActor
type ScheduleCreateActionRunActor struct {
	Type interface{} `json:"type"`
	ActorId string `json:"actorId"`
	RunInput NullableScheduleActionRunInput `json:"runInput,omitempty"`
	RunOptions NullableTaskOptions `json:"runOptions,omitempty"`
}

type _ScheduleCreateActionRunActor ScheduleCreateActionRunActor
...
func NewScheduleCreateActionRunActor(type_ interface{}, actorId string) *ScheduleCreateActionRunActor {
	this := ScheduleCreateActionRunActor{}
	this.Type = type_
...
// GetRunInput returns the RunInput field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleCreateActionRunActor) GetRunInput() ScheduleActionRunInput {
	if o == nil || IsNil(o.RunInput.Get()) {
		var ret ScheduleActionRunInput
		return ret
	}
	return *o.RunInput.Get()
}

// GetRunInputOk returns a tuple with the RunInput field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetRunInput gets a reference to the given NullableScheduleActionRunInput and assigns it to the RunInput field.
...
func (o *ScheduleCreateActionRunActor) SetRunInputNil() {
	o.RunInput.Set(nil)
}
...
// GetRunOptions returns the RunOptions field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleCreateActionRunActor) GetRunOptions() TaskOptions {
	if o == nil || IsNil(o.RunOptions.Get()) {
		var ret TaskOptions
		return ret
	}
	return *o.RunOptions.Get()
}

// GetRunOptionsOk returns a tuple with the RunOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetRunOptions gets a reference to the given NullableTaskOptions and assigns it to the RunOptions field.
...
func (o *ScheduleCreateActionRunActor) SetRunOptionsNil() {
	o.RunOptions.Set(nil)
}
...
func (o ScheduleCreateActionRunActor) MarshalJSON() ([]byte, error) {
...
func (o ScheduleCreateActionRunActor) ToMap() (map[string]interface{}, error) {
	...
	if o.RunInput.IsSet() {
		toSerialize["runInput"] = o.RunInput.Get()
	}
	if o.RunOptions.IsSet() {
		toSerialize["runOptions"] = o.RunOptions.Get()
	}
	return toSerialize, nil
}

func (o *ScheduleCreateActionRunActor) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleCreateActionRunActor := _ScheduleCreateActionRunActor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleCreateActionRunActor)

	if err != nil {
		return err
	}

	*o = ScheduleCreateActionRunActor(varScheduleCreateActionRunActor)

	return err
}

type NullableScheduleCreateActionRunActor struct {
	value *ScheduleCreateActionRunActor
	isSet bool
}

func (v NullableScheduleCreateActionRunActor) Get() *ScheduleCreateActionRunActor {
	return v.value
}

func (v *NullableScheduleCreateActionRunActor) Set(val *ScheduleCreateActionRunActor) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleCreateActionRunActor) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleCreateActionRunActor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleCreateActionRunActor(val *ScheduleCreateActionRunActor) *NullableScheduleCreateActionRunActor {
	return &NullableScheduleCreateActionRunActor{value: val, isSet: true}
}

func (v NullableScheduleCreateActionRunActor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleCreateActionRunActor) UnmarshalJSON(src []byte) error {
	v.isSet = true
