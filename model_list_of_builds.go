...
// checks if the ListOfBuilds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfBuilds{}

// ListOfBuilds struct for ListOfBuilds
...
type _ListOfBuilds ListOfBuilds

// NewListOfBuilds instantiates a new ListOfBuilds object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfBuilds(total int32, offset int32, limit int32, desc bool, count int32, items []BuildShort) *ListOfBuilds {
	this := ListOfBuilds{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
...
// NewListOfBuildsWithDefaults instantiates a new ListOfBuilds object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfBuildsWithDefaults() *ListOfBuilds {
	this := ListOfBuilds{}
	return &this
}

// GetTotal returns the Total field value
func (o *ListOfBuilds) GetTotal() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListOfBuilds) GetTotalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Total, true
...
func (o *ListOfBuilds) SetTotal(v int32) {
	o.Total = v
}

// GetOffset returns the Offset field value
func (o *ListOfBuilds) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfBuilds) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListOfBuilds) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ListOfBuilds) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfBuilds) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ListOfBuilds) SetLimit(v int32) {
	o.Limit = v
}

// GetDesc returns the Desc field value
func (o *ListOfBuilds) GetDesc() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfBuilds) GetDescOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Desc, true
...
func (o *ListOfBuilds) SetDesc(v bool) {
	o.Desc = v
}

// GetCount returns the Count field value
func (o *ListOfBuilds) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfBuilds) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ListOfBuilds) SetCount(v int32) {
	o.Count = v
}

// GetItems returns the Items field value
func (o *ListOfBuilds) GetItems() []BuildShort {
	if o == nil {
		var ret []BuildShort
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListOfBuilds) GetItemsOk() ([]BuildShort, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListOfBuilds) SetItems(v []BuildShort) {
	o.Items = v
}

func (o ListOfBuilds) MarshalJSON() ([]byte, error) {
...
func (o ListOfBuilds) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfBuilds) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfBuilds := _ListOfBuilds{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfBuilds)

	if err != nil {
		return err
	}

	*o = ListOfBuilds(varListOfBuilds)

	return err
}

type NullableListOfBuilds struct {
	value *ListOfBuilds
	isSet bool
}

func (v NullableListOfBuilds) Get() *ListOfBuilds {
	return v.value
}

func (v *NullableListOfBuilds) Set(val *ListOfBuilds) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfBuilds) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfBuilds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfBuilds(val *ListOfBuilds) *NullableListOfBuilds {
	return &NullableListOfBuilds{value: val, isSet: true}
}

func (v NullableListOfBuilds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfBuilds) UnmarshalJSON(src []byte) error {
	v.isSet = true
