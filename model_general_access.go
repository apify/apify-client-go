...
// GeneralAccess Defines the general access level for the resource.
type GeneralAccess string

// List of GeneralAccess
const (
	ANYONE_WITH_ID_CAN_READ GeneralAccess = "ANYONE_WITH_ID_CAN_READ"
	ANYONE_WITH_NAME_CAN_READ GeneralAccess = "ANYONE_WITH_NAME_CAN_READ"
	FOLLOW_USER_SETTING GeneralAccess = "FOLLOW_USER_SETTING"
	RESTRICTED GeneralAccess = "RESTRICTED"
)

// All allowed values of GeneralAccess enum
var AllowedGeneralAccessEnumValues = []GeneralAccess{
...
func (v *GeneralAccess) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := GeneralAccess(value)
	for _, existing := range AllowedGeneralAccessEnumValues {
	...
	return fmt.Errorf("%+v is not a valid GeneralAccess", value)
}

// NewGeneralAccessFromValue returns a pointer to a valid GeneralAccess
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewGeneralAccessFromValue(v string) (*GeneralAccess, error) {
	ev := GeneralAccess(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for GeneralAccess: valid values are %v", v, AllowedGeneralAccessEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v GeneralAccess) IsValid() bool {
	for _, existing := range AllowedGeneralAccessEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to GeneralAccess value
func (v GeneralAccess) Ptr() *GeneralAccess {
	return &v
}

type NullableGeneralAccess struct {
	value *GeneralAccess
	isSet bool
}

func (v NullableGeneralAccess) Get() *GeneralAccess {
	return v.value
}

func (v *NullableGeneralAccess) Set(val *GeneralAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralAccess(val *GeneralAccess) *NullableGeneralAccess {
	return &NullableGeneralAccess{value: val, isSet: true}
}

func (v NullableGeneralAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
