...
func (o *ScheduleResponse) GetData() Schedule {
	if o == nil {
		var ret Schedule
		return ret
	}
...
func (o *ScheduleResponse) GetDataOk() (*Schedule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ScheduleResponse) SetData(v Schedule) {
	o.Data = v
}
...
func (o *ScheduleResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleResponse := _ScheduleResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleResponse)

	if err != nil {
		return err
	}

	*o = ScheduleResponse(varScheduleResponse)
