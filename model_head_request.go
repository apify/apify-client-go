...
// checks if the HeadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeadRequest{}

// HeadRequest A request from the request queue head without lock information.
...
func (o HeadRequest) MarshalJSON() ([]byte, error) {
...
func (o HeadRequest) ToMap() (map[string]interface{}, error) {
...
func (o *HeadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varHeadRequest := _HeadRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeadRequest)

	if err != nil {
		return err
	}

	*o = HeadRequest(varHeadRequest)

	return err
}

type NullableHeadRequest struct {
	value *HeadRequest
	isSet bool
}

func (v NullableHeadRequest) Get() *HeadRequest {
	return v.value
}

func (v *NullableHeadRequest) Set(val *HeadRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHeadRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHeadRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeadRequest(val *HeadRequest) *NullableHeadRequest {
	return &NullableHeadRequest{value: val, isSet: true}
}

func (v NullableHeadRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeadRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
