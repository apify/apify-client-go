...
// checks if the RequestQueueResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestQueueResponse{}
...
type _RequestQueueResponse RequestQueueResponse

// NewRequestQueueResponse instantiates a new RequestQueueResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequestQueueResponse(data RequestQueue) *RequestQueueResponse {
	this := RequestQueueResponse{}
	this.Data = data
	return &this
}

// NewRequestQueueResponseWithDefaults instantiates a new RequestQueueResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRequestQueueResponseWithDefaults() *RequestQueueResponse {
	this := RequestQueueResponse{}
	return &this
}

// GetData returns the Data field value
func (o *RequestQueueResponse) GetData() RequestQueue {
	if o == nil {
		var ret RequestQueue
		return ret
	}
...
func (o *RequestQueueResponse) GetDataOk() (*RequestQueue, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *RequestQueueResponse) SetData(v RequestQueue) {
	o.Data = v
}

func (o RequestQueueResponse) MarshalJSON() ([]byte, error) {
...
func (o RequestQueueResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *RequestQueueResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestQueueResponse := _RequestQueueResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestQueueResponse)

	if err != nil {
		return err
	}

	*o = RequestQueueResponse(varRequestQueueResponse)

	return err
}

type NullableRequestQueueResponse struct {
	value *RequestQueueResponse
	isSet bool
}

func (v NullableRequestQueueResponse) Get() *RequestQueueResponse {
	return v.value
}

func (v *NullableRequestQueueResponse) Set(val *RequestQueueResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestQueueResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestQueueResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestQueueResponse(val *RequestQueueResponse) *NullableRequestQueueResponse {
	return &NullableRequestQueueResponse{value: val, isSet: true}
}

func (v NullableRequestQueueResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestQueueResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
