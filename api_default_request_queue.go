...
// DefaultRequestQueueAPIService DefaultRequestQueueAPI service
type DefaultRequestQueueAPIService service

type ApiActorRunRequestQueueDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
}

func (r ApiActorRunRequestQueueDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunRequestQueueDeleteExecute(r)
}

/*
ActorRunRequestQueueDelete Delete default request queue
...
[Delete request queue](/api/v2/request-queue-delete) endpoint.
 ...
 @return ApiActorRunRequestQueueDeleteRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueDelete(ctx context.Context, runId string) ApiActorRunRequestQueueDeleteRequest {
	return ApiActorRunRequestQueueDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueDeleteExecute(r ApiActorRunRequestQueueDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue"
...
type ApiActorRunRequestQueueGetRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
}

func (r ApiActorRunRequestQueueGetRequest) Execute() (*RequestQueueResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueGetExecute(r)
}

/*
ActorRunRequestQueueGet Get default request queue
...
[Get request queue](/api/v2/request-queue-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueGetRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueGet(ctx context.Context, runId string) ApiActorRunRequestQueueGetRequest {
	return ApiActorRunRequestQueueGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueGetExecute(r ApiActorRunRequestQueueGetRequest) (*RequestQueueResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueGet")
	if err != nil {
...
type ApiActorRunRequestQueueHeadGetRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	limit *float64
...
func (r ApiActorRunRequestQueueHeadGetRequest) Limit(limit float64) ApiActorRunRequestQueueHeadGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorRunRequestQueueHeadGetRequest) ClientKey(clientKey string) ApiActorRunRequestQueueHeadGetRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueHeadGetRequest) Execute() (*HeadResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueHeadGetExecute(r)
}

/*
ActorRunRequestQueueHeadGet Get default request queue head
...
[Get head](/api/v2/request-queue-head-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueHeadGetRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueHeadGet(ctx context.Context, runId string) ApiActorRunRequestQueueHeadGetRequest {
	return ApiActorRunRequestQueueHeadGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return HeadResponse
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueHeadGetExecute(r ApiActorRunRequestQueueHeadGetRequest) (*HeadResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueHeadGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/head"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunRequestQueueHeadLockPostRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	lockSecs *float64
...
func (r ApiActorRunRequestQueueHeadLockPostRequest) LockSecs(lockSecs float64) ApiActorRunRequestQueueHeadLockPostRequest {
	r.lockSecs = &lockSecs
	return r
}

// How many items from the queue should be returned.
func (r ApiActorRunRequestQueueHeadLockPostRequest) Limit(limit float64) ApiActorRunRequestQueueHeadLockPostRequest {
	r.limit = &limit
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueHeadLockPostRequest) ClientKey(clientKey string) ApiActorRunRequestQueueHeadLockPostRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueHeadLockPostRequest) Execute() (*HeadAndLockResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueHeadLockPostExecute(r)
}

/*
ActorRunRequestQueueHeadLockPost Get and lock default request queue head
...
[Get head and lock](/api/v2/request-queue-head-lock-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueHeadLockPostRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueHeadLockPost(ctx context.Context, runId string) ApiActorRunRequestQueueHeadLockPostRequest {
	return ApiActorRunRequestQueueHeadLockPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueHeadLockPostExecute(r ApiActorRunRequestQueueHeadLockPostRequest) (*HeadAndLockResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueHeadLockPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/head/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunRequestQueuePutRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
...
// 
func (r ApiActorRunRequestQueuePutRequest) UpdateRequestQueueRequest(updateRequestQueueRequest UpdateRequestQueueRequest) ApiActorRunRequestQueuePutRequest {
	r.updateRequestQueueRequest = &updateRequestQueueRequest
	return r
}

func (r ApiActorRunRequestQueuePutRequest) Execute() (*RequestQueueResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueuePutExecute(r)
}

/*
ActorRunRequestQueuePut Update default request queue
...
[Update request queue](/api/v2/request-queue-put) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueuePutRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueuePut(ctx context.Context, runId string) ApiActorRunRequestQueuePutRequest {
	return ApiActorRunRequestQueuePutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
//  @return RequestQueueResponse
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueuePutExecute(r ApiActorRunRequestQueuePutRequest) (*RequestQueueResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueuePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestId string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestDeleteRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestDeleteRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueRequestDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestDeleteExecute(r)
}

/*
ActorRunRequestQueueRequestDelete Delete request from default request queue
...
[Delete request](/api/v2/request-queue-request-delete) endpoint.
 ...
 @return ApiActorRunRequestQueueRequestDeleteRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestDelete(ctx context.Context, runId string, requestId string) ApiActorRunRequestQueueRequestDeleteRequest {
	return ApiActorRunRequestQueueRequestDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestDeleteExecute(r ApiActorRunRequestQueueRequestDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/requests/{requestId}"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunRequestQueueRequestGetRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestId string
...
func (r ApiActorRunRequestQueueRequestGetRequest) Execute() (*RequestResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestGetExecute(r)
}

/*
ActorRunRequestQueueRequestGet Get request from default request queue
...
[Get request](/api/v2/request-queue-request-get) endpoint.
 ...
 @param runId Actor run ID.
 @param requestId Request ID.
 @return ApiActorRunRequestQueueRequestGetRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestGet(ctx context.Context, runId string, requestId string) ApiActorRunRequestQueueRequestGetRequest {
	return ApiActorRunRequestQueueRequestGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestGetExecute(r ApiActorRunRequestQueueRequestGetRequest) (*RequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestLockDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestId string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestLockDeleteRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestLockDeleteRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end after lock was removed. 
func (r ApiActorRunRequestQueueRequestLockDeleteRequest) Forefront(forefront string) ApiActorRunRequestQueueRequestLockDeleteRequest {
	r.forefront = &forefront
	return r
}

func (r ApiActorRunRequestQueueRequestLockDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestLockDeleteExecute(r)
}

/*
ActorRunRequestQueueRequestLockDelete Delete lock on request in default request queue
...
[Delete request lock](/api/v2/request-queue-request-lock-delete) endpoint.
 ...
 @param runId Actor run ID.
 @param requestId Request ID.
 @return ApiActorRunRequestQueueRequestLockDeleteRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestLockDelete(ctx context.Context, runId string, requestId string) ApiActorRunRequestQueueRequestLockDeleteRequest {
	return ApiActorRunRequestQueueRequestLockDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
// Execute executes the request
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestLockDeleteExecute(r ApiActorRunRequestQueueRequestLockDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestLockDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/requests/{requestId}/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"requestId"+"}", url.PathEscape(parameterValueToString(r.requestId, "requestId")), -1)
...
type ApiActorRunRequestQueueRequestLockPutRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestId string
...
// How long the requests will be locked for (in seconds).
func (r ApiActorRunRequestQueueRequestLockPutRequest) LockSecs(lockSecs float64) ApiActorRunRequestQueueRequestLockPutRequest {
	r.lockSecs = &lockSecs
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestLockPutRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestLockPutRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end after lock expires. 
func (r ApiActorRunRequestQueueRequestLockPutRequest) Forefront(forefront string) ApiActorRunRequestQueueRequestLockPutRequest {
	r.forefront = &forefront
	return r
}

func (r ApiActorRunRequestQueueRequestLockPutRequest) Execute() (*ProlongRequestLockResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestLockPutExecute(r)
}

/*
ActorRunRequestQueueRequestLockPut Prolong lock on request in default request queue
...
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestLockPut(ctx context.Context, runId string, requestId string) ApiActorRunRequestQueueRequestLockPutRequest {
	return ApiActorRunRequestQueueRequestLockPutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestLockPutExecute(r ApiActorRunRequestQueueRequestLockPutRequest) (*ProlongRequestLockResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestLockPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestPutRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestId string
...
// 
func (r ApiActorRunRequestQueueRequestPutRequest) Request(request Request) ApiActorRunRequestQueueRequestPutRequest {
	r.request = &request
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiActorRunRequestQueueRequestPutRequest) Forefront(forefront string) ApiActorRunRequestQueueRequestPutRequest {
	r.forefront = &forefront
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestPutRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestPutRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueRequestPutRequest) Execute() (*UpdateRequestResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestPutExecute(r)
}

/*
ActorRunRequestQueueRequestPut Update request in default request queue
...
[Update request](/api/v2/request-queue-request-put) endpoint.
 ...
 @param runId Actor run ID.
 @param requestId Request ID.
 @return ApiActorRunRequestQueueRequestPutRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestPut(ctx context.Context, runId string, requestId string) ApiActorRunRequestQueueRequestPutRequest {
	return ApiActorRunRequestQueueRequestPutRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestPutExecute(r ApiActorRunRequestQueueRequestPutRequest) (*UpdateRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestsBatchDeleteRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	contentType *string
...
// 
func (r ApiActorRunRequestQueueRequestsBatchDeleteRequest) ContentType(contentType string) ApiActorRunRequestQueueRequestsBatchDeleteRequest {
	r.contentType = &contentType
	return r
}

// 
func (r ApiActorRunRequestQueueRequestsBatchDeleteRequest) RequestDraftDelete(requestDraftDelete []RequestDraftDelete) ApiActorRunRequestQueueRequestsBatchDeleteRequest {
	r.requestDraftDelete = &requestDraftDelete
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestsBatchDeleteRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestsBatchDeleteRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueRequestsBatchDeleteRequest) Execute() (*BatchDeleteResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestsBatchDeleteExecute(r)
}

/*
ActorRunRequestQueueRequestsBatchDelete Batch delete requests from default request queue
...
[Delete requests](/api/v2/request-queue-requests-batch-delete) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueRequestsBatchDeleteRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsBatchDelete(ctx context.Context, runId string) ApiActorRunRequestQueueRequestsBatchDeleteRequest {
	return ApiActorRunRequestQueueRequestsBatchDeleteRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsBatchDeleteExecute(r ApiActorRunRequestQueueRequestsBatchDeleteRequest) (*BatchDeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestsBatchDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/requests/batch"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunRequestQueueRequestsBatchPostRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
...
// 
func (r ApiActorRunRequestQueueRequestsBatchPostRequest) RequestBase(requestBase []RequestBase) ApiActorRunRequestQueueRequestsBatchPostRequest {
	r.requestBase = &requestBase
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestsBatchPostRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestsBatchPostRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiActorRunRequestQueueRequestsBatchPostRequest) Forefront(forefront string) ApiActorRunRequestQueueRequestsBatchPostRequest {
	r.forefront = &forefront
	return r
}

func (r ApiActorRunRequestQueueRequestsBatchPostRequest) Execute() (*BatchAddResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestsBatchPostExecute(r)
}

/*
ActorRunRequestQueueRequestsBatchPost Batch add requests to default request queue
...
[Add requests](/api/v2/request-queue-requests-batch-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueRequestsBatchPostRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsBatchPost(ctx context.Context, runId string) ApiActorRunRequestQueueRequestsBatchPostRequest {
	return ApiActorRunRequestQueueRequestsBatchPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsBatchPostExecute(r ApiActorRunRequestQueueRequestsBatchPostRequest) (*BatchAddResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestsBatchPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestsGetRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	clientKey *string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestsGetRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestsGetRequest {
	r.clientKey = &clientKey
	return r
}
...
// Deprecated
func (r ApiActorRunRequestQueueRequestsGetRequest) ExclusiveStartId(exclusiveStartId string) ApiActorRunRequestQueueRequestsGetRequest {
	r.exclusiveStartId = &exclusiveStartId
	return r
}

// Number of keys to be returned. Maximum value is &#x60;10000&#x60;.
func (r ApiActorRunRequestQueueRequestsGetRequest) Limit(limit float64) ApiActorRunRequestQueueRequestsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorRunRequestQueueRequestsGetRequest) Cursor(cursor string) ApiActorRunRequestQueueRequestsGetRequest {
	r.cursor = &cursor
	return r
}
...
func (r ApiActorRunRequestQueueRequestsGetRequest) Filter(filter []string) ApiActorRunRequestQueueRequestsGetRequest {
	r.filter = &filter
	return r
}

func (r ApiActorRunRequestQueueRequestsGetRequest) Execute() (*ListOfRequestsResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestsGetExecute(r)
}

/*
ActorRunRequestQueueRequestsGet List default request queue's requests
...
[List requests](/api/v2/request-queue-requests-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueRequestsGetRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsGet(ctx context.Context, runId string) ApiActorRunRequestQueueRequestsGetRequest {
	return ApiActorRunRequestQueueRequestsGetRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsGetExecute(r ApiActorRunRequestQueueRequestsGetRequest) (*ListOfRequestsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/requests"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
...
type ApiActorRunRequestQueueRequestsPostRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	requestBase *RequestBase
...
// 
func (r ApiActorRunRequestQueueRequestsPostRequest) RequestBase(requestBase RequestBase) ApiActorRunRequestQueueRequestsPostRequest {
	r.requestBase = &requestBase
	return r
}

// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestsPostRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestsPostRequest {
	r.clientKey = &clientKey
	return r
}

// Determines if request should be added to the head of the queue or to the end. Default value is &#x60;false&#x60; (end of queue). 
func (r ApiActorRunRequestQueueRequestsPostRequest) Forefront(forefront string) ApiActorRunRequestQueueRequestsPostRequest {
	r.forefront = &forefront
	return r
}

func (r ApiActorRunRequestQueueRequestsPostRequest) Execute() (*AddRequestResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestsPostExecute(r)
}

/*
ActorRunRequestQueueRequestsPost Add request to default request queue
...
[Add request](/api/v2/request-queue-requests-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueRequestsPostRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsPost(ctx context.Context, runId string) ApiActorRunRequestQueueRequestsPostRequest {
	return ApiActorRunRequestQueueRequestsPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsPostExecute(r ApiActorRunRequestQueueRequestsPostRequest) (*AddRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorRunRequestQueueRequestsUnlockPostRequest struct {
	ctx context.Context
	ApiService *DefaultRequestQueueAPIService
	runId string
	clientKey *string
...
// A unique identifier of the client accessing the request queue. It must be a string between 1 and 32 characters long. This identifier is used to determine whether the queue was accessed by multiple clients. If &#x60;clientKey&#x60; is not provided, the system considers this API call to come from a new client. For details, see the &#x60;hadMultipleClients&#x60; field returned by the [Get head](#/reference/request-queues/queue-head) operation. 
func (r ApiActorRunRequestQueueRequestsUnlockPostRequest) ClientKey(clientKey string) ApiActorRunRequestQueueRequestsUnlockPostRequest {
	r.clientKey = &clientKey
	return r
}

func (r ApiActorRunRequestQueueRequestsUnlockPostRequest) Execute() (*UnlockRequestsResponse, *http.Response, error) {
	return r.ApiService.ActorRunRequestQueueRequestsUnlockPostExecute(r)
}

/*
ActorRunRequestQueueRequestsUnlockPost Unlock requests in default request queue
...
[Unlock requests](/api/v2/request-queue-requests-unlock-post) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param runId Actor run ID.
 @return ApiActorRunRequestQueueRequestsUnlockPostRequest
*/
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsUnlockPost(ctx context.Context, runId string) ApiActorRunRequestQueueRequestsUnlockPostRequest {
	return ApiActorRunRequestQueueRequestsUnlockPostRequest{
		ApiService: a,
		ctx: ctx,
		runId: runId,
...
func (a *DefaultRequestQueueAPIService) ActorRunRequestQueueRequestsUnlockPostExecute(r ApiActorRunRequestQueueRequestsUnlockPostRequest) (*UnlockRequestsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultRequestQueueAPIService.ActorRunRequestQueueRequestsUnlockPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-runs/{runId}/request-queue/requests/unlock"
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", url.PathEscape(parameterValueToString(r.runId, "runId")), -1)
