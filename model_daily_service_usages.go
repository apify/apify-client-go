...
// checks if the DailyServiceUsages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DailyServiceUsages{}

// DailyServiceUsages struct for DailyServiceUsages
type DailyServiceUsages struct {
	Date string `json:"date"`
	// A map of service usage item names to their usage details.
	ServiceUsage map[string]UsageItem `json:"serviceUsage"`
	TotalUsageCreditsUsd float32 `json:"totalUsageCreditsUsd"`
}

type _DailyServiceUsages DailyServiceUsages
...
// GetServiceUsage returns the ServiceUsage field value
func (o *DailyServiceUsages) GetServiceUsage() map[string]UsageItem {
	...
	return o.ServiceUsage
}

// GetServiceUsageOk returns a tuple with the ServiceUsage field value
// and a boolean to check if the value has been set.
func (o *DailyServiceUsages) GetServiceUsageOk() (map[string]UsageItem, bool) {
	if o == nil {
		return map[string]UsageItem{}, false
	}
	return o.ServiceUsage, true
}

// SetServiceUsage sets field value
func (o *DailyServiceUsages) SetServiceUsage(v map[string]UsageItem) {
	o.ServiceUsage = v
}

// GetTotalUsageCreditsUsd returns the TotalUsageCreditsUsd field value
func (o *DailyServiceUsages) GetTotalUsageCreditsUsd() float32 {
	...
	return o.TotalUsageCreditsUsd
}

// GetTotalUsageCreditsUsdOk returns a tuple with the TotalUsageCreditsUsd field value
// and a boolean to check if the value has been set.
func (o *DailyServiceUsages) GetTotalUsageCreditsUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalUsageCreditsUsd, true
}

// SetTotalUsageCreditsUsd sets field value
func (o *DailyServiceUsages) SetTotalUsageCreditsUsd(v float32) {
	o.TotalUsageCreditsUsd = v
}

func (o DailyServiceUsages) MarshalJSON() ([]byte, error) {
...
func (o DailyServiceUsages) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["date"] = o.Date
	toSerialize["serviceUsage"] = o.ServiceUsage
	toSerialize["totalUsageCreditsUsd"] = o.TotalUsageCreditsUsd
	return toSerialize, nil
}

func (o *DailyServiceUsages) UnmarshalJSON(data []byte) (err error) {
	...
	varDailyServiceUsages := _DailyServiceUsages{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDailyServiceUsages)

	if err != nil {
		return err
	}

	*o = DailyServiceUsages(varDailyServiceUsages)

	return err
}

type NullableDailyServiceUsages struct {
	value *DailyServiceUsages
	isSet bool
}

func (v NullableDailyServiceUsages) Get() *DailyServiceUsages {
	return v.value
}

func (v *NullableDailyServiceUsages) Set(val *DailyServiceUsages) {
	v.value = val
	v.isSet = true
}

func (v NullableDailyServiceUsages) IsSet() bool {
	return v.isSet
}

func (v *NullableDailyServiceUsages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDailyServiceUsages(val *DailyServiceUsages) *NullableDailyServiceUsages {
	return &NullableDailyServiceUsages{value: val, isSet: true}
}

func (v NullableDailyServiceUsages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDailyServiceUsages) UnmarshalJSON(src []byte) error {
	v.isSet = true
