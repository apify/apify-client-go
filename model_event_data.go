...
func NewEventData(actorId string, actorRunId string) *EventData {
	this := EventData{}
...
func (o *EventData) GetActorId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *EventData) GetActorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventData) SetActorId(v string) {
	o.ActorId = v
}

// GetActorRunId returns the ActorRunId field value
func (o *EventData) GetActorRunId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetActorRunIdOk returns a tuple with the ActorRunId field value
// and a boolean to check if the value has been set.
func (o *EventData) GetActorRunIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActorRunId, true
}

// SetActorRunId sets field value
func (o *EventData) SetActorRunId(v string) {
	o.ActorRunId = v
}
...
func (o EventData) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["actorRunId"] = o.ActorRunId
	return toSerialize, nil
}

func (o *EventData) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varEventData)
