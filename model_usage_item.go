...
type UsageItem struct {
	...
	BaseUnitPriceUsd *float32 `json:"baseUnitPriceUsd,omitempty"`
	AmountAfterVolumeDiscountUsd *float32 `json:"amountAfterVolumeDiscountUsd,omitempty"`
	// 
	PriceTiers []PriceTiers `json:"priceTiers,omitempty"`
}
...
// GetBaseAmountUsd returns the BaseAmountUsd field value
func (o *UsageItem) GetBaseAmountUsd() float32 {
	...
	return o.BaseAmountUsd
}

// GetBaseAmountUsdOk returns a tuple with the BaseAmountUsd field value
// and a boolean to check if the value has been set.
func (o *UsageItem) GetBaseAmountUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BaseAmountUsd, true
}

// SetBaseAmountUsd sets field value
func (o *UsageItem) SetBaseAmountUsd(v float32) {
	o.BaseAmountUsd = v
}

// GetBaseUnitPriceUsd returns the BaseUnitPriceUsd field value if set, zero value otherwise.
func (o *UsageItem) GetBaseUnitPriceUsd() float32 {
	if o == nil || IsNil(o.BaseUnitPriceUsd) {
		var ret float32
		return ret
	}
	return *o.BaseUnitPriceUsd
}

// GetBaseUnitPriceUsdOk returns a tuple with the BaseUnitPriceUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageItem) GetBaseUnitPriceUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.BaseUnitPriceUsd) {
		return nil, false
	}
	return o.BaseUnitPriceUsd, true
}
...
// SetBaseUnitPriceUsd gets a reference to the given float32 and assigns it to the BaseUnitPriceUsd field.
func (o *UsageItem) SetBaseUnitPriceUsd(v float32) {
	o.BaseUnitPriceUsd = &v
}

// GetAmountAfterVolumeDiscountUsd returns the AmountAfterVolumeDiscountUsd field value if set, zero value otherwise.
func (o *UsageItem) GetAmountAfterVolumeDiscountUsd() float32 {
	if o == nil || IsNil(o.AmountAfterVolumeDiscountUsd) {
		var ret float32
		return ret
	}
	return *o.AmountAfterVolumeDiscountUsd
}

// GetAmountAfterVolumeDiscountUsdOk returns a tuple with the AmountAfterVolumeDiscountUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsageItem) GetAmountAfterVolumeDiscountUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.AmountAfterVolumeDiscountUsd) {
		return nil, false
	}
	return o.AmountAfterVolumeDiscountUsd, true
}
...
// SetAmountAfterVolumeDiscountUsd gets a reference to the given float32 and assigns it to the AmountAfterVolumeDiscountUsd field.
func (o *UsageItem) SetAmountAfterVolumeDiscountUsd(v float32) {
	o.AmountAfterVolumeDiscountUsd = &v
}
...
// SetPriceTiers gets a reference to the given []PriceTiers and assigns it to the PriceTiers field.
...
func (o UsageItem) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["baseAmountUsd"] = o.BaseAmountUsd
	if !IsNil(o.BaseUnitPriceUsd) {
		toSerialize["baseUnitPriceUsd"] = o.BaseUnitPriceUsd
	}
	if !IsNil(o.AmountAfterVolumeDiscountUsd) {
		toSerialize["amountAfterVolumeDiscountUsd"] = o.AmountAfterVolumeDiscountUsd
	}
...
func (o *UsageItem) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varUsageItem)
