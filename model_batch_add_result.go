...
// checks if the BatchAddResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchAddResult{}

// BatchAddResult Result of a batch add operation containing successfully processed and failed requests.
type BatchAddResult struct {
	// Requests that were successfully added to the request queue.
	ProcessedRequests []AddedRequest `json:"processedRequests"`
	// Requests that failed to be added and can be retried.
	UnprocessedRequests []RequestDraft `json:"unprocessedRequests"`
}

type _BatchAddResult BatchAddResult
...
// GetProcessedRequests returns the ProcessedRequests field value
func (o *BatchAddResult) GetProcessedRequests() []AddedRequest {
	if o == nil {
		var ret []AddedRequest
		return ret
	}

	return o.ProcessedRequests
}

// GetProcessedRequestsOk returns a tuple with the ProcessedRequests field value
// and a boolean to check if the value has been set.
func (o *BatchAddResult) GetProcessedRequestsOk() ([]AddedRequest, bool) {
	if o == nil {
		return nil, false
	}
	return o.ProcessedRequests, true
}

// SetProcessedRequests sets field value
func (o *BatchAddResult) SetProcessedRequests(v []AddedRequest) {
	o.ProcessedRequests = v
}

// GetUnprocessedRequests returns the UnprocessedRequests field value
func (o *BatchAddResult) GetUnprocessedRequests() []RequestDraft {
	if o == nil {
		var ret []RequestDraft
		return ret
	}

	return o.UnprocessedRequests
}

// GetUnprocessedRequestsOk returns a tuple with the UnprocessedRequests field value
// and a boolean to check if the value has been set.
func (o *BatchAddResult) GetUnprocessedRequestsOk() ([]RequestDraft, bool) {
	if o == nil {
		return nil, false
	}
	return o.UnprocessedRequests, true
}

// SetUnprocessedRequests sets field value
func (o *BatchAddResult) SetUnprocessedRequests(v []RequestDraft) {
	o.UnprocessedRequests = v
}

func (o BatchAddResult) MarshalJSON() ([]byte, error) {
...
func (o BatchAddResult) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["processedRequests"] = o.ProcessedRequests
	toSerialize["unprocessedRequests"] = o.UnprocessedRequests
	return toSerialize, nil
}

func (o *BatchAddResult) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchAddResult := _BatchAddResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchAddResult)

	if err != nil {
		return err
	}

	*o = BatchAddResult(varBatchAddResult)

	return err
}

type NullableBatchAddResult struct {
	value *BatchAddResult
	isSet bool
}

func (v NullableBatchAddResult) Get() *BatchAddResult {
	return v.value
}

func (v *NullableBatchAddResult) Set(val *BatchAddResult) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchAddResult) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchAddResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchAddResult(val *BatchAddResult) *NullableBatchAddResult {
	return &NullableBatchAddResult{value: val, isSet: true}
}

func (v NullableBatchAddResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchAddResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
