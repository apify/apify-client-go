...
// checks if the ListOfBuildsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfBuildsResponse{}

// ListOfBuildsResponse struct for ListOfBuildsResponse
type ListOfBuildsResponse struct {
	Data ListOfBuilds `json:"data"`
}

type _ListOfBuildsResponse ListOfBuildsResponse

// NewListOfBuildsResponse instantiates a new ListOfBuildsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfBuildsResponse(data ListOfBuilds) *ListOfBuildsResponse {
	this := ListOfBuildsResponse{}
	this.Data = data
	return &this
}

// NewListOfBuildsResponseWithDefaults instantiates a new ListOfBuildsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfBuildsResponseWithDefaults() *ListOfBuildsResponse {
	this := ListOfBuildsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfBuildsResponse) GetData() ListOfBuilds {
	if o == nil {
		var ret ListOfBuilds
		return ret
	}
...
func (o *ListOfBuildsResponse) GetDataOk() (*ListOfBuilds, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfBuildsResponse) SetData(v ListOfBuilds) {
	o.Data = v
}

func (o ListOfBuildsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfBuildsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfBuildsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfBuildsResponse := _ListOfBuildsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfBuildsResponse)

	if err != nil {
		return err
	}

	*o = ListOfBuildsResponse(varListOfBuildsResponse)

	return err
}

type NullableListOfBuildsResponse struct {
	value *ListOfBuildsResponse
	isSet bool
}

func (v NullableListOfBuildsResponse) Get() *ListOfBuildsResponse {
	return v.value
}

func (v *NullableListOfBuildsResponse) Set(val *ListOfBuildsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfBuildsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfBuildsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfBuildsResponse(val *ListOfBuildsResponse) *NullableListOfBuildsResponse {
	return &NullableListOfBuildsResponse{value: val, isSet: true}
}

func (v NullableListOfBuildsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfBuildsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
