...
// ActorBuildsAPIService ActorBuildsAPI service
type ActorBuildsAPIService service

type ApiActorBuildAbortPostRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	buildId string
}

func (r ApiActorBuildAbortPostRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActorBuildAbortPostExecute(r)
}

/*
ActorBuildAbortPost Abort build
...
`FINISHED`, `FAILED`, `ABORTING` and `TIMED-OUT` this call does nothing.
 ...
 @return ApiActorBuildAbortPostRequest
*/
func (a *ActorBuildsAPIService) ActorBuildAbortPost(ctx context.Context, buildId string) ApiActorBuildAbortPostRequest {
	return ApiActorBuildAbortPostRequest{
		ApiService: a,
		ctx: ctx,
		buildId: buildId,
...
func (a *ActorBuildsAPIService) ActorBuildAbortPostExecute(r ApiActorBuildAbortPostRequest) (*BuildResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildAbortPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-builds/{buildId}/abort"
...
type ApiActorBuildDeleteRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	buildId string
}

func (r ApiActorBuildDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.ActorBuildDeleteExecute(r)
}

/*
ActorBuildDelete Delete build
...
Only users with build permissions for the Actor can delete builds.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param buildId ID of the build, found in the build's Info tab.
 @return ApiActorBuildDeleteRequest
*/
func (a *ActorBuildsAPIService) ActorBuildDelete(ctx context.Context, buildId string) ApiActorBuildDeleteRequest {
	return ApiActorBuildDeleteRequest{
		ApiService: a,
		ctx: ctx,
		buildId: buildId,
...
// Execute executes the request
func (a *ActorBuildsAPIService) ActorBuildDeleteExecute(r ApiActorBuildDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-builds/{buildId}"
	localVarPath = strings.Replace(localVarPath, "{"+"buildId"+"}", url.PathEscape(parameterValueToString(r.buildId, "buildId")), -1)
...
type ApiActorBuildGetRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	buildId string
...
func (r ApiActorBuildGetRequest) WaitForFinish(waitForFinish float64) ApiActorBuildGetRequest {
	r.waitForFinish = &waitForFinish
	return r
}

func (r ApiActorBuildGetRequest) Execute() (*BuildResponse, *http.Response, error) {
	return r.ApiService.ActorBuildGetExecute(r)
}

/*
ActorBuildGet Get build
...
if you access the endpoint without the token, certain attributes, such as `usageUsd` and `usageTotalUsd`, will be hidden.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param buildId ID of the build, found in the build's Info tab.
 @return ApiActorBuildGetRequest
*/
func (a *ActorBuildsAPIService) ActorBuildGet(ctx context.Context, buildId string) ApiActorBuildGetRequest {
	return ApiActorBuildGetRequest{
		ApiService: a,
		ctx: ctx,
		buildId: buildId,
...
// Execute executes the request
//  @return BuildResponse
func (a *ActorBuildsAPIService) ActorBuildGetExecute(r ApiActorBuildGetRequest) (*BuildResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActorBuildLogGetRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	buildId string
	stream *bool
...
func (r ApiActorBuildLogGetRequest) Stream(stream bool) ApiActorBuildLogGetRequest {
	r.stream = &stream
	return r
}

// If &#x60;true&#x60; or &#x60;1&#x60; then the web browser will download the log file rather than open it in a tab. 
func (r ApiActorBuildLogGetRequest) Download(download bool) ApiActorBuildLogGetRequest {
	r.download = &download
	return r
}

func (r ApiActorBuildLogGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.ActorBuildLogGetExecute(r)
}

/*
ActorBuildLogGet Get build's Log
...
This endpoint is a shortcut for getting the build's log. Same as [Get log](/api/v2/log-get) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param buildId ID of the build, found in the build's Info tab.
 @return ApiActorBuildLogGetRequest
*/
func (a *ActorBuildsAPIService) ActorBuildLogGet(ctx context.Context, buildId string) ApiActorBuildLogGetRequest {
	return ApiActorBuildLogGetRequest{
		ApiService: a,
		ctx: ctx,
		buildId: buildId,
...
// Execute executes the request
//  @return string
func (a *ActorBuildsAPIService) ActorBuildLogGetExecute(r ApiActorBuildLogGetRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildLogGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-builds/{buildId}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"buildId"+"}", url.PathEscape(parameterValueToString(r.buildId, "buildId")), -1)
...
type ApiActorBuildOpenapiJsonGetRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	buildId string
}

func (r ApiActorBuildOpenapiJsonGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActorBuildOpenapiJsonGetExecute(r)
}

/*
ActorBuildOpenapiJsonGet Get OpenAPI definition
...
:::
 ...
 @return ApiActorBuildOpenapiJsonGetRequest
*/
func (a *ActorBuildsAPIService) ActorBuildOpenapiJsonGet(ctx context.Context, buildId string) ApiActorBuildOpenapiJsonGetRequest {
	return ApiActorBuildOpenapiJsonGetRequest{
		ApiService: a,
		ctx: ctx,
		buildId: buildId,
...
func (a *ActorBuildsAPIService) ActorBuildOpenapiJsonGetExecute(r ApiActorBuildOpenapiJsonGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildOpenapiJsonGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-builds/{buildId}/openapi.json"
	localVarPath = strings.Replace(localVarPath, "{"+"buildId"+"}", url.PathEscape(parameterValueToString(r.buildId, "buildId")), -1)
...
type ApiActorBuildsGetRequest struct {
	ctx context.Context
	ApiService *ActorBuildsAPIService
	offset *float64
	limit *float64
...
func (r ApiActorBuildsGetRequest) Offset(offset float64) ApiActorBuildsGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiActorBuildsGetRequest) Limit(limit float64) ApiActorBuildsGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiActorBuildsGetRequest) Desc(desc bool) ApiActorBuildsGetRequest {
	r.desc = &desc
	return r
}

func (r ApiActorBuildsGetRequest) Execute() (*ListOfBuildsResponse, *http.Response, error) {
	return r.ApiService.ActorBuildsGetExecute(r)
}

/*
ActorBuildsGet Get user builds list
...
the `desc=1` parameter.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiActorBuildsGetRequest
*/
func (a *ActorBuildsAPIService) ActorBuildsGet(ctx context.Context) ApiActorBuildsGetRequest {
	return ApiActorBuildsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ActorBuildsAPIService) ActorBuildsGetExecute(r ApiActorBuildsGetRequest) (*ListOfBuildsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorBuildsAPIService.ActorBuildsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-builds"
