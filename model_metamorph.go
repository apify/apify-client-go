...
// checks if the Metamorph type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Metamorph{}

// Metamorph Information about a metamorph event that occurred during the run.
type Metamorph struct {
	...
	InputKey NullableString `json:"inputKey,omitempty"`
}

type _Metamorph Metamorph
...
// GetInputKey returns the InputKey field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Metamorph) GetInputKey() string {
	if o == nil || IsNil(o.InputKey.Get()) {
		var ret string
		return ret
	}
	return *o.InputKey.Get()
}

// GetInputKeyOk returns a tuple with the InputKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetInputKey gets a reference to the given NullableString and assigns it to the InputKey field.
func (o *Metamorph) SetInputKey(v string) {
	o.InputKey.Set(&v)
}
// SetInputKeyNil sets the value for InputKey to be an explicit nil
func (o *Metamorph) SetInputKeyNil() {
	o.InputKey.Set(nil)
}
...
func (o Metamorph) MarshalJSON() ([]byte, error) {
...
func (o Metamorph) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["createdAt"] = o.CreatedAt
	toSerialize["actorId"] = o.ActorId
	toSerialize["buildId"] = o.BuildId
	if o.InputKey.IsSet() {
		toSerialize["inputKey"] = o.InputKey.Get()
	}
	return toSerialize, nil
}

func (o *Metamorph) UnmarshalJSON(data []byte) (err error) {
	...
	varMetamorph := _Metamorph{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetamorph)

	if err != nil {
		return err
	}

	*o = Metamorph(varMetamorph)

	return err
}

type NullableMetamorph struct {
	value *Metamorph
	isSet bool
}

func (v NullableMetamorph) Get() *Metamorph {
	return v.value
}

func (v *NullableMetamorph) Set(val *Metamorph) {
	v.value = val
	v.isSet = true
}

func (v NullableMetamorph) IsSet() bool {
	return v.isSet
}

func (v *NullableMetamorph) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetamorph(val *Metamorph) *NullableMetamorph {
	return &NullableMetamorph{value: val, isSet: true}
}

func (v NullableMetamorph) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetamorph) UnmarshalJSON(src []byte) error {
	v.isSet = true
