...
// checks if the ScheduleCreateActionRunActorTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleCreateActionRunActorTask{}

// ScheduleCreateActionRunActorTask struct for ScheduleCreateActionRunActorTask
...
type _ScheduleCreateActionRunActorTask ScheduleCreateActionRunActorTask

// NewScheduleCreateActionRunActorTask instantiates a new ScheduleCreateActionRunActorTask object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduleCreateActionRunActorTask(type_ interface{}, actorTaskId string) *ScheduleCreateActionRunActorTask {
	this := ScheduleCreateActionRunActorTask{}
	this.Type = type_
	this.ActorTaskId = actorTaskId
	return &this
}

// NewScheduleCreateActionRunActorTaskWithDefaults instantiates a new ScheduleCreateActionRunActorTask object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScheduleCreateActionRunActorTaskWithDefaults() *ScheduleCreateActionRunActorTask {
	this := ScheduleCreateActionRunActorTask{}
	return &this
}
...
func (o *ScheduleCreateActionRunActorTask) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ScheduleCreateActionRunActorTask) GetTypeOk() (*interface{}, bool) {
...
func (o *ScheduleCreateActionRunActorTask) SetType(v interface{}) {
	o.Type = v
}

// GetActorTaskId returns the ActorTaskId field value
func (o *ScheduleCreateActionRunActorTask) GetActorTaskId() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.ActorTaskId
}

// GetActorTaskIdOk returns a tuple with the ActorTaskId field value
// and a boolean to check if the value has been set.
func (o *ScheduleCreateActionRunActorTask) GetActorTaskIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActorTaskId, true
}

// SetActorTaskId sets field value
func (o *ScheduleCreateActionRunActorTask) SetActorTaskId(v string) {
	o.ActorTaskId = v
}

// GetInput returns the Input field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduleCreateActionRunActorTask) GetInput() map[string]interface{} {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ScheduleCreateActionRunActorTask) GetInputOk() (map[string]interface{}, bool) {
...
func (o *ScheduleCreateActionRunActorTask) HasInput() bool {
	if o != nil && !IsNil(o.Input) {
		return true
	}
...
func (o *ScheduleCreateActionRunActorTask) SetInput(v map[string]interface{}) {
	o.Input = v
}

func (o ScheduleCreateActionRunActorTask) MarshalJSON() ([]byte, error) {
...
func (o ScheduleCreateActionRunActorTask) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.Type != nil {
		toSerialize["type"] = o.Type
	}
	toSerialize["actorTaskId"] = o.ActorTaskId
	if o.Input != nil {
...
func (o *ScheduleCreateActionRunActorTask) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleCreateActionRunActorTask := _ScheduleCreateActionRunActorTask{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleCreateActionRunActorTask)

	if err != nil {
		return err
	}

	*o = ScheduleCreateActionRunActorTask(varScheduleCreateActionRunActorTask)

	return err
}

type NullableScheduleCreateActionRunActorTask struct {
	value *ScheduleCreateActionRunActorTask
	isSet bool
}

func (v NullableScheduleCreateActionRunActorTask) Get() *ScheduleCreateActionRunActorTask {
	return v.value
}

func (v *NullableScheduleCreateActionRunActorTask) Set(val *ScheduleCreateActionRunActorTask) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleCreateActionRunActorTask) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleCreateActionRunActorTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleCreateActionRunActorTask(val *ScheduleCreateActionRunActorTask) *NullableScheduleCreateActionRunActorTask {
	return &NullableScheduleCreateActionRunActorTask{value: val, isSet: true}
}

func (v NullableScheduleCreateActionRunActorTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleCreateActionRunActorTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
