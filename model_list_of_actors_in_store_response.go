...
// checks if the ListOfActorsInStoreResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfActorsInStoreResponse{}

// ListOfActorsInStoreResponse struct for ListOfActorsInStoreResponse
type ListOfActorsInStoreResponse struct {
	Data ListOfStoreActors `json:"data"`
}

type _ListOfActorsInStoreResponse ListOfActorsInStoreResponse

// NewListOfActorsInStoreResponse instantiates a new ListOfActorsInStoreResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfActorsInStoreResponse(data ListOfStoreActors) *ListOfActorsInStoreResponse {
	this := ListOfActorsInStoreResponse{}
	this.Data = data
	return &this
}

// NewListOfActorsInStoreResponseWithDefaults instantiates a new ListOfActorsInStoreResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfActorsInStoreResponseWithDefaults() *ListOfActorsInStoreResponse {
	this := ListOfActorsInStoreResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfActorsInStoreResponse) GetData() ListOfStoreActors {
	if o == nil {
		var ret ListOfStoreActors
		return ret
	}
...
func (o *ListOfActorsInStoreResponse) GetDataOk() (*ListOfStoreActors, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfActorsInStoreResponse) SetData(v ListOfStoreActors) {
	o.Data = v
}

func (o ListOfActorsInStoreResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfActorsInStoreResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfActorsInStoreResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfActorsInStoreResponse := _ListOfActorsInStoreResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfActorsInStoreResponse)

	if err != nil {
		return err
	}

	*o = ListOfActorsInStoreResponse(varListOfActorsInStoreResponse)

	return err
}

type NullableListOfActorsInStoreResponse struct {
	value *ListOfActorsInStoreResponse
	isSet bool
}

func (v NullableListOfActorsInStoreResponse) Get() *ListOfActorsInStoreResponse {
	return v.value
}

func (v *NullableListOfActorsInStoreResponse) Set(val *ListOfActorsInStoreResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfActorsInStoreResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfActorsInStoreResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfActorsInStoreResponse(val *ListOfActorsInStoreResponse) *NullableListOfActorsInStoreResponse {
	return &NullableListOfActorsInStoreResponse{value: val, isSet: true}
}

func (v NullableListOfActorsInStoreResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfActorsInStoreResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
