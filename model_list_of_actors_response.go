...
// checks if the ListOfActorsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfActorsResponse{}

// ListOfActorsResponse struct for ListOfActorsResponse
type ListOfActorsResponse struct {
	Data ListOfActors `json:"data"`
}

type _ListOfActorsResponse ListOfActorsResponse

// NewListOfActorsResponse instantiates a new ListOfActorsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfActorsResponse(data ListOfActors) *ListOfActorsResponse {
	this := ListOfActorsResponse{}
	this.Data = data
	return &this
}

// NewListOfActorsResponseWithDefaults instantiates a new ListOfActorsResponse object
...
func (o *ListOfActorsResponse) GetData() ListOfActors {
	if o == nil {
		var ret ListOfActors
		return ret
	}
...
func (o *ListOfActorsResponse) GetDataOk() (*ListOfActors, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfActorsResponse) SetData(v ListOfActors) {
	o.Data = v
}

func (o ListOfActorsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfActorsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfActorsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfActorsResponse := _ListOfActorsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfActorsResponse)

	if err != nil {
		return err
	}

	*o = ListOfActorsResponse(varListOfActorsResponse)

	return err
}

type NullableListOfActorsResponse struct {
	value *ListOfActorsResponse
	isSet bool
}

func (v NullableListOfActorsResponse) Get() *ListOfActorsResponse {
	return v.value
}

func (v *NullableListOfActorsResponse) Set(val *ListOfActorsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfActorsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfActorsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfActorsResponse(val *ListOfActorsResponse) *NullableListOfActorsResponse {
	return &NullableListOfActorsResponse{value: val, isSet: true}
}

func (v NullableListOfActorsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfActorsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
