...
// checks if the ActorShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorShort{}
...
type ActorShort struct {
	...
	Stats NullableActorStats `json:"stats,omitempty"`
}

type _ActorShort ActorShort
...
// SetStats gets a reference to the given NullableActorStats and assigns it to the Stats field.
func (o *ActorShort) SetStats(v ActorStats) {
	o.Stats.Set(&v)
}
// SetStatsNil sets the value for Stats to be an explicit nil
func (o *ActorShort) SetStatsNil() {
	o.Stats.Set(nil)
}
...
func (o ActorShort) ToMap() (map[string]interface{}, error) {
...
func (o *ActorShort) UnmarshalJSON(data []byte) (err error) {
	...
	varActorShort := _ActorShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorShort)

	if err != nil {
		return err
	}

	*o = ActorShort(varActorShort)
