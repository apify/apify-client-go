...
// checks if the ActorTaskRunsPost201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskRunsPost201Response{}

// ActorTaskRunsPost201Response struct for ActorTaskRunsPost201Response
type ActorTaskRunsPost201Response struct {
	Data Run `json:"data"`
}

type _ActorTaskRunsPost201Response ActorTaskRunsPost201Response

// NewActorTaskRunsPost201Response instantiates a new ActorTaskRunsPost201Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskRunsPost201Response(data Run) *ActorTaskRunsPost201Response {
	this := ActorTaskRunsPost201Response{}
	this.Data = data
	return &this
}

// NewActorTaskRunsPost201ResponseWithDefaults instantiates a new ActorTaskRunsPost201Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskRunsPost201ResponseWithDefaults() *ActorTaskRunsPost201Response {
	this := ActorTaskRunsPost201Response{}
	return &this
}

// GetData returns the Data field value
func (o *ActorTaskRunsPost201Response) GetData() Run {
	if o == nil {
		var ret Run
		return ret
	}
...
func (o *ActorTaskRunsPost201Response) GetDataOk() (*Run, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ActorTaskRunsPost201Response) SetData(v Run) {
	o.Data = v
}

func (o ActorTaskRunsPost201Response) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskRunsPost201Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ActorTaskRunsPost201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskRunsPost201Response := _ActorTaskRunsPost201Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskRunsPost201Response)

	if err != nil {
		return err
	}

	*o = ActorTaskRunsPost201Response(varActorTaskRunsPost201Response)

	return err
}

type NullableActorTaskRunsPost201Response struct {
	value *ActorTaskRunsPost201Response
	isSet bool
}

func (v NullableActorTaskRunsPost201Response) Get() *ActorTaskRunsPost201Response {
	return v.value
}

func (v *NullableActorTaskRunsPost201Response) Set(val *ActorTaskRunsPost201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskRunsPost201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskRunsPost201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskRunsPost201Response(val *ActorTaskRunsPost201Response) *NullableActorTaskRunsPost201Response {
	return &NullableActorTaskRunsPost201Response{value: val, isSet: true}
}

func (v NullableActorTaskRunsPost201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskRunsPost201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
