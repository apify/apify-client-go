...
// RequestDraftDelete A request that should be deleted.
type RequestDraftDelete struct {
	RequestDraftDeleteById *RequestDraftDeleteById
	RequestDraftDeleteByUniqueKey *RequestDraftDeleteByUniqueKey
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *RequestDraftDelete) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into RequestDraftDeleteById
	err = json.Unmarshal(data, &dst.RequestDraftDeleteById);
	if err == nil {
		jsonRequestDraftDeleteById, _ := json.Marshal(dst.RequestDraftDeleteById)
		if string(jsonRequestDraftDeleteById) == "{}" { // empty struct
			dst.RequestDraftDeleteById = nil
		} else {
			return nil // data stored in dst.RequestDraftDeleteById, return on the first match
		}
	} else {
		dst.RequestDraftDeleteById = nil
	}

	// try to unmarshal JSON data into RequestDraftDeleteByUniqueKey
	err = json.Unmarshal(data, &dst.RequestDraftDeleteByUniqueKey);
	if err == nil {
		jsonRequestDraftDeleteByUniqueKey, _ := json.Marshal(dst.RequestDraftDeleteByUniqueKey)
		if string(jsonRequestDraftDeleteByUniqueKey) == "{}" { // empty struct
			dst.RequestDraftDeleteByUniqueKey = nil
		} else {
			return nil // data stored in dst.RequestDraftDeleteByUniqueKey, return on the first match
		}
	} else {
		dst.RequestDraftDeleteByUniqueKey = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(RequestDraftDelete)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src RequestDraftDelete) MarshalJSON() ([]byte, error) {
	if src.RequestDraftDeleteById != nil {
		return json.Marshal(&src.RequestDraftDeleteById)
	}

	if src.RequestDraftDeleteByUniqueKey != nil {
		return json.Marshal(&src.RequestDraftDeleteByUniqueKey)
	}
...
type NullableRequestDraftDelete struct {
	value *RequestDraftDelete
	isSet bool
}

func (v NullableRequestDraftDelete) Get() *RequestDraftDelete {
	return v.value
}

func (v *NullableRequestDraftDelete) Set(val *RequestDraftDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestDraftDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestDraftDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestDraftDelete(val *RequestDraftDelete) *NullableRequestDraftDelete {
	return &NullableRequestDraftDelete{value: val, isSet: true}
}

func (v NullableRequestDraftDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestDraftDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
