...
// checks if the EncodeAndSignResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncodeAndSignResponse{}

// EncodeAndSignResponse struct for EncodeAndSignResponse
type EncodeAndSignResponse struct {
	Data EncodeAndSignData `json:"data"`
}

type _EncodeAndSignResponse EncodeAndSignResponse

// NewEncodeAndSignResponse instantiates a new EncodeAndSignResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEncodeAndSignResponse(data EncodeAndSignData) *EncodeAndSignResponse {
	this := EncodeAndSignResponse{}
	this.Data = data
	return &this
}

// NewEncodeAndSignResponseWithDefaults instantiates a new EncodeAndSignResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEncodeAndSignResponseWithDefaults() *EncodeAndSignResponse {
	this := EncodeAndSignResponse{}
	return &this
}

// GetData returns the Data field value
func (o *EncodeAndSignResponse) GetData() EncodeAndSignData {
	if o == nil {
		var ret EncodeAndSignData
		return ret
	}
...
func (o *EncodeAndSignResponse) GetDataOk() (*EncodeAndSignData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *EncodeAndSignResponse) SetData(v EncodeAndSignData) {
	o.Data = v
}

func (o EncodeAndSignResponse) MarshalJSON() ([]byte, error) {
...
func (o EncodeAndSignResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *EncodeAndSignResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEncodeAndSignResponse := _EncodeAndSignResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEncodeAndSignResponse)

	if err != nil {
		return err
	}

	*o = EncodeAndSignResponse(varEncodeAndSignResponse)

	return err
}

type NullableEncodeAndSignResponse struct {
	value *EncodeAndSignResponse
	isSet bool
}

func (v NullableEncodeAndSignResponse) Get() *EncodeAndSignResponse {
	return v.value
}

func (v *NullableEncodeAndSignResponse) Set(val *EncodeAndSignResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeAndSignResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeAndSignResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeAndSignResponse(val *EncodeAndSignResponse) *NullableEncodeAndSignResponse {
	return &NullableEncodeAndSignResponse{value: val, isSet: true}
}

func (v NullableEncodeAndSignResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeAndSignResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
