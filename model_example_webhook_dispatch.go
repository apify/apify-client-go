...
// checks if the ExampleWebhookDispatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExampleWebhookDispatch{}

// ExampleWebhookDispatch struct for ExampleWebhookDispatch
...
type _ExampleWebhookDispatch ExampleWebhookDispatch
...
func (o *ExampleWebhookDispatch) SetFinishedAtNil() {
...
func (o *ExampleWebhookDispatch) SetRemovedAtNil() {
	o.RemovedAt.Set(nil)
}
...
func (o ExampleWebhookDispatch) MarshalJSON() ([]byte, error) {
...
func (o ExampleWebhookDispatch) ToMap() (map[string]interface{}, error) {
...
func (o *ExampleWebhookDispatch) UnmarshalJSON(data []byte) (err error) {
	...
	varExampleWebhookDispatch := _ExampleWebhookDispatch{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExampleWebhookDispatch)

	if err != nil {
		return err
	}

	*o = ExampleWebhookDispatch(varExampleWebhookDispatch)

	return err
}

type NullableExampleWebhookDispatch struct {
	value *ExampleWebhookDispatch
	isSet bool
}

func (v NullableExampleWebhookDispatch) Get() *ExampleWebhookDispatch {
	return v.value
}

func (v *NullableExampleWebhookDispatch) Set(val *ExampleWebhookDispatch) {
	v.value = val
	v.isSet = true
}

func (v NullableExampleWebhookDispatch) IsSet() bool {
	return v.isSet
}

func (v *NullableExampleWebhookDispatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExampleWebhookDispatch(val *ExampleWebhookDispatch) *NullableExampleWebhookDispatch {
	return &NullableExampleWebhookDispatch{value: val, isSet: true}
}

func (v NullableExampleWebhookDispatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExampleWebhookDispatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
