...
// WebhookDispatchStatus Status of the webhook dispatch indicating whether the HTTP request was successful.
type WebhookDispatchStatus string

// List of WebhookDispatchStatus
const (
...
// All allowed values of WebhookDispatchStatus enum
var AllowedWebhookDispatchStatusEnumValues = []WebhookDispatchStatus{
	"ACTIVE",
	"SUCCEEDED",
	"FAILED",
}

func (v *WebhookDispatchStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := WebhookDispatchStatus(value)
	for _, existing := range AllowedWebhookDispatchStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid WebhookDispatchStatus", value)
}

// NewWebhookDispatchStatusFromValue returns a pointer to a valid WebhookDispatchStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewWebhookDispatchStatusFromValue(v string) (*WebhookDispatchStatus, error) {
	ev := WebhookDispatchStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for WebhookDispatchStatus: valid values are %v", v, AllowedWebhookDispatchStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v WebhookDispatchStatus) IsValid() bool {
	for _, existing := range AllowedWebhookDispatchStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to WebhookDispatchStatus value
func (v WebhookDispatchStatus) Ptr() *WebhookDispatchStatus {
	return &v
}

type NullableWebhookDispatchStatus struct {
	value *WebhookDispatchStatus
	isSet bool
}

func (v NullableWebhookDispatchStatus) Get() *WebhookDispatchStatus {
	return v.value
}

func (v *NullableWebhookDispatchStatus) Set(val *WebhookDispatchStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookDispatchStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookDispatchStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookDispatchStatus(val *WebhookDispatchStatus) *NullableWebhookDispatchStatus {
	return &NullableWebhookDispatchStatus{value: val, isSet: true}
}

func (v NullableWebhookDispatchStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookDispatchStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
