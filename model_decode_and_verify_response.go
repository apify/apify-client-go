...
// checks if the DecodeAndVerifyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DecodeAndVerifyResponse{}

// DecodeAndVerifyResponse struct for DecodeAndVerifyResponse
type DecodeAndVerifyResponse struct {
	Data DecodeAndVerifyData `json:"data"`
}

type _DecodeAndVerifyResponse DecodeAndVerifyResponse

// NewDecodeAndVerifyResponse instantiates a new DecodeAndVerifyResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDecodeAndVerifyResponse(data DecodeAndVerifyData) *DecodeAndVerifyResponse {
	this := DecodeAndVerifyResponse{}
	this.Data = data
	return &this
}

// NewDecodeAndVerifyResponseWithDefaults instantiates a new DecodeAndVerifyResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDecodeAndVerifyResponseWithDefaults() *DecodeAndVerifyResponse {
	this := DecodeAndVerifyResponse{}
	return &this
}

// GetData returns the Data field value
func (o *DecodeAndVerifyResponse) GetData() DecodeAndVerifyData {
	if o == nil {
		var ret DecodeAndVerifyData
		return ret
	}
...
func (o *DecodeAndVerifyResponse) GetDataOk() (*DecodeAndVerifyData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *DecodeAndVerifyResponse) SetData(v DecodeAndVerifyData) {
	o.Data = v
}

func (o DecodeAndVerifyResponse) MarshalJSON() ([]byte, error) {
...
func (o DecodeAndVerifyResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *DecodeAndVerifyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDecodeAndVerifyResponse := _DecodeAndVerifyResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDecodeAndVerifyResponse)

	if err != nil {
		return err
	}

	*o = DecodeAndVerifyResponse(varDecodeAndVerifyResponse)

	return err
}

type NullableDecodeAndVerifyResponse struct {
	value *DecodeAndVerifyResponse
	isSet bool
}

func (v NullableDecodeAndVerifyResponse) Get() *DecodeAndVerifyResponse {
	return v.value
}

func (v *NullableDecodeAndVerifyResponse) Set(val *DecodeAndVerifyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeAndVerifyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeAndVerifyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeAndVerifyResponse(val *DecodeAndVerifyResponse) *NullableDecodeAndVerifyResponse {
	return &NullableDecodeAndVerifyResponse{value: val, isSet: true}
}

func (v NullableDecodeAndVerifyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeAndVerifyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
