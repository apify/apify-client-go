...
// checks if the HeadAndLockResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeadAndLockResponse{}

// HeadAndLockResponse Response containing locked requests from the request queue head.
type HeadAndLockResponse struct {
	Data LockedRequestQueueHead `json:"data"`
}

type _HeadAndLockResponse HeadAndLockResponse

// NewHeadAndLockResponse instantiates a new HeadAndLockResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHeadAndLockResponse(data LockedRequestQueueHead) *HeadAndLockResponse {
	this := HeadAndLockResponse{}
	this.Data = data
	return &this
}

// NewHeadAndLockResponseWithDefaults instantiates a new HeadAndLockResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHeadAndLockResponseWithDefaults() *HeadAndLockResponse {
	this := HeadAndLockResponse{}
	return &this
}

// GetData returns the Data field value
func (o *HeadAndLockResponse) GetData() LockedRequestQueueHead {
	if o == nil {
		var ret LockedRequestQueueHead
		return ret
	}
...
func (o *HeadAndLockResponse) GetDataOk() (*LockedRequestQueueHead, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *HeadAndLockResponse) SetData(v LockedRequestQueueHead) {
	o.Data = v
}

func (o HeadAndLockResponse) MarshalJSON() ([]byte, error) {
...
func (o HeadAndLockResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *HeadAndLockResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHeadAndLockResponse := _HeadAndLockResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeadAndLockResponse)

	if err != nil {
		return err
	}

	*o = HeadAndLockResponse(varHeadAndLockResponse)

	return err
}

type NullableHeadAndLockResponse struct {
	value *HeadAndLockResponse
	isSet bool
}

func (v NullableHeadAndLockResponse) Get() *HeadAndLockResponse {
	return v.value
}

func (v *NullableHeadAndLockResponse) Set(val *HeadAndLockResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHeadAndLockResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHeadAndLockResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeadAndLockResponse(val *HeadAndLockResponse) *NullableHeadAndLockResponse {
	return &NullableHeadAndLockResponse{value: val, isSet: true}
}

func (v NullableHeadAndLockResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeadAndLockResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
