...
// checks if the EncodeAndSignData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncodeAndSignData{}

// EncodeAndSignData struct for EncodeAndSignData
type EncodeAndSignData struct {
	Encoded string `json:"encoded"`
}

type _EncodeAndSignData EncodeAndSignData

// NewEncodeAndSignData instantiates a new EncodeAndSignData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEncodeAndSignData(encoded string) *EncodeAndSignData {
	this := EncodeAndSignData{}
	this.Encoded = encoded
	return &this
}

// NewEncodeAndSignDataWithDefaults instantiates a new EncodeAndSignData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEncodeAndSignDataWithDefaults() *EncodeAndSignData {
	this := EncodeAndSignData{}
	return &this
}

// GetEncoded returns the Encoded field value
func (o *EncodeAndSignData) GetEncoded() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *EncodeAndSignData) GetEncodedOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EncodeAndSignData) SetEncoded(v string) {
	o.Encoded = v
}

func (o EncodeAndSignData) MarshalJSON() ([]byte, error) {
...
func (o EncodeAndSignData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["encoded"] = o.Encoded
	return toSerialize, nil
}

func (o *EncodeAndSignData) UnmarshalJSON(data []byte) (err error) {
	...
	varEncodeAndSignData := _EncodeAndSignData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEncodeAndSignData)

	if err != nil {
		return err
	}

	*o = EncodeAndSignData(varEncodeAndSignData)

	return err
}

type NullableEncodeAndSignData struct {
	value *EncodeAndSignData
	isSet bool
}

func (v NullableEncodeAndSignData) Get() *EncodeAndSignData {
	return v.value
}

func (v *NullableEncodeAndSignData) Set(val *EncodeAndSignData) {
	v.value = val
	v.isSet = true
}

func (v NullableEncodeAndSignData) IsSet() bool {
	return v.isSet
}

func (v *NullableEncodeAndSignData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncodeAndSignData(val *EncodeAndSignData) *NullableEncodeAndSignData {
	return &NullableEncodeAndSignData{value: val, isSet: true}
}

func (v NullableEncodeAndSignData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncodeAndSignData) UnmarshalJSON(src []byte) error {
	v.isSet = true
