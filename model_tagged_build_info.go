...
// checks if the TaggedBuildInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaggedBuildInfo{}

// TaggedBuildInfo Information about a tagged build.
...
func (o *TaggedBuildInfo) SetFinishedAtNil() {
...
func (o TaggedBuildInfo) MarshalJSON() ([]byte, error) {
...
func (o TaggedBuildInfo) ToMap() (map[string]interface{}, error) {
...
type NullableTaggedBuildInfo struct {
	value *TaggedBuildInfo
	isSet bool
}

func (v NullableTaggedBuildInfo) Get() *TaggedBuildInfo {
	return v.value
}

func (v *NullableTaggedBuildInfo) Set(val *TaggedBuildInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableTaggedBuildInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableTaggedBuildInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaggedBuildInfo(val *TaggedBuildInfo) *NullableTaggedBuildInfo {
	return &NullableTaggedBuildInfo{value: val, isSet: true}
}

func (v NullableTaggedBuildInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaggedBuildInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
