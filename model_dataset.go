...
type Dataset struct {
	...
	CleanItemCount int32 `json:"cleanItemCount"`
...
// GetCleanItemCount returns the CleanItemCount field value
func (o *Dataset) GetCleanItemCount() int32 {
	...
	return o.CleanItemCount
}

// GetCleanItemCountOk returns a tuple with the CleanItemCount field value
// and a boolean to check if the value has been set.
func (o *Dataset) GetCleanItemCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CleanItemCount, true
}

// SetCleanItemCount sets field value
...
// GetItemsPublicUrl returns the ItemsPublicUrl field value if set, zero value otherwise.
func (o *Dataset) GetItemsPublicUrl() string {
	if o == nil || IsNil(o.ItemsPublicUrl) {
		var ret string
		return ret
	}
	return *o.ItemsPublicUrl
}

// GetItemsPublicUrlOk returns a tuple with the ItemsPublicUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Dataset) GetItemsPublicUrlOk() (*string, bool) {
	if o == nil || IsNil(o.ItemsPublicUrl) {
		return nil, false
	}
	return o.ItemsPublicUrl, true
}
...
// SetItemsPublicUrl gets a reference to the given string and assigns it to the ItemsPublicUrl field.
...
func (o *Dataset) SetUrlSigningSecretKeyNil() {
...
// SetStats gets a reference to the given DatasetStats and assigns it to the Stats field.
...
func (o Dataset) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["cleanItemCount"] = o.CleanItemCount
	if o.ActId.IsSet() {
	...
	if !IsNil(o.ItemsPublicUrl) {
		toSerialize["itemsPublicUrl"] = o.ItemsPublicUrl
	}
