...
// checks if the ListOfKeysResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfKeysResponse{}

// ListOfKeysResponse struct for ListOfKeysResponse
type ListOfKeysResponse struct {
	Data ListOfKeys `json:"data"`
}

type _ListOfKeysResponse ListOfKeysResponse

// NewListOfKeysResponse instantiates a new ListOfKeysResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfKeysResponse(data ListOfKeys) *ListOfKeysResponse {
	this := ListOfKeysResponse{}
	this.Data = data
	return &this
}

// NewListOfKeysResponseWithDefaults instantiates a new ListOfKeysResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfKeysResponseWithDefaults() *ListOfKeysResponse {
	this := ListOfKeysResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfKeysResponse) GetData() ListOfKeys {
	if o == nil {
		var ret ListOfKeys
		return ret
	}
...
func (o *ListOfKeysResponse) GetDataOk() (*ListOfKeys, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfKeysResponse) SetData(v ListOfKeys) {
	o.Data = v
}

func (o ListOfKeysResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfKeysResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfKeysResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfKeysResponse := _ListOfKeysResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfKeysResponse)

	if err != nil {
		return err
	}

	*o = ListOfKeysResponse(varListOfKeysResponse)

	return err
}

type NullableListOfKeysResponse struct {
	value *ListOfKeysResponse
	isSet bool
}

func (v NullableListOfKeysResponse) Get() *ListOfKeysResponse {
	return v.value
}

func (v *NullableListOfKeysResponse) Set(val *ListOfKeysResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfKeysResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfKeysResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfKeysResponse(val *ListOfKeysResponse) *NullableListOfKeysResponse {
	return &NullableListOfKeysResponse{value: val, isSet: true}
}

func (v NullableListOfKeysResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfKeysResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
