...
// checks if the ScheduleShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleShort{}

// ScheduleShort struct for ScheduleShort
type ScheduleShort struct {
	...
	// 
	Actions []ScheduleActionShort `json:"actions"`
}

type _ScheduleShort ScheduleShort
...
// GetIsExclusive returns the IsExclusive field value
...
// GetIsExclusiveOk returns a tuple with the IsExclusive field value
// and a boolean to check if the value has been set.
...
// SetIsExclusive sets field value
...
func (o ScheduleShort) MarshalJSON() ([]byte, error) {
...
func (o ScheduleShort) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleShort) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleShort := _ScheduleShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleShort)

	if err != nil {
		return err
	}

	*o = ScheduleShort(varScheduleShort)

	return err
}

type NullableScheduleShort struct {
	value *ScheduleShort
	isSet bool
}

func (v NullableScheduleShort) Get() *ScheduleShort {
	return v.value
}

func (v *NullableScheduleShort) Set(val *ScheduleShort) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleShort) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleShort(val *ScheduleShort) *NullableScheduleShort {
	return &NullableScheduleShort{value: val, isSet: true}
}

func (v NullableScheduleShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
