...
// checks if the LockedHeadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LockedHeadRequest{}

// LockedHeadRequest A request from the request queue head that has been locked for processing.
...
type _LockedHeadRequest LockedHeadRequest
...
func (o LockedHeadRequest) MarshalJSON() ([]byte, error) {
...
func (o LockedHeadRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["lockExpiresAt"] = o.LockExpiresAt
	return toSerialize, nil
}

func (o *LockedHeadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLockedHeadRequest := _LockedHeadRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLockedHeadRequest)

	if err != nil {
		return err
	}

	*o = LockedHeadRequest(varLockedHeadRequest)

	return err
}

type NullableLockedHeadRequest struct {
	value *LockedHeadRequest
	isSet bool
}

func (v NullableLockedHeadRequest) Get() *LockedHeadRequest {
	return v.value
}

func (v *NullableLockedHeadRequest) Set(val *LockedHeadRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLockedHeadRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLockedHeadRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLockedHeadRequest(val *LockedHeadRequest) *NullableLockedHeadRequest {
	return &NullableLockedHeadRequest{value: val, isSet: true}
}

func (v NullableLockedHeadRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLockedHeadRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
