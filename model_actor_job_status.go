...
// ActorJobStatus Status of an Actor job (run or build).
type ActorJobStatus string

// List of ActorJobStatus
const (
	READY ActorJobStatus = "READY"
	RUNNING ActorJobStatus = "RUNNING"
	SUCCEEDED ActorJobStatus = "SUCCEEDED"
	FAILED ActorJobStatus = "FAILED"
	TIMING_OUT ActorJobStatus = "TIMING-OUT"
	TIMED_OUT ActorJobStatus = "TIMED-OUT"
	ABORTING ActorJobStatus = "ABORTING"
	ABORTED ActorJobStatus = "ABORTED"
)

// All allowed values of ActorJobStatus enum
var AllowedActorJobStatusEnumValues = []ActorJobStatus{
	"READY",
	"RUNNING",
	"SUCCEEDED",
	"FAILED",
...
func (v *ActorJobStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ActorJobStatus(value)
	...
	return fmt.Errorf("%+v is not a valid ActorJobStatus", value)
}

// NewActorJobStatusFromValue returns a pointer to a valid ActorJobStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewActorJobStatusFromValue(v string) (*ActorJobStatus, error) {
	ev := ActorJobStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ActorJobStatus: valid values are %v", v, AllowedActorJobStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ActorJobStatus) IsValid() bool {
	for _, existing := range AllowedActorJobStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to ActorJobStatus value
func (v ActorJobStatus) Ptr() *ActorJobStatus {
	return &v
}

type NullableActorJobStatus struct {
	value *ActorJobStatus
	isSet bool
}

func (v NullableActorJobStatus) Get() *ActorJobStatus {
	return v.value
}

func (v *NullableActorJobStatus) Set(val *ActorJobStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableActorJobStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableActorJobStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorJobStatus(val *ActorJobStatus) *NullableActorJobStatus {
	return &NullableActorJobStatus{value: val, isSet: true}
}

func (v NullableActorJobStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorJobStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
