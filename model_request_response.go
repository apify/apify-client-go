...
// checks if the RequestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestResponse{}
...
func (o *RequestResponse) GetData() Request {
	if o == nil {
		var ret Request
		return ret
	}
...
func (o *RequestResponse) GetDataOk() (*Request, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *RequestResponse) SetData(v Request) {
	o.Data = v
}
...
func (o RequestResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *RequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestResponse := _RequestResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestResponse)

	if err != nil {
		return err
	}

	*o = RequestResponse(varRequestResponse)
