...
type BuildOptions struct {
	UseCache NullableBool `json:"useCache,omitempty"`
	BetaPackages NullableBool `json:"betaPackages,omitempty"`
	MemoryMbytes NullableInt32 `json:"memoryMbytes,omitempty"`
	DiskMbytes NullableInt32 `json:"diskMbytes,omitempty"`
}
...
func (o *BuildOptions) GetUseCache() bool {
...
func (o *BuildOptions) GetUseCacheOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BuildOptions) HasUseCache() bool {
...
func (o *BuildOptions) SetUseCache(v bool) {
	o.UseCache.Set(&v)
}
...
func (o *BuildOptions) UnsetUseCache() {
	o.UseCache.Unset()
}

// GetBetaPackages returns the BetaPackages field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BuildOptions) GetBetaPackages() bool {
	if o == nil || IsNil(o.BetaPackages.Get()) {
		var ret bool
		return ret
	}
	return *o.BetaPackages.Get()
}

// GetBetaPackagesOk returns a tuple with the BetaPackages field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BuildOptions) GetBetaPackagesOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return o.BetaPackages.Get(), o.BetaPackages.IsSet()
}

// HasBetaPackages returns a boolean if a field has been set.
func (o *BuildOptions) HasBetaPackages() bool {
	if o != nil && o.BetaPackages.IsSet() {
		return true
	}
...
// SetBetaPackages gets a reference to the given NullableBool and assigns it to the BetaPackages field.
func (o *BuildOptions) SetBetaPackages(v bool) {
	o.BetaPackages.Set(&v)
}
// SetBetaPackagesNil sets the value for BetaPackages to be an explicit nil
func (o *BuildOptions) SetBetaPackagesNil() {
	o.BetaPackages.Set(nil)
}

// UnsetBetaPackages ensures that no value is present for BetaPackages, not even an explicit nil
func (o *BuildOptions) UnsetBetaPackages() {
	o.BetaPackages.Unset()
}

// GetMemoryMbytes returns the MemoryMbytes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BuildOptions) GetMemoryMbytes() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BuildOptions) GetMemoryMbytesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BuildOptions) HasMemoryMbytes() bool {
...
func (o *BuildOptions) SetMemoryMbytes(v int32) {
	o.MemoryMbytes.Set(&v)
}
// SetMemoryMbytesNil sets the value for MemoryMbytes to be an explicit nil
func (o *BuildOptions) SetMemoryMbytesNil() {
	o.MemoryMbytes.Set(nil)
}

// UnsetMemoryMbytes ensures that no value is present for MemoryMbytes, not even an explicit nil
func (o *BuildOptions) UnsetMemoryMbytes() {
	o.MemoryMbytes.Unset()
}

// GetDiskMbytes returns the DiskMbytes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *BuildOptions) GetDiskMbytes() int32 {
	if o == nil || IsNil(o.DiskMbytes.Get()) {
		var ret int32
		return ret
	}
	return *o.DiskMbytes.Get()
}

// GetDiskMbytesOk returns a tuple with the DiskMbytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BuildOptions) GetDiskMbytesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.DiskMbytes.Get(), o.DiskMbytes.IsSet()
}

// HasDiskMbytes returns a boolean if a field has been set.
func (o *BuildOptions) HasDiskMbytes() bool {
	if o != nil && o.DiskMbytes.IsSet() {
		return true
	}
...
// SetDiskMbytes gets a reference to the given NullableInt32 and assigns it to the DiskMbytes field.
func (o *BuildOptions) SetDiskMbytes(v int32) {
	o.DiskMbytes.Set(&v)
}
// SetDiskMbytesNil sets the value for DiskMbytes to be an explicit nil
func (o *BuildOptions) SetDiskMbytesNil() {
	o.DiskMbytes.Set(nil)
}

// UnsetDiskMbytes ensures that no value is present for DiskMbytes, not even an explicit nil
func (o *BuildOptions) UnsetDiskMbytes() {
	o.DiskMbytes.Unset()
}
...
func (o BuildOptions) ToMap() (map[string]interface{}, error) {
	...
	if o.UseCache.IsSet() {
		toSerialize["useCache"] = o.UseCache.Get()
	}
	if o.BetaPackages.IsSet() {
		toSerialize["betaPackages"] = o.BetaPackages.Get()
	}
	if o.MemoryMbytes.IsSet() {
		toSerialize["memoryMbytes"] = o.MemoryMbytes.Get()
	}
	if o.DiskMbytes.IsSet() {
		toSerialize["diskMbytes"] = o.DiskMbytes.Get()
	}
