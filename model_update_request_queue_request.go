...
// checks if the UpdateRequestQueueRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateRequestQueueRequest{}

// UpdateRequestQueueRequest Request object for updating a request queue.
...
func NewUpdateRequestQueueRequest() *UpdateRequestQueueRequest {
	this := UpdateRequestQueueRequest{}
	return &this
}
...
func (o *UpdateRequestQueueRequest) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o UpdateRequestQueueRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateRequestQueueRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateRequestQueueRequest struct {
	value *UpdateRequestQueueRequest
	isSet bool
}

func (v NullableUpdateRequestQueueRequest) Get() *UpdateRequestQueueRequest {
	return v.value
}

func (v *NullableUpdateRequestQueueRequest) Set(val *UpdateRequestQueueRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRequestQueueRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRequestQueueRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRequestQueueRequest(val *UpdateRequestQueueRequest) *NullableUpdateRequestQueueRequest {
	return &NullableUpdateRequestQueueRequest{value: val, isSet: true}
}

func (v NullableUpdateRequestQueueRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRequestQueueRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
