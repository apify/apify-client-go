...
// checks if the ListOfWebhooks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfWebhooks{}

// ListOfWebhooks struct for ListOfWebhooks
type ListOfWebhooks struct {
	...
	Items []WebhookShort `json:"items"`
}

type _ListOfWebhooks ListOfWebhooks
...
func (o ListOfWebhooks) MarshalJSON() ([]byte, error) {
...
func (o ListOfWebhooks) ToMap() (map[string]interface{}, error) {
...
func (o *ListOfWebhooks) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfWebhooks := _ListOfWebhooks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfWebhooks)

	if err != nil {
		return err
	}

	*o = ListOfWebhooks(varListOfWebhooks)

	return err
}

type NullableListOfWebhooks struct {
	value *ListOfWebhooks
	isSet bool
}

func (v NullableListOfWebhooks) Get() *ListOfWebhooks {
	return v.value
}

func (v *NullableListOfWebhooks) Set(val *ListOfWebhooks) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfWebhooks) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfWebhooks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfWebhooks(val *ListOfWebhooks) *NullableListOfWebhooks {
	return &NullableListOfWebhooks{value: val, isSet: true}
}

func (v NullableListOfWebhooks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfWebhooks) UnmarshalJSON(src []byte) error {
	v.isSet = true
