...
type Limits struct {
	...
	MaxConcurrentActorJobs int32 `json:"maxConcurrentActorJobs"`
	MaxTeamAccountSeatCount int32 `json:"maxTeamAccountSeatCount"`
...
// GetMaxConcurrentActorJobs returns the MaxConcurrentActorJobs field value
func (o *Limits) GetMaxConcurrentActorJobs() int32 {
	...
	return o.MaxConcurrentActorJobs
}

// GetMaxConcurrentActorJobsOk returns a tuple with the MaxConcurrentActorJobs field value
// and a boolean to check if the value has been set.
func (o *Limits) GetMaxConcurrentActorJobsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MaxConcurrentActorJobs, true
}

// SetMaxConcurrentActorJobs sets field value
func (o *Limits) SetMaxConcurrentActorJobs(v int32) {
	o.MaxConcurrentActorJobs = v
}

// GetMaxTeamAccountSeatCount returns the MaxTeamAccountSeatCount field value
func (o *Limits) GetMaxTeamAccountSeatCount() int32 {
	...
	return o.MaxTeamAccountSeatCount
}

// GetMaxTeamAccountSeatCountOk returns a tuple with the MaxTeamAccountSeatCount field value
// and a boolean to check if the value has been set.
func (o *Limits) GetMaxTeamAccountSeatCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MaxTeamAccountSeatCount, true
}

// SetMaxTeamAccountSeatCount sets field value
func (o *Limits) SetMaxTeamAccountSeatCount(v int32) {
	o.MaxTeamAccountSeatCount = v
}
...
func (o Limits) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["maxConcurrentActorJobs"] = o.MaxConcurrentActorJobs
	toSerialize["maxTeamAccountSeatCount"] = o.MaxTeamAccountSeatCount
