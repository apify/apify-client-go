...
// checks if the TieredPricingPerDatasetItemEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TieredPricingPerDatasetItemEntry{}

// TieredPricingPerDatasetItemEntry A single tier's price-per-dataset-item entry.
type TieredPricingPerDatasetItemEntry struct {
	// Price per unit in USD for this tier.
	TieredPricePerUnitUsd float32 `json:"tieredPricePerUnitUsd"`
}

type _TieredPricingPerDatasetItemEntry TieredPricingPerDatasetItemEntry

// NewTieredPricingPerDatasetItemEntry instantiates a new TieredPricingPerDatasetItemEntry object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTieredPricingPerDatasetItemEntry(tieredPricePerUnitUsd float32) *TieredPricingPerDatasetItemEntry {
	this := TieredPricingPerDatasetItemEntry{}
	this.TieredPricePerUnitUsd = tieredPricePerUnitUsd
	return &this
}

// NewTieredPricingPerDatasetItemEntryWithDefaults instantiates a new TieredPricingPerDatasetItemEntry object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTieredPricingPerDatasetItemEntryWithDefaults() *TieredPricingPerDatasetItemEntry {
	this := TieredPricingPerDatasetItemEntry{}
	return &this
}

// GetTieredPricePerUnitUsd returns the TieredPricePerUnitUsd field value
func (o *TieredPricingPerDatasetItemEntry) GetTieredPricePerUnitUsd() float32 {
	if o == nil {
		var ret float32
		return ret
	}

	return o.TieredPricePerUnitUsd
}

// GetTieredPricePerUnitUsdOk returns a tuple with the TieredPricePerUnitUsd field value
// and a boolean to check if the value has been set.
func (o *TieredPricingPerDatasetItemEntry) GetTieredPricePerUnitUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TieredPricePerUnitUsd, true
}

// SetTieredPricePerUnitUsd sets field value
func (o *TieredPricingPerDatasetItemEntry) SetTieredPricePerUnitUsd(v float32) {
	o.TieredPricePerUnitUsd = v
}

func (o TieredPricingPerDatasetItemEntry) MarshalJSON() ([]byte, error) {
...
func (o TieredPricingPerDatasetItemEntry) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["tieredPricePerUnitUsd"] = o.TieredPricePerUnitUsd
	return toSerialize, nil
}

func (o *TieredPricingPerDatasetItemEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varTieredPricingPerDatasetItemEntry := _TieredPricingPerDatasetItemEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTieredPricingPerDatasetItemEntry)

	if err != nil {
		return err
	}

	*o = TieredPricingPerDatasetItemEntry(varTieredPricingPerDatasetItemEntry)

	return err
}

type NullableTieredPricingPerDatasetItemEntry struct {
	value *TieredPricingPerDatasetItemEntry
	isSet bool
}

func (v NullableTieredPricingPerDatasetItemEntry) Get() *TieredPricingPerDatasetItemEntry {
	return v.value
}

func (v *NullableTieredPricingPerDatasetItemEntry) Set(val *TieredPricingPerDatasetItemEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableTieredPricingPerDatasetItemEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableTieredPricingPerDatasetItemEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTieredPricingPerDatasetItemEntry(val *TieredPricingPerDatasetItemEntry) *NullableTieredPricingPerDatasetItemEntry {
	return &NullableTieredPricingPerDatasetItemEntry{value: val, isSet: true}
}

func (v NullableTieredPricingPerDatasetItemEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTieredPricingPerDatasetItemEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
