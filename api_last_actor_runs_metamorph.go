...
// LastActorRunsMetamorphAPIService LastActorRunsMetamorphAPI service
type LastActorRunsMetamorphAPIService service

type ApiActRunsLastMetamorphPostRequest struct {
	ctx context.Context
	ApiService *LastActorRunsMetamorphAPIService
	actorId string
...
func (r ApiActRunsLastMetamorphPostRequest) TargetActorId(targetActorId string) ApiActRunsLastMetamorphPostRequest {
	r.targetActorId = &targetActorId
	return r
}

// Filter for the run status.
func (r ApiActRunsLastMetamorphPostRequest) Status(status string) ApiActRunsLastMetamorphPostRequest {
	r.status = &status
	return r
}
...
func (r ApiActRunsLastMetamorphPostRequest) Build(build string) ApiActRunsLastMetamorphPostRequest {
	r.build = &build
	return r
}

func (r ApiActRunsLastMetamorphPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActRunsLastMetamorphPostExecute(r)
}

/*
ActRunsLastMetamorphPost Metamorph Actor's last run
...
on the Actor's last run.
 ...
 @return ApiActRunsLastMetamorphPostRequest
*/
func (a *LastActorRunsMetamorphAPIService) ActRunsLastMetamorphPost(ctx context.Context, actorId string) ApiActRunsLastMetamorphPostRequest {
	return ApiActRunsLastMetamorphPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
//  @return RunResponse
func (a *LastActorRunsMetamorphAPIService) ActRunsLastMetamorphPostExecute(r ApiActRunsLastMetamorphPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorRunsMetamorphAPIService.ActRunsLastMetamorphPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/runs/last/metamorph"
