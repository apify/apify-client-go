...
// checks if the PriceTiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceTiers{}

// PriceTiers struct for PriceTiers
...
type _PriceTiers PriceTiers

// NewPriceTiers instantiates a new PriceTiers object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPriceTiers(quantityAbove float32, discountPercent float32, tierQuantity float32, unitPriceUsd float32, priceUsd float32) *PriceTiers {
	this := PriceTiers{}
...
// NewPriceTiersWithDefaults instantiates a new PriceTiers object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPriceTiersWithDefaults() *PriceTiers {
	this := PriceTiers{}
	return &this
}

// GetQuantityAbove returns the QuantityAbove field value
func (o *PriceTiers) GetQuantityAbove() float32 {
	if o == nil {
		var ret float32
		return ret
	}

	return o.QuantityAbove
}

// GetQuantityAboveOk returns a tuple with the QuantityAbove field value
// and a boolean to check if the value has been set.
func (o *PriceTiers) GetQuantityAboveOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.QuantityAbove, true
}

// SetQuantityAbove sets field value
func (o *PriceTiers) SetQuantityAbove(v float32) {
	o.QuantityAbove = v
}

// GetDiscountPercent returns the DiscountPercent field value
func (o *PriceTiers) GetDiscountPercent() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PriceTiers) GetDiscountPercentOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PriceTiers) SetDiscountPercent(v float32) {
	o.DiscountPercent = v
}

// GetTierQuantity returns the TierQuantity field value
func (o *PriceTiers) GetTierQuantity() float32 {
	if o == nil {
		var ret float32
		return ret
	}

	return o.TierQuantity
}

// GetTierQuantityOk returns a tuple with the TierQuantity field value
// and a boolean to check if the value has been set.
func (o *PriceTiers) GetTierQuantityOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TierQuantity, true
}

// SetTierQuantity sets field value
func (o *PriceTiers) SetTierQuantity(v float32) {
	o.TierQuantity = v
}

// GetUnitPriceUsd returns the UnitPriceUsd field value
func (o *PriceTiers) GetUnitPriceUsd() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// GetUnitPriceUsdOk returns a tuple with the UnitPriceUsd field value
// and a boolean to check if the value has been set.
func (o *PriceTiers) GetUnitPriceUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
// SetUnitPriceUsd sets field value
func (o *PriceTiers) SetUnitPriceUsd(v float32) {
	o.UnitPriceUsd = v
}

// GetPriceUsd returns the PriceUsd field value
func (o *PriceTiers) GetPriceUsd() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PriceTiers) GetPriceUsdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PriceTiers) SetPriceUsd(v float32) {
	o.PriceUsd = v
}

func (o PriceTiers) MarshalJSON() ([]byte, error) {
...
func (o PriceTiers) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["quantityAbove"] = o.QuantityAbove
	toSerialize["discountPercent"] = o.DiscountPercent
	toSerialize["tierQuantity"] = o.TierQuantity
	toSerialize["unitPriceUsd"] = o.UnitPriceUsd
	toSerialize["priceUsd"] = o.PriceUsd
	return toSerialize, nil
}

func (o *PriceTiers) UnmarshalJSON(data []byte) (err error) {
	...
	varPriceTiers := _PriceTiers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPriceTiers)

	if err != nil {
		return err
	}

	*o = PriceTiers(varPriceTiers)

	return err
}

type NullablePriceTiers struct {
	value *PriceTiers
	isSet bool
}

func (v NullablePriceTiers) Get() *PriceTiers {
	return v.value
}

func (v *NullablePriceTiers) Set(val *PriceTiers) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceTiers) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceTiers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceTiers(val *PriceTiers) *NullablePriceTiers {
	return &NullablePriceTiers{value: val, isSet: true}
}

func (v NullablePriceTiers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceTiers) UnmarshalJSON(src []byte) error {
	v.isSet = true
