...
// checks if the ActorStatsPublicActorRunStats30Days type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorStatsPublicActorRunStats30Days{}

// ActorStatsPublicActorRunStats30Days Run status counts over the past 30 days.
type ActorStatsPublicActorRunStats30Days struct {
	ABORTED *int32 `json:"ABORTED,omitempty"`
	FAILED *int32 `json:"FAILED,omitempty"`
	SUCCEEDED *int32 `json:"SUCCEEDED,omitempty"`
	TIMED_OUT *int32 `json:"TIMED-OUT,omitempty"`
	TOTAL *int32 `json:"TOTAL,omitempty"`
}

// NewActorStatsPublicActorRunStats30Days instantiates a new ActorStatsPublicActorRunStats30Days object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorStatsPublicActorRunStats30Days() *ActorStatsPublicActorRunStats30Days {
	this := ActorStatsPublicActorRunStats30Days{}
	return &this
}

// NewActorStatsPublicActorRunStats30DaysWithDefaults instantiates a new ActorStatsPublicActorRunStats30Days object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorStatsPublicActorRunStats30DaysWithDefaults() *ActorStatsPublicActorRunStats30Days {
	this := ActorStatsPublicActorRunStats30Days{}
	return &this
}

// GetABORTED returns the ABORTED field value if set, zero value otherwise.
func (o *ActorStatsPublicActorRunStats30Days) GetABORTED() int32 {
...
func (o *ActorStatsPublicActorRunStats30Days) GetABORTEDOk() (*int32, bool) {
	if o == nil || IsNil(o.ABORTED) {
		return nil, false
	}
...
func (o *ActorStatsPublicActorRunStats30Days) HasABORTED() bool {
	if o != nil && !IsNil(o.ABORTED) {
		return true
	}
...
func (o *ActorStatsPublicActorRunStats30Days) SetABORTED(v int32) {
	o.ABORTED = &v
}

// GetFAILED returns the FAILED field value if set, zero value otherwise.
func (o *ActorStatsPublicActorRunStats30Days) GetFAILED() int32 {
...
// and a boolean to check if the value has been set.
func (o *ActorStatsPublicActorRunStats30Days) GetFAILEDOk() (*int32, bool) {
	if o == nil || IsNil(o.FAILED) {
		return nil, false
	}
...
func (o *ActorStatsPublicActorRunStats30Days) HasFAILED() bool {
	if o != nil && !IsNil(o.FAILED) {
		return true
	}
...
func (o *ActorStatsPublicActorRunStats30Days) SetFAILED(v int32) {
	o.FAILED = &v
}

// GetSUCCEEDED returns the SUCCEEDED field value if set, zero value otherwise.
func (o *ActorStatsPublicActorRunStats30Days) GetSUCCEEDED() int32 {
...
// and a boolean to check if the value has been set.
func (o *ActorStatsPublicActorRunStats30Days) GetSUCCEEDEDOk() (*int32, bool) {
	if o == nil || IsNil(o.SUCCEEDED) {
		return nil, false
	}
...
func (o *ActorStatsPublicActorRunStats30Days) HasSUCCEEDED() bool {
	if o != nil && !IsNil(o.SUCCEEDED) {
		return true
	}
...
func (o *ActorStatsPublicActorRunStats30Days) SetSUCCEEDED(v int32) {
	o.SUCCEEDED = &v
}

// GetTIMED_OUT returns the TIMED_OUT field value if set, zero value otherwise.
func (o *ActorStatsPublicActorRunStats30Days) GetTIMED_OUT() int32 {
	if o == nil || IsNil(o.TIMED_OUT) {
		var ret int32
		return ret
	}
	return *o.TIMED_OUT
...
// GetTIMED_OUTOk returns a tuple with the TIMED_OUT field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ActorStatsPublicActorRunStats30Days) GetTIMED_OUTOk() (*int32, bool) {
	if o == nil || IsNil(o.TIMED_OUT) {
		return nil, false
	}
	return o.TIMED_OUT, true
}

// HasTIMED_OUT returns a boolean if a field has been set.
func (o *ActorStatsPublicActorRunStats30Days) HasTIMED_OUT() bool {
	if o != nil && !IsNil(o.TIMED_OUT) {
		return true
	}
...
// SetTIMED_OUT gets a reference to the given int32 and assigns it to the TIMED_OUT field.
func (o *ActorStatsPublicActorRunStats30Days) SetTIMED_OUT(v int32) {
	o.TIMED_OUT = &v
}

// GetTOTAL returns the TOTAL field value if set, zero value otherwise.
func (o *ActorStatsPublicActorRunStats30Days) GetTOTAL() int32 {
...
// and a boolean to check if the value has been set.
func (o *ActorStatsPublicActorRunStats30Days) GetTOTALOk() (*int32, bool) {
	if o == nil || IsNil(o.TOTAL) {
		return nil, false
	}
	return o.TOTAL, true
...
func (o *ActorStatsPublicActorRunStats30Days) HasTOTAL() bool {
	if o != nil && !IsNil(o.TOTAL) {
		return true
	}
...
func (o *ActorStatsPublicActorRunStats30Days) SetTOTAL(v int32) {
	o.TOTAL = &v
}

func (o ActorStatsPublicActorRunStats30Days) MarshalJSON() ([]byte, error) {
...
func (o ActorStatsPublicActorRunStats30Days) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TIMED_OUT) {
		toSerialize["TIMED-OUT"] = o.TIMED_OUT
	}
	if !IsNil(o.TOTAL) {
...
type NullableActorStatsPublicActorRunStats30Days struct {
	value *ActorStatsPublicActorRunStats30Days
	isSet bool
}

func (v NullableActorStatsPublicActorRunStats30Days) Get() *ActorStatsPublicActorRunStats30Days {
	return v.value
}

func (v *NullableActorStatsPublicActorRunStats30Days) Set(val *ActorStatsPublicActorRunStats30Days) {
	v.value = val
	v.isSet = true
}

func (v NullableActorStatsPublicActorRunStats30Days) IsSet() bool {
	return v.isSet
}

func (v *NullableActorStatsPublicActorRunStats30Days) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorStatsPublicActorRunStats30Days(val *ActorStatsPublicActorRunStats30Days) *NullableActorStatsPublicActorRunStats30Days {
	return &NullableActorStatsPublicActorRunStats30Days{value: val, isSet: true}
}

func (v NullableActorStatsPublicActorRunStats30Days) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorStatsPublicActorRunStats30Days) UnmarshalJSON(src []byte) error {
	v.isSet = true
