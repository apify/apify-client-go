...
// checks if the ScheduleInvoked type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleInvoked{}

// ScheduleInvoked struct for ScheduleInvoked
...
type _ScheduleInvoked ScheduleInvoked
...
func (o ScheduleInvoked) MarshalJSON() ([]byte, error) {
...
func (o ScheduleInvoked) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleInvoked) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleInvoked := _ScheduleInvoked{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleInvoked)

	if err != nil {
		return err
	}

	*o = ScheduleInvoked(varScheduleInvoked)

	return err
}

type NullableScheduleInvoked struct {
	value *ScheduleInvoked
	isSet bool
}

func (v NullableScheduleInvoked) Get() *ScheduleInvoked {
	return v.value
}

func (v *NullableScheduleInvoked) Set(val *ScheduleInvoked) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleInvoked) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleInvoked) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleInvoked(val *ScheduleInvoked) *NullableScheduleInvoked {
	return &NullableScheduleInvoked{value: val, isSet: true}
}

func (v NullableScheduleInvoked) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleInvoked) UnmarshalJSON(src []byte) error {
	v.isSet = true
