...
// checks if the RequestQueueHead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestQueueHead{}

// RequestQueueHead A batch of requests from the request queue head without locking.
type RequestQueueHead struct {
	...
	Items []HeadRequest `json:"items"`
}

type _RequestQueueHead RequestQueueHead
...
func (o RequestQueueHead) MarshalJSON() ([]byte, error) {
...
func (o RequestQueueHead) ToMap() (map[string]interface{}, error) {
...
func (o *RequestQueueHead) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestQueueHead := _RequestQueueHead{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestQueueHead)

	if err != nil {
		return err
	}

	*o = RequestQueueHead(varRequestQueueHead)

	return err
}

type NullableRequestQueueHead struct {
	value *RequestQueueHead
	isSet bool
}

func (v NullableRequestQueueHead) Get() *RequestQueueHead {
	return v.value
}

func (v *NullableRequestQueueHead) Set(val *RequestQueueHead) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestQueueHead) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestQueueHead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestQueueHead(val *RequestQueueHead) *NullableRequestQueueHead {
	return &NullableRequestQueueHead{value: val, isSet: true}
}

func (v NullableRequestQueueHead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestQueueHead) UnmarshalJSON(src []byte) error {
	v.isSet = true
