...
// checks if the ListOfDatasetsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfDatasetsResponse{}

// ListOfDatasetsResponse struct for ListOfDatasetsResponse
type ListOfDatasetsResponse struct {
	Data ListOfDatasets `json:"data"`
}

type _ListOfDatasetsResponse ListOfDatasetsResponse

// NewListOfDatasetsResponse instantiates a new ListOfDatasetsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfDatasetsResponse(data ListOfDatasets) *ListOfDatasetsResponse {
	this := ListOfDatasetsResponse{}
	this.Data = data
	return &this
}

// NewListOfDatasetsResponseWithDefaults instantiates a new ListOfDatasetsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfDatasetsResponseWithDefaults() *ListOfDatasetsResponse {
	this := ListOfDatasetsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfDatasetsResponse) GetData() ListOfDatasets {
	if o == nil {
		var ret ListOfDatasets
		return ret
	}
...
func (o *ListOfDatasetsResponse) GetDataOk() (*ListOfDatasets, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfDatasetsResponse) SetData(v ListOfDatasets) {
	o.Data = v
}

func (o ListOfDatasetsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfDatasetsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfDatasetsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfDatasetsResponse := _ListOfDatasetsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfDatasetsResponse)

	if err != nil {
		return err
	}

	*o = ListOfDatasetsResponse(varListOfDatasetsResponse)

	return err
}

type NullableListOfDatasetsResponse struct {
	value *ListOfDatasetsResponse
	isSet bool
}

func (v NullableListOfDatasetsResponse) Get() *ListOfDatasetsResponse {
	return v.value
}

func (v *NullableListOfDatasetsResponse) Set(val *ListOfDatasetsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfDatasetsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfDatasetsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfDatasetsResponse(val *ListOfDatasetsResponse) *NullableListOfDatasetsResponse {
	return &NullableListOfDatasetsResponse{value: val, isSet: true}
}

func (v NullableListOfDatasetsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfDatasetsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
