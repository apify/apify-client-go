...
// checks if the DecodeAndVerifyData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DecodeAndVerifyData{}

// DecodeAndVerifyData struct for DecodeAndVerifyData
type DecodeAndVerifyData struct {
	Decoded interface{} `json:"decoded"`
	EncodedByUserId NullableString `json:"encodedByUserId"`
	IsVerifiedUser bool `json:"isVerifiedUser"`
}

type _DecodeAndVerifyData DecodeAndVerifyData
...
// GetDecoded returns the Decoded field value
...
// GetDecodedOk returns a tuple with the Decoded field value
...
// SetDecoded sets field value
func (o *DecodeAndVerifyData) SetDecoded(v interface{}) {
	o.Decoded = v
}

// GetEncodedByUserId returns the EncodedByUserId field value
// If the value is explicit nil, the zero value for string will be returned
func (o *DecodeAndVerifyData) GetEncodedByUserId() string {
	if o == nil || o.EncodedByUserId.Get() == nil {
		var ret string
		return ret
	}

	return *o.EncodedByUserId.Get()
}

// GetEncodedByUserIdOk returns a tuple with the EncodedByUserId field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DecodeAndVerifyData) GetEncodedByUserIdOk() (*string, bool) {
	...
	return o.EncodedByUserId.Get(), o.EncodedByUserId.IsSet()
}

// SetEncodedByUserId sets field value
func (o *DecodeAndVerifyData) SetEncodedByUserId(v string) {
	o.EncodedByUserId.Set(&v)
}

// GetIsVerifiedUser returns the IsVerifiedUser field value
func (o *DecodeAndVerifyData) GetIsVerifiedUser() bool {
	...
	return o.IsVerifiedUser
}

// GetIsVerifiedUserOk returns a tuple with the IsVerifiedUser field value
// and a boolean to check if the value has been set.
func (o *DecodeAndVerifyData) GetIsVerifiedUserOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsVerifiedUser, true
}

// SetIsVerifiedUser sets field value
func (o *DecodeAndVerifyData) SetIsVerifiedUser(v bool) {
	o.IsVerifiedUser = v
}

func (o DecodeAndVerifyData) MarshalJSON() ([]byte, error) {
...
func (o DecodeAndVerifyData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.Decoded != nil {
		toSerialize["decoded"] = o.Decoded
	}
	toSerialize["encodedByUserId"] = o.EncodedByUserId.Get()
	toSerialize["isVerifiedUser"] = o.IsVerifiedUser
	return toSerialize, nil
}

func (o *DecodeAndVerifyData) UnmarshalJSON(data []byte) (err error) {
	...
	varDecodeAndVerifyData := _DecodeAndVerifyData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDecodeAndVerifyData)

	if err != nil {
		return err
	}

	*o = DecodeAndVerifyData(varDecodeAndVerifyData)

	return err
}

type NullableDecodeAndVerifyData struct {
	value *DecodeAndVerifyData
	isSet bool
}

func (v NullableDecodeAndVerifyData) Get() *DecodeAndVerifyData {
	return v.value
}

func (v *NullableDecodeAndVerifyData) Set(val *DecodeAndVerifyData) {
	v.value = val
	v.isSet = true
}

func (v NullableDecodeAndVerifyData) IsSet() bool {
	return v.isSet
}

func (v *NullableDecodeAndVerifyData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecodeAndVerifyData(val *DecodeAndVerifyData) *NullableDecodeAndVerifyData {
	return &NullableDecodeAndVerifyData{value: val, isSet: true}
}

func (v NullableDecodeAndVerifyData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecodeAndVerifyData) UnmarshalJSON(src []byte) error {
	v.isSet = true
