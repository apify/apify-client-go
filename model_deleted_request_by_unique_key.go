...
// checks if the DeletedRequestByUniqueKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletedRequestByUniqueKey{}
...
type _DeletedRequestByUniqueKey DeletedRequestByUniqueKey
...
func NewDeletedRequestByUniqueKey(uniqueKey string) *DeletedRequestByUniqueKey {
	this := DeletedRequestByUniqueKey{}
...
func (o DeletedRequestByUniqueKey) MarshalJSON() ([]byte, error) {
...
func (o DeletedRequestByUniqueKey) ToMap() (map[string]interface{}, error) {
...
func (o *DeletedRequestByUniqueKey) UnmarshalJSON(data []byte) (err error) {
	...
	varDeletedRequestByUniqueKey := _DeletedRequestByUniqueKey{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeletedRequestByUniqueKey)

	if err != nil {
		return err
	}

	*o = DeletedRequestByUniqueKey(varDeletedRequestByUniqueKey)

	return err
}

type NullableDeletedRequestByUniqueKey struct {
	value *DeletedRequestByUniqueKey
	isSet bool
}

func (v NullableDeletedRequestByUniqueKey) Get() *DeletedRequestByUniqueKey {
	return v.value
}

func (v *NullableDeletedRequestByUniqueKey) Set(val *DeletedRequestByUniqueKey) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletedRequestByUniqueKey) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletedRequestByUniqueKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletedRequestByUniqueKey(val *DeletedRequestByUniqueKey) *NullableDeletedRequestByUniqueKey {
	return &NullableDeletedRequestByUniqueKey{value: val, isSet: true}
}

func (v NullableDeletedRequestByUniqueKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletedRequestByUniqueKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
