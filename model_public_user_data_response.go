...
// checks if the PublicUserDataResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicUserDataResponse{}

// PublicUserDataResponse struct for PublicUserDataResponse
type PublicUserDataResponse struct {
	Data UserPublicInfo `json:"data"`
}

type _PublicUserDataResponse PublicUserDataResponse

// NewPublicUserDataResponse instantiates a new PublicUserDataResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPublicUserDataResponse(data UserPublicInfo) *PublicUserDataResponse {
	this := PublicUserDataResponse{}
	this.Data = data
	return &this
}

// NewPublicUserDataResponseWithDefaults instantiates a new PublicUserDataResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPublicUserDataResponseWithDefaults() *PublicUserDataResponse {
	this := PublicUserDataResponse{}
	return &this
}

// GetData returns the Data field value
func (o *PublicUserDataResponse) GetData() UserPublicInfo {
	if o == nil {
		var ret UserPublicInfo
		return ret
	}
...
func (o *PublicUserDataResponse) GetDataOk() (*UserPublicInfo, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *PublicUserDataResponse) SetData(v UserPublicInfo) {
	o.Data = v
}

func (o PublicUserDataResponse) MarshalJSON() ([]byte, error) {
...
func (o PublicUserDataResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *PublicUserDataResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicUserDataResponse := _PublicUserDataResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicUserDataResponse)

	if err != nil {
		return err
	}

	*o = PublicUserDataResponse(varPublicUserDataResponse)

	return err
}

type NullablePublicUserDataResponse struct {
	value *PublicUserDataResponse
	isSet bool
}

func (v NullablePublicUserDataResponse) Get() *PublicUserDataResponse {
	return v.value
}

func (v *NullablePublicUserDataResponse) Set(val *PublicUserDataResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicUserDataResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicUserDataResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicUserDataResponse(val *PublicUserDataResponse) *NullablePublicUserDataResponse {
	return &NullablePublicUserDataResponse{value: val, isSet: true}
}

func (v NullablePublicUserDataResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicUserDataResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
