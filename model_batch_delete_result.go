...
// checks if the BatchDeleteResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchDeleteResult{}

// BatchDeleteResult Result of a batch delete operation containing successfully deleted and failed requests.
type BatchDeleteResult struct {
	// Requests that were successfully deleted from the request queue.
	ProcessedRequests []DeletedRequest `json:"processedRequests"`
	// Requests that failed to be deleted and can be retried.
	UnprocessedRequests []RequestDraft `json:"unprocessedRequests"`
}

type _BatchDeleteResult BatchDeleteResult
...
func (o *BatchDeleteResult) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchDeleteResult := _BatchDeleteResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchDeleteResult)

	if err != nil {
		return err
	}

	*o = BatchDeleteResult(varBatchDeleteResult)

	return err
}

type NullableBatchDeleteResult struct {
	value *BatchDeleteResult
	isSet bool
}

func (v NullableBatchDeleteResult) Get() *BatchDeleteResult {
	return v.value
}

func (v *NullableBatchDeleteResult) Set(val *BatchDeleteResult) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBatchDeleteResult(val *BatchDeleteResult) *NullableBatchDeleteResult {
	return &NullableBatchDeleteResult{value: val, isSet: true}
}
