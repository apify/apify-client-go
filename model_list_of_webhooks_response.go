...
// checks if the ListOfWebhooksResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfWebhooksResponse{}

// ListOfWebhooksResponse struct for ListOfWebhooksResponse
type ListOfWebhooksResponse struct {
	Data ListOfWebhooks `json:"data"`
}

type _ListOfWebhooksResponse ListOfWebhooksResponse

// NewListOfWebhooksResponse instantiates a new ListOfWebhooksResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListOfWebhooksResponse(data ListOfWebhooks) *ListOfWebhooksResponse {
	this := ListOfWebhooksResponse{}
	this.Data = data
	return &this
}

// NewListOfWebhooksResponseWithDefaults instantiates a new ListOfWebhooksResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListOfWebhooksResponseWithDefaults() *ListOfWebhooksResponse {
	this := ListOfWebhooksResponse{}
	return &this
}

// GetData returns the Data field value
func (o *ListOfWebhooksResponse) GetData() ListOfWebhooks {
	if o == nil {
		var ret ListOfWebhooks
		return ret
	}
...
func (o *ListOfWebhooksResponse) GetDataOk() (*ListOfWebhooks, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ListOfWebhooksResponse) SetData(v ListOfWebhooks) {
	o.Data = v
}

func (o ListOfWebhooksResponse) MarshalJSON() ([]byte, error) {
...
func (o ListOfWebhooksResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ListOfWebhooksResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfWebhooksResponse := _ListOfWebhooksResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfWebhooksResponse)

	if err != nil {
		return err
	}

	*o = ListOfWebhooksResponse(varListOfWebhooksResponse)

	return err
}

type NullableListOfWebhooksResponse struct {
	value *ListOfWebhooksResponse
	isSet bool
}

func (v NullableListOfWebhooksResponse) Get() *ListOfWebhooksResponse {
	return v.value
}

func (v *NullableListOfWebhooksResponse) Set(val *ListOfWebhooksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfWebhooksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfWebhooksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfWebhooksResponse(val *ListOfWebhooksResponse) *NullableListOfWebhooksResponse {
	return &NullableListOfWebhooksResponse{value: val, isSet: true}
}

func (v NullableListOfWebhooksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfWebhooksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
