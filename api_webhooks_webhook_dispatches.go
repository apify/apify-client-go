...
// WebhooksWebhookDispatchesAPIService WebhooksWebhookDispatchesAPI service
type WebhooksWebhookDispatchesAPIService service

type ApiWebhookDispatchGetRequest struct {
	ctx context.Context
	ApiService *WebhooksWebhookDispatchesAPIService
	dispatchId string
}

func (r ApiWebhookDispatchGetRequest) Execute() (*WebhookDispatchResponse, *http.Response, error) {
	return r.ApiService.WebhookDispatchGetExecute(r)
}

/*
WebhookDispatchGet Get webhook dispatch

Gets webhook dispatch object with all details.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param dispatchId Webhook dispatch ID.
 @return ApiWebhookDispatchGetRequest
*/
func (a *WebhooksWebhookDispatchesAPIService) WebhookDispatchGet(ctx context.Context, dispatchId string) ApiWebhookDispatchGetRequest {
	return ApiWebhookDispatchGetRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *WebhooksWebhookDispatchesAPIService) WebhookDispatchGetExecute(r ApiWebhookDispatchGetRequest) (*WebhookDispatchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WebhookDispatchResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhookDispatchesAPIService.WebhookDispatchGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/webhook-dispatches/{dispatchId}"
	localVarPath = strings.Replace(localVarPath, "{"+"dispatchId"+"}", url.PathEscape(parameterValueToString(r.dispatchId, "dispatchId")), -1)
...
type ApiWebhookDispatchesGetRequest struct {
	ctx context.Context
	ApiService *WebhooksWebhookDispatchesAPIService
	offset *float64
	limit *float64
...
func (r ApiWebhookDispatchesGetRequest) Offset(offset float64) ApiWebhookDispatchesGetRequest {
	r.offset = &offset
	return r
}

// Maximum number of items to return. The default value as well as the maximum is &#x60;1000&#x60;. 
func (r ApiWebhookDispatchesGetRequest) Limit(limit float64) ApiWebhookDispatchesGetRequest {
	r.limit = &limit
	return r
}
...
func (r ApiWebhookDispatchesGetRequest) Desc(desc bool) ApiWebhookDispatchesGetRequest {
	r.desc = &desc
	return r
}

func (r ApiWebhookDispatchesGetRequest) Execute() (*ListOfWebhookDispatchesResponse, *http.Response, error) {
	return r.ApiService.WebhookDispatchesGetExecute(r)
}

/*
WebhookDispatchesGet Get list of webhook dispatches
...
parameter.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiWebhookDispatchesGetRequest
*/
func (a *WebhooksWebhookDispatchesAPIService) WebhookDispatchesGet(ctx context.Context) ApiWebhookDispatchesGetRequest {
	return ApiWebhookDispatchesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WebhooksWebhookDispatchesAPIService) WebhookDispatchesGetExecute(r ApiWebhookDispatchesGetRequest) (*ListOfWebhookDispatchesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksWebhookDispatchesAPIService.WebhookDispatchesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/webhook-dispatches"
