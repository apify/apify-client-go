...
// checks if the RequestBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestBase{}

// RequestBase struct for RequestBase
type RequestBase struct {
	...
	LoadedUrl NullableString `json:"loadedUrl,omitempty"`
	...
	NoRetry NullableBool `json:"noRetry,omitempty"`
	...
	HandledAt NullableTime `json:"handledAt,omitempty"`
}
...
// GetLoadedUrl returns the LoadedUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RequestBase) GetLoadedUrl() string {
	if o == nil || IsNil(o.LoadedUrl.Get()) {
		var ret string
		return ret
	}
	return *o.LoadedUrl.Get()
}
...
// SetLoadedUrl gets a reference to the given NullableString and assigns it to the LoadedUrl field.
func (o *RequestBase) SetLoadedUrl(v string) {
	o.LoadedUrl.Set(&v)
}
// SetLoadedUrlNil sets the value for LoadedUrl to be an explicit nil
func (o *RequestBase) SetLoadedUrlNil() {
	o.LoadedUrl.Set(nil)
}
...
func (o *RequestBase) SetPayloadNil() {
	o.Payload.Set(nil)
}
...
// GetNoRetry returns the NoRetry field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RequestBase) GetNoRetry() bool {
	if o == nil || IsNil(o.NoRetry.Get()) {
		var ret bool
		return ret
	}
	return *o.NoRetry.Get()
}
...
// SetNoRetry gets a reference to the given NullableBool and assigns it to the NoRetry field.
func (o *RequestBase) SetNoRetry(v bool) {
	o.NoRetry.Set(&v)
}
// SetNoRetryNil sets the value for NoRetry to be an explicit nil
func (o *RequestBase) SetNoRetryNil() {
	o.NoRetry.Set(nil)
}
...
func (o *RequestBase) GetHandledAt() time.Time {
	if o == nil || IsNil(o.HandledAt.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *RequestBase) SetHandledAtNil() {
	o.HandledAt.Set(nil)
}
...
func (o RequestBase) MarshalJSON() ([]byte, error) {
...
func (o RequestBase) ToMap() (map[string]interface{}, error) {
	...
	if o.LoadedUrl.IsSet() {
		toSerialize["loadedUrl"] = o.LoadedUrl.Get()
	}
	if o.Payload.IsSet() {
	...
	if o.NoRetry.IsSet() {
		toSerialize["noRetry"] = o.NoRetry.Get()
	}
	if o.ErrorMessages != nil {
		toSerialize["errorMessages"] = o.ErrorMessages
	}
	if o.HandledAt.IsSet() {
		toSerialize["handledAt"] = o.HandledAt.Get()
	}
	return toSerialize, nil
}

type NullableRequestBase struct {
	value *RequestBase
	isSet bool
}

func (v NullableRequestBase) Get() *RequestBase {
	return v.value
}

func (v *NullableRequestBase) Set(val *RequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestBase(val *RequestBase) *NullableRequestBase {
	return &NullableRequestBase{value: val, isSet: true}
}

func (v NullableRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
