...
type Version struct {
	VersionNumber string `json:"versionNumber" validate:"regexp=^([0-9]|[1-9][0-9])\\\\.([0-9]|[1-9][0-9])$"`
	SourceType NullableVersionSourceType `json:"sourceType"`
	// 
...
// If the value is explicit nil, the zero value for VersionSourceType will be returned
...
func (o *Version) SetApplyEnvVarsToBuildNil() {
...
func (o *Version) SetGitRepoUrlNil() {
...
func (o *Version) SetTarballUrlNil() {
...
func (o *Version) SetGitHubGistUrlNil() {
