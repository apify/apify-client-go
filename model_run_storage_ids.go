...
// checks if the RunStorageIds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunStorageIds{}

// RunStorageIds A map of aliased storage IDs associated with this run, grouped by storage type.
type RunStorageIds struct {
	Datasets *RunStorageIdsDatasets `json:"datasets,omitempty"`
	KeyValueStores *RunStorageIdsDatasets `json:"keyValueStores,omitempty"`
	RequestQueues *RunStorageIdsDatasets `json:"requestQueues,omitempty"`
}

// NewRunStorageIds instantiates a new RunStorageIds object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRunStorageIds() *RunStorageIds {
	this := RunStorageIds{}
	return &this
}

// NewRunStorageIdsWithDefaults instantiates a new RunStorageIds object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRunStorageIdsWithDefaults() *RunStorageIds {
	this := RunStorageIds{}
	return &this
}

// GetDatasets returns the Datasets field value if set, zero value otherwise.
func (o *RunStorageIds) GetDatasets() RunStorageIdsDatasets {
	if o == nil || IsNil(o.Datasets) {
		var ret RunStorageIdsDatasets
		return ret
	}
	return *o.Datasets
}
...
func (o *RunStorageIds) GetDatasetsOk() (*RunStorageIdsDatasets, bool) {
	if o == nil || IsNil(o.Datasets) {
		return nil, false
	}
...
func (o *RunStorageIds) HasDatasets() bool {
	if o != nil && !IsNil(o.Datasets) {
		return true
	}
...
// SetDatasets gets a reference to the given RunStorageIdsDatasets and assigns it to the Datasets field.
func (o *RunStorageIds) SetDatasets(v RunStorageIdsDatasets) {
	o.Datasets = &v
}

// GetKeyValueStores returns the KeyValueStores field value if set, zero value otherwise.
func (o *RunStorageIds) GetKeyValueStores() RunStorageIdsDatasets {
	if o == nil || IsNil(o.KeyValueStores) {
		var ret RunStorageIdsDatasets
		return ret
	}
	return *o.KeyValueStores
}

// GetKeyValueStoresOk returns a tuple with the KeyValueStores field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunStorageIds) GetKeyValueStoresOk() (*RunStorageIdsDatasets, bool) {
	if o == nil || IsNil(o.KeyValueStores) {
		return nil, false
	}
	return o.KeyValueStores, true
}

// HasKeyValueStores returns a boolean if a field has been set.
func (o *RunStorageIds) HasKeyValueStores() bool {
	if o != nil && !IsNil(o.KeyValueStores) {
		return true
	}
...
// SetKeyValueStores gets a reference to the given RunStorageIdsDatasets and assigns it to the KeyValueStores field.
func (o *RunStorageIds) SetKeyValueStores(v RunStorageIdsDatasets) {
	o.KeyValueStores = &v
}

// GetRequestQueues returns the RequestQueues field value if set, zero value otherwise.
func (o *RunStorageIds) GetRequestQueues() RunStorageIdsDatasets {
	if o == nil || IsNil(o.RequestQueues) {
		var ret RunStorageIdsDatasets
		return ret
	}
	return *o.RequestQueues
}

// GetRequestQueuesOk returns a tuple with the RequestQueues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunStorageIds) GetRequestQueuesOk() (*RunStorageIdsDatasets, bool) {
	if o == nil || IsNil(o.RequestQueues) {
		return nil, false
	}
	return o.RequestQueues, true
}

// HasRequestQueues returns a boolean if a field has been set.
func (o *RunStorageIds) HasRequestQueues() bool {
	if o != nil && !IsNil(o.RequestQueues) {
		return true
	}
...
// SetRequestQueues gets a reference to the given RunStorageIdsDatasets and assigns it to the RequestQueues field.
func (o *RunStorageIds) SetRequestQueues(v RunStorageIdsDatasets) {
	o.RequestQueues = &v
}

func (o RunStorageIds) MarshalJSON() ([]byte, error) {
...
func (o RunStorageIds) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Datasets) {
		toSerialize["datasets"] = o.Datasets
	}
	if !IsNil(o.KeyValueStores) {
		toSerialize["keyValueStores"] = o.KeyValueStores
	}
	if !IsNil(o.RequestQueues) {
		toSerialize["requestQueues"] = o.RequestQueues
	}
	return toSerialize, nil
}

type NullableRunStorageIds struct {
	value *RunStorageIds
	isSet bool
}

func (v NullableRunStorageIds) Get() *RunStorageIds {
	return v.value
}

func (v *NullableRunStorageIds) Set(val *RunStorageIds) {
	v.value = val
	v.isSet = true
}

func (v NullableRunStorageIds) IsSet() bool {
	return v.isSet
}

func (v *NullableRunStorageIds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunStorageIds(val *RunStorageIds) *NullableRunStorageIds {
	return &NullableRunStorageIds{value: val, isSet: true}
}

func (v NullableRunStorageIds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunStorageIds) UnmarshalJSON(src []byte) error {
	v.isSet = true
