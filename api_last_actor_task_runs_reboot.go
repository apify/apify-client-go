...
// LastActorTaskRunsRebootAPIService LastActorTaskRunsRebootAPI service
type LastActorTaskRunsRebootAPIService service

type ApiActorTaskRunsLastRebootPostRequest struct {
	ctx context.Context
	ApiService *LastActorTaskRunsRebootAPIService
	actorTaskId string
	status *string
}

// Filter for the run status.
func (r ApiActorTaskRunsLastRebootPostRequest) Status(status string) ApiActorTaskRunsLastRebootPostRequest {
	r.status = &status
	return r
}

func (r ApiActorTaskRunsLastRebootPostRequest) Execute() (*RunResponse, *http.Response, error) {
	return r.ApiService.ActorTaskRunsLastRebootPostExecute(r)
}

/*
ActorTaskRunsLastRebootPost Reboot Actor task's last run
...
or request queue will be lost.
 ...
 @return ApiActorTaskRunsLastRebootPostRequest
*/
func (a *LastActorTaskRunsRebootAPIService) ActorTaskRunsLastRebootPost(ctx context.Context, actorTaskId string) ApiActorTaskRunsLastRebootPostRequest {
	return ApiActorTaskRunsLastRebootPostRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return RunResponse
func (a *LastActorTaskRunsRebootAPIService) ActorTaskRunsLastRebootPostExecute(r ApiActorTaskRunsLastRebootPostRequest) (*RunResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LastActorTaskRunsRebootAPIService.ActorTaskRunsLastRebootPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actor-tasks/{actorTaskId}/runs/last/reboot"
