...
// checks if the MonthlyUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonthlyUsage{}
...
type MonthlyUsage struct {
	...
	MonthlyServiceUsage map[string]UsageItem `json:"monthlyServiceUsage"`
	// 
...
type _MonthlyUsage MonthlyUsage
...
func NewMonthlyUsage(usageCycle UsageCycle, monthlyServiceUsage map[string]UsageItem, dailyServiceUsages []DailyServiceUsages, totalUsageCreditsUsdBeforeVolumeDiscount float32, totalUsageCreditsUsdAfterVolumeDiscount float32) *MonthlyUsage {
	...
	this.MonthlyServiceUsage = monthlyServiceUsage
	this.DailyServiceUsages = dailyServiceUsages
...
// GetUsageCycle returns the UsageCycle field value
...
// GetUsageCycleOk returns a tuple with the UsageCycle field value
// and a boolean to check if the value has been set.
func (o *MonthlyUsage) GetUsageCycleOk() (*UsageCycle, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UsageCycle, true
}

// SetUsageCycle sets field value
func (o *MonthlyUsage) SetUsageCycle(v UsageCycle) {
	o.UsageCycle = v
}

// GetMonthlyServiceUsage returns the MonthlyServiceUsage field value
func (o *MonthlyUsage) GetMonthlyServiceUsage() map[string]UsageItem {
	if o == nil {
		var ret map[string]UsageItem
		return ret
	}

	return o.MonthlyServiceUsage
}

// GetMonthlyServiceUsageOk returns a tuple with the MonthlyServiceUsage field value
// and a boolean to check if the value has been set.
func (o *MonthlyUsage) GetMonthlyServiceUsageOk() (map[string]UsageItem, bool) {
	if o == nil {
		return map[string]UsageItem{}, false
	}
	return o.MonthlyServiceUsage, true
}

// SetMonthlyServiceUsage sets field value
func (o *MonthlyUsage) SetMonthlyServiceUsage(v map[string]UsageItem) {
	o.MonthlyServiceUsage = v
}

// GetDailyServiceUsages returns the DailyServiceUsages field value
func (o *MonthlyUsage) GetDailyServiceUsages() []DailyServiceUsages {
	if o == nil {
		var ret []DailyServiceUsages
		return ret
	}

	return o.DailyServiceUsages
}

// GetDailyServiceUsagesOk returns a tuple with the DailyServiceUsages field value
// and a boolean to check if the value has been set.
func (o *MonthlyUsage) GetDailyServiceUsagesOk() ([]DailyServiceUsages, bool) {
	if o == nil {
		return nil, false
	}
	return o.DailyServiceUsages, true
}

// SetDailyServiceUsages sets field value
func (o *MonthlyUsage) SetDailyServiceUsages(v []DailyServiceUsages) {
	o.DailyServiceUsages = v
}

// GetTotalUsageCreditsUsdBeforeVolumeDiscount returns the TotalUsageCreditsUsdBeforeVolumeDiscount field value
func (o *MonthlyUsage) GetTotalUsageCreditsUsdBeforeVolumeDiscount() float32 {
	...
	return o.TotalUsageCreditsUsdBeforeVolumeDiscount
}

// GetTotalUsageCreditsUsdBeforeVolumeDiscountOk returns a tuple with the TotalUsageCreditsUsdBeforeVolumeDiscount field value
// and a boolean to check if the value has been set.
func (o *MonthlyUsage) GetTotalUsageCreditsUsdBeforeVolumeDiscountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalUsageCreditsUsdBeforeVolumeDiscount, true
}

// SetTotalUsageCreditsUsdBeforeVolumeDiscount sets field value
func (o *MonthlyUsage) SetTotalUsageCreditsUsdBeforeVolumeDiscount(v float32) {
	o.TotalUsageCreditsUsdBeforeVolumeDiscount = v
}

// GetTotalUsageCreditsUsdAfterVolumeDiscount returns the TotalUsageCreditsUsdAfterVolumeDiscount field value
func (o *MonthlyUsage) GetTotalUsageCreditsUsdAfterVolumeDiscount() float32 {
	...
	return o.TotalUsageCreditsUsdAfterVolumeDiscount
}

// GetTotalUsageCreditsUsdAfterVolumeDiscountOk returns a tuple with the TotalUsageCreditsUsdAfterVolumeDiscount field value
// and a boolean to check if the value has been set.
func (o *MonthlyUsage) GetTotalUsageCreditsUsdAfterVolumeDiscountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalUsageCreditsUsdAfterVolumeDiscount, true
}

// SetTotalUsageCreditsUsdAfterVolumeDiscount sets field value
func (o *MonthlyUsage) SetTotalUsageCreditsUsdAfterVolumeDiscount(v float32) {
	o.TotalUsageCreditsUsdAfterVolumeDiscount = v
}
...
func (o MonthlyUsage) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["usageCycle"] = o.UsageCycle
	toSerialize["monthlyServiceUsage"] = o.MonthlyServiceUsage
	toSerialize["dailyServiceUsages"] = o.DailyServiceUsages
	toSerialize["totalUsageCreditsUsdBeforeVolumeDiscount"] = o.TotalUsageCreditsUsdBeforeVolumeDiscount
	toSerialize["totalUsageCreditsUsdAfterVolumeDiscount"] = o.TotalUsageCreditsUsdAfterVolumeDiscount
	return toSerialize, nil
}

func (o *MonthlyUsage) UnmarshalJSON(data []byte) (err error) {
	...
	varMonthlyUsage := _MonthlyUsage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMonthlyUsage)

	if err != nil {
		return err
	}

	*o = MonthlyUsage(varMonthlyUsage)
