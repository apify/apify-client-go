...
// checks if the HeadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeadResponse{}

// HeadResponse Response containing requests from the request queue head without locking.
type HeadResponse struct {
	Data RequestQueueHead `json:"data"`
}

type _HeadResponse HeadResponse

// NewHeadResponse instantiates a new HeadResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHeadResponse(data RequestQueueHead) *HeadResponse {
	this := HeadResponse{}
	this.Data = data
	return &this
}

// NewHeadResponseWithDefaults instantiates a new HeadResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHeadResponseWithDefaults() *HeadResponse {
	this := HeadResponse{}
	return &this
}

// GetData returns the Data field value
func (o *HeadResponse) GetData() RequestQueueHead {
	if o == nil {
		var ret RequestQueueHead
		return ret
	}
...
func (o *HeadResponse) GetDataOk() (*RequestQueueHead, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *HeadResponse) SetData(v RequestQueueHead) {
	o.Data = v
}

func (o HeadResponse) MarshalJSON() ([]byte, error) {
...
func (o HeadResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *HeadResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varHeadResponse := _HeadResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeadResponse)

	if err != nil {
		return err
	}

	*o = HeadResponse(varHeadResponse)

	return err
}

type NullableHeadResponse struct {
	value *HeadResponse
	isSet bool
}

func (v NullableHeadResponse) Get() *HeadResponse {
	return v.value
}

func (v *NullableHeadResponse) Set(val *HeadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHeadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHeadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeadResponse(val *HeadResponse) *NullableHeadResponse {
	return &NullableHeadResponse{value: val, isSet: true}
}

func (v NullableHeadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
