...
// checks if the DatasetStatisticsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetStatisticsResponse{}

// DatasetStatisticsResponse struct for DatasetStatisticsResponse
type DatasetStatisticsResponse struct {
	Data DatasetStatistics `json:"data"`
}

type _DatasetStatisticsResponse DatasetStatisticsResponse

// NewDatasetStatisticsResponse instantiates a new DatasetStatisticsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDatasetStatisticsResponse(data DatasetStatistics) *DatasetStatisticsResponse {
	this := DatasetStatisticsResponse{}
	this.Data = data
	return &this
}

// NewDatasetStatisticsResponseWithDefaults instantiates a new DatasetStatisticsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDatasetStatisticsResponseWithDefaults() *DatasetStatisticsResponse {
	this := DatasetStatisticsResponse{}
	return &this
}

// GetData returns the Data field value
func (o *DatasetStatisticsResponse) GetData() DatasetStatistics {
	if o == nil {
		var ret DatasetStatistics
		return ret
	}
...
func (o *DatasetStatisticsResponse) GetDataOk() (*DatasetStatistics, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *DatasetStatisticsResponse) SetData(v DatasetStatistics) {
	o.Data = v
}

func (o DatasetStatisticsResponse) MarshalJSON() ([]byte, error) {
...
func (o DatasetStatisticsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *DatasetStatisticsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasetStatisticsResponse := _DatasetStatisticsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDatasetStatisticsResponse)

	if err != nil {
		return err
	}

	*o = DatasetStatisticsResponse(varDatasetStatisticsResponse)

	return err
}

type NullableDatasetStatisticsResponse struct {
	value *DatasetStatisticsResponse
	isSet bool
}

func (v NullableDatasetStatisticsResponse) Get() *DatasetStatisticsResponse {
	return v.value
}

func (v *NullableDatasetStatisticsResponse) Set(val *DatasetStatisticsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasetStatisticsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasetStatisticsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasetStatisticsResponse(val *DatasetStatisticsResponse) *NullableDatasetStatisticsResponse {
	return &NullableDatasetStatisticsResponse{value: val, isSet: true}
}

func (v NullableDatasetStatisticsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasetStatisticsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
