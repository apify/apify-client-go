...
// checks if the BuildUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildUsage{}

// BuildUsage struct for BuildUsage
type BuildUsage struct {
	ACTOR_COMPUTE_UNITS NullableFloat32 `json:"ACTOR_COMPUTE_UNITS,omitempty"`
}

// NewBuildUsage instantiates a new BuildUsage object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBuildUsage() *BuildUsage {
	this := BuildUsage{}
	return &this
}

// NewBuildUsageWithDefaults instantiates a new BuildUsage object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBuildUsageWithDefaults() *BuildUsage {
	this := BuildUsage{}
	return &this
}
...
func (o *BuildUsage) GetACTOR_COMPUTE_UNITS() float32 {
...
func (o *BuildUsage) GetACTOR_COMPUTE_UNITSOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BuildUsage) HasACTOR_COMPUTE_UNITS() bool {
...
func (o *BuildUsage) UnsetACTOR_COMPUTE_UNITS() {
	o.ACTOR_COMPUTE_UNITS.Unset()
}

func (o BuildUsage) MarshalJSON() ([]byte, error) {
...
func (o BuildUsage) ToMap() (map[string]interface{}, error) {
...
type NullableBuildUsage struct {
	value *BuildUsage
	isSet bool
}

func (v NullableBuildUsage) Get() *BuildUsage {
	return v.value
}

func (v *NullableBuildUsage) Set(val *BuildUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildUsage(val *BuildUsage) *NullableBuildUsage {
	return &NullableBuildUsage{value: val, isSet: true}
}

func (v NullableBuildUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
