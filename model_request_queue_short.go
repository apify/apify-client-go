...
// checks if the RequestQueueShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestQueueShort{}

// RequestQueueShort A shortened request queue object for list responses.
type RequestQueueShort struct {
	...
	TotalRequestCount int32 `json:"totalRequestCount"`
	// The number of requests that have been handled.
	HandledRequestCount int32 `json:"handledRequestCount"`
	// The number of requests that are pending and have not been handled yet.
	PendingRequestCount int32 `json:"pendingRequestCount"`
	...
	Stats *RequestQueueStats `json:"stats,omitempty"`
}

type _RequestQueueShort RequestQueueShort
...
// GetTotalRequestCount returns the TotalRequestCount field value
func (o *RequestQueueShort) GetTotalRequestCount() int32 {
	...
	return o.TotalRequestCount
}

// GetTotalRequestCountOk returns a tuple with the TotalRequestCount field value
// and a boolean to check if the value has been set.
func (o *RequestQueueShort) GetTotalRequestCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalRequestCount, true
}

// SetTotalRequestCount sets field value
func (o *RequestQueueShort) SetTotalRequestCount(v int32) {
	o.TotalRequestCount = v
}

// GetHandledRequestCount returns the HandledRequestCount field value
func (o *RequestQueueShort) GetHandledRequestCount() int32 {
	...
	return o.HandledRequestCount
}

// GetHandledRequestCountOk returns a tuple with the HandledRequestCount field value
// and a boolean to check if the value has been set.
func (o *RequestQueueShort) GetHandledRequestCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HandledRequestCount, true
}

// SetHandledRequestCount sets field value
func (o *RequestQueueShort) SetHandledRequestCount(v int32) {
	o.HandledRequestCount = v
}

// GetPendingRequestCount returns the PendingRequestCount field value
func (o *RequestQueueShort) GetPendingRequestCount() int32 {
	...
	return o.PendingRequestCount
}

// GetPendingRequestCountOk returns a tuple with the PendingRequestCount field value
// and a boolean to check if the value has been set.
func (o *RequestQueueShort) GetPendingRequestCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PendingRequestCount, true
}

// SetPendingRequestCount sets field value
func (o *RequestQueueShort) SetPendingRequestCount(v int32) {
	o.PendingRequestCount = v
}
...
func (o *RequestQueueShort) SetActIdNil() {
	o.ActId.Set(nil)
}
...
func (o *RequestQueueShort) SetActRunIdNil() {
	o.ActRunId.Set(nil)
}
...
// GetHadMultipleClients returns the HadMultipleClients field value
func (o *RequestQueueShort) GetHadMultipleClients() bool {
	...
	return o.HadMultipleClients
}

// GetHadMultipleClientsOk returns a tuple with the HadMultipleClients field value
// and a boolean to check if the value has been set.
func (o *RequestQueueShort) GetHadMultipleClientsOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HadMultipleClients, true
}

// SetHadMultipleClients sets field value
func (o *RequestQueueShort) SetHadMultipleClients(v bool) {
	o.HadMultipleClients = v
}
...
// SetStats gets a reference to the given RequestQueueStats and assigns it to the Stats field.
func (o *RequestQueueShort) SetStats(v RequestQueueStats) {
	o.Stats = &v
}

func (o RequestQueueShort) MarshalJSON() ([]byte, error) {
...
func (o RequestQueueShort) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["totalRequestCount"] = o.TotalRequestCount
	toSerialize["handledRequestCount"] = o.HandledRequestCount
	toSerialize["pendingRequestCount"] = o.PendingRequestCount
	if o.ActId.IsSet() {
	...
	toSerialize["hadMultipleClients"] = o.HadMultipleClients
...
func (o *RequestQueueShort) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestQueueShort := _RequestQueueShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestQueueShort)

	if err != nil {
		return err
	}

	*o = RequestQueueShort(varRequestQueueShort)

	return err
}

type NullableRequestQueueShort struct {
	value *RequestQueueShort
	isSet bool
}

func (v NullableRequestQueueShort) Get() *RequestQueueShort {
	return v.value
}

func (v *NullableRequestQueueShort) Set(val *RequestQueueShort) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestQueueShort) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestQueueShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestQueueShort(val *RequestQueueShort) *NullableRequestQueueShort {
	return &NullableRequestQueueShort{value: val, isSet: true}
}

func (v NullableRequestQueueShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestQueueShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
