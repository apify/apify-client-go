...
// checks if the ListOfRequests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOfRequests{}

// ListOfRequests A paginated list of requests from the request queue.
...
type _ListOfRequests ListOfRequests
...
// GetExclusiveStartId returns the ExclusiveStartId field value if set, zero value otherwise.
// Deprecated
func (o *ListOfRequests) GetExclusiveStartId() string {
	if o == nil || IsNil(o.ExclusiveStartId) {
		var ret string
		return ret
	}
	return *o.ExclusiveStartId
}

// GetExclusiveStartIdOk returns a tuple with the ExclusiveStartId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// Deprecated
func (o *ListOfRequests) GetExclusiveStartIdOk() (*string, bool) {
	...
	return o.ExclusiveStartId, true
}
...
// SetExclusiveStartId gets a reference to the given string and assigns it to the ExclusiveStartId field.
// Deprecated
func (o *ListOfRequests) SetExclusiveStartId(v string) {
	o.ExclusiveStartId = &v
}
...
func (o ListOfRequests) MarshalJSON() ([]byte, error) {
...
func (o ListOfRequests) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	toSerialize["limit"] = o.Limit
	if !IsNil(o.ExclusiveStartId) {
		toSerialize["exclusiveStartId"] = o.ExclusiveStartId
	}
	if !IsNil(o.Cursor) {
...
func (o *ListOfRequests) UnmarshalJSON(data []byte) (err error) {
	...
	varListOfRequests := _ListOfRequests{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOfRequests)

	if err != nil {
		return err
	}

	*o = ListOfRequests(varListOfRequests)

	return err
}

type NullableListOfRequests struct {
	value *ListOfRequests
	isSet bool
}

func (v NullableListOfRequests) Get() *ListOfRequests {
	return v.value
}

func (v *NullableListOfRequests) Set(val *ListOfRequests) {
	v.value = val
	v.isSet = true
}

func (v NullableListOfRequests) IsSet() bool {
	return v.isSet
}

func (v *NullableListOfRequests) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOfRequests(val *ListOfRequests) *NullableListOfRequests {
	return &NullableListOfRequests{value: val, isSet: true}
}

func (v NullableListOfRequests) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOfRequests) UnmarshalJSON(src []byte) error {
	v.isSet = true
