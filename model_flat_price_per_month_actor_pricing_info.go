...
// checks if the FlatPricePerMonthActorPricingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlatPricePerMonthActorPricingInfo{}

// FlatPricePerMonthActorPricingInfo struct for FlatPricePerMonthActorPricingInfo
type FlatPricePerMonthActorPricingInfo struct {
	...
	TrialMinutes int32 `json:"trialMinutes"`
	// Monthly flat price in USD
	PricePerUnitUsd float32 `json:"pricePerUnitUsd"`
}

type _FlatPricePerMonthActorPricingInfo FlatPricePerMonthActorPricingInfo
...
func NewFlatPricePerMonthActorPricingInfo(apifyMarginPercentage float32, createdAt time.Time, startedAt time.Time, pricingModel string, trialMinutes int32, pricePerUnitUsd float32) *FlatPricePerMonthActorPricingInfo {
	this := FlatPricePerMonthActorPricingInfo{}
...
// GetTrialMinutes returns the TrialMinutes field value
func (o *FlatPricePerMonthActorPricingInfo) GetTrialMinutes() int32 {
	...
	return o.TrialMinutes
}

// GetTrialMinutesOk returns a tuple with the TrialMinutes field value
// and a boolean to check if the value has been set.
func (o *FlatPricePerMonthActorPricingInfo) GetTrialMinutesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TrialMinutes, true
}

// SetTrialMinutes sets field value
func (o *FlatPricePerMonthActorPricingInfo) SetTrialMinutes(v int32) {
	o.TrialMinutes = v
}

// GetPricePerUnitUsd returns the PricePerUnitUsd field value
...
// GetPricePerUnitUsdOk returns a tuple with the PricePerUnitUsd field value
// and a boolean to check if the value has been set.
...
// SetPricePerUnitUsd sets field value
func (o *FlatPricePerMonthActorPricingInfo) SetPricePerUnitUsd(v float32) {
	o.PricePerUnitUsd = v
}

func (o FlatPricePerMonthActorPricingInfo) MarshalJSON() ([]byte, error) {
...
func (o FlatPricePerMonthActorPricingInfo) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["trialMinutes"] = o.TrialMinutes
	toSerialize["pricePerUnitUsd"] = o.PricePerUnitUsd
	return toSerialize, nil
}

func (o *FlatPricePerMonthActorPricingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varFlatPricePerMonthActorPricingInfo := _FlatPricePerMonthActorPricingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFlatPricePerMonthActorPricingInfo)

	if err != nil {
		return err
	}

	*o = FlatPricePerMonthActorPricingInfo(varFlatPricePerMonthActorPricingInfo)

	return err
}

type NullableFlatPricePerMonthActorPricingInfo struct {
	value *FlatPricePerMonthActorPricingInfo
	isSet bool
}

func (v NullableFlatPricePerMonthActorPricingInfo) Get() *FlatPricePerMonthActorPricingInfo {
	return v.value
}

func (v *NullableFlatPricePerMonthActorPricingInfo) Set(val *FlatPricePerMonthActorPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableFlatPricePerMonthActorPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableFlatPricePerMonthActorPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlatPricePerMonthActorPricingInfo(val *FlatPricePerMonthActorPricingInfo) *NullableFlatPricePerMonthActorPricingInfo {
	return &NullableFlatPricePerMonthActorPricingInfo{value: val, isSet: true}
}

func (v NullableFlatPricePerMonthActorPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlatPricePerMonthActorPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
