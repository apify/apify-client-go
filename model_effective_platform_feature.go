...
// checks if the EffectivePlatformFeature type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EffectivePlatformFeature{}

// EffectivePlatformFeature struct for EffectivePlatformFeature
type EffectivePlatformFeature struct {
	IsEnabled bool `json:"isEnabled"`
	DisabledReason NullableString `json:"disabledReason"`
	DisabledReasonType NullableString `json:"disabledReasonType"`
	IsTrial bool `json:"isTrial"`
	TrialExpirationAt NullableTime `json:"trialExpirationAt"`
}

type _EffectivePlatformFeature EffectivePlatformFeature

// NewEffectivePlatformFeature instantiates a new EffectivePlatformFeature object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEffectivePlatformFeature(isEnabled bool, disabledReason NullableString, disabledReasonType NullableString, isTrial bool, trialExpirationAt NullableTime) *EffectivePlatformFeature {
	this := EffectivePlatformFeature{}
...
// NewEffectivePlatformFeatureWithDefaults instantiates a new EffectivePlatformFeature object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEffectivePlatformFeatureWithDefaults() *EffectivePlatformFeature {
	this := EffectivePlatformFeature{}
	return &this
}

// GetIsEnabled returns the IsEnabled field value
func (o *EffectivePlatformFeature) GetIsEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *EffectivePlatformFeature) GetIsEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeature) SetIsEnabled(v bool) {
	o.IsEnabled = v
}

// GetDisabledReason returns the DisabledReason field value
// If the value is explicit nil, the zero value for string will be returned
func (o *EffectivePlatformFeature) GetDisabledReason() string {
...
func (o *EffectivePlatformFeature) GetDisabledReasonOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeature) SetDisabledReason(v string) {
	o.DisabledReason.Set(&v)
}

// GetDisabledReasonType returns the DisabledReasonType field value
// If the value is explicit nil, the zero value for string will be returned
func (o *EffectivePlatformFeature) GetDisabledReasonType() string {
	if o == nil || o.DisabledReasonType.Get() == nil {
		var ret string
		return ret
	}

	return *o.DisabledReasonType.Get()
}

// GetDisabledReasonTypeOk returns a tuple with the DisabledReasonType field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EffectivePlatformFeature) GetDisabledReasonTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.DisabledReasonType.Get(), o.DisabledReasonType.IsSet()
}

// SetDisabledReasonType sets field value
func (o *EffectivePlatformFeature) SetDisabledReasonType(v string) {
	o.DisabledReasonType.Set(&v)
}

// GetIsTrial returns the IsTrial field value
func (o *EffectivePlatformFeature) GetIsTrial() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeature) GetIsTrialOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeature) SetIsTrial(v bool) {
	o.IsTrial = v
}

// GetTrialExpirationAt returns the TrialExpirationAt field value
// If the value is explicit nil, the zero value for time.Time will be returned
func (o *EffectivePlatformFeature) GetTrialExpirationAt() time.Time {
	if o == nil || o.TrialExpirationAt.Get() == nil {
		var ret time.Time
		return ret
	}

	return *o.TrialExpirationAt.Get()
}

// GetTrialExpirationAtOk returns a tuple with the TrialExpirationAt field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EffectivePlatformFeature) GetTrialExpirationAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return o.TrialExpirationAt.Get(), o.TrialExpirationAt.IsSet()
}

// SetTrialExpirationAt sets field value
func (o *EffectivePlatformFeature) SetTrialExpirationAt(v time.Time) {
	o.TrialExpirationAt.Set(&v)
}

func (o EffectivePlatformFeature) MarshalJSON() ([]byte, error) {
...
func (o EffectivePlatformFeature) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["isEnabled"] = o.IsEnabled
	toSerialize["disabledReason"] = o.DisabledReason.Get()
	toSerialize["disabledReasonType"] = o.DisabledReasonType.Get()
	toSerialize["isTrial"] = o.IsTrial
	toSerialize["trialExpirationAt"] = o.TrialExpirationAt.Get()
	return toSerialize, nil
}

func (o *EffectivePlatformFeature) UnmarshalJSON(data []byte) (err error) {
	...
	varEffectivePlatformFeature := _EffectivePlatformFeature{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEffectivePlatformFeature)

	if err != nil {
		return err
	}

	*o = EffectivePlatformFeature(varEffectivePlatformFeature)

	return err
}

type NullableEffectivePlatformFeature struct {
	value *EffectivePlatformFeature
	isSet bool
}

func (v NullableEffectivePlatformFeature) Get() *EffectivePlatformFeature {
	return v.value
}

func (v *NullableEffectivePlatformFeature) Set(val *EffectivePlatformFeature) {
	v.value = val
	v.isSet = true
}

func (v NullableEffectivePlatformFeature) IsSet() bool {
	return v.isSet
}

func (v *NullableEffectivePlatformFeature) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEffectivePlatformFeature(val *EffectivePlatformFeature) *NullableEffectivePlatformFeature {
	return &NullableEffectivePlatformFeature{value: val, isSet: true}
}

func (v NullableEffectivePlatformFeature) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEffectivePlatformFeature) UnmarshalJSON(src []byte) error {
	v.isSet = true
