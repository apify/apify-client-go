...
// checks if the CurrentPricingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrentPricingInfo{}

// CurrentPricingInfo struct for CurrentPricingInfo
type CurrentPricingInfo struct {
	PricingModel string `json:"pricingModel"`
	ApifyMarginPercentage *float32 `json:"apifyMarginPercentage,omitempty"`
	CreatedAt *time.Time `json:"createdAt,omitempty"`
	StartedAt *time.Time `json:"startedAt,omitempty"`
	NotifiedAboutChangeAt NullableTime `json:"notifiedAboutChangeAt,omitempty"`
	NotifiedAboutFutureChangeAt NullableTime `json:"notifiedAboutFutureChangeAt,omitempty"`
	...
	IsPPEPlatformUsagePaidByUser *bool `json:"isPPEPlatformUsagePaidByUser,omitempty"`
	ReasonForChange NullableString `json:"reasonForChange,omitempty"`
	TrialMinutes NullableInt32 `json:"trialMinutes,omitempty"`
	UnitName NullableString `json:"unitName,omitempty"`
	PricePerUnitUsd NullableFloat32 `json:"pricePerUnitUsd,omitempty"`
	MinimalMaxTotalChargeUsd NullableFloat32 `json:"minimalMaxTotalChargeUsd,omitempty"`
	// Per-event pricing configuration for pay-per-event Actors.
	PricingPerEvent map[string]interface{} `json:"pricingPerEvent,omitempty"`
}
...
// GetApifyMarginPercentage returns the ApifyMarginPercentage field value if set, zero value otherwise.
func (o *CurrentPricingInfo) GetApifyMarginPercentage() float32 {
	if o == nil || IsNil(o.ApifyMarginPercentage) {
		var ret float32
		return ret
	}
...
// GetApifyMarginPercentageOk returns a tuple with the ApifyMarginPercentage field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetApifyMarginPercentage gets a reference to the given float32 and assigns it to the ApifyMarginPercentage field.
...
// GetNotifiedAboutChangeAt returns the NotifiedAboutChangeAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetNotifiedAboutChangeAt() time.Time {
	if o == nil || IsNil(o.NotifiedAboutChangeAt.Get()) {
		var ret time.Time
		return ret
	}
	return *o.NotifiedAboutChangeAt.Get()
}
...
func (o *CurrentPricingInfo) GetNotifiedAboutChangeAtOk() (*time.Time, bool) {
	...
	return o.NotifiedAboutChangeAt.Get(), o.NotifiedAboutChangeAt.IsSet()
}
...
func (o *CurrentPricingInfo) HasNotifiedAboutChangeAt() bool {
	if o != nil && o.NotifiedAboutChangeAt.IsSet() {
		return true
	}
...
// SetNotifiedAboutChangeAt gets a reference to the given NullableTime and assigns it to the NotifiedAboutChangeAt field.
func (o *CurrentPricingInfo) SetNotifiedAboutChangeAt(v time.Time) {
	o.NotifiedAboutChangeAt.Set(&v)
}
// SetNotifiedAboutChangeAtNil sets the value for NotifiedAboutChangeAt to be an explicit nil
func (o *CurrentPricingInfo) SetNotifiedAboutChangeAtNil() {
	o.NotifiedAboutChangeAt.Set(nil)
}
...
func (o *CurrentPricingInfo) UnsetNotifiedAboutChangeAt() {
	o.NotifiedAboutChangeAt.Unset()
}

// GetNotifiedAboutFutureChangeAt returns the NotifiedAboutFutureChangeAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetNotifiedAboutFutureChangeAt() time.Time {
	if o == nil || IsNil(o.NotifiedAboutFutureChangeAt.Get()) {
		var ret time.Time
		return ret
	}
	return *o.NotifiedAboutFutureChangeAt.Get()
}
...
func (o *CurrentPricingInfo) GetNotifiedAboutFutureChangeAtOk() (*time.Time, bool) {
	...
	return o.NotifiedAboutFutureChangeAt.Get(), o.NotifiedAboutFutureChangeAt.IsSet()
}
...
func (o *CurrentPricingInfo) HasNotifiedAboutFutureChangeAt() bool {
	if o != nil && o.NotifiedAboutFutureChangeAt.IsSet() {
		return true
	}
...
// SetNotifiedAboutFutureChangeAt gets a reference to the given NullableTime and assigns it to the NotifiedAboutFutureChangeAt field.
func (o *CurrentPricingInfo) SetNotifiedAboutFutureChangeAt(v time.Time) {
	o.NotifiedAboutFutureChangeAt.Set(&v)
}
// SetNotifiedAboutFutureChangeAtNil sets the value for NotifiedAboutFutureChangeAt to be an explicit nil
func (o *CurrentPricingInfo) SetNotifiedAboutFutureChangeAtNil() {
	o.NotifiedAboutFutureChangeAt.Set(nil)
}
...
func (o *CurrentPricingInfo) UnsetNotifiedAboutFutureChangeAt() {
	o.NotifiedAboutFutureChangeAt.Unset()
}
...
// GetIsPPEPlatformUsagePaidByUser returns the IsPPEPlatformUsagePaidByUser field value if set, zero value otherwise.
func (o *CurrentPricingInfo) GetIsPPEPlatformUsagePaidByUser() bool {
	if o == nil || IsNil(o.IsPPEPlatformUsagePaidByUser) {
		var ret bool
		return ret
	}
	return *o.IsPPEPlatformUsagePaidByUser
}

// GetIsPPEPlatformUsagePaidByUserOk returns a tuple with the IsPPEPlatformUsagePaidByUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CurrentPricingInfo) GetIsPPEPlatformUsagePaidByUserOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPPEPlatformUsagePaidByUser) {
		return nil, false
	}
	return o.IsPPEPlatformUsagePaidByUser, true
}
...
// SetIsPPEPlatformUsagePaidByUser gets a reference to the given bool and assigns it to the IsPPEPlatformUsagePaidByUser field.
func (o *CurrentPricingInfo) SetIsPPEPlatformUsagePaidByUser(v bool) {
	o.IsPPEPlatformUsagePaidByUser = &v
}

// GetReasonForChange returns the ReasonForChange field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetReasonForChange() string {
	if o == nil || IsNil(o.ReasonForChange.Get()) {
		var ret string
		return ret
	}
	return *o.ReasonForChange.Get()
}
...
// SetReasonForChange gets a reference to the given NullableString and assigns it to the ReasonForChange field.
func (o *CurrentPricingInfo) SetReasonForChange(v string) {
	o.ReasonForChange.Set(&v)
}
// SetReasonForChangeNil sets the value for ReasonForChange to be an explicit nil
func (o *CurrentPricingInfo) SetReasonForChangeNil() {
	o.ReasonForChange.Set(nil)
}
...
func (o *CurrentPricingInfo) UnsetReasonForChange() {
	o.ReasonForChange.Unset()
}

// GetTrialMinutes returns the TrialMinutes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetTrialMinutes() int32 {
	if o == nil || IsNil(o.TrialMinutes.Get()) {
		var ret int32
		return ret
	}
	return *o.TrialMinutes.Get()
}

// GetTrialMinutesOk returns a tuple with the TrialMinutes field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetTrialMinutes gets a reference to the given NullableInt32 and assigns it to the TrialMinutes field.
func (o *CurrentPricingInfo) SetTrialMinutes(v int32) {
	o.TrialMinutes.Set(&v)
}
// SetTrialMinutesNil sets the value for TrialMinutes to be an explicit nil
func (o *CurrentPricingInfo) SetTrialMinutesNil() {
	o.TrialMinutes.Set(nil)
}
...
func (o *CurrentPricingInfo) SetUnitNameNil() {
	o.UnitName.Set(nil)
}
...
// GetPricePerUnitUsd returns the PricePerUnitUsd field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetPricePerUnitUsd() float32 {
	if o == nil || IsNil(o.PricePerUnitUsd.Get()) {
		var ret float32
		return ret
	}
	return *o.PricePerUnitUsd.Get()
}
...
// SetPricePerUnitUsd gets a reference to the given NullableFloat32 and assigns it to the PricePerUnitUsd field.
func (o *CurrentPricingInfo) SetPricePerUnitUsd(v float32) {
	o.PricePerUnitUsd.Set(&v)
}
// SetPricePerUnitUsdNil sets the value for PricePerUnitUsd to be an explicit nil
func (o *CurrentPricingInfo) SetPricePerUnitUsdNil() {
	o.PricePerUnitUsd.Set(nil)
}
...
func (o *CurrentPricingInfo) UnsetPricePerUnitUsd() {
	o.PricePerUnitUsd.Unset()
}

// GetMinimalMaxTotalChargeUsd returns the MinimalMaxTotalChargeUsd field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetMinimalMaxTotalChargeUsd() float32 {
	if o == nil || IsNil(o.MinimalMaxTotalChargeUsd.Get()) {
		var ret float32
		return ret
	}
	return *o.MinimalMaxTotalChargeUsd.Get()
}

// GetMinimalMaxTotalChargeUsdOk returns a tuple with the MinimalMaxTotalChargeUsd field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CurrentPricingInfo) GetMinimalMaxTotalChargeUsdOk() (*float32, bool) {
	...
	return o.MinimalMaxTotalChargeUsd.Get(), o.MinimalMaxTotalChargeUsd.IsSet()
}
...
func (o *CurrentPricingInfo) HasMinimalMaxTotalChargeUsd() bool {
	if o != nil && o.MinimalMaxTotalChargeUsd.IsSet() {
		return true
	}
...
// SetMinimalMaxTotalChargeUsd gets a reference to the given NullableFloat32 and assigns it to the MinimalMaxTotalChargeUsd field.
func (o *CurrentPricingInfo) SetMinimalMaxTotalChargeUsd(v float32) {
	o.MinimalMaxTotalChargeUsd.Set(&v)
}
// SetMinimalMaxTotalChargeUsdNil sets the value for MinimalMaxTotalChargeUsd to be an explicit nil
func (o *CurrentPricingInfo) SetMinimalMaxTotalChargeUsdNil() {
	o.MinimalMaxTotalChargeUsd.Set(nil)
}
...
func (o *CurrentPricingInfo) UnsetMinimalMaxTotalChargeUsd() {
	o.MinimalMaxTotalChargeUsd.Unset()
}

// GetPricingPerEvent returns the PricingPerEvent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentPricingInfo) GetPricingPerEvent() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.PricingPerEvent
}

// GetPricingPerEventOk returns a tuple with the PricingPerEvent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CurrentPricingInfo) GetPricingPerEventOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PricingPerEvent) {
		return map[string]interface{}{}, false
	}
	return o.PricingPerEvent, true
}
...
// SetPricingPerEvent gets a reference to the given map[string]interface{} and assigns it to the PricingPerEvent field.
func (o *CurrentPricingInfo) SetPricingPerEvent(v map[string]interface{}) {
	o.PricingPerEvent = v
}

func (o CurrentPricingInfo) MarshalJSON() ([]byte, error) {
...
func (o CurrentPricingInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["pricingModel"] = o.PricingModel
	if !IsNil(o.ApifyMarginPercentage) {
	...
	if o.NotifiedAboutChangeAt.IsSet() {
		toSerialize["notifiedAboutChangeAt"] = o.NotifiedAboutChangeAt.Get()
	}
	if o.NotifiedAboutFutureChangeAt.IsSet() {
		toSerialize["notifiedAboutFutureChangeAt"] = o.NotifiedAboutFutureChangeAt.Get()
	}
	...
	if !IsNil(o.IsPPEPlatformUsagePaidByUser) {
		toSerialize["isPPEPlatformUsagePaidByUser"] = o.IsPPEPlatformUsagePaidByUser
	}
	if o.ReasonForChange.IsSet() {
		toSerialize["reasonForChange"] = o.ReasonForChange.Get()
	}
	if o.TrialMinutes.IsSet() {
		toSerialize["trialMinutes"] = o.TrialMinutes.Get()
	}
	if o.UnitName.IsSet() {
		toSerialize["unitName"] = o.UnitName.Get()
	}
	if o.PricePerUnitUsd.IsSet() {
		toSerialize["pricePerUnitUsd"] = o.PricePerUnitUsd.Get()
	}
	if o.MinimalMaxTotalChargeUsd.IsSet() {
		toSerialize["minimalMaxTotalChargeUsd"] = o.MinimalMaxTotalChargeUsd.Get()
	}
	if o.PricingPerEvent != nil {
		toSerialize["pricingPerEvent"] = o.PricingPerEvent
	}
	return toSerialize, nil
}

func (o *CurrentPricingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varCurrentPricingInfo := _CurrentPricingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCurrentPricingInfo)

	if err != nil {
		return err
	}

	*o = CurrentPricingInfo(varCurrentPricingInfo)

	return err
}

type NullableCurrentPricingInfo struct {
	value *CurrentPricingInfo
	isSet bool
}

func (v NullableCurrentPricingInfo) Get() *CurrentPricingInfo {
	return v.value
}

func (v *NullableCurrentPricingInfo) Set(val *CurrentPricingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCurrentPricingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCurrentPricingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurrentPricingInfo(val *CurrentPricingInfo) *NullableCurrentPricingInfo {
	return &NullableCurrentPricingInfo{value: val, isSet: true}
}

func (v NullableCurrentPricingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurrentPricingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
