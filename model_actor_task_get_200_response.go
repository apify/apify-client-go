...
// checks if the ActorTaskGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActorTaskGet200Response{}

// ActorTaskGet200Response struct for ActorTaskGet200Response
type ActorTaskGet200Response struct {
	Data Task `json:"data"`
}

type _ActorTaskGet200Response ActorTaskGet200Response

// NewActorTaskGet200Response instantiates a new ActorTaskGet200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewActorTaskGet200Response(data Task) *ActorTaskGet200Response {
	this := ActorTaskGet200Response{}
	this.Data = data
	return &this
}

// NewActorTaskGet200ResponseWithDefaults instantiates a new ActorTaskGet200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewActorTaskGet200ResponseWithDefaults() *ActorTaskGet200Response {
	this := ActorTaskGet200Response{}
	return &this
}

// GetData returns the Data field value
func (o *ActorTaskGet200Response) GetData() Task {
	if o == nil {
		var ret Task
		return ret
	}
...
func (o *ActorTaskGet200Response) GetDataOk() (*Task, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ActorTaskGet200Response) SetData(v Task) {
	o.Data = v
}

func (o ActorTaskGet200Response) MarshalJSON() ([]byte, error) {
...
func (o ActorTaskGet200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *ActorTaskGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActorTaskGet200Response := _ActorTaskGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActorTaskGet200Response)

	if err != nil {
		return err
	}

	*o = ActorTaskGet200Response(varActorTaskGet200Response)

	return err
}

type NullableActorTaskGet200Response struct {
	value *ActorTaskGet200Response
	isSet bool
}

func (v NullableActorTaskGet200Response) Get() *ActorTaskGet200Response {
	return v.value
}

func (v *NullableActorTaskGet200Response) Set(val *ActorTaskGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActorTaskGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActorTaskGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActorTaskGet200Response(val *ActorTaskGet200Response) *NullableActorTaskGet200Response {
	return &NullableActorTaskGet200Response{value: val, isSet: true}
}

func (v NullableActorTaskGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActorTaskGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
