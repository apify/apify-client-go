...
// checks if the RequestRegistration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestRegistration{}

// RequestRegistration Result of registering a request in the request queue, either by adding a new request or updating an existing one.
...
type _RequestRegistration RequestRegistration
...
// GetWasAlreadyPresent returns the WasAlreadyPresent field value
func (o *RequestRegistration) GetWasAlreadyPresent() bool {
	...
	return o.WasAlreadyPresent
}

// GetWasAlreadyPresentOk returns a tuple with the WasAlreadyPresent field value
// and a boolean to check if the value has been set.
func (o *RequestRegistration) GetWasAlreadyPresentOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.WasAlreadyPresent, true
}

// SetWasAlreadyPresent sets field value
func (o *RequestRegistration) SetWasAlreadyPresent(v bool) {
	o.WasAlreadyPresent = v
}

// GetWasAlreadyHandled returns the WasAlreadyHandled field value
func (o *RequestRegistration) GetWasAlreadyHandled() bool {
	...
	return o.WasAlreadyHandled
}

// GetWasAlreadyHandledOk returns a tuple with the WasAlreadyHandled field value
// and a boolean to check if the value has been set.
func (o *RequestRegistration) GetWasAlreadyHandledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.WasAlreadyHandled, true
}

// SetWasAlreadyHandled sets field value
func (o *RequestRegistration) SetWasAlreadyHandled(v bool) {
	o.WasAlreadyHandled = v
}

func (o RequestRegistration) MarshalJSON() ([]byte, error) {
...
func (o RequestRegistration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["requestId"] = o.RequestId
	toSerialize["wasAlreadyPresent"] = o.WasAlreadyPresent
	toSerialize["wasAlreadyHandled"] = o.WasAlreadyHandled
	return toSerialize, nil
}

func (o *RequestRegistration) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestRegistration := _RequestRegistration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRequestRegistration)

	if err != nil {
		return err
	}

	*o = RequestRegistration(varRequestRegistration)

	return err
}

type NullableRequestRegistration struct {
	value *RequestRegistration
	isSet bool
}

func (v NullableRequestRegistration) Get() *RequestRegistration {
	return v.value
}

func (v *NullableRequestRegistration) Set(val *RequestRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestRegistration(val *RequestRegistration) *NullableRequestRegistration {
	return &NullableRequestRegistration{value: val, isSet: true}
}

func (v NullableRequestRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
