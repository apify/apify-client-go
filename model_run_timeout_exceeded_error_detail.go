...
// checks if the RunTimeoutExceededErrorDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunTimeoutExceededErrorDetail{}

// RunTimeoutExceededErrorDetail struct for RunTimeoutExceededErrorDetail
...
// NewRunTimeoutExceededErrorDetail instantiates a new RunTimeoutExceededErrorDetail object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRunTimeoutExceededErrorDetail() *RunTimeoutExceededErrorDetail {
	this := RunTimeoutExceededErrorDetail{}
	return &this
}

// NewRunTimeoutExceededErrorDetailWithDefaults instantiates a new RunTimeoutExceededErrorDetail object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRunTimeoutExceededErrorDetailWithDefaults() *RunTimeoutExceededErrorDetail {
	this := RunTimeoutExceededErrorDetail{}
	return &this
}

// GetType returns the Type field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RunTimeoutExceededErrorDetail) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *RunTimeoutExceededErrorDetail) GetTypeOk() (*interface{}, bool) {
...
func (o *RunTimeoutExceededErrorDetail) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *RunTimeoutExceededErrorDetail) SetType(v interface{}) {
	o.Type = v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *RunTimeoutExceededErrorDetail) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *RunTimeoutExceededErrorDetail) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *RunTimeoutExceededErrorDetail) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *RunTimeoutExceededErrorDetail) SetMessage(v string) {
	o.Message = &v
}

func (o RunTimeoutExceededErrorDetail) MarshalJSON() ([]byte, error) {
...
func (o RunTimeoutExceededErrorDetail) ToMap() (map[string]interface{}, error) {
...
type NullableRunTimeoutExceededErrorDetail struct {
	value *RunTimeoutExceededErrorDetail
	isSet bool
}

func (v NullableRunTimeoutExceededErrorDetail) Get() *RunTimeoutExceededErrorDetail {
	return v.value
}

func (v *NullableRunTimeoutExceededErrorDetail) Set(val *RunTimeoutExceededErrorDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableRunTimeoutExceededErrorDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableRunTimeoutExceededErrorDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunTimeoutExceededErrorDetail(val *RunTimeoutExceededErrorDetail) *NullableRunTimeoutExceededErrorDetail {
	return &NullableRunTimeoutExceededErrorDetail{value: val, isSet: true}
}

func (v NullableRunTimeoutExceededErrorDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunTimeoutExceededErrorDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
