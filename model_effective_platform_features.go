...
// checks if the EffectivePlatformFeatures type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EffectivePlatformFeatures{}

// EffectivePlatformFeatures struct for EffectivePlatformFeatures
type EffectivePlatformFeatures struct {
	...
	PROXY EffectivePlatformFeature `json:"PROXY"`
	PROXY_EXTERNAL_ACCESS EffectivePlatformFeature `json:"PROXY_EXTERNAL_ACCESS"`
	PROXY_RESIDENTIAL EffectivePlatformFeature `json:"PROXY_RESIDENTIAL"`
	PROXY_SERPS EffectivePlatformFeature `json:"PROXY_SERPS"`
	WEBHOOKS EffectivePlatformFeature `json:"WEBHOOKS"`
	ACTORS_PUBLIC_ALL EffectivePlatformFeature `json:"ACTORS_PUBLIC_ALL"`
	ACTORS_PUBLIC_DEVELOPER EffectivePlatformFeature `json:"ACTORS_PUBLIC_DEVELOPER"`
}

type _EffectivePlatformFeatures EffectivePlatformFeatures

// NewEffectivePlatformFeatures instantiates a new EffectivePlatformFeatures object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEffectivePlatformFeatures(aCTORS EffectivePlatformFeature, sTORAGE EffectivePlatformFeature, sCHEDULER EffectivePlatformFeature, pROXY EffectivePlatformFeature, pROXYEXTERNALACCESS EffectivePlatformFeature, pROXYRESIDENTIAL EffectivePlatformFeature, pROXYSERPS EffectivePlatformFeature, wEBHOOKS EffectivePlatformFeature, aCTORSPUBLICALL EffectivePlatformFeature, aCTORSPUBLICDEVELOPER EffectivePlatformFeature) *EffectivePlatformFeatures {
	this := EffectivePlatformFeatures{}
	this.ACTORS = aCTORS
	this.STORAGE = sTORAGE
	this.SCHEDULER = sCHEDULER
	this.PROXY = pROXY
	this.PROXY_EXTERNAL_ACCESS = pROXYEXTERNALACCESS
	this.PROXY_RESIDENTIAL = pROXYRESIDENTIAL
	this.PROXY_SERPS = pROXYSERPS
	this.WEBHOOKS = wEBHOOKS
	this.ACTORS_PUBLIC_ALL = aCTORSPUBLICALL
	this.ACTORS_PUBLIC_DEVELOPER = aCTORSPUBLICDEVELOPER
	return &this
}

// NewEffectivePlatformFeaturesWithDefaults instantiates a new EffectivePlatformFeatures object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEffectivePlatformFeaturesWithDefaults() *EffectivePlatformFeatures {
	this := EffectivePlatformFeatures{}
	return &this
}

// GetACTORS returns the ACTORS field value
func (o *EffectivePlatformFeatures) GetACTORS() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}
...
func (o *EffectivePlatformFeatures) GetACTORSOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeatures) SetACTORS(v EffectivePlatformFeature) {
	o.ACTORS = v
}

// GetSTORAGE returns the STORAGE field value
func (o *EffectivePlatformFeatures) GetSTORAGE() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetSTORAGEOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeatures) SetSTORAGE(v EffectivePlatformFeature) {
	o.STORAGE = v
}

// GetSCHEDULER returns the SCHEDULER field value
func (o *EffectivePlatformFeatures) GetSCHEDULER() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetSCHEDULEROk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeatures) SetSCHEDULER(v EffectivePlatformFeature) {
	o.SCHEDULER = v
}

// GetPROXY returns the PROXY field value
func (o *EffectivePlatformFeatures) GetPROXY() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetPROXYOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PROXY, true
...
func (o *EffectivePlatformFeatures) SetPROXY(v EffectivePlatformFeature) {
	o.PROXY = v
}

// GetPROXY_EXTERNAL_ACCESS returns the PROXY_EXTERNAL_ACCESS field value
func (o *EffectivePlatformFeatures) GetPROXY_EXTERNAL_ACCESS() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}

	return o.PROXY_EXTERNAL_ACCESS
}

// GetPROXY_EXTERNAL_ACCESSOk returns a tuple with the PROXY_EXTERNAL_ACCESS field value
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetPROXY_EXTERNAL_ACCESSOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PROXY_EXTERNAL_ACCESS, true
}

// SetPROXY_EXTERNAL_ACCESS sets field value
func (o *EffectivePlatformFeatures) SetPROXY_EXTERNAL_ACCESS(v EffectivePlatformFeature) {
	o.PROXY_EXTERNAL_ACCESS = v
}

// GetPROXY_RESIDENTIAL returns the PROXY_RESIDENTIAL field value
func (o *EffectivePlatformFeatures) GetPROXY_RESIDENTIAL() EffectivePlatformFeature {
	...
	return o.PROXY_RESIDENTIAL
}

// GetPROXY_RESIDENTIALOk returns a tuple with the PROXY_RESIDENTIAL field value
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetPROXY_RESIDENTIALOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PROXY_RESIDENTIAL, true
}

// SetPROXY_RESIDENTIAL sets field value
func (o *EffectivePlatformFeatures) SetPROXY_RESIDENTIAL(v EffectivePlatformFeature) {
	o.PROXY_RESIDENTIAL = v
}

// GetPROXY_SERPS returns the PROXY_SERPS field value
func (o *EffectivePlatformFeatures) GetPROXY_SERPS() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}

	return o.PROXY_SERPS
}

// GetPROXY_SERPSOk returns a tuple with the PROXY_SERPS field value
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetPROXY_SERPSOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PROXY_SERPS, true
}

// SetPROXY_SERPS sets field value
func (o *EffectivePlatformFeatures) SetPROXY_SERPS(v EffectivePlatformFeature) {
	o.PROXY_SERPS = v
}

// GetWEBHOOKS returns the WEBHOOKS field value
func (o *EffectivePlatformFeatures) GetWEBHOOKS() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetWEBHOOKSOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EffectivePlatformFeatures) SetWEBHOOKS(v EffectivePlatformFeature) {
	o.WEBHOOKS = v
}

// GetACTORS_PUBLIC_ALL returns the ACTORS_PUBLIC_ALL field value
func (o *EffectivePlatformFeatures) GetACTORS_PUBLIC_ALL() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}

	return o.ACTORS_PUBLIC_ALL
}

// GetACTORS_PUBLIC_ALLOk returns a tuple with the ACTORS_PUBLIC_ALL field value
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetACTORS_PUBLIC_ALLOk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ACTORS_PUBLIC_ALL, true
}

// SetACTORS_PUBLIC_ALL sets field value
func (o *EffectivePlatformFeatures) SetACTORS_PUBLIC_ALL(v EffectivePlatformFeature) {
	o.ACTORS_PUBLIC_ALL = v
}

// GetACTORS_PUBLIC_DEVELOPER returns the ACTORS_PUBLIC_DEVELOPER field value
func (o *EffectivePlatformFeatures) GetACTORS_PUBLIC_DEVELOPER() EffectivePlatformFeature {
	if o == nil {
		var ret EffectivePlatformFeature
		return ret
	}

	return o.ACTORS_PUBLIC_DEVELOPER
}

// GetACTORS_PUBLIC_DEVELOPEROk returns a tuple with the ACTORS_PUBLIC_DEVELOPER field value
// and a boolean to check if the value has been set.
func (o *EffectivePlatformFeatures) GetACTORS_PUBLIC_DEVELOPEROk() (*EffectivePlatformFeature, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ACTORS_PUBLIC_DEVELOPER, true
}

// SetACTORS_PUBLIC_DEVELOPER sets field value
func (o *EffectivePlatformFeatures) SetACTORS_PUBLIC_DEVELOPER(v EffectivePlatformFeature) {
	o.ACTORS_PUBLIC_DEVELOPER = v
}

func (o EffectivePlatformFeatures) MarshalJSON() ([]byte, error) {
...
func (o EffectivePlatformFeatures) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ACTORS"] = o.ACTORS
	toSerialize["STORAGE"] = o.STORAGE
	toSerialize["SCHEDULER"] = o.SCHEDULER
	toSerialize["PROXY"] = o.PROXY
	toSerialize["PROXY_EXTERNAL_ACCESS"] = o.PROXY_EXTERNAL_ACCESS
	toSerialize["PROXY_RESIDENTIAL"] = o.PROXY_RESIDENTIAL
	toSerialize["PROXY_SERPS"] = o.PROXY_SERPS
	toSerialize["WEBHOOKS"] = o.WEBHOOKS
	toSerialize["ACTORS_PUBLIC_ALL"] = o.ACTORS_PUBLIC_ALL
	toSerialize["ACTORS_PUBLIC_DEVELOPER"] = o.ACTORS_PUBLIC_DEVELOPER
	return toSerialize, nil
}

func (o *EffectivePlatformFeatures) UnmarshalJSON(data []byte) (err error) {
	...
	varEffectivePlatformFeatures := _EffectivePlatformFeatures{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEffectivePlatformFeatures)

	if err != nil {
		return err
	}

	*o = EffectivePlatformFeatures(varEffectivePlatformFeatures)

	return err
}

type NullableEffectivePlatformFeatures struct {
	value *EffectivePlatformFeatures
	isSet bool
}

func (v NullableEffectivePlatformFeatures) Get() *EffectivePlatformFeatures {
	return v.value
}

func (v *NullableEffectivePlatformFeatures) Set(val *EffectivePlatformFeatures) {
	v.value = val
	v.isSet = true
}

func (v NullableEffectivePlatformFeatures) IsSet() bool {
	return v.isSet
}

func (v *NullableEffectivePlatformFeatures) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEffectivePlatformFeatures(val *EffectivePlatformFeatures) *NullableEffectivePlatformFeatures {
	return &NullableEffectivePlatformFeatures{value: val, isSet: true}
}

func (v NullableEffectivePlatformFeatures) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEffectivePlatformFeatures) UnmarshalJSON(src []byte) error {
	v.isSet = true
