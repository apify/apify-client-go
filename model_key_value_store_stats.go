...
// checks if the KeyValueStoreStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyValueStoreStats{}

// KeyValueStoreStats struct for KeyValueStoreStats
type KeyValueStoreStats struct {
	ReadCount int32 `json:"readCount"`
	WriteCount int32 `json:"writeCount"`
	DeleteCount int32 `json:"deleteCount"`
	ListCount int32 `json:"listCount"`
	S3StorageBytes *int32 `json:"s3StorageBytes,omitempty"`
	StorageBytes *int32 `json:"storageBytes,omitempty"`
}

type _KeyValueStoreStats KeyValueStoreStats
...
// GetDeleteCount returns the DeleteCount field value
func (o *KeyValueStoreStats) GetDeleteCount() int32 {
	...
	return o.DeleteCount
}

// GetDeleteCountOk returns a tuple with the DeleteCount field value
// and a boolean to check if the value has been set.
func (o *KeyValueStoreStats) GetDeleteCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DeleteCount, true
}

// SetDeleteCount sets field value
func (o *KeyValueStoreStats) SetDeleteCount(v int32) {
	o.DeleteCount = v
}

// GetListCount returns the ListCount field value
...
// GetListCountOk returns a tuple with the ListCount field value
// and a boolean to check if the value has been set.
func (o *KeyValueStoreStats) GetListCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ListCount, true
}

// SetListCount sets field value
func (o *KeyValueStoreStats) SetListCount(v int32) {
	o.ListCount = v
}

// GetS3StorageBytes returns the S3StorageBytes field value if set, zero value otherwise.
func (o *KeyValueStoreStats) GetS3StorageBytes() int32 {
	if o == nil || IsNil(o.S3StorageBytes) {
		var ret int32
		return ret
	}
	return *o.S3StorageBytes
}

// GetS3StorageBytesOk returns a tuple with the S3StorageBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *KeyValueStoreStats) GetS3StorageBytesOk() (*int32, bool) {
	if o == nil || IsNil(o.S3StorageBytes) {
		return nil, false
	}
	return o.S3StorageBytes, true
}
...
// SetS3StorageBytes gets a reference to the given int32 and assigns it to the S3StorageBytes field.
...
func (o KeyValueStoreStats) MarshalJSON() ([]byte, error) {
...
func (o KeyValueStoreStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["readCount"] = o.ReadCount
	toSerialize["writeCount"] = o.WriteCount
	toSerialize["deleteCount"] = o.DeleteCount
	toSerialize["listCount"] = o.ListCount
	if !IsNil(o.S3StorageBytes) {
		toSerialize["s3StorageBytes"] = o.S3StorageBytes
	}
...
func (o *KeyValueStoreStats) UnmarshalJSON(data []byte) (err error) {
	...
	varKeyValueStoreStats := _KeyValueStoreStats{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeyValueStoreStats)

	if err != nil {
		return err
	}

	*o = KeyValueStoreStats(varKeyValueStoreStats)

	return err
}

type NullableKeyValueStoreStats struct {
	value *KeyValueStoreStats
	isSet bool
}

func (v NullableKeyValueStoreStats) Get() *KeyValueStoreStats {
	return v.value
}

func (v *NullableKeyValueStoreStats) Set(val *KeyValueStoreStats) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyValueStoreStats) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyValueStoreStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyValueStoreStats(val *KeyValueStoreStats) *NullableKeyValueStoreStats {
	return &NullableKeyValueStoreStats{value: val, isSet: true}
}

func (v NullableKeyValueStoreStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyValueStoreStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
