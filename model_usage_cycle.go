...
// checks if the UsageCycle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsageCycle{}

// UsageCycle struct for UsageCycle
type UsageCycle struct {
	StartAt time.Time `json:"startAt"`
	EndAt time.Time `json:"endAt"`
}

type _UsageCycle UsageCycle
...
func (o UsageCycle) MarshalJSON() ([]byte, error) {
...
func (o UsageCycle) ToMap() (map[string]interface{}, error) {
...
func (o *UsageCycle) UnmarshalJSON(data []byte) (err error) {
	...
	varUsageCycle := _UsageCycle{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsageCycle)

	if err != nil {
		return err
	}

	*o = UsageCycle(varUsageCycle)

	return err
}

type NullableUsageCycle struct {
	value *UsageCycle
	isSet bool
}

func (v NullableUsageCycle) Get() *UsageCycle {
	return v.value
}

func (v *NullableUsageCycle) Set(val *UsageCycle) {
	v.value = val
	v.isSet = true
}

func (v NullableUsageCycle) IsSet() bool {
	return v.isSet
}

func (v *NullableUsageCycle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsageCycle(val *UsageCycle) *NullableUsageCycle {
	return &NullableUsageCycle{value: val, isSet: true}
}

func (v NullableUsageCycle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsageCycle) UnmarshalJSON(src []byte) error {
	v.isSet = true
