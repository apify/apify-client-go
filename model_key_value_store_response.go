...
// checks if the KeyValueStoreResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyValueStoreResponse{}
...
type _KeyValueStoreResponse KeyValueStoreResponse

// NewKeyValueStoreResponse instantiates a new KeyValueStoreResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewKeyValueStoreResponse(data KeyValueStore) *KeyValueStoreResponse {
	this := KeyValueStoreResponse{}
	this.Data = data
	return &this
}

// NewKeyValueStoreResponseWithDefaults instantiates a new KeyValueStoreResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewKeyValueStoreResponseWithDefaults() *KeyValueStoreResponse {
	this := KeyValueStoreResponse{}
	return &this
}

// GetData returns the Data field value
func (o *KeyValueStoreResponse) GetData() KeyValueStore {
	if o == nil {
		var ret KeyValueStore
		return ret
	}
...
func (o *KeyValueStoreResponse) GetDataOk() (*KeyValueStore, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *KeyValueStoreResponse) SetData(v KeyValueStore) {
	o.Data = v
}

func (o KeyValueStoreResponse) MarshalJSON() ([]byte, error) {
...
func (o KeyValueStoreResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	return toSerialize, nil
}

func (o *KeyValueStoreResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varKeyValueStoreResponse := _KeyValueStoreResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeyValueStoreResponse)

	if err != nil {
		return err
	}

	*o = KeyValueStoreResponse(varKeyValueStoreResponse)

	return err
}

type NullableKeyValueStoreResponse struct {
	value *KeyValueStoreResponse
	isSet bool
}

func (v NullableKeyValueStoreResponse) Get() *KeyValueStoreResponse {
	return v.value
}

func (v *NullableKeyValueStoreResponse) Set(val *KeyValueStoreResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyValueStoreResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyValueStoreResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyValueStoreResponse(val *KeyValueStoreResponse) *NullableKeyValueStoreResponse {
	return &NullableKeyValueStoreResponse{value: val, isSet: true}
}

func (v NullableKeyValueStoreResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyValueStoreResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
