...
// ActorsActorVersionsAPIService ActorsActorVersionsAPI service
type ActorsActorVersionsAPIService service

type ApiActVersionDeleteRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
}

func (r ApiActVersionDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActVersionDeleteExecute(r)
}

/*
ActVersionDelete Delete version
...
Deletes a specific version of Actor's source code.
 ...
 @param versionNumber Actor version.
 @return ApiActVersionDeleteRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionDelete(ctx context.Context, actorId string, versionNumber string) ApiActVersionDeleteRequest {
	return ApiActVersionDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsActorVersionsAPIService) ActVersionDeleteExecute(r ApiActVersionDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/versions/{versionNumber}"
...
type ApiActVersionEnvVarDeleteRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
func (r ApiActVersionEnvVarDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarDeleteExecute(r)
}

/*
ActVersionEnvVarDelete Delete environment variable
...
Deletes a specific environment variable.
 ...
 @return ApiActVersionEnvVarDeleteRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarDelete(ctx context.Context, actorId string, versionNumber string, envVarName string) ApiActVersionEnvVarDeleteRequest {
	return ApiActVersionEnvVarDeleteRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarDeleteExecute(r ApiActVersionEnvVarDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/versions/{versionNumber}/env-vars/{envVarName}"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versionNumber"+"}", url.PathEscape(parameterValueToString(r.versionNumber, "versionNumber")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"envVarName"+"}", url.PathEscape(parameterValueToString(r.envVarName, "envVarName")), -1)
...
type ApiActVersionEnvVarGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
func (r ApiActVersionEnvVarGetRequest) Execute() (*EnvVarResponse, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarGetExecute(r)
}

/*
ActVersionEnvVarGet Get environment variable
...
If `isSecret` is set to `true`, then `value` will never be returned.
 ...
 @param versionNumber Actor version.
 @param envVarName The name of the environment variable
 @return ApiActVersionEnvVarGetRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarGet(ctx context.Context, actorId string, versionNumber string, envVarName string) ApiActVersionEnvVarGetRequest {
	return ApiActVersionEnvVarGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarGetExecute(r ApiActVersionEnvVarGetRequest) (*EnvVarResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EnvVarResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActVersionEnvVarPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
// 
func (r ApiActVersionEnvVarPostRequest) EnvVarRequest(envVarRequest EnvVarRequest) ApiActVersionEnvVarPostRequest {
	r.envVarRequest = &envVarRequest
	return r
}

func (r ApiActVersionEnvVarPostRequest) Execute() (*EnvVarResponse, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarPostExecute(r)
}

/*
ActVersionEnvVarPost Update environment variable (POST)
...
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarPost(ctx context.Context, actorId string, versionNumber string, envVarName string) ApiActVersionEnvVarPostRequest {
	return ApiActVersionEnvVarPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return EnvVarResponse
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarPostExecute(r ApiActVersionEnvVarPostRequest) (*EnvVarResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.envVarRequest == nil {
		return localVarReturnValue, nil, reportError("envVarRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.envVarRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiActVersionEnvVarPutRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
// 
func (r ApiActVersionEnvVarPutRequest) EnvVarRequest(envVarRequest EnvVarRequest) ApiActVersionEnvVarPutRequest {
	r.envVarRequest = &envVarRequest
	return r
}

func (r ApiActVersionEnvVarPutRequest) Execute() (*EnvVarResponse, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarPutExecute(r)
}

/*
ActVersionEnvVarPut Update environment variable
...
endpoint.
 ...
 @param versionNumber Actor version.
 @param envVarName The name of the environment variable
 @return ApiActVersionEnvVarPutRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarPut(ctx context.Context, actorId string, versionNumber string, envVarName string) ApiActVersionEnvVarPutRequest {
	return ApiActVersionEnvVarPutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return EnvVarResponse
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarPutExecute(r ApiActVersionEnvVarPutRequest) (*EnvVarResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActVersionEnvVarsGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
func (r ApiActVersionEnvVarsGetRequest) Execute() (*ListOfEnvVarsResponse, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarsGetExecute(r)
}

/*
ActVersionEnvVarsGet Get list of environment variables
...
The response is a JSON object with the list of [EnvVar objects](#/reference/actors/environment-variable-object), where each contains basic information about a single environment variable.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param versionNumber Actor version.
 @return ApiActVersionEnvVarsGetRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarsGet(ctx context.Context, actorId string, versionNumber string) ApiActVersionEnvVarsGetRequest {
	return ApiActVersionEnvVarsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return ListOfEnvVarsResponse
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarsGetExecute(r ApiActVersionEnvVarsGetRequest) (*ListOfEnvVarsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfEnvVarsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/versions/{versionNumber}/env-vars"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versionNumber"+"}", url.PathEscape(parameterValueToString(r.versionNumber, "versionNumber")), -1)
...
type ApiActVersionEnvVarsPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
// 
func (r ApiActVersionEnvVarsPostRequest) EnvVarRequest(envVarRequest EnvVarRequest) ApiActVersionEnvVarsPostRequest {
	r.envVarRequest = &envVarRequest
	return r
}

func (r ApiActVersionEnvVarsPostRequest) Execute() (*EnvVarResponse, *http.Response, error) {
	return r.ApiService.ActVersionEnvVarsPostExecute(r)
}

/*
ActVersionEnvVarsPost Create environment variable
...
endpoint.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param versionNumber Actor version.
 @return ApiActVersionEnvVarsPostRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarsPost(ctx context.Context, actorId string, versionNumber string) ApiActVersionEnvVarsPostRequest {
	return ApiActVersionEnvVarsPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return EnvVarResponse
func (a *ActorsActorVersionsAPIService) ActVersionEnvVarsPostExecute(r ApiActVersionEnvVarsPostRequest) (*EnvVarResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionEnvVarsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActVersionGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
func (r ApiActVersionGetRequest) Execute() (*VersionResponse, *http.Response, error) {
	return r.ApiService.ActVersionGetExecute(r)
}

/*
ActVersionGet Get version
...
Gets a [Version object](#/reference/actors/version-object) that contains all the details about a specific version of an Actor.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param versionNumber Actor version.
 @return ApiActVersionGetRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionGet(ctx context.Context, actorId string, versionNumber string) ApiActVersionGetRequest {
	return ApiActVersionGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
func (a *ActorsActorVersionsAPIService) ActVersionGetExecute(r ApiActVersionGetRequest) (*VersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActVersionPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
	createOrUpdateVersionRequest *CreateOrUpdateVersionRequest
}

// 
func (r ApiActVersionPostRequest) CreateOrUpdateVersionRequest(createOrUpdateVersionRequest CreateOrUpdateVersionRequest) ApiActVersionPostRequest {
	r.createOrUpdateVersionRequest = &createOrUpdateVersionRequest
	return r
}

func (r ApiActVersionPostRequest) Execute() (*VersionResponse, *http.Response, error) {
	return r.ApiService.ActVersionPostExecute(r)
}

/*
ActVersionPost Update version (POST)
...
This endpoint is an alias for the [`PUT` update version](#tag/ActorsVersion-object/operation/act_version_put) method and behaves identically.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param versionNumber Actor version.
 @return ApiActVersionPostRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionPost(ctx context.Context, actorId string, versionNumber string) ApiActVersionPostRequest {
	return ApiActVersionPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return VersionResponse
func (a *ActorsActorVersionsAPIService) ActVersionPostExecute(r ApiActVersionPostRequest) (*VersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createOrUpdateVersionRequest == nil {
		return localVarReturnValue, nil, reportError("createOrUpdateVersionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createOrUpdateVersionRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiActVersionPutRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	versionNumber string
...
// 
func (r ApiActVersionPutRequest) CreateOrUpdateVersionRequest(createOrUpdateVersionRequest CreateOrUpdateVersionRequest) ApiActVersionPutRequest {
	r.createOrUpdateVersionRequest = &createOrUpdateVersionRequest
	return r
}

func (r ApiActVersionPutRequest) Execute() (*VersionResponse, *http.Response, error) {
	return r.ApiService.ActVersionPutExecute(r)
}

/*
ActVersionPut Update version
...
returned by the [Get version](#/reference/actors/version-object/get-version) endpoint.
 ...
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @param versionNumber Actor version.
 @return ApiActVersionPutRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionPut(ctx context.Context, actorId string, versionNumber string) ApiActVersionPutRequest {
	return ApiActVersionPutRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return VersionResponse
func (a *ActorsActorVersionsAPIService) ActVersionPutExecute(r ApiActVersionPutRequest) (*VersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiActVersionsGetRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
}

func (r ApiActVersionsGetRequest) Execute() (*ListOfVersionsResponse, *http.Response, error) {
	return r.ApiService.ActVersionsGetExecute(r)
}

/*
ActVersionsGet Get list of versions
...
contains basic information about a single version.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActVersionsGetRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionsGet(ctx context.Context, actorId string) ApiActVersionsGetRequest {
	return ApiActVersionsGetRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return ListOfVersionsResponse
func (a *ActorsActorVersionsAPIService) ActVersionsGetExecute(r ApiActVersionsGetRequest) (*ListOfVersionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOfVersionsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/actors/{actorId}/versions"
	localVarPath = strings.Replace(localVarPath, "{"+"actorId"+"}", url.PathEscape(parameterValueToString(r.actorId, "actorId")), -1)
...
type ApiActVersionsPostRequest struct {
	ctx context.Context
	ApiService *ActorsActorVersionsAPIService
	actorId string
	createOrUpdateVersionRequest *CreateOrUpdateVersionRequest
...
// 
func (r ApiActVersionsPostRequest) CreateOrUpdateVersionRequest(createOrUpdateVersionRequest CreateOrUpdateVersionRequest) ApiActVersionsPostRequest {
	r.createOrUpdateVersionRequest = &createOrUpdateVersionRequest
	return r
}

func (r ApiActVersionsPostRequest) Execute() (*VersionResponse, *http.Response, error) {
	return r.ApiService.ActVersionsPostExecute(r)
}

/*
ActVersionsPost Create version
...
returned by the [Get version](#/reference/actors/version-object/get-version) endpoint.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param actorId Actor ID or a tilde-separated owner's username and Actor name.
 @return ApiActVersionsPostRequest
*/
func (a *ActorsActorVersionsAPIService) ActVersionsPost(ctx context.Context, actorId string) ApiActVersionsPostRequest {
	return ApiActVersionsPostRequest{
		ApiService: a,
		ctx: ctx,
		actorId: actorId,
...
// Execute executes the request
//  @return VersionResponse
func (a *ActorsActorVersionsAPIService) ActVersionsPostExecute(r ApiActVersionsPostRequest) (*VersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActorsActorVersionsAPIService.ActVersionsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
